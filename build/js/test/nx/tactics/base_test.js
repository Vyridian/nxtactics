...
export default class nx_tactics_base_test {
  ...
  static test_coveragesummary() {
    const output = vx_core.f_new_from_type(
      ...
      "docnums", vx_core.f_new_from_type(vx_test.t_testcoveragenums, ":pct", 37, ":tests", 119, ":total", 319), 
      "funcnums", vx_core.f_new_from_type(vx_test.t_testcoveragenums, ":pct", 1, ":tests", 2, ":total", 128), 
      "bigospacenums", vx_core.f_new_from_type(vx_test.t_testcoveragenums, ":pct", 100, ":tests", 0, ":total", 0), 
      "bigotimenums", vx_core.f_new_from_type(vx_test.t_testcoveragenums, ":pct", 100, ":tests", 0, ":total", 0), 
      "totalnums", vx_core.f_new_from_type(vx_test.t_testcoveragenums, ":pct", 0, ":tests", 2, ":total", 319), 
    ...
    const output = vx_core.f_new_from_type(
      ...
      "funcmap",
        vx_core.f_new_from_type(
          ...
          "cardimagelist<-tactics-placekeys", 0,
          "cardimagelist<-tactics-unitkeys", 0,
          "cardimagelist<-unitlist", 0,
          "cardlist-copy<-card-count-isnum", 0,
          "cardlist-copy<-tactics-rulekey-count-isnum", 0,
          "cardlist-images<-tactics-places", 0,
          "cardlist-images<-tactics-units", 0,
          ...
          "skilllist<-tactics-keys", 0,
          "skilllistlist<-sectionlist", 0,
          "skillmap<-skilllist", 0,
          "skillmap<-tactics-keys", 0,
          ...
          "unit<-tactics-key", 0,
          "unitability<-tactics-key", 0,
          "unitabilitylist<-tactics-keys", 0,
          "unitabilitymap<-tactics-keys", 0,
          ...
          "unitmap<-tactics-keys", 0,
          "unitmap<-unitlist", 0,
          "unitpower<-tactics-key", 0,
          "unitpower<-tactics-key-abilities", 0,
          "unitpower<-tactics-key-lvl", 0,
          "unitpower<-tactics-key-lvl-abilities", 0,
          "unitpower<-tactics-key-lvl-abilities-items", 0,
          "unitpower<-tactics-key-lvl-rating-abilities", 0,
          "unitpower<-tactics-key-lvl-rating-abilities-items", 0,
          "unitpower<-tactics-key-rating", 0,
          "unitpower<-tactics-key-rating-abilities", 0,
          "unitpowerlist<-tactics-keys", 0,
          "unitpowermap<-tactics-keys", 0,
          "unitpowermap<-unitpowerlist", 0,
          "unitskill<-tactics-key", 0,
          "unitskill<-tactics-key-abilities", 0,
          "unitskill<-tactics-key-items", 0,
          "unitskill<-tactics-key-lvl", 0,
          "unitskill<-tactics-key-lvl-abilities", 0,
          "unitskill<-tactics-key-lvl-abilities-items", 0,
          "unitskill<-tactics-key-lvl-abilities-items-specialties", 0,
          "unitskill<-tactics-key-lvl-abilities-specialties", 0,
          "unitskill<-tactics-key-lvl-items", 0,
          "unitskill<-tactics-key-lvl-specialties", 0,
          "unitskilllist<-tactics-keys", 0,
          "unitskillmap<-tactics-keys", 0,
