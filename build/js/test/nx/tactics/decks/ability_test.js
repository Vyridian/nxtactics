...
export default class nx_tactics_decks_ability_test {


  static test_package(context) {
    const testcaselist = nx_tactics_decks_ability_test.test_cases(context)
    const output = vx_core.f_new_from_type(
      vx_test.t_testpackage,
      ":testpkg", "nx/tactics/decks/ability",
      ":caselist", testcaselist,
      ":coveragesummary", nx_tactics_decks_ability_test.test_coveragesummary(),
      ":coveragedetail", nx_tactics_decks_ability_test.test_coveragedetail()
    );
    return output;
  }
  ...
  static test_coveragedetail() {
    const output = vx_core.f_new_from_type(
      ...
      "funcmap",
        vx_core.f_new_from_type(
          vx_core.t_intmap,
          "abilitymap-tactics", 0,
          "tactics-abilitymap<-tactics", 0
        )
    )
    return output
  }
