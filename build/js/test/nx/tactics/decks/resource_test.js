...
import nx_tactics_decks_resource from "../../../../src/nx/tactics/decks/resource.js"
import vx_core from "../../../../src/vx/core.js"
import vx_test from "../../../../src/vx/test.js"
import nx_tactics_base from "../../../../src/nx/tactics/base.js"

export default class nx_tactics_decks_resource_test {


  static test_package(context) {
    const testcaselist = nx_tactics_decks_resource_test.test_cases(context)
    const output = vx_core.f_new_from_type(
      vx_test.t_testpackage,
      ":testpkg", "nx/tactics/decks/resource",
      ":caselist", testcaselist,
      ":coveragesummary", nx_tactics_decks_resource_test.test_coveragesummary(),
      ":coveragedetail", nx_tactics_decks_resource_test.test_coveragedetail()
    );
    return output;
  }
