...
export default class nx_tactics_books_magic_test {


  static test_package(context) {
    const testcaselist = nx_tactics_books_magic_test.test_cases(context)
    const output = vx_core.f_new_from_type(
      vx_test.t_testpackage,
      ":testpkg", "nx/tactics/books/magic",
      ":caselist", testcaselist,
      ":coveragesummary", nx_tactics_books_magic_test.test_coveragesummary(),
      ":coveragedetail", nx_tactics_books_magic_test.test_coveragedetail()
    );
    return output;
  }
