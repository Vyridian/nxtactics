...
export default class nx_tactics_books_combat_test {


  static test_package(context) {
    const testcaselist = nx_tactics_books_combat_test.test_cases(context)
    const output = vx_core.f_new_from_type(
      vx_test.t_testpackage,
      ":testpkg", "nx/tactics/books/combat",
      ":caselist", testcaselist,
      ":coveragesummary", nx_tactics_books_combat_test.test_coveragesummary(),
      ":coveragedetail", nx_tactics_books_combat_test.test_coveragedetail()
    );
    return output;
  }
  ...
  static test_coveragedetail() {
    const output = vx_core.f_new_from_type(
      ...
      "funcmap",
        vx_core.f_new_from_type(
          vx_core.t_intmap,
          "chapter_advanced_weaponry", 0,
          "chapter_combat_overview", 0,
          "chapter_early_weaponry", 0,
          "chapter_example_of_play", 0,
          "chapter_modern_equipment", 0,
          "chapter_rules", 0,
          "chapter_skills", 0,
          "tacticsbook", 0
        )
