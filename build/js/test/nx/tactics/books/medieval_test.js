...
export default class nx_tactics_books_medieval_test {


  static test_package(context) {
    const testcaselist = nx_tactics_books_medieval_test.test_cases(context)
    const output = vx_core.f_new_from_type(
      vx_test.t_testpackage,
      ":testpkg", "nx/tactics/books/medieval",
      ":caselist", testcaselist,
      ":coveragesummary", nx_tactics_books_medieval_test.test_coveragesummary(),
      ":coveragedetail", nx_tactics_books_medieval_test.test_coveragedetail()
    );
    return output;
  }
  ...
  static test_coveragedetail() {
    const output = vx_core.f_new_from_type(
      ...
      "funcmap",
        vx_core.f_new_from_type(
          vx_core.t_intmap,
          "chapter_medieval_english", 0,
          "chapter_medieval_french", 0,
