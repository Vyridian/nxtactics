...
export default class nx_tactics_books_characters_test {


  static test_package(context) {
    const testcaselist = nx_tactics_books_characters_test.test_cases(context)
    const output = vx_core.f_new_from_type(
      vx_test.t_testpackage,
      ":testpkg", "nx/tactics/books/characters",
      ":caselist", testcaselist,
      ":coveragesummary", nx_tactics_books_characters_test.test_coveragesummary(),
      ":coveragedetail", nx_tactics_books_characters_test.test_coveragedetail()
    );
    return output;
  }
    ...
    const output = vx_core.f_new_from_type(
      ...
      "funcmap",
        vx_core.f_new_from_type(
          vx_core.t_intmap,
          "chapter_cast", 0,
          "chapter_character_archetypes", 0,
          "chapter_characters_overview", 0,
          "chapter_creating_characters", 0,
          "chapter_props", 0,
          "chapter_sets", 0,
          "chapter_storytelling", 0,
          "tacticsbook", 0
        )
    )
    return output
