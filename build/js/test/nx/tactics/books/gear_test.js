...
export default class nx_tactics_books_gear_test {


  static test_package(context) {
    const testcaselist = nx_tactics_books_gear_test.test_cases(context)
    const output = vx_core.f_new_from_type(
      vx_test.t_testpackage,
      ":testpkg", "nx/tactics/books/gear",
      ":caselist", testcaselist,
      ":coveragesummary", nx_tactics_books_gear_test.test_coveragesummary(),
      ":coveragedetail", nx_tactics_books_gear_test.test_coveragedetail()
    );
    return output;
  }
  ...
  static test_coveragesummary() {
    const output = vx_core.f_new_from_type(
      ...
      "docnums", vx_core.f_new_from_type(vx_test.t_testcoveragenums, ":pct", 0, ":tests", 0, ":total", 4), 
  ...
  static test_coveragedetail() {
    const output = vx_core.f_new_from_type(
      ...
      "funcmap",
        vx_core.f_new_from_type(
          vx_core.t_intmap,
          "chapter_gear_construction", 0,
          "chapter_gear_items", 0,
          "chapter_gear_overview", 0,
          "tacticsbook", 0
        )
    )
    return output
