      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "Large Units",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Large Units", ":summary", "* [Action]: Vehicles with multiple crew members that take up more than 1 space, may take 1 Action per space.\nIt must, however, perform all Actions at the same time before further Movement."),
            "Huge Units",
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "Turn Radius",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Turn Radius", ":summary", "* Normally a unit can turn whenever it wants, but a unit moving at high speed or a unit that is not particularly\nagile will only be able to turn after moving a certain number of spaces.  The number of spaces a unit must move to\nturn is the turn radius.")
          )
        ),
  ...
  static f_chapter_land_sea_and_air_unit_types() {
    ...
    output = vx_core.f_new(
      ...
      vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new(
              ...
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_rulemap},
                ":Broadside",
                vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Broadside", ":image", "Rules/Images/Broadside.png", ":summary", "* Archaic ships mount large guns on each side of the ship and must turn sideways to attack targets.  All attacks\nfrom such guns may only fire directly at 90 degrees from the front of the ship.")
              ),
              ":unitmap",
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_unitmap},
        ...
        "Strategic Movement",
        vx_core.f_new({"any-1": nx_tactics_base.t_section}, ":name", "Strategic Movement")
      )
    )
    return output
  }
