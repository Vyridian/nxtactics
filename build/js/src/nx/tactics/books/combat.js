      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_itemmap},
            ":Buckler",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Buckler", ":classification", "Shield", ":armor", "1"),
            "Kite Shield",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Kite Shield", ":classification", "Shield", ":armor", "2"),
            "Legionary Shield",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Legionary Shield", ":classification", "Shield", ":armor", "2"),
            "Round Shield",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Round Shield", ":titles", "Hoplon Round Shield, Target Shield", ":classification", "Shield", ":armor", "2"),
            ":Shield",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Shield", ":titles", "Aegis, Heater", ":classification", "Shield", ":armor", "2"),
            "Tower Shield",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Tower Shield", ":titles", "Hoplite Shield", ":classification", "Shield", ":armor", "3"),
            "Wicker Shield",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Wicker Shield", ":classification", "Shield")
          )
        ),
        ":Axes",
        vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_itemmap},
            ":Backsword",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Backsword", ":classification", "Sword", ":energy", "100J", ":modifiers", "Bleeding"),
            "Bastard Sword",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Bastard Sword", ":classification", "Sword", ":energy", "100J", ":modifiers", "Bleeding"),
            ":Bokken",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Bokken", ":classification", "Sword"),
            ":Broadsword",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Broadsword", ":classification", "Sword", ":energy", "100J", ":modifiers", "Bleeding"),
            "Butterfly Sword",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Butterfly Sword", ":classification", "Sword", ":energy", "100J"),
            "Cavalry Sword",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Cavalry Sword", ":classification", "Sword", ":energy", "100J", ":modifiers", "Bleeding"),
            ":Cutlass",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Cutlass", ":classification", "Sword", ":energy", "100J", ":modifiers", "Bleeding"),
            ":Epee",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Epee", ":classification", "Sword", ":energy", "100J"),
            ":Falchion",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Falchion", ":summary", "* A short, cleaving sword for close-in combat used by many troops including archers.", ":classification", "Sword", ":energy", "100J"),
            ":Foil",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Foil", ":classification", "Sword", ":energy", "50J"),
            "Great Sword",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Great Sword", ":titles", "Two-handed Sword", ":classification", "Sword", ":energy", "200J", ":modifiers", "Bleeding"),
            "Hook Sword",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Hook Sword", ":classification", "Sword", ":energy", "100J"),
            ":Katana",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Katana", ":classification", "Sword", ":energy", "100J", ":modifiers", "Bleeding"),
            ":Katar",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Katar", ":classification", "Sword", ":energy", "100J"),
            ":Longsword",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Longsword", ":summary", "[Fight]: [Melee]\n[Damage]:10x1 [Pierce] [Slash]", ":classification", "Sword", ":energy", "100J"),
            ":Ninjato",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Ninjato", ":classification", "Sword", ":energy", "100J", ":modifiers", "Bleeding"),
            ":No-Dachi",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "No-Dachi", ":classification", "Sword", ":energy", "200J"),
            ":Rapier",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Rapier", ":classification", "Sword", ":energy", "100J", ":modifiers", "Bleeding, Piercing"),
            ":Saber",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Saber", ":classification", "Sword", ":energy", "100J", ":modifiers", "Bleeding"),
            ":Scimitar",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Scimitar", ":classification", "Sword", ":energy", "100J", ":modifiers", "Bleeding"),
            "Short Sword",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Short Sword", ":classification", "Sword", ":energy", "100J", ":modifiers", "Bleeding"),
            ":Tanto",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Tanto", ":classification", "Sword", ":energy", "100J"),
            ":Wakizashi",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Wakizashi", ":classification", "Sword", ":energy", "100J")
          )
        ),
        ":Archery",
        vx_core.f_new(
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_itemmap},
            ":C4",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "C4"),
            "Improvised Explosive Device (IED)",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Improvised Explosive Device (IED)"),
            "White Phosphorous Grenade",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "White Phosphorous Grenade")
          )
        ),
        "Modern Pistols",
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new(
              ...
              vx_core.f_new(
                ...
                ":Rally",
                vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Rally")
              )
            ),
            ":Military",
            vx_core.f_new(
