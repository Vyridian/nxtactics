      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            ":Jazeraint",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Jazeraint"),
            "Laminated Armor",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Laminated Armor", ":armor", "1mm"),
            "Leather Armor",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Leather Armor", ":armor", "0mm"),
            "Leather Pants",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Leather Pants", ":armor", "0mm"),
            "Leather Shirt",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Leather Shirt", ":armor", "0mm"),
            "Leather Vest",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Leather Vest", ":armor", "0mm"),
            "Padded Armor",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Padded Armor", ":armor", "0mm"),
            "Plate Armor",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Plate Armor", ":armor", "3mm"),
            ":Platemail",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Platemail", ":armor", "2mm"),
            "Quilted Armor",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Quilted Armor", ":armor", "0mm"),
            ":Ringmail",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Ringmail", ":armor", "1mm"),
            ":Scalemail",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Scalemail", ":armor", "2mm"),
            "Scale Barding",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Scale Barding", ":armor", "2mm"),
            "Splint Armor",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Splint Armor", ":titles", "Lamellar", ":armor", "2mm"),
            "Studded Leather Armor",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Studded Leather Armor", ":armor", "0mm")
          )
        ),
        ":Shields",
        vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "Improvised Weapons",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Improvised Weapons"),
            ":Shuriken",
