      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "Eugenic Warrior",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Eugenic Warrior", ":reference", "* Khan, Star Trek II", ":summary", "* Through bioengineering, an elite warrior caste has been created combining strategic genius, leadership skills,\nand physical perfection.  Unfortunately, they also develop incredible egos and megalomania.", ":titles", "Master Race, Super Soldier")
          )
        ),
        ":MegaCorps",
        vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            ":Netrunner",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Netrunner", ":summary", "* Outlaw computer jocks or hackers.  Some people do it for the glory; most do it for the money.  Information is\npower in the modern world and all the information is somewhere on the Net.  Further, the modern world is a marvel\nof automation, so a clever person may turn that automation to his own uses.", ":titles", "Crystaljock, Hacker"),
            ":Nomad",
            ...
            ":Rocker",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Rocker", ":summary", "* Zonedancing - Dancing turned into a dominance game.  A dancer attempts to persuade other dancers in his zone to\nconform to his movements using charisma, talent or violence.", ":titles", "Bard"),
            ":Solo",
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "Safe House",
            vx_core.f_new({"any-1": nx_tactics_base.t_scene}, ":name", "Safe House", ":summary", "* A small-time fixer has evidence of the identity of a cyber serial killer, the Night City Stalker.  Two news\norganizations are bidding on the deal, but the loser contacted the Stalker out of spite."),
            "Toxic Spill",
            vx_core.f_new({"any-1": nx_tactics_base.t_scene}, ":name", "Toxic Spill", ":summary", "* While guarding a 200 person Nomad camp, the well drill discovers a hidden toxic waste dump.  Alarms alert the\ndumping company that their little secret has been discovered, so they send a team to 'clean up' the problem.\n* The whole Nomad camp must evacuate 3 miles to town before they are silenced, unfortunately they do not have\nenough vehicles to do it in one trip."),
            "The Heist",
            vx_core.f_new(
              {"any-1": nx_tactics_base.t_scene},
              ":name",
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            ":Transjet",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Transjet", ":summary", "* The Transjet is the standard commercial airliner across the world. It flies up\nbeyond the atmosphere where it can travel at extreme speeds and then lands\nanywhere in the world within an hour.", ":titles", "Hopper, Transatmospheric Jet")
          )
        ),
        "Police Equipment",
        vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "Orca Medium Cruiser",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Orca Medium Cruiser", ":summary", "* Fully Submersible Medium Cruiser loaded with 6 Manta Fighters, 1 Pelican Transport, 6 Sea Lion ATVs, and\n4 Barracuda Submarines."),
            "Leviathan Command Carrier",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Leviathan Command Carrier", ":summary", "* Fully Submersible Heavy Carrier loaded with 12 Manta Fighters, 4 Pelican Transports, 6 Sea Lion ATVs, and\n8 Barracuda Submarines.")
          )
        ),
        "Body Armor",
        vx_core.f_new(
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Damocles Orbital Laser", ":image", "HighTech/DamoclesSatellite.jpg", ":summary", "* Orbital Laser Platform designed for strategic strikes against land targets. May also be used agaist\nlarge orbital targets or for asteroid defense."),
            "EMP Satellite",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "EMP Satellite", ":reference", "* What's it going to be, Plissken? Them or us? I shut down the third world, you win they lose. I shut\ndown America, they win, you lose. The more things change, the more they stay the same. - Snake Plissken,\nEscape from LA", ":titles", "Goldeneye"),
            "Hunter Killer Satellite",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Hunter Killer Satellite", ":summary", "* A combat ready satellite often masquerading as a peaceful version. Hunter Satellites act like UAV's\nquietly patrolling until their weaponry is needed, then they are disposable.", ":titles", "Battle Satellite"),
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "Gundarium Alpha",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Gundarium Alpha", ":summary", "Originally called Luna Titanium, it was renamed after the success of the RX-78 Gundam built from it.\nA super high-tensile alloy originally known as Luna Titanium.  Originally intended for use inside thermonuclear\nreactors, this alloy's superb strength, durability, heat resistance and radiation-absorbing properties make it\nan ideal material for mobile suit armor.", ":titles", "Gundarium, Luna Titanium"),
            "Gundarium Gamma",
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "L4: Avalon",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "L4: Avalon", ":summary", "The first of the L5 colonies, Avalon has the largest starship construction facilities. Its proximity\nto Earth and the Moon provide it optimal security and resources."),
            "L3: Eden",
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Titan Research Station", ":summary", "* A small, permanent research colony has been erected on Titan to study its\nunique atmosphere and geology. The hope was to discover evidence of primitive\nlife, but no life has yet to be discovered.")
          )
        )
      )
    )
