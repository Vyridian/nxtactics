...
export default class nx_tactics_books_high_technology {
  ...
  static f_chapter_car_wars() {
    ...
    output = vx_core.f_new({"any-1": nx_tactics_base.t_chapter}, ":name", "Car Wars")
    return output
  }
  ...
  static f_chapter_cyberpunk() {
    ...
    output = vx_core.f_new(
      ...
      "Cyberpunk",
      ":summary",
      "* The year is 2151.\n\nThings are pretty bad on planet Earth:\n* Global Warming - The build up of smothering greenhouse effect gases has resulted in the complete melting of the Arctic ice cap as well as much of the Antartic ice cap. Coastal areas have been inundated and global temperatures continue to rise, a new record every year.\n* Resource Depletion - As the climate changed, desperate farmers overfarmed their land, increasing erosion and therefore food prices. Fossil fuels became increasingly scarce and given the ongoing climate problems, ecologically unsuitable.\n* Aging Population -\n* Economic Collapse -\n\nThings are slightly better in space:\n* Orbital Stations - For the last hundred years, large space colonies have been constructed at the five Lagrange points around Earth. Relative to Earth, the Orbital stations are gleaming paradises of corporate efficiency. Corporate interests are certainly strong on the Orbital colonies, and the Orbitals increasingly chafe at Earth's taxation of their goods and the high tariffs on imports.\n* Luna - Huge moon bases dot the lunar surface. With its low gravity and limitless lunar rock, the Moon is the natural construction center for most Orbital facilities and spaceships. Surface and underground mining operations go around the clock. Enormous massdrivers propel the material into Earth orbit.\n* Mercury - Solar stations on Mercury provide limitless power while the molten surface provides limitless ore. Though the surface is hellish and survival is difficult, Mercury provides wealth beyond imagining to those able to survive. The population is 90% male with most residents on a 6 year work contract. After the contract they usually return to wherever they came from with enough money to buy a house and start a family. Like a military veteran, Mercury companies also offer generous benefits for the rest of the contractor's life or generous death benefits to their family if they don't survive. Despite extensive safety systems, the fatatlity rate remains 1 in 20 even among these hardy folk. Politically, Mercury is extremely independent and has little patience for the affairs of the other planets.\n* Venus\n* Mars\n* Asteroid Belt - Though Luna provides a steady supply of material to the colonies, whole Asteroids can be ferried from the Asteroid Belt to create instant colonies. Further, the valuable minerals in an asteroid are easier to detect and mine than in either Lunar or Terrestrial mines. The Asteroid field is large, however, so a whole crop of freelance prospectors have travelled to the Asteroid Belt in a high-tech gold-rush.\n* Jupiter\n* Saturn\n\n* Cryomax - Maximum security prison where prisoners are stored in partial cryonic suspension to maximize space.\n** Reference - Demolition Man\n* Crystal - Liquid crystal computer matrix",
      ":sectionmap",
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            ":Innovator",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Innovator", ":reference", "Appleseed, Genetic Android, Bioroid", ":summary", "* Genetically engineered artificial human. Theoretically superior to humans in every way, they are purposely implanted with a number of limitations:\n* They cannot reproduce.\n* They must undergo routine medical treatments or their genetic structure breaks down.\n* They are peaceful in nature to buffer mankind's tendency to violence.\n* They defer to human authority unless they believe that the authority will harm mankind."),
            "Cycle Police",
            vx_core.f_new(
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    ...
                    ":Motorcycles",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unitspecialty}, ":name", "Motorcycles")
                  )
                )
              )
            ),
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "Medical Technician",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Medical Technician", ":titles", "Med Tech"),
            ":Scientist",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Scientist")
          )
        ),
        "Offworld Colonies",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            ":Miner",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Miner"),
            ":Pirate",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Pirate")
          )
        ),
        ":Sprawls",
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            ":Netrunner",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Netrunner", ":summary", "* Outlaw computer jocks or hackers. Some people do it for the glory; most do it for the money. Information is power in the modern world and all the information is somewhere on the Net. Further, the modern world is a marvel of automation, so a clever person may turn that automation to his own uses.", ":titles", "Crystaljock, Hacker"),
            ":Nomad",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Nomad", ":summary", "* Deltajock - A pilot of delta-winged smuggling craft\n* Panzerjock - A driver of armored smuggling hovercraft", ":titles", "Deltajock, Gypsy, Linerunner, Panzerjock, Road Warrior, Smuggler"),
            ":Rocker",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Rocker", ":summary", "* Zonedancing - Dancing turned into a dominance game. A dancer attempts to persuade other dancers in his zone to conform to his movements using charisma, talent or violence.", ":titles", "Bard"),
            ":Solo",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Solo", ":reference", "* I don't want to walk this Earth if I gotta do it solo...so...low. - Iyaz, Solo", ":titles", "Assassin, Hit Man"),
            ":Tech",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Tech", ":titles", "Cybertech")
          )
        )
      )
    )
  ...
  static f_chapter_cyberpunk_campaign() {
    ...
    output = vx_core.f_new(
      ...
      vx_core.f_new(
        {"any-1": nx_tactics_base.t_sectionmap},
        "Cyberpunk Overview",
        vx_core.f_new({"any-1": nx_tactics_base.t_section}, ":name", "Cyberpunk Overview", ":summary", "* Events Leading to War\n* Overview of the War\n* Aftermath"),
        "Car Wars",
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_section},
          ":name",
          ...
          vx_core.f_new(
            ...
            vx_core.f_new(
              ...
              "Escort Duty",
              ":summary",
              "* An Agricorp has commissioned some independents to covertly escort an unmarked tractor-trailer 1900 miles from their site in La Jolla to a USDA facility near Nashville, TN.\n* A rival has sent its own independents to get their hands on the cargo.\n* Note: The cargo/escort is a decoy for the real shipment.",
              ":teammap",
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_teammap},
                ":Escort",
                vx_core.f_new({"any-1": nx_tactics_base.t_team}, ":name", "Escort", ":completevictory", "$1000/each if cargo delivered intact.", ":forces", "* 1 Tractor-trailer\n* 2 Sedans", ":partialvictory", "Prevent enemy from taking any of the shipment."),
                ":Interceptors",
                vx_core.f_new({"any-1": nx_tactics_base.t_team}, ":name", "Interceptors", ":completevictory", "Capture the entire shipment.", ":forces", "* 1 Van\n* 3 Sedans", ":partialvictory", "Capture any of the shipment.")
              )
            ),
            "Safe House",
            vx_core.f_new({"any-1": nx_tactics_base.t_scene}, ":name", "Safe House", ":summary", "* A small-time fixer has evidence of the identity of a cyber serial killer, the Night City Stalker. Two news organizations are bidding on the deal, but the loser contacted the Stalker out of spite."),
            "Toxic Spill",
            vx_core.f_new({"any-1": nx_tactics_base.t_scene}, ":name", "Toxic Spill", ":summary", "* While guarding a 200 person Nomad camp, the well drill discovers a hidden toxic waste dump.  Alarms alert the dumping company that their little secret has been discovered, so they send a team to 'clean up' the problem.\n* The whole Nomad camp must evacuate 3 miles to town before they are silenced, unfortunately they do not have enough vehicles to do it in one trip."),
            "The Heist",
            vx_core.f_new(
              {"any-1": nx_tactics_base.t_scene},
              ":name",
              "The Heist",
              ":summary",
              "* In a winter storm, a shipment of Palladium is diverted to a small warehouse in a corporate park. It will not be moved until the weather turns, so it is a perfect opportunity to break in and steal the goods.\n* During the storm, the skies are dangerous, and even the roads are fairly dicey.  Snowmobile are certainly an option.",
              ":teammap",
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_teammap},
                ":Thieves",
                vx_core.f_new({"any-1": nx_tactics_base.t_team}, ":name", "Thieves", ":completevictory", "Capture the whole shipment.", ":forces", "* 10 Thieves\n* 5 Snowmobiles\n* 3 Sedans", ":partialvictory", "Take at least half of the shipment."),
                ":Guards",
                vx_core.f_new({"any-1": nx_tactics_base.t_team}, ":name", "Guards", ":completevictory", "Protect the entire shipment.", ":forces", "* 10 Armed and Armored Guards\n* 10 Unarmored, sleeping Guards\n * 5 Sedans\n * 2 Helicopters", ":partialvictory", "Protect at least half of the shipment.")
              )
            )
          )
        )
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Hypersonic Airliner",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Hypersonic Airliner", ":summary", "* Suborbital passenger plane that can make intercontinental flights at Mach 5+\n* Such high speed planes are all wedge shaped Hypersonic Waveriders."),
            "Suborbital Shuttle",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Suborbital Shuttle", ":summary", "* Suborbital passenger plane that can reach the upper atmosphere and connect to an [Orbital Skyhook Satellite]'s tether. The end of the tether holds a small wing shaped cargo container.  Passengers and cargo are quickly exchanged, and the container is reeled back up to the skyhook while the plane returns to its launch site.")
          )
        ),
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Valkyrie Air Cavalry", ":classification", "Lt. Aircraft"),
            "Aurora Transatmospheric Fighter",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Aurora Transatmospheric Fighter", ":summary", "* A sleek, shuttle-like jet with speeds of Mach 5. A nuclear engine, stealth armor, full environmental containment, and a virtual or direct neural link make this one-man craft the deadliest thing in the skies.\n* It carries twin 30mm autocannons, a plasma cannon, 16 air-to-air missiles, and 2 fuel air explosives for ground targets.", ":classification", "Lt. Aircraft")
          )
        )
      )
    )
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            ":Autobike",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Autobike", ":summary", "* Autonomous motorcycle used for most transit. A small fraction of the Autocar fleet is filled by Autobikes. Though slightly cheaper to rent than Autocars and better in tight traffic, most people use Autocars exclusively."),
            ":Autocar",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Autocar", ":summary", "* Autonomous car used for most transit. Ordinary citizens rarely own their own vehicles, instead they summon an automated rental car with their phone that takes them directly to their destination. Autocars are parked throughout populated areas, so summoning one usually takes seconds. Autocars coordinate with each other and can travel at high speeds in tight traffic without incident.\n* History - Automated cars took over major cities within years of their invention. They solved traffic, parking, accident, and environmental problems all at once while offering cheaper per mile travel than owning your own vehicle. They rapidly made taxi and ridesharing solutions obsolete, and it soon became illegal for a human to drive a vehicle because autocars were so much safer. Soon all mass transit systems reduced down to autocars and some autobikes."),
            ":Cyberchip",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Cyberchip", ":summary", "* Standard memory/application chip. All media is stored on cyberchips and can be played by simply plugging the chip into any standard interface.\n* Plugging cyberchips directly into one's body is called 'Chipping In'."),
            ":Cybercycle",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Cybercycle", ":summary", "* High performance motorcycle that allows direct neural interface."),
            ":Cyberdeck",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Cyberdeck"),
            ":Cyberphone",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Cyberphone"),
            "Direct Neural Interface",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Direct Neural Interface", ":summary", "* This implant includes a processor chip and interface plugs that connect directly to the brain. The chip contains an artificial intelligence avatar program that learns from and emulates the user's personality. This AI can then enter cyberspace or control cybernetic equipment at the speed of a computer program while retaining the decision making logic of its user. Further, the AI regularly updates the user with its decisions, and gathers the user's impression, so it can make further decisions. While 'Jacked In' the user is motionless as his mind is overwhelmed with information from the AI. DNI's are powerful tools, but are also risky technology. Since information floods into the mind at incredible speeds, any malfunction in the DNI or the AI can cause sanity threatening sensory overload or sensory deprivation that seem to last for days in mere seconds.\n* Burn Out - losing one's mind to DNI failure."),
            ":Flitter",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Flitter", ":summary", "* Light, one-man helicopter", ":titles", "Aerogyro, Gyrocopter"),
            "Hover Board",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Hover Board"),
            "Mag Lev Train",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Mag Lev Train", ":summary", "* Speed: 200mph"),
            ":Metrocar",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Metrocar", ":summary", "* Ultra-subcompact reverse trike."),
            "Mister Fusion",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Mister Fusion", ":image", "HighTech/MrFusion.jpg"),
            "Quad ATV",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Quad ATV"),
            "Private Quadcopter",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Private Quadcopter"),
            ":Skimmer",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Skimmer", ":summary", "* The modern hovercraft creates a tightly computer-controlled air pocket beneath it that allows the Skimmer to move quickly over land or sea. The Skimmer manipulates the pocket to change direction. Though fast and all-terrain, they are not as quiet, maneuverable, or energy efficient as Autocars, so their use is limited to lightly populated areas.", ":titles", "Ground Effect Vehicle, Hovercraft")
          )
        ),
        "Corporate Equipment",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_itemmap},
            "Cargo Osprey",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Cargo Osprey"),
            "Corporate Limosine",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Corporate Limosine"),
            "Corporate Osprey",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Corporate Osprey", ":summary", "* Speed: 275knots\n* Range: 600miles\n* The Osprey is a tilt-wing propeller plane that is used as a corporate commuter plane. Like a helicopter, it can land on buildings, and it can also fly directly to nearby cities."),
            "Personal Aerodyne",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Personal Aerodyne", ":summary", "* Speed: 250mph\n* Range: 400miles"),
            ":Transjet",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Transjet", ":summary", "* The Transjet is the standard commercial airliner across the world. It flies up beyond the atmosphere where it can travel at extreme speeds and then lands anywhere in the world within an hour.", ":titles", "Hopper, Transatmospheric Jet")
          )
        ),
        "Police Equipment",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_itemmap},
            ":Aerodyne",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Aerodyne", ":reference", "Blade Runner", ":summary", "* Speed: 350mph\n* Range: 400miles\n* Short and bulbous, the Aerodyne has the aerodynamics of a brick.  It relies on its huge jets to fly.", ":titles", "Air Car, Pegasus")
          )
        ),
        "Military Equipment",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Combat Aerodyne",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Combat Aerodyne", ":summary", "* Speed: 480mph\n* Range: 600miles\n* Armored combat Aerodyne"),
            "Barracuda Drone Submarine",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Barracuda Drone Submarine", ":summary", "* Carrier borne small, unmanned, high speed, attack submarine. It is designed as a long range drone that continually scouts the water surrounding a capital ship. Its tip is a HEAT shaped explosive, and it uses a particularly volitle fuel mix, so that it can be used as a torpedo if any serious threat enters its sphere of control."),
            "Manta VTOL Fighter",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Manta VTOL Fighter", ":reference", "* Carrier Command: Gaea Mission", ":summary", "* Carrier borne VTOL Fighter. It has four redirectable thrusters that allow it to hover at any altitude including directly over water. It is fully sealed and can be launched and recovered underwater, but its underwater speed is poor. Its thrust is sufficient to ferry a Sea Lion ATV or other medium vehicle when necessary. It has a small, replaceable mission module to custom tailor its missions for anti-air, anti-ship, anti-armor, anti-personnel, missile, bombs, repair, apc, recon, science, transport, and more. Its mission module is interchangable with the Sea Lion Amphibious Tank."),
            "Pelican VTOL Heavy Transport",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Pelican VTOL Heavy Transport", ":summary", "* Land based VTOL transport plane. It has four redirectable thrusters that allow it to hover at any altitude including directly over water. It is fully sealed and can land and take off from water. It has a single landing deck on top to facilitate in-air refuelling and resupply of VTOL fighters. It has a large, replaceable mission module to custom tailor its missions for anti-air, anti-ship, anti-armor, anti-personnel, missile, bombs, repair, apc, recon, science, transport, and more. It is powerful enough to carry 1 heavy tank, 2 medium tanks, or 3 APCs. It is, however, a large target with limited armor, so it is not suitable for heavy fire situations."),
            "Sea Lion Amphibious Medium Tank",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Sea Lion Amphibious Medium Tank", ":reference", "* Carrier Command: Gaea Mission", ":summary", "* Carrier borne All Terrain Vehicle. It has six wheels that work equally well on water or land, but on water it augments its speed using a caterpillar drive. It is fully sealed and submerisble, but its underwater speed is poor. It has a small, replaceable mission module to custom tailor its missions for anti-air, anti-ship, anti-armor, anti-personnel, missile, repair, apc, recon, science, and more. Its mission module is interchangable with the Manta Fighter."),
            "Sailfin Light Frigate",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Sailfin Light Frigate", ":summary", "* Fully Submersible Light Frigate loaded with 2 Barracuda Submarines.\n* Purpose - The Sailfin is a high speed interceptor and screening craft. It is equipped with anti-missile and small anti-ship weaponry as well as a large ECM suite.\n* Hydrofoils - Uses a Magnetohydrodynamic (MHD) to produce high speeds with little noise. It is designed in a catamaran configuration with hydrofoils and an air cushion effect to provide near flight.", ":titles", "Flying Fish"),
            "Hammerhead Destroyer",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Hammerhead Destroyer", ":summary", "* Fully Submersible Destroyer loaded with 2 Manta Fighters and 4 Barracuda Submarines.\n* Purpose - The Hammerhead is an all round escort ship for larger capital ships."),
            "Mako Assault Carrier",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Mako Assault Carrier", ":reference", "* Carrier Command: Gaea Mission", ":summary", "* Fully Submersible Light Carrier loaded with 4 Manta Fighters, 4 Sea Lion ATVs, and 2 Barracuda Submarines. Uses a Magnetohydrodynamic (MHD) to produce high speeds with little noise."),
            "Orca Medium Cruiser",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Orca Medium Cruiser", ":summary", "* Fully Submersible Medium Cruiser loaded with 6 Manta Fighters, 1 Pelican Transport, 6 Sea Lion ATVs, and 4 Barracuda Submarines."),
            "Leviathan Command Carrier",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Leviathan Command Carrier", ":summary", "* Fully Submersible Heavy Carrier loaded with 12 Manta Fighters, 4 Pelican Transports, 6 Sea Lion ATVs, and 8 Barracuda Submarines.")
          )
        ),
        "Body Armor",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Stealth Suit",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Stealth Suit", ":reference", "* Nuclear launch detected... - Starcraft", ":titles", "Ghost Special Operative"),
            "Powered Body Armor",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Powered Body Armor", ":summary", "* Heavy Body Armor", ":titles", "Hard Suit")
          )
        )
      )
    )
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Hover Tank",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Hover Tank"),
            "Light Walker",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Light Walker"),
            "Heavy Walker",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Heavy Walker")
          )
        )
      )
    )
  ...
  static f_chapter_high_tech_overview() {
    ...
    output = vx_core.f_new(
      ...
      nx_tactics_base.f_sectionmap_from_sectionlist(
        vx_core.f_new({"any-1": nx_tactics_base.t_section}, ":name", "Why Tactics: High Technology?")
      )
    )
    return output
  }
  ...
  static f_chapter_high_tech_rules() {
    ...
    output = vx_core.f_new(
      ...
      ":sectionmap",
      nx_tactics_base.f_sectionmap_from_sectionlist(
        vx_core.f_new({"any-1": nx_tactics_base.t_section}, ":name", "Cyberspace", ":titles", "The Digital Web, The Net, The Network, World Wide Web, The Web", ":summary", "* A huge, interconnected series of computer networks, software systems, and virtual realities that form a continuous digital universe of nearly infinite scope.\n* Interface programs sort through this information and produce a virtual world tailored to the user's desire. The most common interface is that of digital cities that mirror their real world equivalents, but display computer systems, data blocks, and information pathways instead of buildings, people, and highways.\n* Nodes - Nodes in Cyberspace are locations in Cyberspace. Nodes include Telecom lines, Satellite Uplinks, Firewalls, Security Cameras, Remote Controls, Databases, and Virtual Realities.  Different Nodes usually require valid security or payment to use. Nodes can also hold nasty surprises including alarms and defense programs.\n* Movement - Distances are insignificant in Cyberspace. Instead, movement is measured in tasks.  Any program can perform a number of tasks each turn equal to [Netrunning] skill. Each node entered in Cyberspace is a task. Performing any [Action] at a node is also a task.")
      )
    )
    return output
  }
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            ":Shuttlecraft",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Shuttlecraft"),
            "Cargo Spacefreighter",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Cargo Spacefreighter"),
            "Ore Spacefreighter",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Ore Spacefreighter", ":summary", "* Magsail ship"),
            "Gas Spacefreighter",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Gas Spacefreighter"),
            "Space Rescue Ship",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Space Rescue Ship", ":reference", "Event Horizon", ":summary", "Emergency Medical and Rescue Craft"),
            "Star Explorer",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Star Explorer", ":summary", "Scout Vessel"),
            ":Spaceliner",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Spaceliner", ":summary", "Luxury cruise liner for tourism or transport", ":titles", "Starliner")
          )
        ),
        "Fighter Class",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Star Bomber",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Star Bomber"),
            "Star Figher",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Star Figher", ":summary", "* General purpose space fighter that can be fitted with special purpose gear."),
            "Star Interceptor",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Star Interceptor"),
            "Star Torpedo Bomber",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Star Torpedo Bomber")
          )
        ),
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Assault Star Carrier"),
            "Missile Frigate",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Missile Frigate"),
            "Siege Frigate",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Siege Frigate"),
            "Star Destroyer",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Star Destroyer"),
            "System Defense Corvette",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "System Defense Corvette", ":summary", "Interplanetary Defense")
          )
        ),
        "High Tech Cruisers",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Star Battleship",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Star Battleship"),
            "Star Carrier",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Star Carrier"),
            "Star Cruiser",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Star Cruiser")
          )
        ),
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Super Star Battleship"),
            "Super Star Carrier",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Super Star Carrier")
          )
        ),
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Communication Satellite"),
            "Damocles Orbital Laser",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Damocles Orbital Laser", ":image", "HighTech/DamoclesSatellite.jpg", ":summary", "* Orbital Laser Platform designed for strategic strikes against land targets. May also be used against large orbital targets or for asteroid defense."),
            "EMP Satellite",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "EMP Satellite", ":reference", "* What's it going to be, Plissken? Them or us? I shut down the third world, you win they lose. I shut down America, they win, you lose. The more things change, the more they stay the same. - Snake Plissken, Escape from LA", ":titles", "Goldeneye"),
            "Hunter Killer Satellite",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Hunter Killer Satellite", ":summary", "* A combat ready satellite often masquerading as a peaceful version. Hunter Satellites act like UAV's quietly patrolling until their weaponry is needed, then they are disposable.", ":titles", "Battle Satellite"),
            "Orbital Skyhook Satellite",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Orbital Skyhook Satellite", ":summary", "* Large rotating satellite in low orbit. Its purpose is to drop its kilometers long tether to dock with a [Suborbital Shuttle] and use its momentum to fling the shuttle into higher orbit. A few of these Skyhooks at different orbits can pull a shuttle all the way into high orbit. Pulling up shuttles gradually degrades the satellite's orbit, but fortunately, the same system can be used in reverse to slow orbital craft without using fuel which returns lost momentum to the Skyhook."),
            "Solar Reflector Satellite",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Solar Reflector Satellite", ":summary", "* These are massive, lightweight solar mirrors that can be focused for variouse purposes. They can focus light for solar farms, generate light for long nights like on the moon, generate thrust by light pressure and by heating ablative drives.")
          )
        )
      )
    )
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_scenemap},
            "Rock War",
            vx_core.f_new({"any-1": nx_tactics_base.t_scene}, ":name", "Rock War"),
            "Battle in the Depths",
            vx_core.f_new({"any-1": nx_tactics_base.t_scene}, ":name", "Battle in the Depths", ":summary", "* An undersea fission cannon is discovered before it becomes operational.\n* A squadron is sent ahead of the fleet to destroy the cannon before it is brought to bear on the fleet.\n* The base defenders need to stall for 10 minutes until the cannon can be fired destroying most of the fleet. 5 minutes later a second shot will ensure victory.\n* The battle takes place completely underwater."),
            "Destroy the Downlink",
            vx_core.f_new({"any-1": nx_tactics_base.t_scene}, ":name", "Destroy the Downlink", ":summary", "* The rebels choose to destroy a microwave receiver converting power from a vast orbital solar satellite array. If they can destroy it, the entire area will be without power and defenseless for days allowing the rebels free reign to take territory.\n* The defenders realize the vulnerability of the station and it is heavily defended."),
            "Rat Warren",
            vx_core.f_new({"any-1": nx_tactics_base.t_scene}, ":name", "Rat Warren", ":summary", "* The mechs stationed to defend the city are cut off from reinforcements.\n* The rebels see an opportunity, but they have only powersuits and their wits to take the colossal defenders down. They can use the sewers and subways as cover to launch hit and run attacks."),
            "Traitorous Acts",
            vx_core.f_new({"any-1": nx_tactics_base.t_scene}, ":name", "Traitorous Acts", ":summary", "* An surprise attack is launched on a munitions depot, but there is a problem. The defenders are not surprised: there is a mole in your group.\n* Attackers have a superior force, but one of them is a traitor. They will have to watch their backs.\n* Defender secretly chooses one attacking unit as the traitor and can choose to activate it at any time."),
            "Joy Ride",
            vx_core.f_new({"any-1": nx_tactics_base.t_scene}, ":name", "Joy Ride", ":summary", "* A young, hotshot rebel manages to sneak into an enemy test facility and steal a prototype mecha. The whole base is on his tail, and he will need to use urban cover and speed to try to get away."),
            "Train Spotting",
            vx_core.f_new({"any-1": nx_tactics_base.t_scene}, ":name", "Train Spotting", ":summary", "* Ambush a mag-lev train and stop it before it escapes.\n* Attackers must disable the train and destroy the defenders.\n* Defenders must escape or drive off the attackers."),
            "Breaking Damocles",
            vx_core.f_new({"any-1": nx_tactics_base.t_scene}, ":name", "Breaking Damocles", ":summary", "* The Damocles is an orbital facility equipped with a powerful laser. Its existence has put major pressure on Earth governments to comply with UEA demands.\n* Attackers must placed explosives along the edge of the facility and destroy the attitude control thrusters to send the facility into a death spiral that would make it burn up in orbit. Hopefully, it will crash in an uninhabited area.\n* Defenders must destroy the attackers or the explosives to prevent this nightmare scene."),
            "Moon Rocket",
            vx_core.f_new({"any-1": nx_tactics_base.t_scene}, ":name", "Moon Rocket", ":summary", "* A huge rocket is about to be launched from its silo in a crater on the Moon.\n* The attackers must destroy the launch silo or failing that the missile itself before it leaves the combat area. Critical hits on the missile may cause it to explode, destroying the launch base."),
            "Mirage Storm",
            vx_core.f_new({"any-1": nx_tactics_base.t_scene}, ":name", "Mirage Storm", ":summary", "* Two recon mechs gather intelligence around Jupiter but are pursued. The recon units try to even the odds by flying into the atmosphere directly into a super storm. The storm plays havoc with normal sensors, but the recon units can sort out the jumble of sensor data.\n* The 5 attackers must destroy the 2 escaping mechs.\n* The defenders must drive off or destroy the superior attackers.\n* Special Rules: For each defender place 2 additional ghost mechs on the battlefield. These represent false image data produced by the cloud. After each attack, the defenders may secretly switch which unit is the real mech among the three identical images. The ghost mechs are obviously immune to all damage.")
          )
        ),
        "Jovian Odyssey",
        vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          "Europa Incident",
          ":summary",
          "* The Flashlight Project - Blocked from what they believed to be their rightful control over the colonies at every turn by the Jovian Confederation, UEA launched several top-secret advanced weapons projects.  One of the less successful efforts was the Flashlight Project, an attempt to develop heavy autonomous drone combat spacecraft. The two Lucifer prototypes, the ultimate end result of the project, were ideal for commerce raiding. They could operate for years without more than cursory communication with their home base; their stealth systems could hide them from the most determined sensors; and their heavy array of particle beam weapons could savage a warship in a single volley.\n* The project turned out to be too complicated and expensive to mass-produce, but the prototype was dispatched to Jovian space for 'field trials', with orders to destroy any target with a Jovian registry it came across. The plan was to disrupt the Jovian economy enough to make them more pliable to UEA demands.\n* After the Battle of Elysee, the UEA council determined that the Lucifer would be a political hand grenade if it was captured. They ordered the Lucifer to self destruct, but it had already disappeared in the radiation and magnetic fields around Jupiter, the very fields they had relied upon to hide the drone as it went about its work. Finally, the crew managed to get a signal through, but some interference caused the drone to change course and crash on Europa instead of self-destructing.",
          ":scenemap",
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_scenemap},
            "A Damaged Freighter",
            vx_core.f_new({"any-1": nx_tactics_base.t_scene}, ":name", "A Damaged Freighter", ":summary", "* The UEA Black Eagle Squadron is smuggled aboard the freighter Narsus to recover the datacore of the Lucifer and destroy any evidence. The Black Eagles had planned to slip onto Europa undetected after the Narsus dropped into orbit around the moon. Supposedly, she was to be taking on water for a journey up to Ganymede. The plan was that she would deploy the Eagles’ exo-armors, head off to deliver the rest of her cargo, then return and pick them up a week later. Faulty parts led to an explosion in Narsus' engines during her insertion burn. The captain managed to drop the freighter into a stable orbit around Europa before the engines completely died, but then, as is standard practice for merchant crews, immediately set off a distress beacon.\n* With all the unexplained attacks in Jovian space lately, an exo-armor patrol is dispatched from their carrier to investigate. The crew seems to sincerely have severe engine trouble. Some of the Jovians will have to board the Narsus leaving their exos tethered to the hull. The remainder stay on patrol.\n* Inside, the freighter is in zero-g and is particularly cramped. The crew's story seems to hold up, but the four passengers are uneasy about the situation. The engines are in bad shape and are irradiated. The cargo hold has large, sealed, liquid cargo bins labeled with warnings as liquid methane. If the Jovians start attempt to open the cargo, the captain will lose his nerve and reveal that the passengers are UEA pilots. A firefight erupts and the Black Eagles get into the cargo containers and remotely open the cargo bay to vacuum. The UEA troops escape by detonating the Narsus as a distraction (killing the crew, of course) and releasing an ECM scrambler pod. They have clearly descended to Europa somewhere."),
            "Escape to the Ice Planet",
            vx_core.f_new({"any-1": nx_tactics_base.t_scene}, ":name", "Escape to the Ice Planet", ":summary", "* With Europa's low surface gravity, the Black Eagle team's exo-armors descend to the surface safely using their own thrusters. Europa’s surface is covered by a thick layer of ice. Unlike ice on Earth, this isn’t slippery - it’s nowhere near the freezing point. The surface is perilous with unstable ground and spontaneous geysers.\n* The UEA team radios for a pickup using a small signal booster in orbit. They then begin a tedious search for the Lucifer.\n* The JAF patrol rejoins its carrier and begins a search of Europa.\n* The UEA team eventually discovers the crashed Lucifer but finds footprints and vehicle tracks nearby. The data core has already been removed and taken to the small research station Europa 1. The UEA team breaks the ice beneath the Lucifer to let it fall into the ocean below never to be discovered. Then they must follow the tracks to recover the data core before its secrets are revealed and/or silence the witnesses.\n* When the JAF arrives, they must deduce what has happened and race to intercept the UEA team."),
            "Hide and Seek",
            vx_core.f_new({"any-1": nx_tactics_base.t_scene}, ":name", "Hide and Seek", ":summary", "* Europa 1 is not well guarded, but it is a large facility with lots of staff. The UEA must infiltrate the base and quickly locate the data core before the rendezvous in 12 hours. The station is unarmed, and if a firefight erupts, everyone will flee to the underground shelters. If they run out of time, the UEA may be forced to destroy the base, but this would not guarantee the destruction of the data core.\n* The JAF can immediately land at the base and are introduced to Dr. Han Krieger and his attractive daughter Paula. They have recovered the data core, but did not have sufficient equipment to study the downed ship.\n* If the UEA can get close enough they can hack the core remotely and trigger a data wipe. They may also threaten to blow up the base if they are not given the core. Whether they succeed or not, the UEA will have to retreat back to the rendezvous point or be stranded. When they retreat, the JAF will have to guess at where they are going and why, but either way they will need to pursue them."),
            "Hell Unchained",
            vx_core.f_new({"any-1": nx_tactics_base.t_scene}, ":name", "Hell Unchained", ":summary", "* Suddenly, a large shadow passes overhead. It's a frigate, the UEA pickup has arrived. Six exo-armors exit its bay and begin to advance.\n* As the JAF prepare to meet them, the frigate opens fire. Suddenly, there is a deep tremor in the ice below. The UEA agents feel it too and stop code. Suddenly, from under the ice, an impossibly brilliant beam of light lances up to engulf one of the descending exo-armors. It doesn't explode but it just melts and disappears in the beam. Soon, the ice seems to explode and the enormous black form of the Lucifer rises from below.\n* With its data core removed and a firefight nearby, it switched to its limited, secondary systems and it is unable to determine friend from foe. Its massive guns are clearly building another charge and moments later it fires at the frigate's engines. The crippled engines briefly leak fusing hydrogen before destroying the frigate in a nuclear fireball. It then begins to engage the new exo-armors from the frigate.\n* The JAF and UEA will have to quickly come to terms with the fact that the Lucifer will kill them all unless they work together.\n* If the Lucifer escapes, it will boost off Europa into a tight slingshot orbit and then use its ECM systems to hide in Jupiters radiation belt. Without its higher brain functions, the Lucifer is more of a killing machine than an assassin, so it is now a question of how much damage it will do before it is taken down.\n* If the Lucifer is destroyed over Europa, it will crash into the ice and be lost in the depths. Without their pickup, the UEA agents will have to negotiate the terms of their surrender. Regardless, they will be tried and interrogated for their actions.")
          )
        ),
        "Jovian History",
        vx_core.f_new({"any-1": nx_tactics_base.t_section}, ":name", "Jovian History", ":summary", "* Mercury, Helios Station - A permanent colony of 8 million orbiting Mercury is established. Its orbit puts it constantly in Mercury's shadow protecting it from most of the Sun's deadyly rays. Naturally, it has access to almost limitless solar power. All equipment around Mercury is outfitted with a unique heavy armor that combines hard radiation shielding with solar collection.\n\n* Venus, New Tokyo - The capital of Venus is a sprawling megaplex of 15 million at the North Pole of Venus. Though terraforming has been going on for decades, the poles are still the only places where the temperatures are survivable. The city is completely enclosed and partially underground. Industry is relegated to the wastelands outside. The Venusian bank invested heavily in developing Venus and has seen phenomenal growth. The bank now effectively owns the entire planet.\n\n* Earth 2210 - The UAE launches an attack against the Jovian civilian colonies in an attempt to push the colonies back into line.\n\n* Mars, Marsquake - The obital elevator around Mars is destroyed by sabotage, and the enormous, carbon-diamond fiber cable was slowly dragged from orbit as the planet turned. The cable dropped with devastating force, wrapping around the equator two and a half times. Fortunately, the sparse population of Mars reduced the scope of the devastation. There is a common joke that Mars is now the only planet with an actual black line at the equator. Hot heads and smugglers have take to racing down the trench created by the cable.\n\n* War Aftermath - Some UAE leaders were found guilty of crimes against humanity for their attacks against the Jovian colonies. The other colonies increasingly see Earth as irrelevant to their future. Earth politics is divided on how to proceed. The UAE has gone underground and now covertly funds a paramilitary group of disgruntled combat veterans and pirates in order to further its aims in space."),
        "Jovian Characters",
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_section},
          ":name",
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Albatross Transorbital Shuttle", ":summary", "* The Albatross is the latest in a long line of shuttles used for cargo and passenger transfers to various atmospheres. One or two are standard equipment for any large military ship.", ":mass", "45tons", ":speedair", "1200kph", ":speedspace", "1.5g"),
            "Beautiful Dreamer Transport",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Beautiful Dreamer Transport", ":summary", "* The Beautiful Dreamer, at first sight, seems to be a standard Inari-class liner. As with many Inari, the Dreamer has been modified heavily, and there are many differences in the ship’s lines. Two concealed railguns run along the ship’s spine, providing an unpleasant and unexpected punch. The cargo bays on the craft’s edges have been modified to carry mechs and fighters, complete with concealed catapults.\n* 2 Medium Railguns\n* 4 Mech Bays - Cannot land fighters.\n* 2 Magnetic Catapults", ":crew", "54", ":mass", "10000tons", ":length", "270m"),
            "Inari Space Liner",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Inari Space Liner", ":summary", "* Unlike the bulk transport Mule, the Inari was designed to be a high speed passenger liner to get people quickly between the planets. Though not as modular as the Mule, the Inari can be heavily customized to specific tasks. Though it is not a military vessel, the Inari is fast and can be modified to be cary significant armor and weapons, thus making it well suited as a privateer.", ":titles", "Georgia on my Mind", ":crew", "108", ":mass", "10000tons", ":length", "200m"),
            "Carver Mining Ship",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Carver Mining Ship", ":summary", "* The Carver is designed for the purpose seeking out and mining asteroids.\nThe ship is very odd looking with three insect-like legs surrounding the main laser drill. The standard protocol for asteroid mining is to land on a mineral-rich feature, drill a deep tunnel, and then pressurize the tunnel so further operations can be done without environment suits. Ore is sent on a conveyor belt to the onboard smelter for separation and purification.\n* The Carver is intended to work perpetually. Its drive system is slow but extremely robust, able to use mined hydrogen for fuel and any waste material as reaction mass. Small tugs commute back and forth carrying ore to nearby space colonies and returning with supplies and spare parts. The tugs also carry replacement crew members.\n* The Carver has been in service for so long that their prices have come down dramatically. Since this work is enormously profitable, banks are willing to finance individuals if they can demonstrate a sound business plan.", ":speedspace", ".15g", ":mass", "1200tons", ":length", "80m", ":width", "80m"),
            "Mule Freighter",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Mule Freighter", ":summary", "* The Mule Freighter is a simple, reliable design for transporting large amounts of cargo across the solar system. It has no interior cargo hold, instead it has a series of connectors to link self contained cargo pods of various sizes. The connectors can also be used to hook onto asteroids or other ships to allow the Mule to act as a tug.\n* The Mule is the most common ship in the solar system and is used by every government and commercial space organization. Because the Mule is so versatile, it can even be used as a slow carrier or missile gunboat. For similar reasons, it is a favorite ship for smuggling or piracy as well.\n* Its acceleration reduces as its load increases. It can transport up to 40ktons before its acceleration becomes too low to be practical.", ":titles", "Narsus", ":speedspace", ".4g", ":crew", "6", ":mass", "4000tons", ":length", "345m", ":width", "40m"),
            "Ox Orbital Tug",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Ox Orbital Tug", ":summary", "* The Ox is a space-only shuttle used for short tranports between space stations, tugbot duty, asteroid transport, and salvage operations. It has large manipulator arms to manage unusually shaped loads. It is a very sturdy if slow craft.", ":speedspace", ".5g", ":mass", "41tons")
          )
        ),
        "Jovian Federation",
        vx_core.f_new(
          ...
          "Jovian Federation",
          ":summary",
          "* Jovian capital ships are built for easy maintainance and reuse. They are composed of 4 sections: engine, cargo, habitat, and mission. All but the mission section can be interchanged with the equivalent sections from other ships. The habitat ring can even be removed for short range missions, or additional cargo modules can be added for greater endurance.",
          ":unitmap",
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Jovian Pilot",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Jovian Pilot"),
            "Jovian Mech Jock",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Jovian Mech Jock"),
            "Jovian Tech",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Jovian Tech"),
            "Lancer Space Interceptor",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Lancer Space Interceptor", ":summary", "* Despite the heavy investment in Mech Suits, Jovian interceptors remain an important part of Jovian armed forces. Their high acceleration allows them to be sent as the first line of defense ahead of the slower Mech Suits. They are well suited to recon and hit-and-run missions. They carry variable weapon pods for specialized recon, ECM, bomber, or long-range scouting missions.\n* 1 Light Laser Cannon\n* 6 Light Missiles\n* 2 Medium Missiles\n* 1 Heavy Missile", ":mass", "50tons", ":height", "25m", ":speedspace", "3.2g", ":width", "10m"),
            "Pathfinder Mech Suit",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Pathfinder Mech Suit", ":image", "JovianChronicles/PathfinderToken.png", ":summary", "* The Pathfinder is a rugged, simple to maintain Exo Suit design that forms the majority of the Jovian Mech forces. It is very agile but relatively fragile and mounts only light weaponry because it is designed primarily as a scout craft. Its high speed, agility, and exceptional close combat abilities proved the value of Mech Suit design and it remains the most iconic Mech Suit in existence.\n* 1 Medium Particle Cannon\n* 2 Medium Missiles\n* 2 Plasma Lances", ":mass", "35tons", ":height", "15.4m", ":speedland", "26kph", ":speedspace", "2.8g", ":width", "11m"),
            "Retaliator Mech Suit",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Retaliator Mech Suit", ":summary", "* The Retailator is the standard Jovian interceptor Mech. Well-armed and fast for its size, it can take on larger opponents and come out on top. Its speed comes at the sacrifice of some armor unfortunately and its thrusters always overheat forcing pilots to take great care or risk burned out thrusters.\n* 1 Medium Rail Cannon\n* 4 Medium Missiles\n* 6 Light Missiles\n* 2 Plasma Lances", ":mass", "42tons", ":height", "15.5m", ":speedland", "66kph", ":speedspace", "2.4g", ":width", "12m"),
            "Vindicator Mech Suit",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Vindicator Mech Suit", ":summary", "* The Vindicator is the most powerful mass-produced Mech in the solar system. It carries massive armor and armament, but its high cost limits its use to a few elite pilots. It is also painfully slow compared to the Pathfinders and Retailators it flies with.\n* 1 Medium Rail Cannon\n* 1 Medium Laser Cannon\n* 10 Heavy Missiles\n* 3 Plasma Lances\n* 2 Anti Missile Systems", ":mass", "70tons", ":height", "16m", ":speedland", "36kph", ":speedspace", "1.8g", ":width", "14m"),
            "Prometheus Mech Suit",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Prometheus Mech Suit", ":summary", "* The Prometheus was intended to be a prototype for a new generation of mech suits which would be more efficient, better armed, and faster than their predecessors. However, as development progressed, several experimental systems were added that made it a one of a kind wonder that could never be mass produced.\n* 1 Heavy Plasma Cannon\n* 2 Light Plasma Cannons\n* 2 Plasma Lances", ":mass", "64tons", ":height", "18m"),
            "Prometheus Storm Attacker",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Prometheus Storm Attacker", ":summary", "* The [Prometheus Mech Suit] can be equipped with a heavy set of extra armor and weapons.\nThe additional mass of the armor is negated by additional thrusters. If these thrusters are damaged the armor can be jettisoned leaving a fully functional Promethus.\n* 1 Heavy Plasma Cannon\n* 2 Light Plasma Cannons\n* 2 Plasma Lances\n* 2 Heavy Laser Cannons\n* 1 Particle Scatter Gun\n* 80 Medium Missiles", ":mass", "82tons", ":height", "21m"),
            "Athena Destroyer",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Athena Destroyer", ":summary", "* Athena Destroyers function much as their wet navy ancestors. Depending on the political climate, they are either protective shepards or hunting wolves. The Athena's job is to get in the way of danger. If an unknown vessel is detected, the destroyer will move ahead into a blocking position to defend the rest of the fleet.\n* The Athena is particularly fast and maneuverable for a capital ship and works closely with any small craft.\nWeapons:\n* Point Defense System\n* 3x Particle Accelerators\n* 6x Railguns\n* 2x Area Defense Laser Cannon\n* 1x Missile Bay", ":speedspace", ".8g", ":mass", "10ktons", ":length", "291m", ":width", "81m"),
            "Forge Patrol Carrier",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Forge Patrol Carrier", ":summary", "* Forge class carriers carry 12 pilots including squadron leaders.\n* There are 24 Forge class vessels commissioned.\n* Speed: .8g\n\nWeapons:\n* Point Defense System\n* 8 Rail Cannons\n* 2 Laser Cannons\n* 2 Missile Bays\n\nVehicles:\n* 6x Mobile Suits with room for 12\n* 6x Catapults", ":mass", "39000tons", ":length", "460m", ":width", "285m"),
            "Explorer Scout Ship",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Explorer Scout Ship", ":summary", "* One of the earliest planetary exploration ships, the Explorer has been produced for many years and is a reliable though uninspired design. Its modular design is its greatest asset and has ensured its continued use for decades. The crew module can be extended on a tether for artificial gravity with the other end counterbalanced by a water tank.", ":speedspace", ".4g", ":mass", "1ktons", ":length", "345m", ":width", "40m"),
            "Gagarin Fleet Tender",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Gagarin Fleet Tender", ":summary", "* The Gagarin is a mobile tender designed to facilitate drydock style repairs close to the front lines.\n* Its mission hull is a gigantic workshop with huge door sections that can surround and refit a vessel in a pressurized environment.\nWeapons:\n* Point Defense System\n* 1x Missile Bay", ":mass", "92ktons", ":length", "740m", ":width", "285m", ":speedspace", ".1g"),
            "Javelin Cruiser",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Javelin Cruiser", ":summary", "* The Javelin is the most common warship in the Jovian Navy despite its age and lack of interceptor or Mech Bays. Its design is based on pre-Mech combat philosophy, emphasizing heavy weapons on capital ships as opposed to projection of force using smaller craft. Therefore, it is very heavily armed for a relatively small craft including the deadly heavy particle beam cannon.\n* Crew accomodations are small but comfortable with cleverly placed mirrors throughout the ship that give the illusion of greater interior space.\n* Point Defense System\n* 2 Heavy Rail Cannons\n* 1 Heavy Particle Beam Cannon Turret\n* 2 Missile Bay\n* 6 Space Dart Heavy Missiles", ":speedspace", ".6g", ":mass", "20ktons", ":length", "235m", ":width", "72m"),
            "Valiant Strike Carrier",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Valiant Strike Carrier", ":summary", "* The Valiant Strike Carrier is a ship like no other. Every other ship in the fleet is designed to work in cooperation with one another. The Valiant is designed to operate on long range, long term patrols with no backup. It is therefore heavily armed, armored, and carries extensive supplies and fabrication facilities.\n* It has two rotating crew decks that are very spacious for a spaceship.\n* 6 Heavy Rail Cannons on 2 Turrets\n* 1 Missile Bay\n* 1 Spinal Particle Beam Cannon\n* 6 Magnetic Catapults\n* 1 Certifuge Crew Module\n* 2 Lancer Interceptors\n* 2 Pathfinder Mech Suits\n* 2 Retaliator Mech Suits\n* 2 Vindicator Mech Suits", ":speedspace", ".8g", ":mass", "40ktons", ":length", "320m", ":width", "75m")
          )
        ),
        ":UEA",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "UEA Commando",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "UEA Commando", ":classification", "Lt. Infantry"),
            "UEA Marine",
            vx_core.f_new(
              {"any-1": nx_tactics_base.t_unit},
              ":name",
            ...
            "UEA Pilot",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "UEA Pilot"),
            "UEA Mecha Pilot",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "UEA Mecha Pilot"),
            "UEA Tech",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "UEA Tech"),
            "Cerberus Mech Suit",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Cerberus Mech Suit", ":summary", "* The Cerberus is the first cutting edge Mobile Suit design from the UEA.\n* The name Cerberus comes from the large ECM pods on each shoulder which continually scan in all directions giving the appearance of 3 heads.\n* The Cerberus is designed as a hit-and-run unit, so it very fast and manueverable but has limited endurance by design. It is only available to commanders and elite pilots.\n* 30mm Massdriver with Depleted Uranium/Tungsten rounds. 20 shots.\n* Linked 20mm Vulcan Autocannons in the head.\n* 1 Plasma Lance\n* 1 Mech Combat Knife", ":classification", "Lt. Spacecraft", ":mass", "63tons", ":height", "17m", ":speedland", "36kph", ":speedspace", "1.8g", ":width", "15m"),
            "Dragonstriker Mech Armor",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Dragonstriker Mech Armor", ":image", "JovianChronicles/DragonstrikerToken.png", ":summary", "* Mechs are designed to battle other mechs and perhaps cripple enemy capital ships. The Dragonstriker is a unique prototype designed to attack enemy capital ships and installations directly. It is a massive mech, towering over other mechs and carrying formidable weapons to battle both capital ship and other mechs.\n* The Dragonstriker has a detachable booster that provides extra acceleration and range. The booster also houses the 2 Medium Laser cannons for strafing enemy capital ships.\n* 4 Heavy Anti-Ship Beam Cannon\n* 2 Medium Anti-Ship Laser Cannon (2 linked under for strafing attacks, mounted to booster)\n* 6 30mm Vulcan Autocannon (4 linked forward, 2 linked rear in head)\n* 4 Heavy Anti-Ship Missile (4 forward)\n* 2 Anti-Missile Laser Turret (1 forward, 1 rear)", ":titles", "CXE-01", ":classification", "Lt. Spacecraft", ":mass", "110tons", ":height", "24m"),
            "Hachiman Destroyer",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Hachiman Destroyer", ":summary", "* The Hachiman is the workhorse of the UEA navy. They have been produced for many years with minor upgrades.\n* 1 Point Defense System\n* 6 Railcannon Turrets\n* 2 Missile Bays\n* 2 Laser Turrets", ":speedspace", ".6g", ":classification", "Hvy. Spacecraft", ":crew", "60", ":mass", "5500tons", ":length", "208m", ":width", "80m"),
            "Lucifer Cybersat",
            vx_core.f_new(
              {"any-1": nx_tactics_base.t_unit},
              ":name",
              "Lucifer Cybersat",
              ":summary",
              "* The Lucifer's designed for one purpose - to ambush and kill enemy warships. Its sophisticated Stealth systems allow it to hide and its strong electronic warfare suite prevents its prey from calling for help. Powerful thrusters allow it to accelerate at incredible speeds, and a cluster of six small linked particle cannons and two large ones allow it to inflict massive damage very quickly.\n* Armor - Despite the advanced technology, its armor is quite thin for its size, and in a stand-up fight, it will almost certainly lose. The only questions are how to force it into a stand-up fight and how many of its attackers it can take with it.\n* Particle Cannons - The combined power of the dual particle cannons are equal to a spaceship's main gun. They have separate fusion engines just to recharge its capacitors, but it still takes 30 seconds between firings.\n* Particle Array - The 6 smaller particle cannons are designed for rapid fire against fast moving targets and are used between firing of the main guns.\n* Claws - Its claws are independent wire-guided drones armed with small energy weapons to deal with enemy interceptors. The claws are very fast and agile, but not very tough. They can replenish their fuel reserves by docking with the Lucifer.\n* Speed - The drones will almost never use their full top speed, and the Lucifer will make every effort to conserve its remass. For long-range travel, it won't boost at more than 0.4 or 0.6 Gs except in short bursts. Much of its time will be spent drifting along a medium-traffic orbit.\n* Stealth - The Lucifer carries an advanced ECM/stealth package that allows it to sneak up on enemies and attempt to cripple them while scrambling any distress calls.\n\nECM(6, 10km), Stealth (6);\nQuantity	Name	Type	Arc	ACC	DM	BR	ROF	Perks + Flaws	Ammo\n1	Particle Cannon Cluster	E	F	+0	x12	4	+4	Hw,Red;AD(2),HEAT	Unl.\n2	Mega Particle Cannon	E	F	-1	x30	7	-1	Red,Hw;AD(2),HEAT;Link	Unl.",
              ":titles",
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    {"any-1": nx_tactics_base.t_unitspecialtymap},
                    "Stealth Vessel",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unitspecialty}, ":name", "Stealth Vessel")
                  )
                )
              )
            ),
            "Lucifer Claw Drone",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Lucifer Claw Drone", ":summary", "Armor:	10/20/30\n* Miscellaneous Threat Value (MTV): -\nCrew:	Computer 1 (Dumb, Level 2) (2 actions)\n\nAccessories: Autopilot; Arm: Manipulator Arm (R5, Can Punch); Armor: HEAT Resistant(5); Communications (-2, 2km);\nHostile Environment Protection: Radiation (4), Vacuum, Extreme Cold; Sensors(+0, 2km); Vulnerable to Haywire;\nQuantity	Name	Type	Arc	ACC	DM	BR	ROF	Perks + Flaws	Ammo\n1	Laser Cannon	E	FF	+1	x10	5	+0	Red;AD(1),HEAT	Unl.\n1	Plasma Lance	E	F	+0	x15	M	+0	AC,Red;HEAT	Unl.", ":classification", "Lt. Spacecraft", ":mass", "3tons", ":speedspace", "5g"),
            "Siren Space Interceptor",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Siren Space Interceptor", ":summary", "* The Siren Fighter is the standard medium range interceptor spaceship used by the UEA. It is faster than any other short range space craft in the Solar System, but without high mobility verniers it is outclassed by Mobile Suits. It is ideally suited for patrolling and policing the space lanes.\n* The Siren can be launched from Earth using a booster rocket making it even more practical for Earth defense.\n* 2 Medium Railguns\n* 6 Medium Missiles\n* 4 Light Missiles", ":classification", "Lt. Spacecraft", ":mass", "40tons", ":length", "14m", ":speedspace", "3.5g", ":width", "12m"),
            "Syreen Mech Suit",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Syreen Mech Suit", ":image", "JovianChronicles/SyreenToken.png", ":summary", "* The Syreen Suit is a Siren space fighter retrofitted into a Mech Suit. It was hastily constructed when the first conflict with the Jovians displayed the dominant mobility of the Jovian Mech Suits.\n* As an efficient and cheap design, it can be fielded in large numbers. However, it does not compare well to the new Mech Suits that it is meant to face, so casualties are high.\n* The Syreen can be launched from Earth using a booster rocket making it even more practical for Earth defense.\n* 2 Heavy Missiles\n* 6 Medium Missiles\n* 4 Light Missiles\n* Point defense laser system\n* 2 Crude manipulator arms for close combat.\n* The command variant includes a powerful ECM pod.", ":classification", "Lt. Spacecraft", ":mass", "52tons", ":height", "17.2m", ":speedspace", "3g", ":width", "17.5m"),
            "Poseidon Battlecruiser",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Poseidon Battlecruiser", ":summary", "* The Poseidon Class Battlecruiser is the top of the line UEA warship. It gets its name from the two rotating living sections that give the ship the appearance of a trident.\n* The Poseidon outclasses any other warship from any faction and is a menancing presense. It was, however, designed before the advent of Mech Suits, so it carries more interceptors than Mechs.\n* Point Defense System\n* 4 Particle Accelerator Batteries\n* 4 Railcannon Batteries\n* 6 Interceptors\n* 4 Mech Suits", ":classification", "Hvy. Spacecraft", ":crew", "200", ":mass", "30ktons", ":length", "325m", ":speedspace", ".5g", ":width", "200m"),
            "Tengu Escort Carrier",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Tengu Escort Carrier", ":summary", "* The Tengu is a long range craft designed for limited engagements and policing. It has extensive supplies but lacks firepower.\n* 1 Point Defense System\n* 2 Missile Bays\n* 2 Mech Suits\n* 2 Fighters\n* 2 Catapults", ":classification", "Hvy. Spacecraft", ":crew", "24", ":mass", "25ktons", ":length", "250m", ":speedspace", ".5g", ":width", "38m"),
            "Wyvern Mech Suit",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Wyvern Mech Suit", ":image", "JovianChronicles/WyvernToken.png", ":summary", "* The Wyveern is the first and most numerous of the UEA Mech Suits.\nThough a copy of the Martial Federation Defender, it is a sturdy,\nreliable and most importantly mass-produceable design. Its primary\nlimitation is the lack of energy weapons which limits its combat\nendurance before it needs to be rearmed.\n* 1 Hyperbazooka\n* 2 Massdriver Machineguns\n* 2 Self guided Missiles", ":speedspace", "1.4g", ":mass", "55tons", ":height", "17m", ":length", "4m", ":speedair", "2.4mach", ":speedland", "36kph", ":width", "14m")
          )
        )
      )
    )
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_itemmap},
            "Titanium Composite",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Titanium Composite", ":summary", "This is the state of the art armor plate before the discovery of Gundarium Alpha which completely eclipses it."),
            "Gundarium Alpha",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Gundarium Alpha", ":summary", "Originally called Luna Titanium, it was renamed after the success of the RX-78 Gundam built from it. A super high-tensile alloy originally known as Luna Titanium. Originally intended for use inside thermonuclear reactors, this alloy's superb strength, durability, heat resistance and radiation-absorbing properties make it an ideal material for mobile suit armor.", ":titles", "Gundarium, Luna Titanium"),
            "Gundarium Gamma",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Gundarium Gamma"),
            "60mm Vulcan Cannon",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "60mm Vulcan Cannon", ":reference", "Stats based on 57mm Bofors Naval Gun", ":titles", "VCU-505EX-Gry/Ver.009 (Titans) / VCU-505EX-V*B/Ver.012 (AEUG)", ":classification", "Cannon", ":modifiers", "Auto", ":muzzlevelocity", "1000m/s", ":range", "8.5km", ":rof", "220/min"),
            "100mm Machine Gun",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "100mm Machine Gun", ":titles", "NF-GMG-Type.37", ":classification", "Cannon", ":modifiers", "Auto", ":muzzlevelocity", "600m/s"),
            "120mm Machine Gun",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "120mm Machine Gun", ":classification", "Cannon", ":modifiers", "Auto", ":muzzlevelocity", "600m/s", ":rounds", "100"),
            "180mm Recoilless Cannon",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "180mm Recoilless Cannon", ":titles", "NFHI-GMCa-type.09", ":classification", "Cannon", ":muzzlevelocity", "300m/s"),
            "240mm Recoilless Cannon",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "240mm Recoilless Cannon", ":classification", "Cannon", ":muzzlevelocity", "300m/s"),
            "280mm Bazooka",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "280mm Bazooka", ":classification", "Hvy. Rocket Launcher", ":modifiers", "HE", ":muzzlevelocity", "120m/s", ":rounds", "4"),
            "360mm Hyper Bazooka",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "360mm Hyper Bazooka", ":summary", "* Capable of destroying a GM in a single hit.", ":titles", "H&amp;L-GB05R (Zeon) / H-Baz-85-Gry/Ver.045 (Titans) / H-Baz-87-A*E/Ver.004 (AEUG)", ":classification", "Hvy. Rocket Launcher", ":modifiers", "HE", ":muzzlevelocity", "120m/s", ":rounds", "10"),
            "380mm Hyper Bazooka",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "380mm Hyper Bazooka", ":titles", "BLASH-XHB-L-03/N-STD", ":classification", "Hvy. Rocket Launcher", ":modifiers", "HE", ":muzzlevelocity", "120m/s", ":rounds", "5"),
            "Clay Bazooka",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Clay Bazooka", ":image", "Gundam/ClayBazooka.jpg", ":classification", "Hvy. Rocket Launcher", ":modifiers", "HE", ":muzzlevelocity", "120m/s"),
            ".4MW Beam Saber",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", ".4MW Beam Saber", ":titles", "XB-G-1048L (Titans) / A*E-Br*G-Sc-L (AEUG)", ":classification", "Hvy. Melee", ":energy", "1.2MJ", ":modifiers", "Energy"),
            ".65MW Beam Saber",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", ".65MW Beam Saber", ":classification", "Hvy. Melee", ":energy", "1.95MJ", ":modifiers", "Energy"),
            "1.3MW Beam Gun",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "1.3MW Beam Gun", ":classification", "Cannon", ":energy", "3.9MJ", ":modifiers", "Energy"),
            "1.3MW Funnel",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "1.3MW Funnel", ":classification", "Cannon", ":energy", "3.9MJ", ":modifiers", "Energy"),
            "1.9MW Beam Rifle",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "1.9MW Beam Rifle", ":summary", "Powered by rechargeable energy cap", ":titles", "BOWA-BR-S-85-C2", ":classification", "Cannon", ":energy", "5.7MJ", ":modifiers", "Energy"),
            "2.2MW Beam Pistol",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "2.2MW Beam Pistol", ":summary", "Powered by rechargeable energy cap", ":classification", "Cannon", ":energy", "6.6MJ", ":modifiers", "Energy"),
            "2.2MW Funnel",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "2.2MW Funnel", ":classification", "Hvy. MG", ":energy", "6.6MJ", ":modifiers", "Energy"),
            "2.6MW Beam Rifle",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "2.6MW Beam Rifle", ":summary", "Powered by rechargeable energy cap", ":titles", "BOWA*XBR-M-86-C2 (Titans), A*E-Br*XBR-87-C (AEUG)", ":classification", "Cannon", ":energy", "7.8MJ", ":modifiers", "Energy"),
            "2.8MW Beam Rifle",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "2.8MW Beam Rifle", ":summary", "Powered by rechargeable energy cap", ":classification", "Cannon", ":energy", "8.4MJ", ":modifiers", "Energy"),
            "5.7MW Beam Rifle",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "5.7MW Beam Rifle", ":image", "Gundam/ZetaBeamRifle.jpg", ":summary", "Powered by replaceable e-pac, doubles as large beam saber", ":classification", "Cannon", ":energy", "17.1MJ", ":modifiers", "Energy"),
            "8.3MW Hyper Mega Launcher",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "8.3MW Hyper Mega Launcher", ":summary", "Powered by replaceable e-pac, doubles as large beam saber", ":classification", "Cannon", ":energy", "24.9MJ", ":modifiers", "Energy"),
            "19.5MW Mega Particle Gun",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "19.5MW Mega Particle Gun", ":classification", "Cannon", ":energy", "58.5MJ", ":modifiers", "Energy")
          )
        )
      )
    )
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            ":Side",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Side", ":length", "32km")
          )
        ),
        "Gundam Federation",
        vx_core.f_new(
          ...
          vx_core.f_new(
              ...
              nx_tactics_base.f_unitskillmap_from_unitskilllist(
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    ...
                    "180mm Recoilless Cannon",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "180mm Recoilless Cannon", ":facing", "F")
                  )
                )
              )
            ),
            ...
            vx_core.f_new(
              ...
              "Gundam/Gundam.png",
              ":summary",
              "* Performance: maximum thruster acceleration 0.93 G; maximum ground running speed 165 km/h\n* Equipment and design features: re-entry coolant system\n* Optional hand armaments: BOWA-XBR-M-79-07G beam rifle, powered by rechargeable energy cap; RX·M-Sh-008/S-01025 shield, can be optionally stored on backpack",
              ":titles",
              "RX-78-2",
              ":classification",
              "Lt. Spacecraft",
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    {"any-1": nx_tactics_base.t_unititemmap},
                    "100mm Machine Gun",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "100mm Machine Gun", ":summary", "Clip-fed, 2 spare clips stored on hip armor"),
                    "180mm Recoilless Cannon",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "180mm Recoilless Cannon"),
                    "60mm Vulcan Cannon",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "60mm Vulcan Cannon", ":summary", "Chest Mount", ":facing", "FF", ":number", "1")
                  )
                )
              )
            ),
            ...
            ":GM",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "GM", ":image", "Gundam/GM.png", ":titles", "RGM-79", ":classification", "Lt. Spacecraft", ":mass", "41.2tons", ":height", "18m"),
            ":Magellan",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Magellan", ":image", "Gundam/Magellan.png", ":classification", "Hvy. Spacecraft"),
            "Pegasus Class Carrier",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Pegasus Class Carrier", ":image", "Gundam/WhiteBase.png", ":summary", "Fixed armaments: 4 x main gun; 2 x mega particle gun; hyper mega particle cannon; 2 x missile launcher\nMobile suits: 8 (12)\n2x Catapults", ":titles", "White Base", ":classification", "Hvy. Spacecraft", ":mass", "54ktons", ":height", "76.5m", ":length", "341.7m", ":width", "124.1m")
          )
        ),
        ":Zeon",
        vx_core.f_new(
          ...
          vx_core.f_new(
              ...
              nx_tactics_base.f_unitskillmap_from_unitskilllist(
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    ...
                    "Hardened vs. Energy",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unitability}, ":name", "Hardened vs. Energy")
                  )
                )
              )
            ),
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    ...
                    vx_core.f_new({"any-1": nx_tactics_base.t_unitability}, ":name", "Hardened vs. Projectiles")
                  )
                )
              )
            ),
            ":Elmeth",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Elmeth", ":image", "Gundam/Elmeth.png", ":classification", "Med. Spacecraft"),
            ":Gelgoog",
            vx_core.f_new(
              {"any-1": nx_tactics_base.t_unit},
              ":name",
            ...
            ":Gouf",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Gouf", ":image", "Gundam/Gouf.png", ":classification", "Lt. Spacecraft"),
            "Rick Dom",
            vx_core.f_new(
              {"any-1": nx_tactics_base.t_unit},
              ":name",
              ...
              "Gundam/RickDom.png",
              ":reference",
              "Realizing that the outcome of the war was going to be decided in space, Zeon devoted all of its mobile suit manufacturing resources to space combat units. Refining the Dom design for space was simple, and mostly involved replacing the hover jet thrusters with standard rocket thrusters. Zeon manufacturers began cranking out hundreds of these new units late in the war, replacing the aging MS-06F Zaku II as the premiere front line combat unit.",
              ":summary",
              ...
              nx_tactics_base.f_unitskillmap_from_unitskilllist(
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    {"any-1": nx_tactics_base.t_unititemmap},
                    "360mm Hyper Bazooka",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "360mm Hyper Bazooka", ":rounds", "10")
                  )
                )
              )
            ),
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    {"any-1": nx_tactics_base.t_unititemmap},
                    "280mm Bazooka",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "280mm Bazooka", ":rounds", "4"),
                    "120mm Machine Gun",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "120mm Machine Gun", ":rounds", "100")
                  )
                )
              )
            ),
            ...
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Gwazine Class Battleship", ":image", "Gundam/Gwazine.png", ":reference", "The Zeon Gwazine class battleships were more than a match for any Federation Forces warship.", ":summary", "Fixed armaments: 3 x 2-barrel main gun; 10 x 2-barrel secondary gun; many x 155mm machine gun\nMobile suits: 20", ":classification", "Hvy. Spacecraft", ":mass", "108.1ktons", ":height", "103m", ":length", "440m", ":width", "320m"),
            ":Musai",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Musai", ":image", "Gundam/Musai.png"),
            "Zanzibar Class Cruiser",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Zanzibar Class Cruiser", ":image", "Gundam/Zanzibar.png", ":reference", "Zeon's closest answer to the Federation's Pegasus class carrier, the Zeon Zanzibar class mobile cruiser replaced the vulnerable H.L.V. for the purpose of ferrying mobile suits to Earth and back to space. With a capacity of 6 mobile suits and a battery of bow-mounted mega particle guns, the Zanzibar was often used as the command ship for smaller fleets when a Gwazine class battleship was either unavailable or unsuitable. Lacking the Pegasus class' integral Minovsky Craft System, the Zanzibar could only operate for short periods in Earth's atmosphere, using sustained thrust. When being launched back into space, the Zanzibar class required a special rocket booster to supply the necessary thrust to break free of Earth's gravity.\nLike most Zeon warships of the One Year War, lacked launch catapults, instead deploying its complement of mobile suits through a simple hatch on the ventral hull.", ":summary", "Fixed armaments: 1 x 2-barrel main gun; 4 x mega particle gun; 5 x 2-barrel machine gun\nMobile suits: 6", ":classification", "Hvy. Spacecraft", ":height", "70.5m", ":length", "255m", ":width", "221.8m")
          )
        ),
        ":0083",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Gundam GP01",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Gundam GP01", ":image", "Gundam/GundamGP01.png", ":titles", "Gundam Unit 01"),
            "Gundam GP02",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Gundam GP02", ":image", "Gundam/GundamGP02.png", ":titles", "Gundam Unit 02"),
            "Gundam GP03",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Gundam GP03", ":image", "Gundam/GundamGP03.png", ":titles", "Gundam Unit 03"),
            "Neue Ziel",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Neue Ziel", ":image", "Gundam/NeueZiel.png")
          )
        ),
        ":AEUG",
        vx_core.f_new(
          ...
          vx_core.f_new(
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    {"any-1": nx_tactics_base.t_unititemmap},
                    "5.7MW Beam Rifle",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "5.7MW Beam Rifle", ":summary", "2 spare e-pacs stored in shield"),
                    "8.3MW Hyper Mega Launcher",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "8.3MW Hyper Mega Launcher"),
                    "60mm Vulcan Cannon",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "60mm Vulcan Cannon", ":facing", "Turretx2", ":number", "2", ":rounds", "1200")
                  )
                )
              )
            ),
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    {"any-1": nx_tactics_base.t_unititemmap},
                    "5.7MW Beam Rifle",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "5.7MW Beam Rifle"),
                    "1.3MW Beam Gun",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "1.3MW Beam Gun")
                  )
                )
              )
            ),
            ...
            vx_core.f_new(
              ...
              ":reference",
              "* Paradoxically, the Gundam Mk. II is not armored with the wonderfully durable Gundarium alloy material used by the original RX-78 Gundam, making it no more or less physically durable than mass-production mobile suits.",
              ":summary",
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    {"any-1": nx_tactics_base.t_unititemmap},
                    "2.6MW Beam Rifle",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "2.6MW Beam Rifle"),
                    "360mm Hyper Bazooka",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "360mm Hyper Bazooka", ":rounds", "7"),
                    "60mm Vulcan Cannon",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "60mm Vulcan Cannon", ":facing", "Turretx2", ":number", "2", ":rounds", "1400")
                  )
                )
              )
            ),
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    {"any-1": nx_tactics_base.t_unititemmap},
                    "2.8MW Beam Rifle",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "2.8MW Beam Rifle"),
                    "60mm Vulcan Cannon",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "60mm Vulcan Cannon", ":facing", "Turretx2", ":number", "2")
                  )
                )
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    {"any-1": nx_tactics_base.t_unititemmap},
                    "1.9MW Beam Rifle",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "1.9MW Beam Rifle"),
                    "60mm Vulcan Cannon",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "60mm Vulcan Cannon", ":facing", "Turretx2", ":number", "2")
                  )
                )
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    {"any-1": nx_tactics_base.t_unititemmap},
                    "2.2MW Beam Pistol",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "2.2MW Beam Pistol", ":number", "2"),
                    "60mm Vulcan Cannon",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "60mm Vulcan Cannon", ":facing", "Turretx2", ":number", "2")
                  )
                )
            ...
            "Super Gundam",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Super Gundam", ":image", "Gundam/SuperGundam.png", ":summary", "Combined Mobile Suit", ":titles", "FXA-05D+RX-178", ":classification", "Med. Spacecraft", ":mass", "72.9tons", ":height", "18.5m"),
            ":Argama",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Argama", ":image", "Gundam/Argama.png", ":classification", "Hvy. Spacecraft"),
            "Garuda Class Transport",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Garuda Class Transport", ":image", "Gundam/Garuda_Audhumla.png", ":summary", "Propulsion system: jet engine x 10\nArmament: laser gun x 10\nMobile suits: 20\nShips of the line: Garuda, Audhumla, Sudori, Melord\nMechanical designer: Kazumi Fujita", ":titles", "Audhumla, Garuda, Melord, Sudori", ":classification", "Med. Aircraft", ":mass", "9800tons", ":length", "317m", ":width", "524m")
          )
        ),
        "Gundam Titans",
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new(
              ...
              "Gundam/GMII.png",
              ":summary",
              "Fixed armaments: beam saber, power rating unknown\nOptional fixed armaments: shield, mounted on either forearm",
              ":titles",
              "RMS-179, RGM-79R",
              ":speedspace",
              "1.06g",
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    {"any-1": nx_tactics_base.t_unititemmap},
                    "1.3MW Funnel",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "1.3MW Funnel", ":number", "10")
                  )
                )
              )
            ),
            ...
            ":Saberfish",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Saberfish", ":image", "Gundam/Saberfish.png", ":summary", "High Altitude Fighter", ":classification", "Lt. Aircraft"),
            ":Gwazine",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Gwazine", ":image", "Gundam/Gwazine.png"),
            ":Jupitris",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Jupitris", ":image", "Gundam/Jupitris.png"),
            ":Salamis",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Salamis", ":image", "Gundam/Salamis.png")
          )
        ),
        "Federation (New)",
        vx_core.f_new(
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    ...
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "19.5 MW Mega Particle Gun", ":facing", "Turret"),
                    "2.2MW Funnel",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "2.2MW Funnel", ":number", "9"),
                    "60mm Vulcan Cannon",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "60mm Vulcan Cannon", ":facing", "Turretx4", ":number", "4")
                  )
                )
              )
            ),
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Orbital Elevator",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Orbital Elevator", ":summary", "* The Orbital Elevator is a miracle of technology and the only practical way to affordably get materials off the planet. The Orbital Elevator, the Asteroid Belt, and the Lunar Railguns are the only sources of building materials for colonies and spacecraft.\n* The Elevator is also a majestic symbol of power for the Martian Council and the Earth Authorities."),
            "Free Mars Radical",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Free Mars Radical"),
            "Martian Pirate",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Martian Pirate"),
            "Sand Marauder",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Sand Marauder")
          )
        ),
        "Moon Colonies",
        vx_core.f_new({"any-1": nx_tactics_base.t_section}, ":name", "Moon Colonies", ":summary", "* The Moon's mineral and ice deposits made it the logical location of the first permanent off-world colony. Robotic solar-powered laser drills cut tunnel complexes into the walls of craters. Human colonists followed soon after. Regular exercise in 1 G training centers is mandatory for all colonists to avoid the dangers of low gravity.\n* Cities dot the lunar landscape connected by underground transport tubes.\n* The two largest cities maintain spaceports complete with Laser Lifters to boost large ships into orbit.", ":titles", "Lunars, Lunatics, Moon Men, Moonies, Selenites"),
        "Solar Colonies",
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_section},
          ":name",
          ...
          vx_core.f_new(
            ...
            ":Stellaser",
            vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Stellaser", ":summary", "* Giant mirrors placed in pairs in Solar orbit. The mirrors gather light by reflecting it back and forth between them before releasing it in a concentrated beam to slowly accelerate starships. Though this beam would certainly be deadly to humans, the beam is only dangerous to exposed targets without sufficient radiation shielding.", ":titles", "Starlight Express")
          )
        ),
        "Venusiau Colonies",
        vx_core.f_new({"any-1": nx_tactics_base.t_section}, ":name", "Venusiau Colonies"),
        "Asteroid Colonies",
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_section},
          ":name",
          ...
          vx_core.f_new(
            ...
            vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Asteroid Mining Colony")
          ),
          ":unitmap",
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Asteroid Miner",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Asteroid Miner", ":titles", "Belter")
          )
        ),
        "Jupiter Colonies",
        vx_core.f_new(
          ...
          "Jupiter Colonies",
          ":summary",
          "* Culture - Personal space in Jovian colonies is extremely limited, so people share quarters with multiple people. There are not even enough beds for each person, so most people live with people who work different shifts and use the same beds on off-shifts. Common areas are used for everything except sleeping. The Jovians have adapted to be far more social and reliant on others for day to day life. This communal living has generally made them a tight knit society with a strong sense of group identity.\n* Science - Jovian science is one of the most advanced in the solar system. Research and development on ways to make their harsh life safer and more comfortable are always high priorites. Jovian scientists crank out a steady stream of innovations across all disciplines.\n* Military - The military has reaped the rewards of Jovian science and is arguably the most advanced force in the solar system, though certainly nowhere near the largest. Jovian forces are composed of separate standing armies: Alpha, Beta, and Gamma Divisions with Alpha containing the Godsfire flagship. Jovian military theory is based on efficient use of a small number of highly mobile units. They do not fear a large scale assault, since they would receive much forewarning of any attempt to mobilize a large force all the way out to Jupiter. Jupiter's remoteness makes it fairly easy to defend against direct assault, but the harsh environment makes sabotage a much greater threat, so Jovian intelligence forces constantly search for threats.\n* Agora - The Jovian governing body with primary offices on Elysee colony.",
          ":placemap",
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_placemap},
            "Elysee Station",
            vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Elysee Station", ":summary", "* The largest Jovian Colony and the capital of the Jovian Confederation."),
            "Joshua Station",
            vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Joshua Station", ":summary", "* The second largest Jovian Colony and Jupiter's hub of manufacturing. The station is essentially a giant factory with live in workers. All commercial starships are constructed here.\n* Jovian Armor Works - The best known aerospace corporation in Jovian space is famous for inventing the Exo-armor and designing almost all of the Exo-armor fleet.\n* Joshua station also houses the seedier areas of Jovian society. Black markets, drug dens, and bordellos operate freely. Jovians tend to have a live and let live attitude, so little effort is made to stop activities that don't threaten the colony.", ":titles", "Wildest Place in the Solar System"),
            "Khannan Station",
            vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Khannan Station", ":summary", "* The third largest Jovian Colony and Jupiter's military center. The station only allows military personnel on board. Large sections of the colony are dedicated to ship construction and others are top secret research labs."),
            "Jovian Gas Refinery",
            vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Jovian Gas Refinery", ":summary", "* These heavily armored, refining stations float in the upper atmosphere of Jupiter. They float by means of enormous rings filled with heated hydrogen and manuever using fusion thrusters. Multiple kilometer long tubes hang from the bottom of the station extracting gases from the differnt layers of the atmosphere. The broad round floatation disc and long tubes give the stations the general appearance of a jelly fish."),
            "Io Colony",
            vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Io Colony", ":reference", "Outland", ":summary", "* A small, titanium mining colony is located on Io. Miners work intensely to gain maximum bonuses. Life is dangerous and many miners are hooked on amphetimines to maximize productivity. Victimless crime is largely ignored in this generally lawless outpost. Besides miners and transport workers there are only cooks, bartenders, prostitutes, a single doctor, a sheriff and two deputies.")
          )
        ),
        "Saturn Colonies",
        vx_core.f_new(
          ...
          "Saturn Colonies",
          ":summary",
          "* With the exception of Titan, the outer planets are too remote and unimportant to ever be colonized. Jupiter provides an unlimited supply of gas resources, so Saturn, Uranus, and Neptune have little to offer.",
          ":placemap",
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_placemap},
            "Titan Research Station",
            vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Titan Research Station", ":summary", "* A small, permanent research colony has been erected on Titan to study its unique atmosphere and geology. The hope was to discover evidence of primitive life, but no life has yet to be discovered.")
          )
        )
      )
    )
          ...
          vx_core.f_new(
            ...
            vx_core.f_new(
              ...
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_unitskillmap},
                ":Strength",
                vx_core.f_new({"any-1": nx_tactics_base.t_unitskill}, ":name", "Strength")
              )
            ),
            "Terminator T-1000",
            vx_core.f_new(
              ...
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_unitskillmap},
                ":Flexible",
                vx_core.f_new({"any-1": nx_tactics_base.t_unitskill}, ":name", "Flexible")
              )
            ),
            "Terminator T-X",
            vx_core.f_new(
              ...
              "Terminator/TX.png",
              ":summary",
              "* The T-X is designed to not only terminate humans but rogue Terminators reprogrammed by the Resistance. It is a composite of the T-800 and T-1000, a solid endoskeleton covered with polymimetic liquid metal alloy, allowing it to take the shape of any humanoid it touches. The T-X endoskeleton contains many powerful weapons making it considerably more deadly than previous versions.",
              ":mass",
              "150kg",
              ":unitskillmap",
              vx_core.f_new(
