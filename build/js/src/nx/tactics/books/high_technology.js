      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "Safe House",
            vx_core.f_new({"any-1": nx_tactics_base.t_scenario}, ":name", "Safe House", ":summary", "* A small-time fixer has evidence of the identity of a cyber serial killer, the Night City Stalker.  Two news\norganizations are bidding on the deal, but the loser contacted the Stalker out of spite."),
            "Toxic Spill",
            vx_core.f_new({"any-1": nx_tactics_base.t_scenario}, ":name", "Toxic Spill", ":summary", "* While guarding a 200 person Nomad camp, the well drill discovers a hidden toxic waste dump.  Alarms alert the\ndumping company that their little secret has been discovered, so they send a team to 'clean up' the problem.\n* The whole Nomad camp must evacuate 3 miles to town before they are silenced, unfortunately they do not have\nenough vehicles to do it in one trip."),
            "The Heist",
            vx_core.f_new(
              {"any-1": nx_tactics_base.t_scenario},
              ":name",
