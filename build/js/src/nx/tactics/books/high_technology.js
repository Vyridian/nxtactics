      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "Hachiman Destroyer",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Hachiman Destroyer", ":summary", "* The Hachiman is the workhorse of the UEA navy. They have been produced\nfor many years with minor upgrades.\n* 1 Point Defense System\n* 6 Railcannon Turrets\n* 2 Missile Bays\n* 2 Laser Turrets", ":speed", ".6g", ":classification", "Hvy. Spacecraft", ":crew", "60", ":mass", "5500tons", ":length", "208m", ":width", "80m"),
            "Lucifer Cybersat",
            vx_core.f_new(
              {"any-1": nx_tactics_base.t_unit},
              ":name",
