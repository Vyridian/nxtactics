    ...
    output = vx_core.f_new(
      ...
      nx_tactics_base.f_sectionmap_from_sectionlist(
        ...
        vx_core.f_new(
          ...
          "Gryph",
          ":summary",
          "* An impressive race of winged, man-like beings. They stand up to seven feet tall, with wingspans in excess of 24 feet. Their bodies are covered with thick feathery down, and they have hawk-like visages and bright, piercing eyes.\n* Like the birds of prey they resemble, Gryphs are hunters by nature. They have exceptionally keen vision which enables them to spot the slightest movement at great distances.\n* Arms - Some Gryph have arms and hands while others have hands at the elbow of their wings instead. The ones without arms rely more on their feet for dexterous tasks.\n* Gryphs live in eyries built on cliffsides or at the tops of high trees. Their dwellings resemble great bird's nests composed of woven vines and leafy canopies.\n* Occassionally the avians will take to adventuring for profit, accepting mercenary posts as scouts, guides, or bouty hunters. The majority, however, would never consider leaving their homes. Gryphs are an independent, strong-willed race that values freedom above all else which can make them difficult employees.\n* Morale - Normal",
          ":titles",
          "Gryphon, Harpy",
          ":unitmap",
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Gryph Javelineer",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Gryph Javelineer", ":traits", "Gryph"),
            "Gryph Light Infantry",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Gryph Light Infantry", ":traits", "Gryph")
          )
        ),
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_section},
        ...
        vx_core.f_new(
          ...
          "Lamia",
          ":unitmap",
          nx_tactics_base.f_unitmap_from_tactics_keys(tactics, "Naga Chieftan", "Naga Enforcer", "Naga Hunter")
        ),
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_section},
          ":name",
          ...
          ":titles",
          "Centaur, Minotaur, Sagittarian",
          ":unitmap",
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Sagitan Horse Archer",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Sagitan Horse Archer"),
            "Sagitan Light Cavalry",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Sagitan Light Cavalry")
          )
        ),
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_section},
            ...
            vx_core.f_new(
              ...
              nx_tactics_base.f_unitskillmap_from_unitskilllist(
                nx_tactics_base.f_unitskill_from_tactics_key_lvl_items(
                  ...
                  "Melee",
                  7,
                  vx_core.f_new({"any-1": vx_core.t_stringlist}, "Hammer: War")
                )
              )
            ),
            "Gnoll Pikeman",
            ...
            vx_core.f_new(
              ...
              nx_tactics_base.f_unitskillmap_from_unitskilllist(
                nx_tactics_base.f_unitskill_from_tactics_key_items(
                  tactics,
                  "Ranged",
                  vx_core.f_new({"any-1": vx_core.t_stringlist}, "Net", "Whip")
                )
              )
            )
          )
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new(
              ...
              ":unitskillmap",
              nx_tactics_base.f_unitskillmap_from_unitskilllist(
                nx_tactics_base.f_unitskill_from_tactics_key_lvl(tactics, "Military", 4)
              )
            )
          )
        ),
      ...
      nx_tactics_base.f_sectionmap_from_sectionlist(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "Pazuzu",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Pazuzu", ":titles", "Lord of Fevers and Plagues", ":reference", "Exorcist, Exorcist II", ":summary", "Dark Angel of the Four Winds with rotting genitals from which he howls through sharpened teeth over stricken cities."),
            "Orcus",
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Baphomet",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Baphomet", ":traits", "Devil"),
            "Count Andromalius",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Count Andromalius", ":traits", "Devil"),
            "Count Bifrons",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Count Bifrons", ":traits", "Devil"),
            "Count Furfur",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Count Furfur", ":traits", "Devil"),
            "Count Halphas",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Count Halphas", ":traits", "Devil"),
            "Count Räum",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Count Räum", ":traits", "Devil"),
            "Duke Agares",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Agares", ":traits", "Devil"),
            "Duke Aim",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Aim", ":traits", "Devil"),
            "Duke Alloces",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Alloces", ":traits", "Devil"),
            "Duke Amdusias",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Amdusias", ":traits", "Devil"),
            "Duke Astaroth",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Astaroth", ":traits", "Devil"),
            "Duke Barbatos",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Barbatos", ":traits", "Devil"),
            "Duke Bathin",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Bathin", ":traits", "Devil"),
            "Duke Buné",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Buné", ":traits", "Devil"),
            "Duke Berith",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Berith", ":traits", "Devil"),
            "Duke Crocell",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Crocell", ":traits", "Devil"),
            "Duke Dantalion",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Dantalion", ":traits", "Devil"),
            "Duke Eligos",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Eligos", ":traits", "Devil"),
            "Duke Focalor",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Focalor", ":traits", "Devil"),
            "Duke Gremory",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Gremory", ":traits", "Devil"),
            "Duke Gusion",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Gusion", ":traits", "Devil"),
            "Duke Haures",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Haures", ":traits", "Devil"),
            "Duke Murmur",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Murmur", ":traits", "Devil"),
            "Duke Sallos",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Sallos", ":traits", "Devil"),
            "Duke Valefor",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Valefor", ":traits", "Devil"),
            "Duke Vapula",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Vapula", ":traits", "Devil"),
            "Duke Vepar",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Vepar", ":traits", "Devil"),
            "Duke Vual",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Vual", ":traits", "Devil"),
            "Duke Zepar",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Duke Zepar", ":traits", "Devil"),
            "Dust Devil",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Dust Devil", ":traits", "Devil"),
            "Fury Devil",
            ...
            ":Hellion",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Hellion", ":titles", "Hellcat", ":traits", "Devil"),
            ":Hellspawn",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Hellspawn", ":titles", "Lemure", ":traits", "Devil"),
            "Ice Devil",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Ice Devil", ":traits", "Devil"),
            "Imp",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Imp", ":titles", "Bottle Imp, Sardonicus", ":traits", "Devil", ":summary", "* The Imp is a foot tall, bat-winged minor Devil with a long forked tail that can be used for grasping. Imps can find and squeeze through the tiniest dimensional cracks and are therefore the most common of all of Hell's legions infesting the world. They can speak, but are mostly incoherent, muttering, lunatics. Their flesh is rubbery and their bones are soft, so they can withstand the massive physical abuse that greater devils heap on them. Though physically weak, they are fast flyers with keen vision and make excellent messengers.\n* Origin - Imps are the Fiend form of cruel children who chose to go to hell to continue their cruelty. Of course, this does not go well for evil child.\n* Personality - They are clever and may try to design intricate plans, or they may just cause trouble and hope that will please their masters.\n* Powers - They may communicate mentally with other devils and it is in this way that they are the most useful. Powerful diabolists have been known to capture Imps and cram them into magical bottles. Anyone who possesess the bottle may converse with the Imp inside. Though the Imp is troublesome and somewhat incoherent, it may be used as a go between to converse with greater devils to negotiate for knowledge or power. While channelling greater devils, the Imp becomes immeditately conherent and possesses a dark intelligence that it uses to conspire with its master.\n* In their home realm, Imps occupy the unenviable position at the bottom of the devil hierarchy. At best, servitors may be employed as scullery workers or menial laborers. Worse they are used as living tools serving as a plunger, polishing, or scrapping instrument. Devils sometimes amuse themselves by squeezing an imp's head into funny faces."),
            "King Baal Moloch",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "King Baal Moloch", ":summary", "* A King of [Devils] with [Godlike] power.\n* Baal appears as a man with a bull's head.\n* Worship involves child sacrifice by fire (to Moloch).", ":titles", "Bael", ":traits", "Devil"),
            "King Balam",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "King Balam", ":traits", "Devil"),
            "King Beleth",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "King Beleth", ":traits", "Devil"),
            "King Belial",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "King Belial", ":traits", "Devil"),
            "King Paimon",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "King Paimon", ":traits", "Devil"),
            "King Purson",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "King Purson", ":traits", "Devil"),
            "King Viné",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "King Viné", ":traits", "Devil"),
            "King Zagan",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "King Zagan", ":traits", "Devil"),
            "Knight Furcas",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Knight Furcas", ":traits", "Devil"),
            "Marquis Amon",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Marquis Amon", ":traits", "Devil"),
            "Marquis Andras",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Marquis Andras", ":traits", "Devil"),
            "Marquis Andrealphus",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Marquis Andrealphus", ":traits", "Devil"),
            "Marquis Cimeies",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Marquis Cimeies", ":traits", "Devil"),
            "Marquis Decarabia",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Marquis Decarabia", ":traits", "Devil"),
            "Marquis Leraje",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Marquis Leraje", ":traits", "Devil"),
            "Marquis Forneus",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Marquis Forneus", ":traits", "Devil"),
            "Marquis Marchosias",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Marquis Marchosias", ":traits", "Devil"),
            "Marquis Naberius",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Marquis Naberius", ":traits", "Devil"),
            "Marquis Oriax",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Marquis Oriax", ":titles", "Orias", ":traits", "Devil"),
            "Marquis Phenex",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Marquis Phenex", ":traits", "Devil"),
            "Marquis Ronové",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Marquis Ronové", ":traits", "Devil"),
            "Marquis Samigina",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Marquis Samigina", ":traits", "Devil"),
            "Marquis Shax",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Marquis Shax", ":traits", "Devil"),
            "Marquis Sabnock",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Marquis Sabnock", ":traits", "Devil"),
            "Nightmare",
            nx_tactics_base.f_unit_from_tactics_key(tactics, "Nightmare"),
            "Pit Fiend",
        ...
        vx_core.f_new(
          ...
          "Mirrorlands",
          ":unitmap",
          nx_tactics_base.f_unitmap_from_tactics_keys(tactics, "Mirror Reflection", "Mirror Shard")
        )
      )
    )
    return output
      ...
      nx_tactics_base.f_sectionmap_from_sectionlist(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Giant: Cloud",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Giant: Cloud"),
            "Giant: Cyclops",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Giant: Cyclops"),
            "Giant: Fire",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Giant: Fire", ":titles", "Eldjotunn"),
            "Giant: Hill",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Giant: Hill"),
            "Giant: Ice",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Giant: Ice", ":titles", "Frost Giant, Jotunn"),
            "Giant: Mountain",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Giant: Mountain"),
            "Giant: Stone",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Giant: Stone"),
            "Giant: Storm",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Giant: Storm")
          )
        ),
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_section},
  ...
  static f_chapter_humanoids_fantastic(tactics) {
    ...
    output = vx_core.f_new(
      ...
      vx_core.f_new(
        ...
        "Alfar:Dark",
        vx_core.f_new({"any-1": nx_tactics_base.t_section}, ":name", "Alfar, Dark", ":titles", "Black Elf, Dark Elf, Dark Elv, Dökkálfar, Drow, Svartalfar", ":reference", "* Norse Dökkálfar (Dark Elf), or Svartalfar (Black Elf) - Subterranean creatures who dwell in the world of Svartalfaheim. Dark elves are often said to be responsible for many of the maladies befalling humanity. In particular, bad dreams are said to be within the domain of the Dökkálfar, as indicated by the German word for nightmare, Albtraum ('Elf-dream').\n* Drow - Shetland Islands malicious troll-like creatures\n* Seven Deadly Sins: Pride", ":summary", "* Maximum Body - 6\n* Preferred Skills - Ranged (Archery), Art, Music, Darkness, Survival\n* Morale - Normal\n* Units - Elite Spies, Light Infantry, Heavy Infantry, Elite Light Archers, Heavy Cavalry, Siege Crews\n* Long ago, before the time of men, Elvish scholars concluded that the seasons of the world were changing and that Elvenkind would slowly fade from the world. The majority grudgingly accepted this as the way of things, but a vocal minority refused to accept their fate. They searched for the tools to change their fate. This search led them to pursue black magic. The other elves were horrified by this blashphemy and called the Wild Hunt to eradicate the renegades and put an end to their abominations. The renegades fled to the subterranean Svartalfaheim. Exposure to the dark radiations of Svartalfaheim changed them into the dark elves. They eventually stopped the Wild Hunt and released them to randomly hunt across the world.\n* Eclipse - A faction of Dark Elves have rejected a return to Svartalfaheim and are committed to taking the surface world from humankind. To this end, they wish to permanently cut off and darken the moons."),
        "Alfar:Light",
        vx_core.f_new({"any-1": nx_tactics_base.t_section}, ":name", "Alfar:Light", ":titles", "Eld, Eldar, Elf, Elv, Elves, Ljósálfar, Sidhe, Sylvan", ":reference", "* Seven Deadly Sins: Pride", ":summary", "* Maximum Body - 4\n* Morale - High\n* Preferred Skills - Ranged (Archery), Art, Music, Wild Magic, Survival\n* Units - Elite Scouts, Light Infantry, Elite Light Archers, Elite Longbow Archers\n\n* Norse Ljósálfar (Light Elf) or Hvítálfar (White Elf)\n* Personality - Whatever the Alfar choose to do, they do it with grace and refinement. They have a strong sense of nobility and will not abide dishonorable acts. For this reason, they have little trust in Humans or Uruks. \n* Biology - Alfar infants will often wander into the Dreaming to play with fae folk for their childhood years. Some Alfar never grow up and stay with the fae, but most become teenagers and return to their community. They age and develop very slowly and can live for over 1000 years. Their blood is red but has a distinctive silvery sheen.\n* Personalties - Though they seem severe from an outsiders' perspective, this is because of their deep distrust of others. They are actually a very idealistic people who remember the lessons of the fae to always keep music and joy in their hearts. Unfortunately, their long lives sometimes make them make decisions slowly as well. They are often surprised by rapidly changing circumstances.\n* History - The Alfar arrived on Thera during the Great Convergence when the Realms intersected. They worship the Moon Goddess Selene and believe the Moon is a portal back to Elysium where they long to return.\n* Abilities - Alfar have long ears with heightened sensitivity. This makes them keenly aware of intruders. Though their vision is unremarkable, they are accustomed to operating at night especially under moonlight.\n* Wild Alfar - Traditional Sidhe culture is closely connected to the woods. They live in semi-permanent settlements an live off the land similar to many native peoples.\n* High Alfar - Some Sidhe have settled down to build beautiful towns of stone and wood. Here they study the arts, sciences, and magick. The two cultures have grown distrustful of each other over their fundamentally different outlooks on life."),
        ":Fae",
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_section},
          ":name",
          ...
          vx_core.f_new(
            ...
            "Clurichaun",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Clurichaun", ":summary", "* A mischievous fairy known for its great love of drinking, haunting bars, pubs and wine cellars."),
            "Fae Dragon",
      ...
      nx_tactics_base.f_sectionmap_from_sectionlist(
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new(
              ...
              nx_tactics_base.f_unitpowermap_from_unitpowerlist(
                nx_tactics_base.f_unitpower_from_tactics_key_abilities(
                  tactics,
                  "Transmutation",
                  vx_core.f_new({"any-1": vx_core.t_stringlist}, "Petrifying Breath", "Petrifying Stare")
                )
              )
            ),
            "Chimera",
            ...
            "Eye Killer",
            nx_tactics_base.f_unit_from_tactics_key(tactics, "Eye Killer"),
            "Gargoyle",
            ...
            "Gorgon",
            nx_tactics_base.f_unit_from_tactics_key(tactics, "Gorgon"),
            "Hippogriff",
            ...
            "Lamassu",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Lamassu", ":titles", "Shedu", ":summary", "* Protective winged bull or lion; with the head of a human female.  Shedu is the male equivalent."),
            "Manticore",
            ...
            "Sphinx",
            nx_tactics_base.f_unit_from_tactics_key(tactics, "Sphinx"),
            "Strix",
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "Fisher Plant: Giant",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Fisher Plant: Giant", ":summary", "* A huge creeper vine plant that covers mulitple nearby trees and has enormous blossoms hanging from high branches. The plant attacks living creatures by dropping vines from the bottom of the blossums that entwine and drag prey into the canaopy above where they die of strangulation or dehydration and are eventually digested. Bones and bits of carcass are dropped below to lure more prey."),
            "Shambler",
    ...
    output = vx_core.f_new(
      ...
      nx_tactics_base.f_sectionmap_from_sectionlist(
        vx_core.f_new(
          ...
          ":unitmap",
          nx_tactics_base.f_unitmap_from_tactics_keys(tactics, "Barghest", "Burning Dead", "Dead of Night", "Dead of Winter", "Dhampyr", "Drowned", "Ghost Ship", "Ghoul", "Husk", "Lich", "Mummy", "Night Terror", "Pestilence Horse", "Scarecrow", "Skeletal Dragon", "Skeletal Knight", "Skeleton", "Skeleton Warrior", "Slayer Dead", "Wendigo", "Wight", "Zombie: Walker")
        ),
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_section},
          ":name",
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Centipede: Poisonous",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Centipede: Poisonous"),
            "Centipede: Amazonian Giant",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Centipede: Amazonian Giant")
          )
        ),
        ":Worms",
        vx_core.f_new(
