      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            ":Bombers",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Bombers"),
            ":Helicopters",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Helicopters"),
            ":Fighters",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Fighters", ":image", "Modern/FighterToken.png"),
            ":Tanks",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Tanks", ":image", "Modern/TankToken.png"),
            "Mobile Missile Launchers",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Mobile Missile Launchers", ":image", "Modern/MobileMissileToken.png"),
            ":Missiles",
            ...
            "Super X",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Super X", ":image", "Daikaiju/SuperXToken.png", ":summary", "* Flight at mach 1\n* Cadmium Missiles\n* Laser Cannons\n* equipped with a wide variety of missiles\n* heat resistant layer", ":mass", "150tons", ":height", "11m", ":length", "27m"),
            "Super X-II",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Super X-II", ":image", "Daikaiju/SuperX2.png"),
            "Super X-III",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Super X-III", ":image", "Daikaiju/SuperX3Token.png", ":summary", "Flight at mach 1.7; can fire a Freezer Beam; equipped with Cadmium Missiles; heat resistant layer", ":mass", "220tons", ":height", "7.4m", ":length", "38.5m", ":width", "58.7m")
          )
        ),
        "Allied Monsters",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            ":Gamera",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Gamera", ":image", "Daikaiju/GameraToken.png", ":summary", "* Flight at Mach 3.5 using rockets contained in limbs\n* Plasma fireballs\n* Elbow claws\n* Can open plates in his chest and fire a Mana Blast\n* Can swim at 180 knots\n* Burrowing ability\n* Able to absorb and manipulate fire\n* Can draw more power by establishing a link with a human host\n* Orign - Believed to be over 150 million years old and created by an ancient civilization as a guardian of the Earth.\n* Armor - So tough that it survived the shock of a nuclear weapon.", ":mass", "120tons", ":height", "80m"),
            "Mecha King Ghidorah",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Mecha King Ghidorah", ":image", "Daikaiju/MechaKingGhidorahToken.png", ":summary", "Antigravity flight at mach 4; able to fire Gravity beams from its mouths on the left and right head; can fire a Laser Triple beam from the central head; equipped with Godzilla Capture Cables and the large Machine Hand restraint that can also discharge electricity", ":mass", "80ktons", ":length", "140m"),
            ":Mechagodzilla",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Mechagodzilla", ":image", "Daikaiju/MechaGodzillaToken.png", ":summary", "Flight at mach 2; Mega-Buster ray from mouth; paralysis missiles; Super Heat Shield NT-20, laser beam eyes; Plasma Grenade that fires energy absorbed by the Super Heat Shield; 'G-Crusher;' shock anchors and cables; dual Garuda shoulder mounted laser cannons", ":mass", "150ktons", ":length", "120m"),
            ":Mogera",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Mogera", ":image", "Daikaiju/MogeraToken.png", ":summary", "Flight at mach 1; can travel through space at mach 44; able to fire Plasma Laser Cannons from eyes; equipped with a rotating drill for a nose; able to fire a beam from its chest; can launch Spiral Grenade missiles from its hands; has treads under feet for faster movement on land; able to fire lasers from its two hands; can separate into the Star Falcon and Land Moguera", ":mass", "160ktons", ":height", "120m"),
            ":Mothra",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Mothra", ":image", "Daikaiju/MothraToken.png", ":summary", "* Flight at mach 3\n* can travel through space\n* hurricane winds from wings\n* antenna ray-shooting beams\n* can release powder from her wings that will reflect energy attacks back on their source\n* able to conduct energy through its touch or release it as strands of lightning from her wings", ":mass", "20ktons", ":length", "65m"),
            "Mothra, Larva",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Mothra, Larva", ":image", "Daikaiju/MothraLarvaeToken.png", ":summary", "Web Attack", ":mass", "15ktons", ":length", "120m")
          )
        ),
        "Enemy Monsters",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            ":Battra",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Battra", ":image", "Daikaiju/BattraToken.png", ":summary", "Flight at mach 3; can travel through space; hurricane winds from wings; able to shoot Prism beams from eyes; can conduct energy through its touch", ":mass", "30ktons", ":length", "73m"),
            "Battra, Larva",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Battra, Larva", ":image", "Daikaiju/BattraLarvaeToken.png", ":summary", "Burrowing ability; adept swimmer; able to shoot Prism beams from horn and eyes; body can generate energy pulses to attack others with its touch", ":mass", "20ktons", ":length", "90m"),
            ":Biollante",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Biollante", ":image", "Daikaiju/Biollante.png"),
            ":Destroyah",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Destroyah", ":image", "Daikaiju/Destroyah.png"),
            ":Godzilla",
            vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new(
              ...
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_unitskillmap},
                ":Gunnery",
                vx_core.f_new({"any-1": nx_tactics_base.t_unitskill}, ":name", "Gunnery", ":summary", "* Getter Beam\n* Tomahawk Boomerang", ":level", "5")
              )
            ),
            "Getter 2",
            vx_core.f_new(
              ...
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_unitskillmap},
                ":Gunnery",
                vx_core.f_new({"any-1": nx_tactics_base.t_unitskill}, ":name", "Gunnery", ":summary", "* Getter Drill\n* Drill Missile", ":level", "5")
              )
            ),
            "Getter 3",
            vx_core.f_new(
              ...
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_unitskillmap},
                ":Gunnery",
                vx_core.f_new({"any-1": nx_tactics_base.t_unitskill}, ":name", "Gunnery", ":summary", "* Getter Missile", ":level", "5")
              )
            ),
            "Getter G Dragon",
            vx_core.f_new(
              ...
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_unitskillmap},
                ":Gunnery",
                vx_core.f_new({"any-1": nx_tactics_base.t_unitskill}, ":name", "Gunnery", ":summary", "* Getter Beam\n* Double Tomahawk Boomerang", ":level", "5")
              )
            ),
            "Getter G Liger",
            vx_core.f_new(
              ...
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_unitskillmap},
                ":Gunnery",
                vx_core.f_new({"any-1": nx_tactics_base.t_unitskill}, ":name", "Gunnery", ":summary", "* Liger Missile", ":level", "5")
              )
            ),
            "Getter G Poseidon",
            vx_core.f_new(
              ...
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_unitskillmap},
                ":Gunnery",
                vx_core.f_new({"any-1": nx_tactics_base.t_unitskill}, ":name", "Gunnery", ":summary", "* Finger Net\n* Strong Missile\n* Getter Cyclone", ":level", "5")
              )
            ),
            "Great Mazinger",
            vx_core.f_new(
              ...
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_unitskillmap},
                ":Gunnery",
                vx_core.f_new({"any-1": nx_tactics_base.t_unitskill}, ":name", "Gunnery", ":summary", "* Navel Missile\n* Atomic Punch\n* Great Boomerang\n* Scramble Cutter - Attack with Great Booster\n* Great Typhoon\n* Breast Burn\n* Thunder Break", ":level", "5")
              )
            ),
            ":Grendizer",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Grendizer", ":image", "Daikaiju/Grendizer.png"),
            "Mazinger Z",
            vx_core.f_new(
              {"any-1": nx_tactics_base.t_unit},
              ":name",
