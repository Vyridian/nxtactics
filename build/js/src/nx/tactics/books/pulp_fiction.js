...
export default class nx_tactics_books_pulp_fiction {
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "Government Agent",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Government Agent", ":summary", "We have top men working on it now.  Who?  Top... men. - Raiders of the Lost Ark")
          )
        ),
        "Treasure Hunters",
        vx_core.f_new(
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    ...
                    ":Antiquities",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unitability}, ":name", "Antiquities"),
                    ":Archeology",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unitability}, ":name", "Archeology"),
                    "Ancient History",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unitability}, ":name", "Ancient History"),
                    "Religious Studies",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unitability}, ":name", "Religious Studies")
                  )
                )
              )
            ),
  ...
  static f_chapter_flash_gordon() {
    let output = nx_tactics_base.e_chapter
    output = vx_core.f_new({"any-1": nx_tactics_base.t_chapter}, ":name", "Flash Gordon")
    return output
  }
  ...
  static f_chapter_hardboiled_detective() {
    let output = nx_tactics_base.e_chapter
    output = vx_core.f_new({"any-1": nx_tactics_base.t_chapter}, ":name", "Hardboiled Detective")
    return output
  }
  ...
  static f_chapter_john_carter_on_mars() {
    let output = nx_tactics_base.e_chapter
    output = vx_core.f_new({"any-1": nx_tactics_base.t_chapter}, ":name", "John Carter on Mars")
    return output
  }
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            ":Pylon",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Pylon"),
            ":Skylon",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Skylon"),
            ":Enik",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Enik"),
            ":Pakuni",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Pakuni"),
            ":Sleestak",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Sleestak")
          )
        )
      )
    )
  ...
  static f_chapter_lost_continent() {
    let output = nx_tactics_base.e_chapter
    output = vx_core.f_new({"any-1": nx_tactics_base.t_chapter}, ":name", "Lost Continent")
    return output
  }
  ...
  static f_chapter_pulp_fiction_overview() {
    ...
    output = vx_core.f_new(
      ...
      vx_core.f_new(
        ...
        vx_core.f_new({"any-1": nx_tactics_base.t_section}, ":name", "Why Tactics: Pulp Fiction?")
      )
    )
    return output
  }
  ...
  static f_chapter_true_grit___crime() {
    let output = nx_tactics_base.e_chapter
    output = vx_core.f_new({"any-1": nx_tactics_base.t_chapter}, ":name", "True Grit / Crime")
    return output
  }
  ...
  static f_chapter_war_of_the_worlds() {
    let output = nx_tactics_base.e_chapter
    output = vx_core.f_new({"any-1": nx_tactics_base.t_chapter}, ":name", "War of the Worlds")
    return output
  }
