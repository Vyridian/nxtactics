...
export default class nx_tactics_books_bookloader {
  ...
  static f_ability_from_ability_key_value(current, key, value) {
    ...
    output = vx_core.f_switch(
      ...
      vx_core.f_case(
        vx_core.f_new({"any-1": vx_core.t_list}, "name", "image"),
        vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(current, key, value)})
      ),
      vx_core.f_else(
  ...
  static f_ability_from_ability_stringmap(ability, propmap) {
    ...
    output = vx_core.f_any_from_map_start_reduce(
      ...
      propmap,
      ability,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_ability_from_ability_key_value)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_ability, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return ability})),
          vx_core.f_case(
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          ability,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_ability_from_ability_xmlchild)
        )
      })
    )
    return output
  ...
  static f_book_from_book_stringmap(book, propmap) {
    ...
    output = vx_core.f_any_from_map_start_reduce(
      ...
      propmap,
      book,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_book_from_book_key_value)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          ...
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return current})),
          vx_core.f_case_1("!--", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return current})),
          vx_core.f_case_1("?xml", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return current})),
          vx_core.f_case_1(
            "doc",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_if_2(
              {"any-1": nx_tactics_base.t_book},
              vx_core.f_then(
                vx_core.f_new_from_type(vx_core.t_boolean_from_func, () => {return vx_core.f_is_empty_1(current)}),
                vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_book_from_xmldoc(child)})
              ),
              vx_core.f_else(
                vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
                  current,
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_book, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return book})),
          vx_core.f_case(
            vx_core.f_new({"any-1": vx_core.t_list}, "reference", "summary", "titles"),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              book,
          ...
          vx_core.f_case_1(
            "chapter",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_book_from_book_xmlchapter(book, child)})
          ),
          vx_core.f_else(
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              book,
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          children,
          book,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_book_from_book_xmlchild)
        )
      })
    )
    return output
  ...
  static f_book_from_xmllist(xmllist) {
    ...
    output = vx_core.f_any_from_list_start_reduce(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_book_from_book_xml)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const bools = vx_core.f_list_from_list_1(
          ...
          booknames,
          vx_core.f_new_from_type(vx_core.t_any_from_any, (bookname) => 
            vx_core.f_let(
              {"any-1": vx_core.t_boolean},
              [],
              vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
  ...
  static f_chapter_from_chapter_stringmap(chapter, propmap) {
    ...
    output = vx_core.f_any_from_map_start_reduce(
      ...
      propmap,
      chapter,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_chapter_from_chapter_key_value)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_chapter, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return chapter})),
          vx_core.f_case(
            vx_core.f_new({"any-1": vx_core.t_list}, "reference", "summary", "titles"),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              chapter,
          ...
          vx_core.f_case_1(
            "section",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_chapter_from_chapter_xmlsection(chapter, child)})
          ),
          vx_core.f_else(
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              chapter,
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          vx_core.f_any_from_struct({"any-1": vx_data_xml.t_xmllist, "struct-2": vx_data_xml.t_xml}, xml, ":children"),
          chap,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_chapter_from_chapter_xmlchild)
        )
      })
    )
    return output
  ...
  static f_damage_from_damage_key_value(current, key, value) {
    ...
    output = vx_core.f_switch(
      ...
      vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return current})),
      vx_core.f_case(
        vx_core.f_new({"any-1": vx_core.t_list}, "name", "image", "classification"),
        vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(current, key, value)})
      ),
      vx_core.f_else(
        vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
  ...
  static f_damage_from_damage_stringmap(damage, propmap) {
    ...
    output = vx_core.f_any_from_map_start_reduce(
      ...
      propmap,
      damage,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_damage_from_damage_key_value)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_damage, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return damage})),
          vx_core.f_case(
            vx_core.f_new({"any-1": vx_core.t_list}, "reference", "summary", "titles"),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              damage,
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          vx_core.f_any_from_struct({"any-1": vx_data_xml.t_xmllist, "struct-2": vx_data_xml.t_xml}, xml, ":children"),
          damage,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_damage_from_damage_xmlchild)
        )
      })
    )
    return output
  ...
  static f_file_read_from_bookname(bookname) {
    ...
    output = vx_core.f_new(
      ...
      "resources/books",
      ":name",
      vx_core.f_new({"any-1": vx_core.t_string}, bookname, ".xml")
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_new(
          ...
          "resources/books",
          ":name",
          vx_core.f_new({"any-1": vx_core.t_string}, bookname, ".vxlisp")
        )
      })
    )
    return output
  ...
  static f_item_from_item_key_value(current, key, value) {
    ...
    output = vx_core.f_switch(
      ...
      vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return current})),
      vx_core.f_case(
        vx_core.f_new({"any-1": vx_core.t_list}, "name", "image", "classification", "crew", "energy", "explosive", "height", "length", "mass", "modifiers", "muzzlevelocity", "range", "rof", "rounds", "speedair", "speedland", "speedspace", "speedwater", "width"),
        vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(current, key, value)})
      ),
      vx_core.f_else(
        vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
  ...
  static f_item_from_item_stringmap(item, propmap) {
    ...
    output = vx_core.f_any_from_map_start_reduce(
      ...
      propmap,
      item,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_item_from_item_key_value)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_item, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return item})),
          vx_core.f_case(
            vx_core.f_new({"any-1": vx_core.t_list}, "reference", "summary", "titles"),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              item,
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          vx_core.f_any_from_struct({"any-1": vx_data_xml.t_xmllist, "struct-2": vx_data_xml.t_xml}, xml, ":children"),
          item,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_item_from_item_xmlchild)
        )
      })
    )
    return output
  ...
  static f_modifier_from_modifier_stringmap(modifier, propmap) {
    ...
    output = vx_core.f_any_from_map_start_reduce(
      ...
      propmap,
      modifier,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_modifier_from_modifier_key_value)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_modifier, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return modifier})),
          vx_core.f_case(
            vx_core.f_new({"any-1": vx_core.t_list}, "reference", "summary", "titles"),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              modifier,
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          vx_core.f_any_from_struct({"any-1": vx_data_xml.t_xmllist, "struct-2": vx_data_xml.t_xml}, xml, ":children"),
          modifier,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_modifier_from_modifier_xmlchild)
        )
      })
    )
    return output
  ...
  /**
   * @function place_from_place_key_value
   * Returns a modified place from a key value.
   * @param  {place} current
   * @param  {string} key
   * @param  {string} value
   * @return {place}
   */
  static t_place_from_place_key_value = {
    vx_type: vx_core.t_type
  }
  static e_place_from_place_key_value = {
    vx_type: nx_tactics_books_bookloader.t_place_from_place_key_value
  }

  // (func place<-place-key-value)
  static f_place_from_place_key_value(current, key, value) {
    let output = nx_tactics_base.e_place
    output = vx_core.f_switch(
      {"any-1": nx_tactics_base.t_place, "any-2": vx_core.t_string},
      key,
      vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return current})),
      vx_core.f_case(
        vx_core.f_new({"any-1": vx_core.t_list}, "name", "image"),
  ...
  /**
   * @function place_from_place_stringmap
   * Returns a place from a propmap.
   * @param  {place} place
   * @param  {stringmap} propmap
   * @return {place}
   */
  static t_place_from_place_stringmap = {
    vx_type: vx_core.t_type
  }
  static e_place_from_place_stringmap = {
    vx_type: nx_tactics_books_bookloader.t_place_from_place_stringmap
  }

  // (func place<-place-stringmap)
  static f_place_from_place_stringmap(place, propmap) {
    let output = nx_tactics_base.e_place
    output = vx_core.f_any_from_map_start_reduce(
      {"any-1": vx_core.t_string, "map-1": vx_core.t_stringmap},
      propmap,
      place,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_place_from_place_key_value)
    )
    return output
  }

  /**
   * @function place_from_place_xmlchild
   * Returns a modified place based on a given child Xml.
   * @param  {place} place
   * @param  {xml} child
   * @return {place}
   */
  static t_place_from_place_xmlchild = {
    vx_type: vx_core.t_type
  }
  static e_place_from_place_xmlchild = {
    vx_type: nx_tactics_books_bookloader.t_place_from_place_xmlchild
  }

  // (func place<-place-xmlchild)
  static f_place_from_place_xmlchild(place, child) {
    let output = nx_tactics_base.e_place
    output = vx_core.f_let(
      {"any-1": nx_tactics_base.t_place, "any-2": vx_core.t_string},
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_place, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return place})),
          vx_core.f_case(
            vx_core.f_new({"any-1": vx_core.t_list}, "reference", "summary", "titles"),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              place,
  ...
  /**
   * @function place_from_xml
   * Returns a place from a given xml.
   * @param  {xml} xml
   * @return {place}
   */
  static t_place_from_xml = {
    vx_type: vx_core.t_type
  }
  static e_place_from_xml = {
    vx_type: nx_tactics_books_bookloader.t_place_from_xml
  }

  // (func place<-xml)
  static f_place_from_xml(xml) {
    let output = nx_tactics_base.e_place
    output = vx_core.f_let(
      {"any-1": nx_tactics_base.t_place, "any-2": vx_data_xml.t_xml, "list-2": vx_data_xml.t_xmllist},
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const propmap = vx_core.f_any_from_struct({"any-1": vx_core.t_stringmap, "struct-2": vx_data_xml.t_xml}, xml, ":propmap")
        const place = nx_tactics_books_bookloader.f_place_from_place_stringmap(
          vx_core.f_empty(
            nx_tactics_base.t_place
          ),
          propmap
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          vx_core.f_any_from_struct({"any-1": vx_data_xml.t_xmllist, "struct-2": vx_data_xml.t_xml}, xml, ":children"),
          place,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_place_from_place_xmlchild)
        )
      })
    )
    return output
  ...
  static f_power_from_power_key_value(current, key, value) {
    ...
    output = vx_core.f_switch(
      ...
      vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return current})),
      vx_core.f_case(
        vx_core.f_new({"any-1": vx_core.t_list}, "name", "image", "stat"),
        vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(current, key, value)})
      ),
      vx_core.f_else(
        vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
  ...
  static f_power_from_power_stringmap(power, propmap) {
    ...
    output = vx_core.f_any_from_map_start_reduce(
      ...
      propmap,
      power,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_power_from_power_key_value)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_power, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return power})),
          vx_core.f_case(
            vx_core.f_new({"any-1": vx_core.t_list}, "reference", "summary", "titles"),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              power,
          ...
          vx_core.f_case_1(
            "ability",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_power_from_power_xmlability(power, child)})
          ),
          vx_core.f_case_1(
            "specialty",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_power_from_power_xmlspecialty(power, child)})
          ),
          vx_core.f_else(
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              power,
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          children,
          power,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_power_from_power_xmlchild)
        )
      })
    )
    return output
  ...
  static f_rule_from_rule_stringmap(rule, propmap) {
    ...
    output = vx_core.f_any_from_map_start_reduce(
      ...
      propmap,
      rule,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_rule_from_rule_key_value)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_rule, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return rule})),
          vx_core.f_case(
            vx_core.f_new({"any-1": vx_core.t_list}, "reference", "summary", "titles", "classification"),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              rule,
              tag,
              vx_data_xml.f_string_first_from_xml(child)
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          vx_core.f_any_from_struct({"any-1": vx_data_xml.t_xmllist, "struct-2": vx_data_xml.t_xml}, xml, ":children"),
          rule,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_rule_from_rule_xmlchild)
        )
      })
    )
    return output
  ...
  static f_section_from_section_stringmap(section, propmap) {
    ...
    output = vx_core.f_any_from_map_start_reduce(
      ...
      propmap,
      section,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_section_from_section_key_value)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_section, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return section})),
          vx_core.f_case(
            vx_core.f_new({"any-1": vx_core.t_list}, "reference", "summary", "titles"),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              section,
          ...
          vx_core.f_case_1(
            "damage",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_section_from_section_xmldamage(section, child)})
          ),
          vx_core.f_case_1(
            "item",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_section_from_section_xmlitem(section, child)})
          ),
          vx_core.f_case_1(
            "modifier",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_section_from_section_xmlmodifier(section, child)})
          ),
          vx_core.f_case_1(
            "place",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_section_from_section_xmlplace(section, child)})
          ),
          vx_core.f_case_1(
            "power",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_section_from_section_xmlpower(section, child)})
          ),
          vx_core.f_case_1(
            "rule",
          ...
          vx_core.f_case_1(
            "section",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_section_from_section_xmlsection(section, child)})
          ),
          vx_core.f_case_1(
            "skill",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_section_from_section_xmlskill(section, child)})
          ),
          vx_core.f_case_1(
            "terrain",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_section_from_section_xmlterrain(section, child)})
          ),
          vx_core.f_case_1(
            "unit",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_section_from_section_xmlunit(section, child)})
          ),
          vx_core.f_else(
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              section,
  ...
  /**
   * @function section_from_section_xmlplace
   * Return a section with new place added to placemap
   * @param  {section} section
   * @param  {xml} xmlplace
   * @return {section}
   */
  static t_section_from_section_xmlplace = {
    vx_type: vx_core.t_type
  }
  static e_section_from_section_xmlplace = {
    vx_type: nx_tactics_books_bookloader.t_section_from_section_xmlplace
  }

  // (func section<-section-xmlplace)
  static f_section_from_section_xmlplace(section, xmlplace) {
    let output = nx_tactics_base.e_section
    output = vx_core.f_let(
      {"any-1": nx_tactics_base.t_section},
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const place = nx_tactics_books_bookloader.f_place_from_xml(xmlplace)
        const name = vx_core.f_any_from_struct({"any-1": vx_core.t_string, "struct-2": nx_tactics_base.t_place}, place, ":name")
        const origmap = vx_core.f_any_from_struct({"any-1": nx_tactics_base.t_placemap, "struct-2": nx_tactics_base.t_section}, section, ":placemap")
        const chgmap = vx_core.f_copy(origmap, name, place)
        return vx_core.f_copy(section, ":placemap", chgmap)
      })
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          children,
          section,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_section_from_section_xmlchild)
        )
      })
    )
    return output
  ...
  static f_skill_from_skill_stringmap(skill, propmap) {
    ...
    output = vx_core.f_any_from_map_start_reduce(
      ...
      propmap,
      skill,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_skill_from_skill_key_value)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_skill, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return skill})),
          vx_core.f_case(
            vx_core.f_new({"any-1": vx_core.t_list}, "reference", "summary", "titles"),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              skill,
          ...
          vx_core.f_case_1(
            "ability",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_skill_from_skill_xmlability(skill, child)})
          ),
          vx_core.f_case_1(
            "specialty",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_skill_from_skill_xmlspecialty(skill, child)})
          ),
          vx_core.f_else(
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              skill,
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          vx_core.f_any_from_struct({"any-1": vx_data_xml.t_xmllist, "struct-2": vx_data_xml.t_xml}, xml, ":children"),
          skill,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_skill_from_skill_xmlchild)
        )
      })
    )
    return output
  ...
  static f_specialty_from_specialty_stringmap(specialty, propmap) {
    ...
    output = vx_core.f_any_from_map_start_reduce(
      ...
      propmap,
      specialty,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_specialty_from_specialty_key_value)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_specialty, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return specialty})),
          vx_core.f_case(
            vx_core.f_new({"any-1": vx_core.t_list}, "reference", "summary", "titles"),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              specialty,
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          vx_core.f_any_from_struct({"any-1": vx_data_xml.t_xmllist, "struct-2": vx_data_xml.t_xml}, xml, ":children"),
          spc,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_specialty_from_specialty_xmlchild)
        )
      })
    )
    return output
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const chapters = vx_core.f_list_from_map_1(
          ...
          chaptermap,
          vx_core.f_new_from_type(vx_core.t_any_from_key_value, ([key, val]) => 
            vx_core.f_new(
              {"any-1": vx_core.t_string},
              vx_core.c_newline,
              "    ",
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        const simage = vx_core.f_switch(
          ...
          image,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return ""})),
          vx_core.f_else(
  ...
  static f_string_vxlisp_from_chapter(chapter) {
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_new({"any-1": vx_core.t_string}, "(func chapter_", chnm, " : base/chapter\n", text, ")\n")
      })
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const chapters = vx_core.f_list_from_map_1(
          ...
          chaptermap,
          vx_core.f_new_from_type(vx_core.t_any_from_key_value, ([key, val]) => val)
        )
        const schapters = vx_core.f_list_from_list_1(
          ...
          chapters,
          vx_core.f_new_from_type(vx_core.t_any_from_any, (chapt) => 
            vx_core.f_let(
              {"any-1": vx_core.t_string},
              [],
              vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
                ...
                return vx_core.f_new({"any-1": vx_core.t_string}, "\n(func chapter_", schnm, " : base/chapter\n ", text, ")")
              })
            ))
        )
  ...
  static f_team_from_team_stringmap(team, propmap) {
    ...
    output = vx_core.f_any_from_map_start_reduce(
      ...
      propmap,
      team,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_team_from_team_key_value)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_team, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return team})),
          vx_core.f_case(
            vx_core.f_new({"any-1": vx_core.t_list}, "reference", "summary", "titles", "completevictory", "deploy", "forces", "partialvictory"),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              team,
              tag,
              vx_data_xml.f_string_first_from_xml(child)
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          vx_core.f_any_from_struct({"any-1": vx_data_xml.t_xmllist, "struct-2": vx_data_xml.t_xml}, xml, ":children"),
          team,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_team_from_team_xmlchild)
        )
      })
    )
    return output
  ...
  static f_terrain_from_terrain_stringmap(terrain, propmap) {
    ...
    output = vx_core.f_any_from_map_start_reduce(
      ...
      propmap,
      terrain,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_terrain_from_terrain_key_value)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_terrain, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return terrain})),
          vx_core.f_case(
            vx_core.f_new({"any-1": vx_core.t_list}, "reference", "summary", "titles", "classification"),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              terrain,
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          vx_core.f_any_from_struct({"any-1": vx_data_xml.t_xmllist, "struct-2": vx_data_xml.t_xml}, xml, ":children"),
          terrain,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_terrain_from_terrain_xmlchild)
        )
      })
    )
    return output
  ...
  static f_unit_from_unit_key_value(current, key, value) {
    ...
    output = vx_core.f_switch(
      ...
      vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return current})),
      vx_core.f_case(
        vx_core.f_new({"any-1": vx_core.t_list}, "name", "image", "classification", "crew", "body", "height", "length", "mass", "mind", "range", "speed", "speedair", "speedland", "speedspace", "speedwater", "width", "will"),
        vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(current, key, value)})
      ),
      vx_core.f_else(
        vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
  ...
  static f_unit_from_unit_stringmap(unit, propmap) {
    ...
    output = vx_core.f_any_from_map_start_reduce(
      ...
      propmap,
      unit,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_unit_from_unit_key_value)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_unit, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return unit})),
          vx_core.f_case(
            vx_core.f_new({"any-1": vx_core.t_list}, "reference", "summary", "titles"),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              unit,
          ...
          vx_core.f_case_1(
            "power",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_unit_from_unit_xmlpower(unit, child)})
          ),
          vx_core.f_case_1(
            "skill",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_unit_from_unit_xmlskill(unit, child)})
          ),
          vx_core.f_case_1(
            "weakness",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_unit_from_unit_xmlweakness(unit, child)})
          ),
          vx_core.f_else(
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              unit,
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          vx_core.f_any_from_struct({"any-1": vx_data_xml.t_xmllist, "struct-2": vx_data_xml.t_xml}, xml, ":children"),
          unt,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_unit_from_unit_xmlchild)
        )
      })
    )
    return output
  ...
  static f_unitability_from_unitability_stringmap(unitability, propmap) {
    ...
    output = vx_core.f_any_from_map_start_reduce(
      ...
      propmap,
      unitability,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_unitability_from_unitability_key_value)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_unitability, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return unitability})),
          vx_core.f_case(
            vx_core.f_new({"any-1": vx_core.t_list}, "reference", "summary", "titles"),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              unitability,
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          vx_core.f_any_from_struct({"any-1": vx_data_xml.t_xmllist, "struct-2": vx_data_xml.t_xml}, xml, ":children"),
          unitability,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_unitability_from_unitability_xmlchild)
        )
      })
    )
    return output
  ...
  static f_unititem_from_unititem_key_value(current, key, value) {
    ...
    output = vx_core.f_switch(
      ...
      vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return current})),
      vx_core.f_case(
        vx_core.f_new({"any-1": vx_core.t_list}, "name", "image", "facing", "modifiers", "number", "rounds"),
        vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(current, key, value)})
      ),
      vx_core.f_else(
        vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
  ...
  static f_unititem_from_unititem_stringmap(unititem, propmap) {
    ...
    output = vx_core.f_any_from_map_start_reduce(
      ...
      propmap,
      unititem,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_unititem_from_unititem_key_value)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_unititem, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return unititem})),
          vx_core.f_case(
            vx_core.f_new({"any-1": vx_core.t_list}, "reference", "summary", "titles"),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              unititem,
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          children,
          unititem,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_unititem_from_unititem_xmlchild)
        )
      })
    )
    return output
  ...
  static f_unitpower_from_unitpower_key_value(current, key, value) {
    ...
    output = vx_core.f_switch(
      ...
      vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return current})),
      vx_core.f_case(
        vx_core.f_new({"any-1": vx_core.t_list}, "name", "image", "back", "bottom", "front", "level", "over", "side", "strength", "under"),
        vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(current, key, value)})
      ),
      vx_core.f_else(
        vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
  ...
  static f_unitpower_from_unitpower_stringmap(unitpower, propmap) {
    ...
    output = vx_core.f_any_from_map_start_reduce(
      ...
      propmap,
      unitpower,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_unitpower_from_unitpower_key_value)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_unitpower, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return unitpower})),
          vx_core.f_case(
            vx_core.f_new({"any-1": vx_core.t_list}, "reference", "summary", "titles"),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              unitpower,
          ...
          vx_core.f_case_1(
            "ability",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_unitpower_from_unitpower_xmlability(unitpower, child)})
          ),
          vx_core.f_case_1(
            "item",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_unitpower_from_unitpower_xmlitem(unitpower, child)})
          ),
          vx_core.f_case_1(
            "specialty",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_unitpower_from_unitpower_xmlspecialty(unitpower, child)})
          ),
          vx_core.f_else(
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              unitpower,
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          vx_core.f_any_from_struct({"any-1": vx_data_xml.t_xmllist, "struct-2": vx_data_xml.t_xml}, xml, ":children"),
          unitpower,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_unitpower_from_unitpower_xmlchild)
        )
      })
    )
    return output
  ...
  static f_unitskill_from_unitskill_key_value(current, key, value) {
    ...
    output = vx_core.f_switch(
      ...
      vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return current})),
      vx_core.f_case(
        vx_core.f_new({"any-1": vx_core.t_list}, "name", "image", "back", "bottom", "front", "level", "side", "top"),
        vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(current, key, value)})
      ),
      vx_core.f_else(
        vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
  ...
  static f_unitskill_from_unitskill_stringmap(unitskill, propmap) {
    ...
    output = vx_core.f_any_from_map_start_reduce(
      ...
      propmap,
      unitskill,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_unitskill_from_unitskill_key_value)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_unitskill, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return unitskill})),
          vx_core.f_case(
            vx_core.f_new({"any-1": vx_core.t_list}, "reference", "summary", "titles"),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              unitskill,
          ...
          vx_core.f_case_1(
            "ability",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_unitskill_from_unitskill_xmlability(unitskill, child)})
          ),
          vx_core.f_case_1(
            "item",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_unitskill_from_unitskill_xmlitem(unitskill, child)})
          ),
          vx_core.f_case_1(
            "specialty",
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_books_bookloader.f_unitskill_from_unitskill_xmlspecialty(unitskill, child)})
          ),
          vx_core.f_else(
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              unitskill,
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          vx_core.f_any_from_struct({"any-1": vx_data_xml.t_xmllist, "struct-2": vx_data_xml.t_xml}, xml, ":children"),
          unitskill,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_unitskill_from_unitskill_xmlchild)
        )
      })
    )
    return output
  ...
  static f_unitspecialty_from_unitspecialty_stringmap(unitspecialty, propmap) {
    ...
    output = vx_core.f_any_from_map_start_reduce(
      ...
      propmap,
      unitspecialty,
      vx_core.f_new_from_type(vx_core.t_any_from_any_key_value, nx_tactics_books_bookloader.t_unitspecialty_from_unitspecialty_key_value)
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_switch(
          {"any-1": nx_tactics_base.t_unitspecialty, "any-2": vx_core.t_string},
          tag,
          vx_core.f_case_1("", vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return unitspecialty})),
          vx_core.f_case(
            vx_core.f_new({"any-1": vx_core.t_list}, "reference", "summary", "titles"),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_copy(
              unitspecialty,
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_any_from_list_start_reduce(
          ...
          vx_core.f_any_from_struct({"any-1": vx_data_xml.t_xmllist, "struct-2": vx_data_xml.t_xml}, xml, ":children"),
          unitspecialty,
          vx_core.f_new_from_type(vx_core.t_any_from_reduce, nx_tactics_books_bookloader.t_unitspecialty_from_unitspecialty_xmlchild)
        )
      })
    )
    return output
  ...
  static {
    ...
    const emptymap = vx_core.vx_new_map(vx_core.t_map, {
      ...
      "place<-place-key-value": nx_tactics_books_bookloader.e_place_from_place_key_value,
      "place<-place-stringmap": nx_tactics_books_bookloader.e_place_from_place_stringmap,
      "place<-place-xmlchild": nx_tactics_books_bookloader.e_place_from_place_xmlchild,
      "place<-xml": nx_tactics_books_bookloader.e_place_from_xml,
    ...
    const funcmap = vx_core.vx_new_map(vx_core.t_funcmap, {
      ...
      "place<-place-key-value": nx_tactics_books_bookloader.t_place_from_place_key_value,
      "place<-place-stringmap": nx_tactics_books_bookloader.t_place_from_place_stringmap,
      "place<-place-xmlchild": nx_tactics_books_bookloader.t_place_from_place_xmlchild,
      "place<-xml": nx_tactics_books_bookloader.t_place_from_xml,
    ...
    // (func place<-place-key-value)
    nx_tactics_books_bookloader.t_place_from_place_key_value['vx_value'] = {
      name          : "place<-place-key-value",
      pkgname       : "nx/tactics/books/bookloader",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_books_bookloader.f_place_from_place_key_value
    }

    // (func place<-place-stringmap)
    nx_tactics_books_bookloader.t_place_from_place_stringmap['vx_value'] = {
      name          : "place<-place-stringmap",
      pkgname       : "nx/tactics/books/bookloader",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_books_bookloader.f_place_from_place_stringmap
    }

    // (func place<-place-xmlchild)
    nx_tactics_books_bookloader.t_place_from_place_xmlchild['vx_value'] = {
      name          : "place<-place-xmlchild",
      pkgname       : "nx/tactics/books/bookloader",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_books_bookloader.f_place_from_place_xmlchild
    }

    // (func place<-xml)
    nx_tactics_books_bookloader.t_place_from_xml['vx_value'] = {
      name          : "place<-xml",
      pkgname       : "nx/tactics/books/bookloader",
      extends       : ":func",
      idx           : 0,
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_books_bookloader.f_place_from_xml
    }
    ...
    // (func section<-section-xmlplace)
    nx_tactics_books_bookloader.t_section_from_section_xmlplace['vx_value'] = {
      name          : "section<-section-xmlplace",
      pkgname       : "nx/tactics/books/bookloader",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_books_bookloader.f_section_from_section_xmlplace
    }
