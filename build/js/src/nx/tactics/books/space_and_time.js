      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "Parallel Dimensions",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Parallel Dimensions"),
            "Dimensional Ripples",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Dimensional Ripples", ":summary", "* Changes made to one dimension can cause similar changes to nearby parallel dimensions like ripples in a pond. Temporal Distortion Waves always cause Dimensional Ripples."),
            "Dimensional Storm",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Dimensional Storm", ":summary", "* A Dimensional Storm is a theoretical disaster where the barriers between dimensions are broken and events from unrelated time periods and dimensions become mixed up creating chaos across multiple dimensions.")
          )
        )
      )
    )
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_rulemap},
            "Space Scale",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Space Scale", ":summary", "* 1 Turn = ?\n* 1 Space = ?\n* 24 x 20 map = ?"),
            "Planetary Scale",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Planetary Scale", ":summary", "* 1 Turn = ?\n* 1 Space = ?\n* 24 x 20 map = ?"),
            "Interplanetary Scale",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Interplanetary Scale", ":summary", "* 1 Turn = ?\n* 1 Space = ?\n* 24 x 20 map = ?"),
            "Stellar Scale",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Stellar Scale", ":summary", "* 1 Turn = ?\n* 1 Space = ?\n* 24 x 20 map = ?"),
            "Galactic Scale",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Galactic Scale", ":summary", "* 1 Turn = ?\n* 1 Space = ?\n* 24 x 20 map = ?")
          )
        ),
        ":Universe",
        vx_core.f_new({"any-1": nx_tactics_base.t_section}, ":name", "Universe", ":reference", "* The story so far: In the beginning the Universe was created. This has made a lot of people\nvery angry and been widely regarded as a bad move. - Douglas Adams, The Restaurant at the\nEnd of the Universe."),
        "Solar System",
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_section},
          ":name",
          ...
          vx_core.f_new(
            ...
            vx_core.f_new(
              ...
              nx_tactics_base.f_placemap_from_placelist(
                vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Jupiter Trojan Asteroid Belt", ":summary", "* There are 2 Asteroid fields at the Lagrange points at both sides of Jupiter. They may be as many asteroids here as in the asteroid belt.")
              )
            )
          )
        ),
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_rulemap},
            "Magnetic Storm",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Magnetic Storm", ":image", "Units/SpaceAndTime/MagneticStorm.jpg", ":summary", "* [+1 Hazard]\n* Blocks [Line of Sight]\n* A Magnetic Storm is treated as a [Nebula] with the following additional effects.\n* [-1 Communications] per space from the edge of the field.\n* [-1 Shielding] per space from the edge of the field."),
            "Micro-meteor Field",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Micro-meteor Field"),
            ":Nebula",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Nebula", ":image", "Units/SpaceAndTime/Nebula.jpg", ":summary", "* Nebulas are placed randomly on the map.\n* At the beginning of the game roll 1 die to determine Speed and 1 die to randomize direction.\n* At the end of each turn all nebulas move their Speed in the given direction.\n* [+1 Hazard]\n* Blocks [Line of Sight]"),
            "Solar Flare",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Solar Flare", ":image", "Units/SpaceAndTime/SolarFlare.jpg", ":reference", "This photograph shows one of the most spectacular solar flares ever recorded; the base of the flare is more than 591Mm across.")
          ),
          ":unitmap",
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Arctic World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Arctic World"),
            "Arid World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Arid World"),
            "Asteroid Field",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Asteroid Field", ":image", "Units/SpaceAndTime/Asteroid.png", ":summary", "* Asteroid fields are placed randomly on the map.\n* At the beginning of the game roll 1 die to determine Speed and 1 die to randomize direction.\n* At the end of each turn all asteroids move their Speed in the given direction.\n* If they collide with a unit, use the asteroid's and the unit's Speed and Body to determine damage.\n* [+2 Hazard]", ":height", "500km", ":length", "500m", ":width", "500m"),
            "Black Hole",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Black Hole", ":image", "Units/SpaceAndTime/BlackHole.png", ":summary", "* Accretion Disk\n* Event Horizon", ":titles", "Singularity"),
            "Blue Giant Star",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Blue Giant Star"),
            ":Comet",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Comet", ":image", "Units/SpaceAndTime/Comet.png"),
            "Debris Field",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Debris Field", ":image", "Units/SpaceAndTime/SpaceDebris.jpg", ":summary", "* [+2 Hazard]\n* Debris Fields are treated as an [Asteroid Field].\n* Any large unit that explodes is replaced with a Debris Field."),
            "Desert World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Desert World"),
            "Dyson Sphere",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Dyson Sphere"),
            "Gas Giant",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Gas Giant"),
            "Greenhouse World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Greenhouse World"),
            "Ionized Atmosphere World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Ionized Atmosphere World", ":summary", "* Atmosphere is heavily ionized which produces powerful lightning storms and regularly disrupts electrical systems and communications."),
            "Irradiated World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Irradiated World"),
            "Jungle World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Jungle World"),
            ":Meteorite",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Meteorite", ":reference", "Armaggeddon"),
            "World: Methane Ocean",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "World: Methane Ocean"),
            "Star: Neutron",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Star: Neutron", ":image", "Units/SpaceAndTime/NeutronStar.png", ":reference", "* 12 miles across and 1.4 times the mass of the sun. One teaspoonful would weigh a billion tons.", ":mass", "2x10^27tons", ":length", "20km"),
            "World: Ocean",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "World: Ocean"),
            "Proto World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Proto World"),
            ":Pulsar",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Pulsar", ":image", "Units/SpaceAndTime/Pulsar.png"),
            "Red Giant Star",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Red Giant Star"),
            "Ring World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Ring World"),
            "Ringed Gas Giant",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Ringed Gas Giant"),
            "Solar Storm World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Solar Storm World", ":summary", "* A planet routinely bombarded by intense solar radiation. The planet itself is not radioactive, but when solar storms appear all life is scoured from any exposed surface. Life underground or underwater is possible."),
            "World: Seasonally Extreme",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "World: Seasonally Extreme", ":summary", "* A planet with a very oblong orbit and high axial shift will produce severe changes in seasons shifting from artic to tropic environments during the year. Such a punishing environment is difficult for complex life to develop. Simple life forms will tend toward short life spans or hibernation during winter months with a massive spring bloom and fall die off."),
            "World: Seasonless",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "World: Seasonless", ":summary", "* A planet with a nearly circular orbit and minor axial shift will produce bands of terrain where the seasons don't change throughout the year. Polar areas are uniformly cold and equatorial areas are uniformly hot. Such a predictable environment is ideal for life to develop."),
            "Seismic World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Seismic World"),
            "World: Tidally Locked",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "World: Tidally Locked"),
            "World: Stony",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Stony World"),
            "Storm World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Storm World"),
            "Swamp World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Swamp World", ":summary", "* The combination of mild greenhouse effect and high amounts of surface water creates a world where most land masses are densely covered with vegetation. Very little dry land exists and the vegetation mostly has its roots underwater. Some particularly dense vegetation can be walked on. Quicksand, parasites, insects, water predators, and other threats are common."),
            "Toxic World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Toxic World"),
            "Tropical World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Tropical World"),
            "Tundra World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Tundra World"),
            "Yellow Star",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Yellow Star")
          )
        )
      )
    )
