      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "Methane Ocean World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Methane Ocean World"),
            "Neutron Star",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Neutron Star", ":image", "Units/SpaceAndTime/NeutronStar.png", ":reference", "* 12 miles across and 1.4 times the mass of the sun.  One teaspoonful would weigh a billion tons.", ":mass", "2x10^27tons", ":length", "20km"),
            "Ocean World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Ocean World"),
            "Proto World",
            ...
            "Solar Storm World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Solar Storm World", ":summary", "* This planet is routinely bombarded by intense solar radiation. The planet itself is not radioactive, but when solar storms appear all life is scoured from any exposed surface. Life underground or underwater is possible."),
            "Seasonally Extreme World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Seasonally Extreme World", ":summary", "* A planet with a very oblong orbit and high axial shift will produce severe changes in seasons shifting from artic to tropic environments during the year. Such a punishing environment is difficult for complex life to develop. Simple life forms will tend toward short life spans or hibernation during winter months with a massive spring bloom and fall die off."),
            "Seasonless World",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Seasonless World", ":summary", "* A planet with a nearly circular orbit and minor axial shift will produce bands of terrain where the seasons don't change throughout the year. Polar areas are uniformly cold and equatorial areas are uniformly hot. Such a predictable environment is ideal for life to develop."),
            "Seismic World",
