      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            ":Body",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Body", ":image", "Tokens/BodyToken.png", ":reference", "* The nature of existence is obvious. The things I can see and touch are real.", ":summary", "* Physical - The physical resistance of the unit. This is equal to the unit's highest Physical skill. Units with low Body are easily killed.\n* Body is determined by Mass. Fit human male: 8:1 (80kg/175lb). Fit human female: 6:1 (60kg/132lb).", ":titles", "Build, Constitution, Endurance, Physique, Size, Stamina, Strength, Toughness"),
            ":Mind",
