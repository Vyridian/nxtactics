      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "Buffy Summers",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Buffy Summers", ":image", "Buffy/Buffy.png", ":titles", "The Slayer"),
            "Rupert Giles",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Rupert Giles", ":image", "Buffy/Giles.png", ":reference", "Ben: She could have killed me.  Giles: No she couldn't.  Never.  And sooner or later, Glory will re-emerge and\nmake Buffy pay for that mercy, and the world with her.  Buffy even knows that, and still she couldn't take a\nhuman life.  She's a hero, you see.  She's not like us.  Ben: Us? (Giles suffocates Ben)"),
            "Willow Rosenberg",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Willow Rosenberg", ":image", "Buffy/Willow.png", ":reference", "Buffy: You wanna go out tonight?  Willow: Strangely, I feel like staying at home... and doing my homework...\nand flossing... and dying a virgin."),
            "Xander Harris",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Xander Harris", ":image", "Buffy/Xander.png", ":reference", "Faith: She got me really wound up. A fight like that and, no kill. I'm about ready to pop!  Xander: Really?\nPop?!  Faith: You up for it?  Xander: Oh, I'm up.  I'm suddenly very up.  It's just, um, I've never been up\nwith people before.  Faith: Just relax. And take your pants off.  Xander: Those two ... concepts are ...\nantithetical.")
          )
        ),
        ":Independents",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            ":Angel",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Angel", ":image", "Buffy/Angel.png", ":reference", "Angel: The elders conceived the perfect punishment for me.  The restored my soul.  Buffy: What, they were all\nout of boils and blinding torment?  Angel: When you become a vampire, the demon takes your body, but it doesn't\nget your soul; that's gone.  No conscience, no remorse, it's an easy way to live.  You have no idea what it's\nlike to have done the things I've done...and care.", ":titles", "Angelus"),
            "Cordelia Chase",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Cordelia Chase", ":image", "Buffy/Cordelia.png", ":reference", "Cordelia: Xander, I know you take pride in being the voice of the common wuss, but the truth is, certain people\ndeserve special priviledges - they're called winners.  Xander: And what about that nutty 'all men are created\nequal' thing?  Cordelia: Propaganda spouted out by the ugly and less deserving."),
            "Faith Lehane",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Faith Lehane", ":image", "Buffy/Faith.png", ":reference", "Faith: ... You're still not seeing the big picture, B.  Something made us different.  We're warriors.  We're built\nto kill.  Buffy: To kill demons!  But it does not mean that we get to pass judgment on people like we're better\nthan everybody else!  Faith: We are better!", ":titles", "The Slayer"),
            ":Spike",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Spike", ":image", "Buffy/Spike.png", ":reference", "Spike: I'll give you a choice.  Now I'm going to kill you - no choice in that.  But I can let you stay dead...\nor bring you back, to be like me.  Willow: I'll scream!  Spike: Bonus.  [A short time later]  Spike: I don't\nunderstand.  This sort of thing's never happened to me before.  Willow: Maybe you were nervous.  Spike: I felt\nall right when I started.  Let's try again.  Spike:  Ow ow ow! Dammit!!  Willow: Maybe you're trying too hard.\nDoesn't this happen to every vampire?  Spike: Not to me it doesn't!", ":titles", "William the Bloody")
          )
        ),
        "Bad Guys",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            ":Adam",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Adam", ":image", "Buffy/Adam.png", ":reference", "Adam: [After killing Professor Walsh, his first act of life] Mommy."),
            ":Gentlemen",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Gentlemen", ":image", "Buffy/Gentlemen.png", ":reference", "Can't even shout, can't even cry.  The Gentlemen are coming by.  Looking in windows, knocking on doors.  They\nneed to take seven and they might take yours.  Can't call to mom, can't say a word.  You're gonna die screaming\nbut you won't be heard. - Hush"),
            ":Glory",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Glory", ":image", "Buffy/Glory.png", ":reference", "Glory: Wait, I've always wanted to try this.  You know that thing with worms, where if you have one and you rip it in half,\nyou get two worms.  Do you think that'll work with you?  [Buffy headbutts her] Ow! You hit me.  What are you\ncrazy?  You can't go around hitting people.  What were you, born in a barn?  Fine, be that way! [grabs Buffy by\nthe throat] I just noticed something, you have superpowers, that is so cool.  Can you fly? [throws Buffy across\nthe room]", ":titles", "Glorificus, That Which Cannot Be Named, The Beast, Her Splendiferousness, Her Sparkling Luminescence, Oh\nSweaty-Naughty-Feelings-Causing One"),
            "Mayor Wilkins",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Mayor Wilkins", ":image", "Buffy/Mayor.png", ":reference", "Do you think he was going to betray me?  Oh, now, that's a horrible thought.  And now he's dead, I'll never\nhave the chance to scold him."),
            ":Sweet",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Sweet", ":image", "Buffy/Sweet.png", ":reference", "I can bring whole cities to ruin and still have time to get a soft shoe in ... Something's cooking. I'm at the\ngriddle. I bought Nero his very first fiddle.")
          )
        )
      )
    )
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    ...
                    ":Capoeira",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unitspecialty}, ":name", "Capoeira")
                  )
                )
              )
            ),
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    {"any-1": nx_tactics_base.t_unitspecialtymap},
                    "Commando Training",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unitspecialty}, ":name", "Commando Training")
                  )
                )
              )
            ),
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    ...
                    vx_core.f_new({"any-1": nx_tactics_base.t_unitspecialty}, ":name", "Kung Fu, Dragon Style")
                  )
                )
              )
            ),
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    {"any-1": nx_tactics_base.t_unitspecialtymap},
                    ":Wrestling",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unitspecialty}, ":name", "Wrestling")
                  )
                )
              )
            )
          ...
          vx_core.f_new(
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    {"any-1": nx_tactics_base.t_unitspecialtymap},
                    ":Boxing",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unitspecialty}, ":name", "Boxing")
                  )
                )
              )
            ),
            ...
            vx_core.f_new(
              ...
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_unitskillmap},
                "Close Combat",
                vx_core.f_new({"any-1": nx_tactics_base.t_unitskill}, ":name", "Close Combat", ":level", "9")
              )
            ),
            ":Sagat",
            vx_core.f_new(
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    {"any-1": nx_tactics_base.t_unitabilitymap},
                    "Knee Strike",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unitability}, ":name", "Knee Strike")
                  ),
                  ":unitspecialtymap",
                  vx_core.f_new(
                    {"any-1": nx_tactics_base.t_unitspecialtymap},
                    "Muay Thai",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unitspecialty}, ":name", "Muay Thai")
                  )
                )
              )
            ),
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    {"any-1": nx_tactics_base.t_unitspecialtymap},
                    ":Ninjutsu",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unitspecialty}, ":name", "Ninjutsu")
                  )
                )
              )
            )
  ...
  static f_chapter_world_of_darkness() {
    ...
    output = vx_core.f_new(
      ...
      vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new(
              ...
              vx_core.f_new(
                ...
                ":Autocthonia",
                vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Autocthonia", ":summary", "* Description - A metallic Horizon Realm the size of a moon. It was discovered by the Void Engineers, but Iteration X has taken charge of its exploration. Autocthonia seems to represent the mechanical precision of Iteration X's ideal world. It is ruled by logic instead of emotions without fear or pain. Others fear that this 'ideal' has no room for anything remotely human.")
              ),
              ":unitmap",
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_unitmap},
                ":Biomechanic",
                vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Biomechanic", ":summary", "* BioMechanics focus on using cybernetic implants to achieve a man-machine interface."),
                "Central Computer",
                vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Central Computer", ":summary", "* Iteration X has installed a massive central computer system on Autocthonia. It is the central hub tied to all Iteration systems. The Iteration believes so strongly in the infallible nature of the Central Computer that all of the convention's decisions are made in consulation with the Central Computer.\n* Some fear that Iteration X relies too heavily on the Central Computer which has become their master instead of their servant. Many see their trust in the Central Computer to have become worship. Pessimists wonder if the Central Computer is something more than just a computer system.", ":titles", "Great Computer"),
                "Iteration Cyborg",
                vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Iteration Cyborg"),
                ":Macrotechnician",
                vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Macrotechnician", ":summary", "* Macrotechnicians focus on the construction of optimal equipment for other Iterators."),
                "Iteration Statistician",
                vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Iteration Statistician", ":summary", "* Statisticians focus on the use of predictive models and simulations to anticipate future events. They believein gathering massive amounts of data and number crush to discover patterns that have not been previously noticed."),
                "Time-Motion Manager",
            ...
            vx_core.f_new(
              ...
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_unitmap},
                "Syndicate Enforcer",
                vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Syndicate Enforcer", ":summary", "* Enforcers work in law enforcement, the judicial system, and the\ncriminal underworld. They influence both the criminals that the\nmasses fear and the police and judges to whom they turn to for\nprotection. They make sure that the bills are paid and the contracts\nare kept."),
                "Syndicate Financier",
                vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Syndicate Financier", ":summary", "* The Financiers work in positions of finanical influence and perform silent adjustments to the flow of global commerce."),
                "Syndicate Messenger",
                vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Syndicate Messenger", ":summary", "* The Messengers work in advertising. Their mission is more than just\nselling products, they are in charge of shaping trends. They build\ndemand for entire product segments. Among many other things, this\nincludes creating conflict to spur military spending.")
              )
            ),
            "Void Engineers",
            vx_core.f_new(
              ...
              vx_core.f_new(
                ...
                vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Copernicus Research Center", ":summary", "* An fantastically immense space station in the form of a Dyson\nSphere"),
                "Earth Frontier Corp",
                vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Earth Frontier Corp", ":summary", "* The Earth Frontier Corp continues to investigate the wonders of the extreme environments on Earth including the ocean deep, frozen poles, rain forests and jungles, inaccessible mountain-tops, and underground caverns."),
                "Neutralization Corp",
                vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Neutralization Corp", ":summary", "* The Neutralization Corps is responsible for identifying and eliminating Reality Deviants already on Earth. This includes alien landings, dimensional incursions, hauntings, etc. The NWO usually handles witnesses and media fallout."),
                "Pan Dimensional Corp",
                vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Pan Dimensional Corp", ":summary", "* The Pan-Dimensional Corps: Responsible for the exploration and study of the Deep Universe, the Digital Web and other alternate dimensions, including time itself."),
                "Research Corp",
                vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Research Corp", ":summary", "* The Research Corp is responsible for the development of dimensional science, the Technocratic study of the Umbra."),
                "Void Border Corp",
                vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Void Border Corp", ":summary", "* The Border Corps is responsible for repelling invasions from beyond the reaches of Earth. They maintain heavily armed spaceships, dimensional craft, and marines.")
              )
            )
          )
        ),
          ...
          vx_core.f_new(
            ...
            vx_core.f_new(
              ...
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_unitmap},
                "Void Ship",
                vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Void Ship", ":reference", "* Flying Dutchman\n* Mage: Sons of Ether\n* Space 1889\n* Spelljammers", ":summary", "* A Void Ship is designed to travel between realms through the [Aether].", ":titles", "Aether Flyer, Void Cruiser")
              )
            ),
            ":Verbena",
        ...
        ":Marauders",
        vx_core.f_new({"any-1": nx_tactics_base.t_section}, ":name", "Marauders", ":summary", "* Mages who have fallen into Quiet which has warped around them into personal [Paradox] Bubble fantasy worlds that\nwreck havoc on those around them.  Their Quiet blends the real world with their fantasy world.  From the outside\nperspective, the Marauders are dangerously insane."),
        ":Nephilm",
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Bane, Disease",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Bane, Disease", ":summary", "* These repulsive Banes appear like blood covered bags of pus.  They are drawn to plagues, cesspools, medical\nwaste, etc."),
            "Bane, Madness",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Bane, Madness", ":summary", "* These formless spirits wear down the sanity of those exposed to them with disembodied voices, disturbing\nvisions, and horrible shrieking."),
            "Bane, Poison",
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "Hollow Man",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Hollow Man", ":reference", "* They're good for us.  They kill the bad things inside us...What you're supposed to do is eat it.  You eat as much\nas you can and you keep eating it. - The Stuff", ":summary", "* A person infested by parasites, insects, or small animals.  The hapless victim has become completely hollowed\nout by its unwanted tenants, but is somehow still alive.  The Hollow Man is desolate, immobile, and empty without\nthe possessing colony, but they are poor company at best."),
            ":Normality",
            vx_core.f_new(
              {"any-1": nx_tactics_base.t_unit},
              ":name",
