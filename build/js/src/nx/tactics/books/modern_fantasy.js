      ...
      nx_tactics_base.f_sectionmap_from_sectionlist(
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "Rupert Giles",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Rupert Giles", ":image", "Buffy/Giles.png", ":reference", "Ben: She could have killed me. Giles: No she couldn't. Never. And sooner or later, Glory will re-emerge and make Buffy pay for that mercy, and the world with her. Buffy even knows that, and still she couldn't take a human life. She's a hero, you see. She's not like us. Ben: Us? (Giles suffocates Ben)"),
            "Willow Rosenberg",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Willow Rosenberg", ":image", "Buffy/Willow.png", ":reference", "Buffy: You wanna go out tonight?  Willow: Strangely, I feel like staying at home... and doing my homework... and flossing... and dying a virgin."),
            "Xander Harris",
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            ":Angel",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Angel", ":image", "Buffy/Angel.png", ":reference", "Angel: The elders conceived the perfect punishment for me. The restored my soul.  Buffy: What, they were all out of boils and blinding torment? Angel: When you become a vampire, the demon takes your body, but it doesn't get your soul; that's gone. No conscience, no remorse, it's an easy way to live. You have no idea what it's like to have done the things I've done...and care.", ":titles", "Angelus"),
            "Cordelia Chase",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Cordelia Chase", ":image", "Buffy/Cordelia.png", ":reference", "Cordelia: Xander, I know you take pride in being the voice of the common wuss, but the truth is, certain people deserve special priviledges - they're called winners. Xander: And what about that nutty 'all men are created equal' thing?  Cordelia: Propaganda spouted out by the ugly and less deserving."),
            "Faith Lehane",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Faith Lehane", ":image", "Buffy/Faith.png", ":reference", "Faith: ... You're still not seeing the big picture, B. Something made us different.  We're warriors.  We're built to kill. Buffy: To kill demons! But it does not mean that we get to pass judgment on people like we're better than everybody else!  Faith: We are better!", ":titles", "The Slayer"),
            ":Spike",
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            ":Gentlemen",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Gentlemen", ":image", "Buffy/Gentlemen.png", ":reference", "Can't even shout, can't even cry. The Gentlemen are coming by. Looking in windows, knocking on doors. They need to take seven and they might take yours. Can't call to mom, can't say a word. You're gonna die screaming but you won't be heard. - Hush"),
            ":Glory",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Glory", ":image", "Buffy/Glory.png", ":reference", "Glory: Wait, I've always wanted to try this. You know that thing with worms, where if you have one and you rip it in half, you get two worms. Do you think that'll work with you? [Buffy headbutts her] Ow! You hit me. What are you crazy? You can't go around hitting people. What were you, born in a barn? Fine, be that way! [grabs Buffy by the throat] I just noticed something, you have superpowers, that is so cool. Can you fly? [throws Buffy across the room]", ":titles", "Glorificus, That Which Cannot Be Named, The Beast, Her Splendiferousness, Her Sparkling Luminescence, Oh Sweaty-Naughty-Feelings-Causing One"),
            "Mayor Wilkins",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Mayor Wilkins", ":image", "Buffy/Mayor.png", ":reference", "Do you think he was going to betray me?  Oh, now, that's a horrible thought. And now he's dead, I'll never have the chance to scold him."),
            ":Sweet",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Sweet", ":image", "Buffy/Sweet.png", ":reference", "I can bring whole cities to ruin and still have time to get a soft shoe in ... Something's cooking. I'm at the griddle. I bought Nero his very first fiddle.")
          )
        )
      )
    )
          ...
          nx_tactics_base.f_sectionmap_from_sectionlist(
            ...
            vx_core.f_new(
              ...
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_unitmap},
                "Syndicate Enforcer",
                vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Syndicate Enforcer", ":summary", "* Enforcers work in law enforcement, the judicial system, and the criminal underworld. They influence both the criminals that the masses fear and the police and judges to whom they turn to for protection. They make sure that the bills are paid and the contracts are kept."),
                "Syndicate Financier",
            ...
            vx_core.f_new(
              ...
              vx_core.f_new(
                ...
                vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Copernicus Research Center", ":summary", "* An fantastically immense space station in the form of a Dyson Sphere"),
                "Earth Frontier Corp",
