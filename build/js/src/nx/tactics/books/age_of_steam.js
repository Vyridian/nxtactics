...
export default class nx_tactics_books_age_of_steam {
  ...
  static f_chapter_age_of_steam_equipment(tactics) {
  ...
  static f_chapter_age_of_steam_overview(tactics) {
    let output = nx_tactics_base.e_chapter
    output = vx_core.f_new(
      {"any-1": nx_tactics_base.t_chapter},
      ":name",
  ...
  static f_chapter_civil_war(tactics) {
    let output = nx_tactics_base.e_chapter
    output = vx_core.f_new(
      {"any-1": nx_tactics_base.t_chapter},
      ":name",
  ...
  static f_chapter_examples_of_play(tactics) {
    let output = nx_tactics_base.e_chapter
    output = vx_core.f_new(
      {"any-1": nx_tactics_base.t_chapter},
      ":name",
  ...
  static f_chapter_steam_age_maps(tactics) {
    let output = nx_tactics_base.e_chapter
    output = vx_core.f_new(
      {"any-1": nx_tactics_base.t_chapter},
      ":name",
  ...
  static f_chapter_victorian_england(tactics) {
    let output = nx_tactics_base.e_chapter
    output = vx_core.f_new(
      {"any-1": nx_tactics_base.t_chapter},
      ":name",
  ...
  static f_chapter_wild_west(tactics) {
    let output = nx_tactics_base.e_chapter
    output = vx_core.f_new(
      {"any-1": nx_tactics_base.t_chapter},
      ":name",
  ...
  static f_tacticsbook(tactics) {
    ...
    output = vx_core.f_new(
      ...
      nx_tactics_base.f_chaptermap_from_chapterlist(
        ...
        nx_tactics_books_age_of_steam.f_chapter_victorian_england(tactics),
        nx_tactics_books_age_of_steam.f_chapter_wild_west(tactics),
        nx_tactics_books_age_of_steam.f_chapter_examples_of_play(tactics)
      )
    )
    return output
  }
