      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            ".45 Colt Peacemaker",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", ".45 Colt Peacemaker", ":image", "images/age-of-steam/Colt1873.jpg", ":reference", "US Army issue from 1873-1892 and used by other notables like Wyatt Earp and Bat Masterson.  Wyatt Earp's\nfictional Colt Buntline was supposed to be a long barrel version of the Colt Peacemaker.", ":summary", "Single action, revolver", ":classification", "Pistol", ":modifiers", "Bleeding", ":range", "30m", ":rounds", "6"),
            ".45 Smith&amp;Wesson Schofield",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", ".45 Smith&amp;Wesson Schofield", ":image", "images/age-of-steam/Schofield1869.jpg", ":reference", "Just meat and potatoes.  Me and Jesse James think it's the best handgun in the world. - Kid, The Quick and the Dead.", ":summary", "Single action, revolver", ":classification", "Pistol", ":modifiers", "Bleeding", ":range", "30m", ":rounds", "6"),
            ".41 Remington Derringer",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", ".41 Remington Derringer", ":image", "images/age-of-steam/Derringer.jpg", ":reference", "The classic Remington design is still popular; a Remington pattern derringer in .38 Special is still smaller than\nthe most compact .25 ACP semiautomatic, and provides far superior terminal ballistic performance in its two shots\nthan the .25 ACP does with six or seven.", ":summary", "Rimfire, single action", ":classification", "Pistol", ":modifiers", "Bleeding", ":range", "16m", ":rounds", "2"),
            ".44 Winchester Model 1873",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", ".44 Winchester Model 1873", ":image", "images/age-of-steam/Winchester1873.jpg", ":reference", "The Winchester is among the earliest repeating rifles, and has become synonymous with lever-action firearms.\nKnown as 'The Gun that Won the West' for its immense popularity at that time.", ":summary", "Lever action, repeating", ":classification", "Rifle", ":length", "125.2cm", ":mass", "4.3kg", ":muzzlevelocity", "379m/s", ":range", "100m"),
            "12g Winchester Model 1887",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "12g Winchester Model 1887", ":reference", "Considered the first truly successful repeating shotgun", ":summary", "Level action", ":classification", "Shotgun", ":length", "1m", ":mass", "3.6kg", ":modifiers", "Scattershot, Bleeding", ":range", "30m", ":rounds", "5"),
            ".50 Gatling Gun",
            ...
            "Napoleon Cannon",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Napoleon Cannon", ":image", "images/age-of-steam/CivilWarCannon.jpg", ":summary", "Smoothbore, muzzle-loading, 12-pounder", ":classification", "Cannon", ":modifiers", "Blast, Indirect Fire", ":range", "250m")
          )
        ),
        "Steam Age Vehicles",
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            "Horseless  Carriage",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Horseless  Carriage"),
            "Mailplane Biplane",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Mailplane Biplane"),
            "Ocean Liner",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Ocean Liner", ":titles", "Liner, Steam Liner"),
            ":Stagecoach",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Stagecoach"),
            "Steam Ferry",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Steam Ferry"),
            "Steam Train Boxcar",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Steam Train Boxcar"),
            "Steam Train Caboose",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Steam Train Caboose"),
            "Steam Train Coach",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Steam Train Coach"),
            "Steam Train Locomotive",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Steam Train Locomotive"),
            "Steam Train Private Coach",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Steam Train Private Coach"),
            ":Steamboat",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Steamboat"),
            "Tramp Freighter",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Tramp Freighter"),
            ":Zepplin",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Zepplin", ":titles", "Dirigible")
          )
        )
      )
    )
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Confederate Cannon",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Confederate Cannon"),
            "Confederate Conscript",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Confederate Conscript"),
            "Confederate Gatling Gunner",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Confederate Gatling Gunner"),
            "Confederate Medic",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Confederate Medic"),
            "Confederate Officer",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Confederate Officer"),
            "Confederate Veteran",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Confederate Veteran")
          )
        ),
        "Confederate Navy",
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new(
              ...
              vx_core.f_new(
                ...
                ":Gunnery",
                vx_core.f_new({"any-1": nx_tactics_base.t_unitskill}, ":name", "Gunnery", ":summary", "2 x 7 inch (178mm) rifles\n2 x 6 inch (152mm) rifles\n6 x 9 inch (229mm) Dahlgren smoothbores\n2 x 12-pounder (5kg) howitzers", ":level", "4")
              )
            )
          )
        ),
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Union Cannon",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Union Cannon"),
            "Union Conscript",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Union Conscript"),
            "Union Gatling Gunner",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Union Gatling Gunner"),
            "Union Medic",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Union Medic"),
            "Union Officer",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Union Officer"),
            "Union Veteran",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Union Veteran")
          )
        ),
        "Union Navy",
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new(
              ...
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_unitskillmap},
                ":Gunnery",
                vx_core.f_new({"any-1": nx_tactics_base.t_unitskill}, ":name", "Gunnery", ":summary", "2 x 11 in (280mm) Dahlgren smoothbores, turret", ":level", "4")
              )
            )
          )
        )
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            ":Mine",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Mine"),
            ":Tumbleweed",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Tumbleweed"),
            "Western Town",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Western Town")
          )
        )
      )
    )
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Dr. John Watson",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Dr. John Watson"),
            "Herbert George Wells",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Herbert George Wells"),
            "Jack the Ripper",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Jack the Ripper"),
            "Sherlock Holmes",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Sherlock Holmes", ":reference", "* Watson: What made like this?\n* Sherlock: Oh, dear Watson. Nothing made me ... I made me.")
          )
        )
      )
    )
      ...
      vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new(
              ...
              vx_core.f_new(
                {"any-1": nx_tactics_base.t_unitskillmap},
                ":Evasion",
                vx_core.f_new({"any-1": nx_tactics_base.t_unitskill}, ":name", "Evasion", ":level", "4")
              )
            )
          )
        ),
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            ":Deputy",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Deputy"),
            ":Sheriff",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Sheriff"),
            "US Marshall",
            vx_core.f_new(
              {"any-1": nx_tactics_base.t_unit},
              ":name",
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Sioux Gunfighter",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Sioux Gunfighter", ":image", "images/age-of-steam/IndianAxe.jpg", ":reference", "Spotted Horse cannot be killed by a bullet! - Spotted Horse, The Quick and the Dead")
          )
        ),
        "Steam Age Townsfolk",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Chinese Monk",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Chinese Monk", ":reference", "I seek not to know the answers, but to understand the questions. - Kwai Chang Caine, Kung Fu TV Series"),
            "Chinese Rail worker",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Chinese Rail worker"),
            ":Cowboy",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Cowboy"),
            ":Dentist",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Dentist"),
            ":Farmer",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Farmer"),
            "General Store Owner",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "General Store Owner"),
            ":Judge",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Judge"),
            ":Preacher",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Preacher"),
            "Saloon Barkeep",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Saloon Barkeep"),
            ":Undertaker",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Undertaker"),
            "Whore with a Heart of Gold",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Whore with a Heart of Gold")
          )
        ),
        "Steam Age Travelers",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Carpet Bagger",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Carpet Bagger"),
            ":Gambler",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Gambler", ":summary", "This is a very special pack.  See, I put an ace in every time I kill a man.  (The deck is all aces) - Ace, The Quick and the Dead"),
            ":Prospector",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Prospector"),
            "Snake Oil Salesman",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Snake Oil Salesman")
          )
        ),
        "Steam Age Tycoons",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            ":Banker",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Banker"),
            "Land Baron",
            vx_core.f_new(
              {"any-1": nx_tactics_base.t_unit},
              ":name",
            ...
            "Oil Baron",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Oil Baron"),
            "Railroad Tycoon",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Railroad Tycoon")
          )
        )
      )
    )
