      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Inquiry Light Recon ATV", ":summary", "* Wheeled\n* Open topped ATV with HMG and MRLx2.", ":speed", "170kph", ":crew", "3", ":mass", "4tons"),
            "Sepoy APC",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Sepoy APC", ":summary", "* Wheeled", ":speed", "300kph", ":crew", "1+11", ":mass", "38tons"),
            "Hunter AC Tank",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Hunter AC Tank", ":summary", "* Air Cushioned\n* Pulse Laser\n* Gauss MG\n* MRL", ":speed", "45kph", ":crew", "6", ":mass", "210tons"),
            "Siega Strider",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Siega Strider", ":summary", "* Legged", ":speed", "200kph", ":crew", "1", ":mass", "60tons"),
            "Striker Grav Tank",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Striker Grav Tank", ":summary", "* 50MW Pulse Laser", ":speed", "480kph", ":crew", "3", ":mass", "522tons"),
            "Tarsan Grav APC",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Tarsan Grav APC", ":speed", "300kph", ":crew", "2+10", ":mass", "51tons"),
            "Essor Recon Drone",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Essor Recon Drone", ":summary", "* No Weapons", ":speed", "1000kph", ":crew", "0", ":mass", "4.3tons"),
            "Princely Lord Attack Speeder",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Princely Lord Attack Speeder", ":summary", "* Grav Flyer\n* Pulse Laser", ":speed", "960kph", ":crew", "2", ":mass", "171tons"),
            "Alliance Exploration Ship",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Alliance Exploration Ship", ":summary", "* SS Copernicus - Floating adrift in open space, the Copernicus is a ghost ship\nin more ways than one."),
            "Hellbore Missile",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Hellbore Missile", ":summary", "* A giant missile designed to drill into a planet and detonate deep in the magma setting\noff massive volcanic eruptions across the world with the intention to make the world\nuninhabitable.")
          )
        ),
        "Azuriach Empire",
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Trepida Light Grav Tank", ":summary", "* Fusion Cannon", ":speed", "1000kph", ":crew", "2", ":mass", "110tons"),
            "Invader Grav Tank",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Invader Grav Tank", ":summary", "* Fusion Cannon", ":speed", "3640kph", ":crew", "4", ":mass", "152tons"),
            "Vortex Land Carrier",
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Vargr Buccaneer Grav Platform", ":summary", "* High speed, open topped, gravity cycle shaped like a cylinder.", ":speed", "1000kph", ":crew", "1", ":mass", "1.4tons")
          )
        ),
        ":Virtuals",
