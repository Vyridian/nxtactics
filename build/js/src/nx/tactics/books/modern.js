...
export default class nx_tactics_books_modern {
      ...
      vx_core.f_new(
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    ...
                    "30mm GAU-8 Avenger",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unititem}, ":name", "30mm GAU-8 Avenger")
                  )
                )
              )
            ),
            "AH-1 Cobra",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "AH-1 Cobra", ":image", "Modern/American_Helicopter_Cobra.png", ":summary", "* 2x 7.62mm Miniguns\n* 2x 7-round 70mm Rocket Pods\n* 20mm XM195 Vulcan Cannon", ":speedair", "350kph", ":classification", "Lt. Aircraft", ":crew", "2", ":mass", "4tons", ":height", "4m", ":length", "13m", ":range", "570km"),
            "Candy Bomber",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Candy Bomber", ":classification", "Hvy. Aircraft"),
            "UH-1 Iroquois (Huey)",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "UH-1 Iroquois (Huey)", ":image", "Modern/American_Helicopter_Huey.png", ":summary", "* 2x 7.62mm M60 Machine Gun\n* 2x 7-round 70mm Rocket Pods", ":speedair", "200kph", ":classification", "Lt. Aircraft", ":crew", "1+14", ":mass", "4tons", ":height", "4m", ":length", "17m", ":width", "3m"),
            "SR-71 Blackbird",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "SR-71 Blackbird", ":image", "Modern/American_SpyPlane_SR71Blackbird.png", ":classification", "Hvy. Aircraft")
          )
        ),
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            ":ICBM",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "ICBM"),
            "Polaris Submarine Missile",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Polaris Submarine Missile")
          )
        ),
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "QF 20 Pounder",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "QF 20 Pounder")
          )
        )
      )
    )
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            ":Administrator",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Administrator"),
            "ATF Agent",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "ATF Agent"),
            ":Congressman",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Congressman"),
            "DEA Agent",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "DEA Agent"),
            ":Diplomat",
            vx_core.f_new(
              {"any-1": nx_tactics_base.t_unit},
              ":name",
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  vx_core.f_new(
                    ...
                    ":Negotiation",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unitability}, ":name", "Negotiation"),
                    ":Politics",
                    vx_core.f_new({"any-1": nx_tactics_base.t_unitability}, ":name", "Politics")
                  )
                )
              )
            ),
            "FBI Agent",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "FBI Agent"),
            ":Monarch",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Monarch"),
            ":Noble",
            vx_core.f_new(
              {"any-1": nx_tactics_base.t_unit},
              ":name",
            ...
            ":Senator",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Senator")
          )
        ),
        "Modern Police",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Police Officer",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Police Officer", ":titles", "Beat Cop, Pig (derogatory), Thin Blue Line"),
            ":Detective",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Detective"),
            "Forensics Investigator",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Forensics Investigator"),
            "Internal Affair Agent",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Internal Affair Agent"),
            ":S.W.A.T.",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "S.W.A.T.")
          )
        ),
        "Modern Criminals",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Armed Robber",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Armed Robber"),
            ":Informant",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Informant"),
            "Purse Snatcher",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Purse Snatcher"),
            "Serial Killer",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Serial Killer")
          )
        ),
        "Modern Crime Gangs",
        vx_core.f_new(
  ...
  static f_chapter_modern_ground_vehicles() {
    ...
    output = vx_core.f_new(
      ...
      vx_core.f_new(
        {"any-1": nx_tactics_base.t_sectionmap},
        "Modern Cycles",
        vx_core.f_new({"any-1": nx_tactics_base.t_section}, ":name", "Modern Cycles"),
        "Modern Cars",
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_section},
          ":name",
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            ":Compact",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Compact", ":image", "Modern/Civilian_Compact.png"),
            "Luxury Sedan",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Luxury Sedan"),
            ":Minivan",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Minivan", ":image", "Modern/Civilian_Minivan.png"),
            ":Sedan",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Sedan", ":image", "Modern/Civilian_Sedan.png"),
            "Sports Car",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Sports Car", ":image", "Modern/Civilian_SportsCar.png"),
            ":Subcompact",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Subcompact", ":titles", "Econobox"),
            "Station Wagon",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Station Wagon", ":image", "Modern/Civilian_StationWagon.png")
          )
        ),
        "Modern Trucks",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Armored Car",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Armored Car", ":summary", "* RWD. 200 hp engine [20], 20 gallon tank [4], driver, gunner, SR 6, TS 80, AC 4 (max 8), 16 mpg @65.\nFP Armor: F30, L30, R30, B30, T30, U20. Cargo 200 cf. Max load 2000 lb. $70,000, 8500 lb."),
            ":HummVee",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "HummVee"),
            ":Jeep",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Jeep"),
            "Land Cruiser",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Land Cruiser"),
            "Pickup Truck",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Pickup Truck", ":image", "Modern/Civilian_PickupTruck.png", ":summary", "* Same as Sport Utility except: two to three passengers. Cargo 160 cf. Max load 1000-3000 lb. $20,000 3300 lb."),
            "Sport Utility",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Sport Utility", ":image", "Modern/Civilian_SUV.png", ":summary", "* RWD or AWD with around 180 hp, two- or four-door with two to eight passengers.  SR 6, TS 110, AC 6 (max 10), 18 mpg@65. Cargo 20-70 cf. Max load 500-1000 lb. $30,000 3500 lb."),
            ":Van",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Van")
          )
        ),
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            ":Bus",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Bus", ":titles", "School Bus"),
            "Bus, Luxury",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Bus, Luxury", ":titles", "Charter Bus"),
            ":Backhoe",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Backhoe"),
            "Bobcat Loader",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Bobcat Loader"),
            ":Bulldozer",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Bulldozer"),
            ":Camper",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Camper"),
            "Cargo Truck",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Cargo Truck"),
            "Construction Crane",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Construction Crane"),
            "Dump Truck",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Dump Truck"),
            "Garbage Truck",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Garbage Truck"),
            "Giant Dump Truck",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Giant Dump Truck"),
            "Giant Shovel",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Giant Shovel"),
            "Recreational Vehicle (RV)",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Recreational Vehicle (RV)"),
            "Tractor Trailer",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Tractor Trailer", ":summary", "* 200 gallon tank, driver, 2 passengers. SR 5.75, TS 125, AC 3 (max 6), 12 mpg@65. No Armor.\nCargo 5000 cf. Max load 30 tons. $300,000, 10 tons.  Tractor trailers use two overlapping vehicle counters.")
          )
        ),
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Police Cruiser",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Police Cruiser"),
            "SWAT Truck",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "SWAT Truck")
          )
        ),
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Armored Personal Carrier (APC)", ":summary", "* Wheeled. 500 hp engine, 60 gallon selfsealing tank, driver, gunner, MG50 also in turret (50), SS [3] back (5),\nSR 2, TS 50, AC 3 (max 20), 3 mpg@50. Militarygrade Armor: F100, L80, R80, B70, T40, U50.  Cargo 10 soldiers with\nfull gear.  Max load 2000 lb. $250,000, 10 tons.")
          )
        ),
        "Modern Trailers",
        vx_core.f_new({"any-1": nx_tactics_base.t_section}, ":name", "Modern Trailers"),
        "Modern Hovercraft",
        vx_core.f_new({"any-1": nx_tactics_base.t_section}, ":name", "Modern Hovercraft"),
        "Modern Trains",
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_section},
          ":name",
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Armored Boxcar",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Armored Boxcar"),
            "Automobile Cargo Car",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Automobile Cargo Car"),
            ":Boxcar",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Boxcar"),
            ":Caboose",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Caboose"),
            "Dining Car",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Dining Car"),
            "Flatbed Car",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Flatbed Car"),
            "Hand Cart",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Hand Cart"),
            ":Locomotive",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Locomotive"),
            ":Monorail",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Monorail"),
            "Passenger Car",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Passenger Car"),
            "Sleeping Car",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Sleeping Car"),
            ":Streetcar",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Streetcar"),
            "Tanker Car",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Tanker Car"),
            ":Tram",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Tram"),
            "Weapon Mount Car",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Weapon Mount Car")
          )
        ),
        "Modern Snowcraft",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_itemmap},
            ":Iceskates",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Iceskates", ":summary", "* Personal, Unpowered, Icecraft"),
            "Ice sailboat",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Ice sailboat", ":summary", "* Medium, Sail, Icecraft"),
            ":Skis",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Skis", ":summary", "* Personal, Unpowered, Snowcraft"),
            ":Snowboard",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Snowboard", ":summary", "* Personal, Unpowered, Snowcraft"),
            ":Snowshoes",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Snowshoes", ":summary", "* Personal, Unpowered, Snowcraft")
          ),
          ":unitmap",
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Dog Sled",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Dog Sled", ":summary", "* Unpowered, Offroad, Snowcraft"),
            ":Snowmobile",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Snowmobile", ":summary", "* Offroad, Snowcraft")
          )
        )
      )
    )
  ...
  static f_chapter_modern_overview() {
    ...
    output = vx_core.f_new(
      ...
      vx_core.f_new(
        ...
        vx_core.f_new({"any-1": nx_tactics_base.t_section}, ":name", "Modern Naval Warfare", ":summary", "* Aircraft Carriers\n* Destroyers\n* Cruisers\n* Torpedo Boats\n* Radar\n* Naval Cannons\n* Stealth Fighters\n* Unmanned Naval Vehicles\n* Nuclear Submarines\n* Attack Submarines"),
        "Modern Aerial Warfare",
        vx_core.f_new({"any-1": nx_tactics_base.t_section}, ":name", "Modern Aerial Warfare", ":summary", "* Jet Planes\n* Stealth Fighters\n* Unmanned Aerial Vehicles (UAV)\n* Air Cavalry\n* Flying Fortress\n* Landing Strips\n* Aircraft Carriers\n* Machine Guns\n* Strafing\n* Tank Killing\n* Stealth Bombing\n* Strategic Bombing\n* Nuclear Bombing\n* Cruise Missiles\n* Fuel Air Explosives\n* Intercontinental Ballistic Missiles (ICBM)")
      )
    )
    return output
  }
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            ":Astronaut",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Astronaut"),
            "International Space Station",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "International Space Station"),
            "Space Shuttle",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Space Shuttle")
          )
        )
      )
    )
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_itemmap},
            "Soccer Ball",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Soccer Ball", ":image", "Modern/Soccer_Ball.png"),
            "Soccer Player (Blue)",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Soccer Player (Blue)", ":image", "Modern/Soccer_PlayerBlue.png"),
            "Soccer Player (Red)",
            vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Soccer Player (Red)", ":image", "Modern/Soccer_PlayerRed.png")
          ),
          ":rulemap",
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_rulemap},
            "Soccer Goal",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Soccer Goal", ":image", "Units/Modern/Soccer_Goal.png")
          )
        ),
        ":Football",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_rulemap},
            "Football Field",
            vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Football Field", ":image", "Units/Modern/Football_Field.jpg")
          ),
          ":unitmap",
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Linebacker (Blue)",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Linebacker (Blue)", ":image", "Modern/Football_LinebackerBlue.png"),
            "Linebacker (Red)",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Linebacker (Red)", ":image", "Modern/Football_LinebackerRed.png"),
            "Quarterback (Blue)",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Quarterback (Blue)", ":image", "Modern/Football_QuarterbackBlue.png"),
            "Quarterback (Red)",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Quarterback (Red)", ":image", "Modern/Football_QuarterbackRed.png"),
            "Receiver (Blue)",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Receiver (Blue)", ":image", "Modern/Football_ReceiverBlue.png"),
            "Receiver (Red)",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Receiver (Red)", ":image", "Modern/Football_ReceiverRed.png")
          )
        ),
        "Underground Sports",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Pit Fighter",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Pit Fighter"),
            "Rollerball Player",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Rollerball Player"),
            "Street Fighter",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Street Fighter")
          )
        ),
        "Other Sports",
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Baseball Player",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Baseball Player"),
            ":Boxer",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Boxer"),
            "Hockey Player",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Hockey Player"),
            "Ping Pong Player",
  ...
  static f_chapter_modern_warfare() {
    ...
    output = vx_core.f_new(
      ...
      vx_core.f_new(
        {"any-1": nx_tactics_base.t_sectionmap},
        "Modern America",
        vx_core.f_new({"any-1": nx_tactics_base.t_section}, ":name", "Modern America", ":reference", "* I'm going to make it up for all of the Sunday Times. I am going to make it up for all of the nusery rhymes. They never really wanted to tell the truth. I'm so tired of you America. ... Tell me, do you really think you go to hell for having loved? Tell me, enough of thinking everything that you've done is good. I really need to know. After soaking the body of Jesus Christ in blood. I 'm so tired of America. ... You took advantage of a world that loved you well. I'm going to a town that has already been burnt down. I'm so tired of you America - Rufus Wainwright, Going To a Town"),
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Advanced Tactical Fighter"),
            "B-1 Bomber",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "B-1 Bomber"),
            "B-2 Stealth Bomber",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "B-2 Stealth Bomber"),
            "Predator UAV",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Predator UAV"),
            "Stealth Fighter",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Stealth Fighter"),
            "SH-60 Seahawk Helicopter",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "SH-60 Seahawk Helicopter"),
            "Blackhawk Helicopter",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Blackhawk Helicopter"),
            "Apache Helicopter",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Apache Helicopter"),
            "C-5 Galaxy",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "C-5 Galaxy"),
            "C-17 Globemaster III",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "C-17 Globemaster III"),
            "BGM-109 Tomahawk Cruise Missile",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "BGM-109 Tomahawk Cruise Missile", ":summary", "* Conventional: 1,000 lb (450 kg) Bullpup, or submunitions dispenser with BLU-97/B Combined Effects Bomb, or a 200 kiloton of TNT (840 terajoule) W80 nuclear device (inactivated per SALT)")
          )
        ),
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Patriot Missile System")
          )
        ),
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Challenger 2",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Challenger 2", ":summary", "Comparable to the M1 Abrams, though it uses a diesel engine.\nOne near Basra survived being hit by 70 RPGs.\n105mm L7 Gun")
          )
        ),
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Leopard 2A6",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Leopard 2A6", ":summary", "Comparable to the M1 Abrams, it carries a heavier gun and uses a diesel engine which increases reliability.")
          )
        ),
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            "Merkava Mark IV",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Merkava Mark IV")
          )
        ),
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            {"any-1": nx_tactics_base.t_unitmap},
            ":Technical",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Technical")
          )
        )
      )
    )
  ...
  static f_chapter_special_ops() {
    let output = nx_tactics_base.e_chapter
    output = vx_core.f_new({"any-1": nx_tactics_base.t_chapter}, ":name", "Special Ops", ":summary", "Special Ops\nBlack Ops\nDeniable Insurgencies\nImpossible Missions\nHostage Rescue")
    return output
  }
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Construction Submarine"),
            "Big Geek",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Big Geek"),
            "Little Geek",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Little Geek"),
            "Navy Seal",
            vx_core.f_new({"any-1": nx_tactics_base.t_unit}, ":name", "Navy Seal")
          )
        )
      )
    )
  ...
  static f_chapter_the_prisoner() {
    let output = nx_tactics_base.e_chapter
    output = vx_core.f_new({"any-1": nx_tactics_base.t_chapter}, ":name", "The Prisoner", ":reference", "* Where am I? You are at the village. Who do you work for?  That would be telling. What do you want? Information. You won't get it. By hook or by crook, we will. Who are you?  I am number 2. Who is number 1? You are number 6. I am not a number. I am a free man. Ha ha ha ha. - The Prisoner\n* Be seeing you. - The Prisoner")
    return output
  }
