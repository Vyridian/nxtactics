...
export default class nx_tactics_base {
   ...
   */
  static t_scene = {}
  static e_scene = {vx_type: nx_tactics_base.t_scene}

  /**
   * type: scenelist
   */
  static t_scenelist = {}
  static e_scenelist = vx_core.vx_new_list(nx_tactics_base.t_scenelist, [])

  /**
   * type: scenemap
   */
  static t_scenemap = {}
  static e_scenemap = {vx_type: nx_tactics_base.t_scenemap}
  ...
  static e_specialtylist = vx_core.vx_new_list(nx_tactics_base.t_specialtylist, [])
  ...
  /**
   * @function ability_from_tactics_key
   * Returns an ability from tactics
   * @param  {tactics} tactics
   * @param  {string} key
   * @return {ability}
   */
  static t_ability_from_tactics_key = {
    vx_type: vx_core.t_type
  }
  static e_ability_from_tactics_key = {
    vx_type: nx_tactics_base.t_ability_from_tactics_key
  }

  // (func ability<-tactics-key)
  static f_ability_from_tactics_key(tactics, key) {
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        const logit = vx_core.f_if_2(
          ...
          vx_core.f_then(
            vx_core.f_new_from_type(vx_core.t_boolean_from_func, () => {return vx_core.f_is_empty_1(ability)}),
  ...
  /**
   * @function abilitylist_from_tactics_keys
   * Return an abilitylist from keys and tactics
   * @param  {tactics} tactics
   * @param  {stringlist} ... keys
   * @return {abilitylist}
   */
  static t_abilitylist_from_tactics_keys = {
    vx_type: vx_core.t_type
  }
  static e_abilitylist_from_tactics_keys = {
    vx_type: nx_tactics_base.t_abilitylist_from_tactics_keys
  }

  // (func abilitylist<-tactics-keys)
  static f_abilitylist_from_tactics_keys(tactics, ...keys) {
    let output = nx_tactics_base.e_abilitylist
    ...
    output = vx_core.f_let(
      ...
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const abilitylist = vx_core.f_list_from_list_1(
          {"any-1": nx_tactics_base.t_ability, "any-2": vx_core.t_string, "list-1": nx_tactics_base.t_abilitylist, "list-2": vx_core.t_stringlist},
          keys,
          vx_core.f_new_from_type(vx_core.t_any_from_any, (key) => 
            nx_tactics_base.f_ability_from_tactics_key(tactics, key))
        )
        return abilitylist
      })
    )
  ...
  /**
   * @function abilitymap_from_tactics_keys
   * Return an abilitymap from keys and tactics
   * @param  {tactics} tactics
   * @param  {stringlist} ... keys
   * @return {abilitymap}
   */
  static t_abilitymap_from_tactics_keys = {
    vx_type: vx_core.t_type
  }
  static e_abilitymap_from_tactics_keys = {
    vx_type: nx_tactics_base.t_abilitymap_from_tactics_keys
  }

  // (func abilitymap<-tactics-keys)
  static f_abilitymap_from_tactics_keys(tactics, ...keys) {
    let output = nx_tactics_base.e_abilitymap
    keys = vx_core.f_new_from_type(vx_core.t_stringlist, ...keys)
    output = vx_core.f_let(
      ...
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const abilitylist = nx_tactics_base.f_abilitylist_from_tactics_keys(tactics, ...keys)
        return nx_tactics_base.f_abilitymap_from_abilitylist(abilitylist)
      })
    )
    return output
  }
  ...
  /**
   * @function cardimage_from_tactics_unitkey
   * Returns a cardimage from a given tactics and unit key.
   * @param  {tactics} tactics
   * @param  {string} key
   * @return {cardimage}
   */
  static t_cardimage_from_tactics_unitkey = {
    vx_type: vx_core.t_type
  }
  static e_cardimage_from_tactics_unitkey = {
    vx_type: nx_tactics_base.t_cardimage_from_tactics_unitkey
  }

  // (func cardimage<-tactics-unitkey)
  static f_cardimage_from_tactics_unitkey(tactics, key) {
    let output = nx_tactics_base.e_cardimage
    output = vx_core.f_let(
      {"any-1": nx_tactics_base.t_cardimage},
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const unit = nx_tactics_base.f_unit_from_tactics_key(tactics, key)
        return nx_tactics_base.f_cardimage_from_card(unit)
      })
    )
    return output
  }
  ...
  /**
   * @function cardimagelist_from_cardlist
   * Returns a cardimagelist from a given cardlist.
   * @param  {cardlist} cardlist
   * @return {cardimagelist}
   */
  static t_cardimagelist_from_cardlist = {
    vx_type: vx_core.t_type
  }
  static e_cardimagelist_from_cardlist = {
    vx_type: nx_tactics_base.t_cardimagelist_from_cardlist
  }

  // (func cardimagelist<-cardlist)
  static f_cardimagelist_from_cardlist(cardlist) {
    let output = nx_tactics_base.e_cardimagelist
    output = vx_core.f_list_from_list_1(
      {"any-1": nx_tactics_base.t_cardimage, "any-2": nx_tactics_base.t_card, "list-1": nx_tactics_base.t_cardimagelist, "list-2": nx_tactics_base.t_cardlist},
      cardlist,
      vx_core.f_new_from_type(vx_core.t_any_from_any, (card) => 
        nx_tactics_base.f_cardimage_from_card(card))
    )
    return output
  }
   ...
   * @return {cardimagelist}
   */
  static t_cardimagelist_from_tactics_unitkeys = {
    vx_type: vx_core.t_type
  }
  static e_cardimagelist_from_tactics_unitkeys = {
    vx_type: nx_tactics_base.t_cardimagelist_from_tactics_unitkeys
  }
  ...
  static e_item_from_tactics_key = {
    vx_type: nx_tactics_base.t_item_from_tactics_key
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        const logit = vx_core.f_if_2(
          {"any-1": vx_core.t_string},
          vx_core.f_then(
            vx_core.f_new_from_type(vx_core.t_boolean_from_func, () => {return vx_core.f_is_empty_1(item)}),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_log(key)})
          ),
          vx_core.f_else(vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return key}))
        )
  ...
  /**
   * @function itemlist_from_tactics_keys
   * Return an itemlist from keys and tactics
   * @param  {tactics} tactics
   * @param  {stringlist} ... keys
   * @return {itemlist}
   */
  static t_itemlist_from_tactics_keys = {
    vx_type: vx_core.t_type
  }
  static e_itemlist_from_tactics_keys = {
    vx_type: nx_tactics_base.t_itemlist_from_tactics_keys
  }

  // (func itemlist<-tactics-keys)
  static f_itemlist_from_tactics_keys(tactics, ...keys) {
    let output = nx_tactics_base.e_itemlist
    keys = vx_core.f_new_from_type(vx_core.t_stringlist, ...keys)
    output = vx_core.f_let(
      {"any-1": nx_tactics_base.t_itemlist},
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const itemlist = vx_core.f_list_from_list_1(
          {"any-1": nx_tactics_base.t_item, "any-2": vx_core.t_string, "list-1": nx_tactics_base.t_itemlist, "list-2": vx_core.t_stringlist},
          keys,
          vx_core.f_new_from_type(vx_core.t_any_from_any, (key) => 
            nx_tactics_base.f_item_from_tactics_key(tactics, key))
        )
        return itemlist
      })
    )
  ...
  /**
   * @function itemmap_from_tactics_keys
   * Return an itemmap from tactics and keys
   * @param  {tactics} tactics
   * @param  {stringlist} ... keys
   * @return {itemmap}
   */
  static t_itemmap_from_tactics_keys = {
    vx_type: vx_core.t_type
  }
  static e_itemmap_from_tactics_keys = {
    vx_type: nx_tactics_base.t_itemmap_from_tactics_keys
  }

  // (func itemmap<-tactics-keys)
  static f_itemmap_from_tactics_keys(tactics, ...keys) {
    let output = nx_tactics_base.e_itemmap
    keys = vx_core.f_new_from_type(vx_core.t_stringlist, ...keys)
    output = vx_core.f_let(
      ...
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const itemlist = nx_tactics_base.f_itemlist_from_tactics_keys(tactics, ...keys)
        return nx_tactics_base.f_itemmap_from_itemlist(itemlist)
      })
    )
    return output
  }
   ...
   * @return {power}
   */
  static t_power_from_tactics_key = {
    vx_type: vx_core.t_type
  }
  static e_power_from_tactics_key = {
    vx_type: nx_tactics_base.t_power_from_tactics_key
  }

  // (func power<-tactics-key)
  static f_power_from_tactics_key(tactics, key) {
    let output = nx_tactics_base.e_power
    output = vx_core.f_let(
      {"any-1": nx_tactics_base.t_power},
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const powermap = vx_core.f_any_from_struct({"any-1": nx_tactics_base.t_powermap, "struct-2": nx_tactics_base.t_tactics}, tactics, ":powermap")
        const power = vx_core.f_any_from_map({"any-1": nx_tactics_base.t_power, "map-1": nx_tactics_base.t_powermap}, powermap, key)
        const logit = vx_core.f_if_2(
          {"any-1": vx_core.t_string},
          vx_core.f_then(
            vx_core.f_new_from_type(vx_core.t_boolean_from_func, () => {return vx_core.f_is_empty_1(power)}),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_log(key)})
          ),
          vx_core.f_else(vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return key}))
        )
  ...
  static f_powermap_from_powerlist(...powerlist) {
    ...
    powerlist = vx_core.f_new_from_type(nx_tactics_base.t_powerlist, ...powerlist)
    output = vx_core.f_map_from_list(
  ...
  /**
   * @function scenemap_from_scenelist
   * Returns a scenemap from a given scenelist
   * @param  {scenelist} ... scenelist
   * @return {scenemap}
   */
  static t_scenemap_from_scenelist = {
    vx_type: vx_core.t_type
  }
  static e_scenemap_from_scenelist = {
    vx_type: nx_tactics_base.t_scenemap_from_scenelist
  }

  // (func scenemap<-scenelist)
  static f_scenemap_from_scenelist(...scenelist) {
    let output = nx_tactics_base.e_scenemap
    scenelist = vx_core.f_new_from_type(nx_tactics_base.t_scenelist, ...scenelist)
    output = vx_core.f_map_from_list(
      {"any-1": nx_tactics_base.t_scene, "any-2": nx_tactics_base.t_scene, "list-2": nx_tactics_base.t_scenelist, "map-1": nx_tactics_base.t_scenemap, "struct-2": nx_tactics_base.t_scene},
      scenelist,
      vx_core.f_new_from_type(vx_core.t_any_from_any, (scene) => 
        vx_core.f_any_from_struct({"any-1": vx_core.t_string, "struct-2": nx_tactics_base.t_scene}, scene, ":name"))
    )
    return output
  }
  ...
  /**
   * @function skill_from_tactics_key
   * Returns a skill from tactics
   * @param  {tactics} tactics
   * @param  {string} key
   * @return {skill}
   */
  static t_skill_from_tactics_key = {
    vx_type: vx_core.t_type
  }
  static e_skill_from_tactics_key = {
    vx_type: nx_tactics_base.t_skill_from_tactics_key
  }

  // (func skill<-tactics-key)
  static f_skill_from_tactics_key(tactics, key) {
    let output = nx_tactics_base.e_skill
    output = vx_core.f_let(
      {"any-1": nx_tactics_base.t_skill},
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const skillmap = vx_core.f_any_from_struct({"any-1": nx_tactics_base.t_skillmap, "struct-2": nx_tactics_base.t_tactics}, tactics, ":skillmap")
        const skill = vx_core.f_any_from_map({"any-1": nx_tactics_base.t_skill, "map-1": nx_tactics_base.t_skillmap}, skillmap, key)
        const logit = vx_core.f_if_2(
          {"any-1": vx_core.t_string},
          vx_core.f_then(
            vx_core.f_new_from_type(vx_core.t_boolean_from_func, () => {return vx_core.f_is_empty_1(skill)}),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_log(key)})
          ),
          vx_core.f_else(vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return key}))
        )
  ...
  /**
   * @function skilllist_from_tactics_keys
   * Return a skilllist from tactics and keys
   * @param  {tactics} tactics
   * @param  {stringlist} ... keys
   * @return {skilllist}
   */
  static t_skilllist_from_tactics_keys = {
    vx_type: vx_core.t_type
  }
  static e_skilllist_from_tactics_keys = {
    vx_type: nx_tactics_base.t_skilllist_from_tactics_keys
  }

  // (func skilllist<-tactics-keys)
  static f_skilllist_from_tactics_keys(tactics, ...keys) {
    let output = nx_tactics_base.e_skilllist
    keys = vx_core.f_new_from_type(vx_core.t_stringlist, ...keys)
    output = vx_core.f_let(
      {"any-1": nx_tactics_base.t_skilllist},
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const skilllist = vx_core.f_list_from_list_1(
          {"any-1": nx_tactics_base.t_skill, "any-2": vx_core.t_string, "list-1": nx_tactics_base.t_skilllist, "list-2": vx_core.t_stringlist},
          keys,
          vx_core.f_new_from_type(vx_core.t_any_from_any, (key) => 
            nx_tactics_base.f_skill_from_tactics_key(tactics, key))
        )
        return skilllist
      })
    )
  ...
  /**
   * @function skillmap_from_tactics_keys
   * Return a skillmap from tactics and keys
   * @param  {tactics} tactics
   * @param  {stringlist} ... keys
   * @return {skillmap}
   */
  static t_skillmap_from_tactics_keys = {
    vx_type: vx_core.t_type
  }
  static e_skillmap_from_tactics_keys = {
    vx_type: nx_tactics_base.t_skillmap_from_tactics_keys
  }

  // (func skillmap<-tactics-keys)
  static f_skillmap_from_tactics_keys(tactics, ...keys) {
    let output = nx_tactics_base.e_skillmap
    keys = vx_core.f_new_from_type(vx_core.t_stringlist, ...keys)
    output = vx_core.f_let(
      {"any-1": nx_tactics_base.t_skillmap},
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const skilllist = nx_tactics_base.f_skilllist_from_tactics_keys(tactics, ...keys)
        return nx_tactics_base.f_skillmap_from_skilllist(skilllist)
      })
    )
    return output
  }
  ...
  /**
   * @function specialty_from_tactics_key
   * Returns a specialty from tactics
   * @param  {tactics} tactics
   * @param  {string} key
   * @return {specialty}
   */
  static t_specialty_from_tactics_key = {
    vx_type: vx_core.t_type
  }
  static e_specialty_from_tactics_key = {
    vx_type: nx_tactics_base.t_specialty_from_tactics_key
  }

  // (func specialty<-tactics-key)
  static f_specialty_from_tactics_key(tactics, key) {
    let output = nx_tactics_base.e_specialty
    output = vx_core.f_let(
      {"any-1": nx_tactics_base.t_specialty},
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        const specialty = vx_core.f_any_from_map({"any-1": nx_tactics_base.t_specialty, "map-1": nx_tactics_base.t_specialtymap}, specialtymap, key)
        const logit = vx_core.f_if_2(
          {"any-1": vx_core.t_string},
          vx_core.f_then(
            vx_core.f_new_from_type(vx_core.t_boolean_from_func, () => {return vx_core.f_is_empty_1(specialty)}),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_log(key)})
          ),
          vx_core.f_else(vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return key}))
        )
  ...
  /**
   * @function specialtylist_from_tactics_keys
   * Return an specialtylist from keys and tactics
   * @param  {tactics} tactics
   * @param  {stringlist} ... keys
   * @return {specialtylist}
   */
  static t_specialtylist_from_tactics_keys = {
    vx_type: vx_core.t_type
  }
  static e_specialtylist_from_tactics_keys = {
    vx_type: nx_tactics_base.t_specialtylist_from_tactics_keys
  }

  // (func specialtylist<-tactics-keys)
  static f_specialtylist_from_tactics_keys(tactics, ...keys) {
    let output = nx_tactics_base.e_specialtylist
    keys = vx_core.f_new_from_type(vx_core.t_stringlist, ...keys)
    output = vx_core.f_let(
      {"any-1": nx_tactics_base.t_specialtylist},
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const specialtylist = vx_core.f_list_from_list_1(
          {"any-1": nx_tactics_base.t_specialty, "any-2": vx_core.t_string, "list-1": nx_tactics_base.t_specialtylist, "list-2": vx_core.t_stringlist},
          keys,
          vx_core.f_new_from_type(vx_core.t_any_from_any, (key) => 
            nx_tactics_base.f_specialty_from_tactics_key(tactics, key))
        )
        return specialtylist
      })
    )
  ...
  /**
   * @function specialtymap_from_specialtylist
   * Returns a specialtymap from a given specialtylist
   * @param  {specialtylist} ... specialtylist
   * @return {specialtymap}
   */
  static t_specialtymap_from_specialtylist = {
    vx_type: vx_core.t_type
  }
  static e_specialtymap_from_specialtylist = {
    vx_type: nx_tactics_base.t_specialtymap_from_specialtylist
  }

  // (func specialtymap<-specialtylist)
  static f_specialtymap_from_specialtylist(...specialtylist) {
    let output = nx_tactics_base.e_specialtymap
    specialtylist = vx_core.f_new_from_type(nx_tactics_base.t_specialtylist, ...specialtylist)
    output = vx_core.f_map_from_list(
      {"any-1": nx_tactics_base.t_specialty, "any-2": nx_tactics_base.t_specialty, "list-2": nx_tactics_base.t_specialtylist, "map-1": nx_tactics_base.t_specialtymap, "struct-2": nx_tactics_base.t_specialty},
      specialtylist,
      vx_core.f_new_from_type(vx_core.t_any_from_any, (specialty) => 
        vx_core.f_any_from_struct({"any-1": vx_core.t_string, "struct-2": nx_tactics_base.t_specialty}, specialty, ":name"))
    )
    return output
  }

  /**
   * @function specialtymap_from_tactics_keys
   * Return a specialtymap from keys and tactics
   * @param  {tactics} tactics
   * @param  {stringlist} ... keys
   * @return {specialtymap}
   */
  static t_specialtymap_from_tactics_keys = {
    vx_type: vx_core.t_type
  }
  static e_specialtymap_from_tactics_keys = {
    vx_type: nx_tactics_base.t_specialtymap_from_tactics_keys
  }

  // (func specialtymap<-tactics-keys)
  static f_specialtymap_from_tactics_keys(tactics, ...keys) {
    let output = nx_tactics_base.e_specialtymap
    keys = vx_core.f_new_from_type(vx_core.t_stringlist, ...keys)
    output = vx_core.f_let(
      ...
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const specialtylist = nx_tactics_base.f_specialtylist_from_tactics_keys(tactics, ...keys)
        return nx_tactics_base.f_specialtymap_from_specialtylist(specialtylist)
      })
    )
    return output
  }
  ...
  static e_unit_from_tactics_key = {
    vx_type: nx_tactics_base.t_unit_from_tactics_key
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        const logit = vx_core.f_if_2(
          {"any-1": vx_core.t_string},
          vx_core.f_then(
            vx_core.f_new_from_type(vx_core.t_boolean_from_func, () => {return vx_core.f_is_empty_1(unit)}),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_log(key)})
          ),
          vx_core.f_else(vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return key}))
        )
  ...
  /**
   * @function unitability_from_tactics_key
   * Returns a unitability from tactics and ability key
   * @param  {tactics} tactics
   * @param  {string} key
   * @return {unitability}
   */
  static t_unitability_from_tactics_key = {
    vx_type: vx_core.t_type
  }
  static e_unitability_from_tactics_key = {
    vx_type: nx_tactics_base.t_unitability_from_tactics_key
  }

  // (func unitability<-tactics-key)
  static f_unitability_from_tactics_key(tactics, key) {
    let output = nx_tactics_base.e_unitability
    output = vx_core.f_let(
      {"any-1": nx_tactics_base.t_unitability},
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const ability = nx_tactics_base.f_ability_from_tactics_key(tactics, key)
        return vx_core.f_new({"any-1": nx_tactics_base.t_unitability}, ":ability", ability)
      })
    )
    return output
  }
  ...
  /**
   * @function unitabilitylist_from_tactics_keys
   * Returns a unitability from tactics and ability keys
   * @param  {tactics} tactics
   * @param  {stringlist} ... keys
   * @return {unitabilitylist}
   */
  static t_unitabilitylist_from_tactics_keys = {
    vx_type: vx_core.t_type
  }
  static e_unitabilitylist_from_tactics_keys = {
    vx_type: nx_tactics_base.t_unitabilitylist_from_tactics_keys
  }

  // (func unitabilitylist<-tactics-keys)
  static f_unitabilitylist_from_tactics_keys(tactics, ...keys) {
    let output = nx_tactics_base.e_unitabilitylist
    keys = vx_core.f_new_from_type(vx_core.t_stringlist, ...keys)
    output = vx_core.f_let(
      {"any-1": nx_tactics_base.t_unitabilitylist, "any-2": nx_tactics_base.t_ability, "list-1": nx_tactics_base.t_unitabilitylist, "list-2": nx_tactics_base.t_abilitylist},
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const abilitylist = nx_tactics_base.f_abilitylist_from_tactics_keys(tactics, ...keys)
        return vx_core.f_list_from_list_1(
          {"any-1": nx_tactics_base.t_unitability, "any-2": nx_tactics_base.t_ability, "list-1": nx_tactics_base.t_unitabilitylist, "list-2": nx_tactics_base.t_abilitylist},
          abilitylist,
          vx_core.f_new_from_type(vx_core.t_any_from_any, (ability) => 
            vx_core.f_new({"any-1": nx_tactics_base.t_unitability}, ":ability", ability))
        )
      })
    )
    return output
  ...
  /**
   * @function unitabilitymap_from_tactics_keys
   * Returns a unitabilitymap from tactics and keys
   * @param  {tactics} tactics
   * @param  {stringlist} ... keys
   * @return {unitabilitymap}
   */
  static t_unitabilitymap_from_tactics_keys = {
    vx_type: vx_core.t_type
  }
  static e_unitabilitymap_from_tactics_keys = {
    vx_type: nx_tactics_base.t_unitabilitymap_from_tactics_keys
  }

  // (func unitabilitymap<-tactics-keys)
  static f_unitabilitymap_from_tactics_keys(tactics, ...keys) {
    ...
    output = vx_core.f_let(
      ...
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const unitabilitylist = nx_tactics_base.f_unitabilitylist_from_tactics_keys(tactics, ...keys)
        return nx_tactics_base.f_unitabilitymap_from_unitabilitylist(unitabilitylist)
      })
    )
    return output
  }
  ...
  /**
   * @function unitlist_from_tactics_keys
   * Return an unitlist from keys and tactics
   * @param  {tactics} tactics
   * @param  {stringlist} ... keys
   * @return {unitlist}
   */
  static t_unitlist_from_tactics_keys = {
    vx_type: vx_core.t_type
  }
  static e_unitlist_from_tactics_keys = {
    vx_type: nx_tactics_base.t_unitlist_from_tactics_keys
  }

  // (func unitlist<-tactics-keys)
  static f_unitlist_from_tactics_keys(tactics, ...keys) {
    let output = nx_tactics_base.e_unitlist
    keys = vx_core.f_new_from_type(vx_core.t_stringlist, ...keys)
    output = vx_core.f_let(
      {"any-1": nx_tactics_base.t_unitlist},
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const unitmap = vx_core.f_any_from_struct({"any-1": nx_tactics_base.t_unitmap, "struct-2": nx_tactics_base.t_tactics}, tactics, ":unitmap")
        const map2 = vx_collection.f_map_from_map_keys({"any-1": nx_tactics_base.t_unit, "map-1": nx_tactics_base.t_unitmap}, unitmap, keys)
        const unitlist = vx_core.f_list_from_map({"any-1": nx_tactics_base.t_unit, "any-2": nx_tactics_base.t_unit, "list-1": nx_tactics_base.t_unitlist, "map-2": nx_tactics_base.t_unitmap}, map2)
        return vx_core.f_log_error({"any-1": nx_tactics_base.t_unitlist}, unitlist)
      })
    )
    return output
  }
  ...
  /**
   * @function unitmap_from_tactics_keys
   * Returns a unitmap from tactics and keys
   * @param  {tactics} tactics
   * @param  {stringlist} ... keys
   * @return {unitmap}
   */
  static t_unitmap_from_tactics_keys = {
    vx_type: vx_core.t_type
  }
  static e_unitmap_from_tactics_keys = {
    vx_type: nx_tactics_base.t_unitmap_from_tactics_keys
  }

  // (func unitmap<-tactics-keys)
  static f_unitmap_from_tactics_keys(tactics, ...keys) {
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const unitlist = nx_tactics_base.f_unitlist_from_tactics_keys(tactics, ...keys)
        return nx_tactics_base.f_unitmap_from_unitlist(unitlist)
      })
    )
    return output
  }
  ...
  static e_unitpower_from_tactics_key_abilities = {
    vx_type: nx_tactics_base.t_unitpower_from_tactics_key_abilities
  }
  ...
  /**
   * @function unitpower_from_tactics_key_lvl
   * @param  {tactics} tactics
   * @param  {string} key
   * @param  {int} level
   * @return {unitpower}
   */
  static t_unitpower_from_tactics_key_lvl = {
    vx_type: vx_core.t_type
  }
  static e_unitpower_from_tactics_key_lvl = {
    vx_type: nx_tactics_base.t_unitpower_from_tactics_key_lvl
  }

  // (func unitpower<-tactics-key-lvl)
  static f_unitpower_from_tactics_key_lvl(tactics, key, level) {
    let output = nx_tactics_base.e_unitpower
    output = nx_tactics_base.f_unitpower_from_tactics_key_lvl_abilities_items(
      tactics,
      key,
  ...
  static e_unitpower_from_tactics_key_lvl_abilities = {
    vx_type: nx_tactics_base.t_unitpower_from_tactics_key_lvl_abilities
  }
  ...
  /**
   * @function unitpower_from_tactics_key_lvl_abilities_items
   ...
   * @return {unitpower}
   */
  static t_unitpower_from_tactics_key_lvl_abilities_items = {
    vx_type: vx_core.t_type
  }
  static e_unitpower_from_tactics_key_lvl_abilities_items = {
    vx_type: nx_tactics_base.t_unitpower_from_tactics_key_lvl_abilities_items
  }
  ...
  static f_unitpower_from_tactics_key_lvl_intensity_abilities_items(tactics, key, level, intensity, abilities, items) {
    ...
    output = vx_core.f_let(
      ...
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const power = nx_tactics_base.f_power_from_tactics_key(tactics, key)
        const abilitylist = nx_tactics_base.f_abilitylist_from_tactics_keys(tactics, abilities)
        const unitabilitylist = vx_core.f_list_from_list_1(
          {"any-1": nx_tactics_base.t_unitability, "any-2": nx_tactics_base.t_ability, "list-1": nx_tactics_base.t_unitabilitylist, "list-2": nx_tactics_base.t_abilitylist},
          abilitylist,
          vx_core.f_new_from_type(vx_core.t_any_from_any, (ability) => 
            vx_core.f_new({"any-1": nx_tactics_base.t_unitability}, ":ability", ability))
        )
        const unitabilitymap = nx_tactics_base.f_unitabilitymap_from_unitabilitylist(unitabilitylist)
        const itemlist = nx_tactics_base.f_itemlist_from_tactics_keys(tactics, items)
        const unititemlist = vx_core.f_list_from_list_1(
          {"any-1": nx_tactics_base.t_unititem, "any-2": nx_tactics_base.t_item, "list-1": nx_tactics_base.t_unititemlist, "list-2": nx_tactics_base.t_itemlist},
          itemlist,
          vx_core.f_new_from_type(vx_core.t_any_from_any, (item) => 
  ...
  /**
   * @function unitskill_from_tactics_key
   * @param  {tactics} tactics
   * @param  {string} key
   * @return {unitskill}
   */
  static t_unitskill_from_tactics_key = {
    vx_type: vx_core.t_type
  }
  static e_unitskill_from_tactics_key = {
    vx_type: nx_tactics_base.t_unitskill_from_tactics_key
  }

  // (func unitskill<-tactics-key)
  static f_unitskill_from_tactics_key(tactics, key) {
   ...
   * @return {unitskill}
   */
  static t_unitskill_from_tactics_key_lvl = {
    vx_type: vx_core.t_type
  }
  static e_unitskill_from_tactics_key_lvl = {
    vx_type: nx_tactics_base.t_unitskill_from_tactics_key_lvl
  }
  ...
  /**
   * @function unitskill_from_tactics_key_lvl_abilities
   * @param  {tactics} tactics
   * @param  {string} key
   * @param  {int} level
   * @param  {stringlist} abilities
  ...
  static e_unitskill_from_tactics_key_lvl_abilities = {
    vx_type: nx_tactics_base.t_unitskill_from_tactics_key_lvl_abilities
  }
   ...
   * @return {unitskill}
   */
  static t_unitskill_from_tactics_key_lvl_abilities_items = {
    vx_type: vx_core.t_type
  }
  static e_unitskill_from_tactics_key_lvl_abilities_items = {
    vx_type: nx_tactics_base.t_unitskill_from_tactics_key_lvl_abilities_items
  }
  ...
  static f_unitskill_from_tactics_key_lvl_abilities_items_specialties(tactics, key, level, abilities, items, specialties) {
    ...
    output = vx_core.f_let(
      ...
      [],
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const skill = nx_tactics_base.f_skill_from_tactics_key(tactics, key)
        const abilitylist = nx_tactics_base.f_abilitylist_from_tactics_keys(tactics, abilities)
        const unitabilitylist = vx_core.f_list_from_list_1(
          {"any-1": nx_tactics_base.t_unitability, "any-2": nx_tactics_base.t_ability, "list-1": nx_tactics_base.t_unitabilitylist, "list-2": nx_tactics_base.t_abilitylist},
          abilitylist,
  ...
  /**
   * @function unitskill_from_tactics_key_lvl_items
   * @param  {tactics} tactics
   * @param  {string} key
   * @param  {int} level
   * @param  {stringlist} items
  ...
  static e_unitskill_from_tactics_key_lvl_items = {
    vx_type: nx_tactics_base.t_unitskill_from_tactics_key_lvl_items
  }
  ...
  static e_unitskilllist_from_tactics_keys = {
    vx_type: nx_tactics_base.t_unitskilllist_from_tactics_keys
  }
  ...
  static f_unitskilllist_from_tactics_keys(tactics, ...keys) {
    ...
    output = vx_core.f_list_from_list_1(
      ...
      keys,
      vx_core.f_new_from_type(vx_core.t_any_from_any, (key) => 
        nx_tactics_base.f_unitskill_from_tactics_key(tactics, key))
    )
    return output
  }
  ...
  static e_unitskillmap_from_tactics_keys = {
    vx_type: nx_tactics_base.t_unitskillmap_from_tactics_keys
  }
  ...
  static {
    ...
    const emptymap = vx_core.vx_new_map(vx_core.t_map, {
      ...
      "scenemap": nx_tactics_base.e_scenemap,
      ...
      "ability<-tactics-key": nx_tactics_base.e_ability_from_tactics_key,
      ...
      "abilitylist<-tactics-keys": nx_tactics_base.e_abilitylist_from_tactics_keys,
      ...
      "item<-tactics-key": nx_tactics_base.e_item_from_tactics_key,
      ...
      "itemlist<-tactics-keys": nx_tactics_base.e_itemlist_from_tactics_keys,
      ...
      "skill<-tactics-key": nx_tactics_base.e_skill_from_tactics_key,
      ...
      "skilllist<-tactics-keys": nx_tactics_base.e_skilllist_from_tactics_keys,
      ...
      "skillmap<-tactics-keys": nx_tactics_base.e_skillmap_from_tactics_keys,
      "specialty<-tactics-key": nx_tactics_base.e_specialty_from_tactics_key,
      ...
      "unitability<-tactics-key": nx_tactics_base.e_unitability_from_tactics_key,
      "unitabilitylist<-tactics-keys": nx_tactics_base.e_unitabilitylist_from_tactics_keys,
      "unitabilitymap<-tactics-keys": nx_tactics_base.e_unitabilitymap_from_tactics_keys,
      ...
      "unitlist<-tactics-keys": nx_tactics_base.e_unitlist_from_tactics_keys,
      ...
      "unitpower<-tactics-key-abilities": nx_tactics_base.e_unitpower_from_tactics_key_abilities,
    ...
    const funcmap = vx_core.vx_new_map(vx_core.t_funcmap, {
      "ability<-tactics-key": nx_tactics_base.t_ability_from_tactics_key,
      ...
      "abilitylist<-tactics-keys": nx_tactics_base.t_abilitylist_from_tactics_keys,
      ...
      "item<-tactics-key": nx_tactics_base.t_item_from_tactics_key,
      ...
      "itemlist<-tactics-keys": nx_tactics_base.t_itemlist_from_tactics_keys,
      ...
      "skill<-tactics-key": nx_tactics_base.t_skill_from_tactics_key,
      ...
      "skilllist<-tactics-keys": nx_tactics_base.t_skilllist_from_tactics_keys,
      ...
      "skillmap<-tactics-keys": nx_tactics_base.t_skillmap_from_tactics_keys,
      "specialty<-tactics-key": nx_tactics_base.t_specialty_from_tactics_key,
      ...
      "unitability<-tactics-key": nx_tactics_base.t_unitability_from_tactics_key,
      "unitabilitylist<-tactics-keys": nx_tactics_base.t_unitabilitylist_from_tactics_keys,
      "unitabilitymap<-tactics-keys": nx_tactics_base.t_unitabilitymap_from_tactics_keys,
      ...
      "unitlist<-tactics-keys": nx_tactics_base.t_unitlist_from_tactics_keys,
      ...
      "unitpower<-tactics-key-abilities": nx_tactics_base.t_unitpower_from_tactics_key_abilities,
    ...
    const typemap = vx_core.vx_new_map(vx_core.t_typemap, {
      ...
      "scenemap": nx_tactics_base.t_scenemap,
    ...
    // (type cardimagelist)
    nx_tactics_base.t_cardimagelist['vx_type'] = vx_core.t_type
    nx_tactics_base.t_cardimagelist['vx_value'] = {
      name          : "cardimagelist",
      pkgname       : "nx/tactics/base",
      extends       : ":list",
      allowfuncs    : [],
      disallowfuncs : [],
      allowtypes    : [nx_tactics_base.t_cardimage],
      disallowtypes : [],
      allowvalues   : [],
      disallowvalues: [],
      traits        : [],
    ...
    // (type scene)
    nx_tactics_base.t_scene['vx_type'] = vx_core.t_type
    nx_tactics_base.t_scene['vx_value'] = {
      name          : "scene",
      pkgname       : "nx/tactics/base",
      extends       : ":struct",
      allowfuncs    : [],
    ...
    nx_tactics_base.e_scene['vx_type'] = nx_tactics_base.t_scene
    nx_tactics_base.e_scene['vx_value'] = {}

    // (type scenelist)
    nx_tactics_base.t_scenelist['vx_type'] = vx_core.t_type
    nx_tactics_base.t_scenelist['vx_value'] = {
      name          : "scenelist",
      pkgname       : "nx/tactics/base",
      extends       : ":list",
      allowfuncs    : [],
      disallowfuncs : [],
      allowtypes    : [nx_tactics_base.t_scene],
      disallowtypes : [],
      allowvalues   : [],
      disallowvalues: [],
      traits        : [],
    ...
    nx_tactics_base.e_scenelist['vx_type'] = nx_tactics_base.t_scenelist

    // (type scenemap)
    nx_tactics_base.t_scenemap['vx_type'] = vx_core.t_type
    nx_tactics_base.t_scenemap['vx_value'] = {
      name          : "scenemap",
      pkgname       : "nx/tactics/base",
      extends       : ":map",
      allowfuncs    : [],
    ...
    nx_tactics_base.e_scenemap['vx_type'] = nx_tactics_base.t_scenemap
    nx_tactics_base.e_scenemap['vx_value'] = {}
    ...
    // (func ability<-tactics-key)
    nx_tactics_base.t_ability_from_tactics_key['vx_value'] = {
      name          : "ability<-tactics-key",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_ability_from_tactics_key
    }
    ...
    // (func abilitylist<-tactics-keys)
    nx_tactics_base.t_abilitylist_from_tactics_keys['vx_value'] = {
      name          : "abilitylist<-tactics-keys",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_abilitylist_from_tactics_keys
    }
    ...
    // (func abilitymap<-tactics-keys)
    nx_tactics_base.t_abilitymap_from_tactics_keys['vx_value'] = {
      name          : "abilitymap<-tactics-keys",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_abilitymap_from_tactics_keys
    }
    ...
    // (func cardimage<-tactics-unitkey)
    nx_tactics_base.t_cardimage_from_tactics_unitkey['vx_value'] = {
      name          : "cardimage<-tactics-unitkey",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_cardimage_from_tactics_unitkey
    }

    // (func cardimagelist<-cardlist)
    nx_tactics_base.t_cardimagelist_from_cardlist['vx_value'] = {
      name          : "cardimagelist<-cardlist",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
    ...
    // (func item<-tactics-key)
    nx_tactics_base.t_item_from_tactics_key['vx_value'] = {
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_item_from_tactics_key
    }
    ...
    // (func itemlist<-tactics-keys)
    nx_tactics_base.t_itemlist_from_tactics_keys['vx_value'] = {
      name          : "itemlist<-tactics-keys",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_itemlist_from_tactics_keys
    }
    ...
    // (func itemmap<-tactics-keys)
    nx_tactics_base.t_itemmap_from_tactics_keys['vx_value'] = {
      name          : "itemmap<-tactics-keys",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_itemmap_from_tactics_keys
    }
    ...
    // (func power<-tactics-key)
    nx_tactics_base.t_power_from_tactics_key['vx_value'] = {
      name          : "power<-tactics-key",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_power_from_tactics_key
    }
    ...
    // (func scenemap<-scenelist)
    nx_tactics_base.t_scenemap_from_scenelist['vx_value'] = {
      name          : "scenemap<-scenelist",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_scenemap_from_scenelist
    }
    ...
    // (func skill<-tactics-key)
    nx_tactics_base.t_skill_from_tactics_key['vx_value'] = {
      name          : "skill<-tactics-key",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_skill_from_tactics_key
    }
    ...
    // (func skilllist<-tactics-keys)
    nx_tactics_base.t_skilllist_from_tactics_keys['vx_value'] = {
      name          : "skilllist<-tactics-keys",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_skilllist_from_tactics_keys
    }
    ...
    // (func skillmap<-tactics-keys)
    nx_tactics_base.t_skillmap_from_tactics_keys['vx_value'] = {
      name          : "skillmap<-tactics-keys",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_skillmap_from_tactics_keys
    }

    // (func specialty<-tactics-key)
    nx_tactics_base.t_specialty_from_tactics_key['vx_value'] = {
      name          : "specialty<-tactics-key",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_specialty_from_tactics_key
    }

    // (func specialtylist<-tactics-keys)
    nx_tactics_base.t_specialtylist_from_tactics_keys['vx_value'] = {
      name          : "specialtylist<-tactics-keys",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_specialtylist_from_tactics_keys
    }

    // (func specialtymap<-specialtylist)
    nx_tactics_base.t_specialtymap_from_specialtylist['vx_value'] = {
      name          : "specialtymap<-specialtylist",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_specialtymap_from_specialtylist
    }

    // (func specialtymap<-tactics-keys)
    nx_tactics_base.t_specialtymap_from_tactics_keys['vx_value'] = {
      name          : "specialtymap<-tactics-keys",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
    ...
    // (func unit<-tactics-key)
    nx_tactics_base.t_unit_from_tactics_key['vx_value'] = {
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_unit_from_tactics_key
    }

    // (func unitability<-tactics-key)
    nx_tactics_base.t_unitability_from_tactics_key['vx_value'] = {
      name          : "unitability<-tactics-key",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_unitability_from_tactics_key
    }

    // (func unitabilitylist<-tactics-keys)
    nx_tactics_base.t_unitabilitylist_from_tactics_keys['vx_value'] = {
      name          : "unitabilitylist<-tactics-keys",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_unitabilitylist_from_tactics_keys
    }

    // (func unitabilitymap<-tactics-keys)
    nx_tactics_base.t_unitabilitymap_from_tactics_keys['vx_value'] = {
      name          : "unitabilitymap<-tactics-keys",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_unitabilitymap_from_tactics_keys
    }
    ...
    // (func unitlist<-tactics-keys)
    nx_tactics_base.t_unitlist_from_tactics_keys['vx_value'] = {
      name          : "unitlist<-tactics-keys",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_unitlist_from_tactics_keys
    }
    ...
    // (func unitmap<-tactics-keys)
    nx_tactics_base.t_unitmap_from_tactics_keys['vx_value'] = {
      name          : "unitmap<-tactics-keys",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_unitmap_from_tactics_keys
    }
    ...
    // (func unitpower<-tactics-key-abilities)
    nx_tactics_base.t_unitpower_from_tactics_key_abilities['vx_value'] = {
      name          : "unitpower<-tactics-key-abilities",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_unitpower_from_tactics_key_abilities
    }

    // (func unitpower<-tactics-key-lvl)
    nx_tactics_base.t_unitpower_from_tactics_key_lvl['vx_value'] = {
      name          : "unitpower<-tactics-key-lvl",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_unitpower_from_tactics_key_lvl
    }
    ...
    nx_tactics_base.t_unitpower_from_tactics_key_lvl_abilities['vx_value'] = {
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_unitpower_from_tactics_key_lvl_abilities
    }

    // (func unitpower<-tactics-key-lvl-abilities-items)
    nx_tactics_base.t_unitpower_from_tactics_key_lvl_abilities_items['vx_value'] = {
      name          : "unitpower<-tactics-key-lvl-abilities-items",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
    ...
    // (func unitskill<-tactics-key)
    nx_tactics_base.t_unitskill_from_tactics_key['vx_value'] = {
      name          : "unitskill<-tactics-key",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
    ...
    nx_tactics_base.t_unitskill_from_tactics_key_lvl['vx_value'] = {
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_unitskill_from_tactics_key_lvl
    }

    // (func unitskill<-tactics-key-lvl-abilities)
    nx_tactics_base.t_unitskill_from_tactics_key_lvl_abilities['vx_value'] = {
      name          : "unitskill<-tactics-key-lvl-abilities",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_unitskill_from_tactics_key_lvl_abilities
    }

    // (func unitskill<-tactics-key-lvl-abilities-items)
    nx_tactics_base.t_unitskill_from_tactics_key_lvl_abilities_items['vx_value'] = {
      name          : "unitskill<-tactics-key-lvl-abilities-items",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
    ...
    // (func unitskilllist<-tactics-keys)
    nx_tactics_base.t_unitskilllist_from_tactics_keys['vx_value'] = {
      name          : "unitskilllist<-tactics-keys",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_unitskilllist_from_tactics_keys
    }

    // (func unitskillmap<-tactics-keys)
    nx_tactics_base.t_unitskillmap_from_tactics_keys['vx_value'] = {
      name          : "unitskillmap<-tactics-keys",
      pkgname       : "nx/tactics/base",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_base.f_unitskillmap_from_tactics_keys
    }
