...
export default class nx_tactics_ui_stylesheet {
   ...
   * {font}
   */
  static c_font_header1 = {vx_type: vx_ui_ui.t_font, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'font-header1', type: vx_ui_ui.t_font}}
   ...
   * {font}
   */
  static c_font_header2 = {vx_type: vx_ui_ui.t_font, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'font-header2', type: vx_ui_ui.t_font}}
   ...
   * {font}
   */
  static c_font_label = {vx_type: vx_ui_ui.t_font, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'font-label', type: vx_ui_ui.t_font}}
   ...
   * {font}
   */
  static c_font_rank = {vx_type: vx_ui_ui.t_font, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'font-rank', type: vx_ui_ui.t_font}}
   ...
   * {font}
   */
  static c_font_text = {vx_type: vx_ui_ui.t_font, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'font-text', type: vx_ui_ui.t_font}}
   ...
   * {font}
   */
  static c_font_textarea = {vx_type: vx_ui_ui.t_font, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'font-textarea', type: vx_ui_ui.t_font}}
   ...
   * {fontface}
   */
  static c_fontface1 = {vx_type: vx_ui_ui.t_fontface, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'fontface1', type: vx_ui_ui.t_fontface}}
   ...
   * {fontface}
   */
  static c_fontface2 = {vx_type: vx_ui_ui.t_fontface, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'fontface2', type: vx_ui_ui.t_fontface}}
   ...
   * {fontface}
   */
  static c_fontface3 = {vx_type: vx_ui_ui.t_fontface, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'fontface3', type: vx_ui_ui.t_fontface}}

  /**
   * Constant: image-jester-black
   * {image}
   */
  static c_image_jester_black = {vx_type: vx_ui_ui.t_image, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'image-jester-black', type: vx_ui_ui.t_image}}

  /**
   * Constant: image-jester-red
   * {image}
   */
  static c_image_jester_red = {vx_type: vx_ui_ui.t_image, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'image-jester-red', type: vx_ui_ui.t_image}}

  /**
   * Constant: point-cardsize
   * {point}
   */
  static c_point_cardsize = {vx_type: vx_ui_ui.t_point, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'point-cardsize', type: vx_ui_ui.t_point}}

  /**
   * Constant: point-iconsize
   * {point}
   */
  static c_point_iconsize = {vx_type: vx_ui_ui.t_point, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'point-iconsize', type: vx_ui_ui.t_point}}

  /**
   * Constant: point-rank-pos1
   * {point}
   */
  static c_point_rank_pos1 = {vx_type: vx_ui_ui.t_point, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'point-rank-pos1', type: vx_ui_ui.t_point}}

  /**
   * Constant: point-rank-pos2
   * {point}
   */
  static c_point_rank_pos2 = {vx_type: vx_ui_ui.t_point, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'point-rank-pos2', type: vx_ui_ui.t_point}}

  /**
   * Constant: point-rank-size
   * {point}
   */
  static c_point_rank_size = {vx_type: vx_ui_ui.t_point, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'point-rank-size', type: vx_ui_ui.t_point}}

  /**
   * Constant: point-suit-pos1
   * {point}
   */
  static c_point_suit_pos1 = {vx_type: vx_ui_ui.t_point, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'point-suit-pos1', type: vx_ui_ui.t_point}}

  /**
   * Constant: point-suit-pos2
   * {point}
   */
  static c_point_suit_pos2 = {vx_type: vx_ui_ui.t_point, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'point-suit-pos2', type: vx_ui_ui.t_point}}

  /**
   * Constant: point-suit-size
   * {point}
   */
  static c_point_suit_size = {vx_type: vx_ui_ui.t_point, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'point-suit-size', type: vx_ui_ui.t_point}}
   ...
   * {style}
   */
  static c_style_app = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-app', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_app_background = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-app-background', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-app-main
   * {style}
   */
  static c_style_app_main = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-app-main', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-app-menubar
   * {style}
   */
  static c_style_app_menubar = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-app-menubar', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-app-menudrawer
   * {style}
   */
  static c_style_app_menudrawer = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-app-menudrawer', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-app-msgbox
   * {style}
   */
  static c_style_app_msgbox = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-app-msgbox', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-app-navbar
   * {style}
   */
  static c_style_app_navbar = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-app-navbar', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-app-navbar-button
   * {style}
   */
  static c_style_app_navbar_button = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-app-navbar-button', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-app-navdrawer
   * {style}
   */
  static c_style_app_navdrawer = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-app-navdrawer', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-app-parallax
   * {style}
   */
  static c_style_app_parallax = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-app-parallax', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-app-statusbar
   * {style}
   */
  static c_style_app_statusbar = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-app-statusbar', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-app-statusdrawer
   * {style}
   */
  static c_style_app_statusdrawer = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-app-statusdrawer', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-app-titlebar
   * {style}
   */
  static c_style_app_titlebar = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-app-titlebar', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-app-titlebar-print
   * {style}
   */
  static c_style_app_titlebar_print = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-app-titlebar-print', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-app-titlebar-title
   * {style}
   */
  static c_style_app_titlebar_title = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-app-titlebar-title', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_body = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-body', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_card_display2 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-card-display2', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-card-display3
   * {style}
   */
  static c_style_card_display3 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-card-display3', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-card-display4
   * {style}
   */
  static c_style_card_display4 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-card-display4', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-card-rank
   * {style}
   */
  static c_style_card_rank = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-card-rank', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-card-suit
   * {style}
   */
  static c_style_card_suit = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-card-suit', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-card-title1
   * {style}
   */
  static c_style_card_title1 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-card-title1', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-card-title2
   * {style}
   */
  static c_style_card_title2 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-card-title2', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-cardimage-image1
   * {style}
   */
  static c_style_cardimage_image1 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-cardimage-image1', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-cardimage-image2
   * {style}
   */
  static c_style_cardimage_image2 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-cardimage-image2', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_clickable = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-clickable', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_deck = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-deck', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_div = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-div', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-hidden
   * {style}
   */
  static c_style_hidden = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-hidden', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_html = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-html', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-image-background
   * {style}
   */
  static c_style_image_background = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-image-background', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-image-coin1
   * {style}
   */
  static c_style_image_coin1 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-image-coin1', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-image-coin2
   * {style}
   */
  static c_style_image_coin2 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-image-coin2', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-image-cup1
   * {style}
   */
  static c_style_image_cup1 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-image-cup1', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-image-cup2
   * {style}
   */
  static c_style_image_cup2 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-image-cup2', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-image-jester-black1
   * {style}
   */
  static c_style_image_jester_black1 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-image-jester-black1', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-image-jester-black2
   * {style}
   */
  static c_style_image_jester_black2 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-image-jester-black2', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-image-jester-red1
   * {style}
   */
  static c_style_image_jester_red1 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-image-jester-red1', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_image_sword1 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-image-sword1', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_selected = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-selected', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_text = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-text', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_text_2 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-text-2', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_text_header1 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-text-header1', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_text_header2 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-text-header2', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_text_label = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-text-label', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_text_rank1 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-text-rank1', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_text_rank2 = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-text-rank2', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_text_title = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-text-title', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_textarea = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-textarea', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_unit = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-unit', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-unit-body
   * {style}
   */
  static c_style_unit_body = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-unit-body', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-unit-bodydetail
   * {style}
   */
  static c_style_unit_bodydetail = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-unit-bodydetail', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_unit_image = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-unit-image', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-unit-mind
   * {style}
   */
  static c_style_unit_mind = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-unit-mind', type: vx_ui_ui.t_style}}
   ...
   * {style}
   */
  static c_style_unit_titles = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-unit-titles', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-unit-value
   * {style}
   */
  static c_style_unit_value = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-unit-value', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-unit-will
   * {style}
   */
  static c_style_unit_will = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-unit-will', type: vx_ui_ui.t_style}}

  /**
   * Constant: style-unit-willdetail
   * {style}
   */
  static c_style_unit_willdetail = {vx_type: vx_ui_ui.t_style, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'style-unit-willdetail', type: vx_ui_ui.t_style}}
   ...
   * {stylesheet}
   */
  static c_stylesheet_app = {vx_type: vx_ui_ui.t_stylesheet, vx_constdef: {pkgname: 'nx/tactics/ui/stylesheet', name: 'stylesheet-app', type: vx_ui_ui.t_stylesheet}}
  ...
  static {
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_fontface1, vx_core.f_new(
      ...
      vx_core.f_new(
        {"any-1": vx_data_file.t_filelist},
        vx_core.f_new({"any-1": vx_data_file.t_file}, ":name", "K2F0fZBRmr9vQ1pHEey6Mo2AAg.woff2", ":path", "https://fonts.gstatic.com/s/elmessiri/v22")
      )
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_fontface2, vx_core.f_new(
      ...
      vx_core.f_new(
        {"any-1": vx_data_file.t_filelist},
        vx_core.f_new({"any-1": vx_data_file.t_file}, ":name", "VuJudM3I2Y35poFONtLdafkUCHw1y1N5piDrWdQ.woff2", ":path", "https://fonts.gstatic.com/s/cormorantupright/v18")
      )
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_fontface3, vx_core.f_new(
      ...
      vx_core.f_new(
        {"any-1": vx_data_file.t_filelist},
        vx_core.f_new({"any-1": vx_data_file.t_file}, ":name", "4iCv6Kp1b9dXlgt_CkvjsGyN.woff2", ":path", "https://fonts.gstatic.com/s/carattere/v7")
      )
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_image_jester_black, vx_core.f_new(
      ...
      ":file",
      vx_core.f_new({"any-1": vx_data_file.t_file}, ":name", "icon-jester-black.svg", ":path", "icons")
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_image_jester_red, vx_core.f_new(
      {"any-1": vx_ui_ui.t_image},
      ":file",
      vx_core.f_new({"any-1": vx_data_file.t_file}, ":name", "icon-jester-red.svg", ":path", "icons")
    ))

    // (const point-cardsize)
    Object.assign(nx_tactics_ui_stylesheet.c_point_cardsize, vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 63, ":y", 88))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_app_background, vx_core.f_new(
      ...
      ":pointsize",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 1000, ":y", 1000)
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_app_main, vx_core.f_new(
      ...
      ":pointpos",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 6, ":y", 12),
      ":pointsize",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":y", 6),
      ":scroll-y",
      true
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_app_titlebar_title, vx_core.f_new(
      ...
      "FFFFFF",
      ":pointpos",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 1),
      ":pointsize",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 50)
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_card_display, vx_core.f_new(
      ...
      vx_ui_ui.c_layout_label,
      ":pointpos",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 10, ":y", 7),
      ":pointsize",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 44)
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_card_display_conflict, vx_core.f_new(
      ...
      vx_ui_ui.c_layout_label,
      ":pointpos",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 5, ":y", 7),
      ":pointsize",
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_card_display2, vx_core.f_new(
      ...
      vx_ui_ui.c_layout_label,
      ":pointpos",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 61, ":y", 12),
      ":pointrotate",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 90),
      ":pointsize",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 60)
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_card_display3, vx_core.f_new(
      ...
      vx_ui_ui.c_layout_label,
      ":pointpos",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 55, ":y", 80),
      ":pointrotate",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 180),
      ":pointsize",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 51)
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_card_title2, vx_core.f_new(
      ...
      vx_ui_ui.c_align_center,
      ":pointpos",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 58, ":y", 88),
      ":pointsize",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 51),
      ":pointrotate",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 180)
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_cardimage_image1, vx_core.f_new(
      ...
      ":pointsize",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 43, ":y", 60),
      ":pointrotate",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 90)
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_image_coin1, vx_core.f_new(
      ...
      vx_core.f_new(
        ...
        "Coins",
        ":file",
        vx_core.f_new({"any-1": vx_data_file.t_file}, ":name", "icon-coin.svg", ":path", "icons")
      )
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_image_cup1, vx_core.f_new(
      ...
      vx_core.f_new(
        ...
        "Cups",
        ":file",
        vx_core.f_new({"any-1": vx_data_file.t_file}, ":name", "icon-cup.svg", ":path", "icons")
      )
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_item_summary, vx_core.f_new(
      ...
      vx_ui_ui.c_layout_label,
      ":pointpos",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 33, ":y", 16),
      ":pointsize",
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_place_detail, vx_core.f_new(
      ...
      ":pointsize",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 60, ":y", 38)
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_unit_body, vx_core.f_new(
      ...
      vx_ui_ui.c_align_center,
      ":pointpos",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 50, ":y", 8),
      ":pointsize",
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_unit_bodydetail, vx_core.f_new(
      ...
      vx_ui_ui.c_layout_label,
      ":pointpos",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 33, ":y", 13),
      ":pointsize",
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_unit_detail, vx_core.f_new(
      ...
      vx_ui_ui.c_layout_label,
      ":pointpos",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 3, ":y", 49),
      ":pointsize",
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_unit_image, vx_core.f_new(
      ...
      vx_ui_ui.c_layout_image,
      ":pointpos",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 1, ":y", 6),
      ":pointsize",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 30, ":y", 42)
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_unit_mind, vx_core.f_new(
      ...
      vx_ui_ui.c_align_center,
      ":pointpos",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 50, ":y", 17),
      ":pointsize",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 13, ":y", 6)
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_unit_minddetail, vx_core.f_new(
      ...
      vx_ui_ui.c_layout_label,
      ":pointpos",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 33, ":y", 22),
      ":pointsize",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 29, ":y", 5)
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_unit_speed, vx_core.f_new(
      ...
      vx_ui_ui.c_align_center,
      ":pointpos",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 50, ":y", 35),
      ":pointsize",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 13, ":y", 6)
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_unit_value, vx_core.f_new(
      ...
      vx_ui_ui.c_align_center,
      ":pointpos",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 50, ":y", 2),
      ":pointsize",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 13, ":y", 6)
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_unit_will, vx_core.f_new(
      ...
      vx_ui_ui.c_align_center,
      ":pointpos",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 50, ":y", 26),
      ":pointsize",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 13, ":y", 6)
    ))
    ...
    Object.assign(nx_tactics_ui_stylesheet.c_style_unit_willdetail, vx_core.f_new(
      ...
      vx_ui_ui.c_layout_label,
      ":pointpos",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 33, ":y", 31),
      ":pointsize",
      vx_core.f_new({"any-1": vx_ui_ui.t_point}, ":x", 29, ":y", 5)
    ))
