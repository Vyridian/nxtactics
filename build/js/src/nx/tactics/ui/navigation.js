...
export default class nx_tactics_ui_navigation {
   ...
   * {event}
   */
  static c_event_navbutton_click = {vx_type: vx_event.t_event, vx_constdef: {pkgname: 'nx/tactics/ui/navigation', name: 'event-navbutton-click', type: vx_event.t_event}}
   ...
   * {eventmap}
   */
  static c_eventmap_navbutton = {vx_type: vx_event.t_eventmap, vx_constdef: {pkgname: 'nx/tactics/ui/navigation', name: 'eventmap-navbutton', type: vx_event.t_eventmap}}
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        return vx_core.f_if_2(
          {"any-1": vx_core.t_boolean},
          vx_core.f_then(
            vx_core.f_new_from_type(vx_core.t_boolean_from_func, () => {return ischange}),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_ui_navigation.f_boolean_navigate_from_select(
              context,
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        ...
        const isnav = vx_core.f_if_2(
          {"any-1": vx_core.t_boolean},
          vx_core.f_then(
            vx_core.f_new_from_type(vx_core.t_boolean_from_func, () => {return isback}),
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_ui_navigation.f_boolean_navigate_back(context)})
          ),
          vx_core.f_else(
            vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return nx_tactics_ui_navigation.f_boolean_navigate_from_navid(context, uid)})
          )
        )
        return event
      })
  ...
  static f_ui_layout_from_main_selected(context, main, selected) {
    ...
    output = vx_core.f_if_2(
      ...
      vx_core.f_then(
        ...
        vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return main})
      ),
      vx_core.f_else(
        vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_let(
          {"any-1": vx_ui_ui.t_ui},
  ...
  static f_ui_layout_from_navbar_selected(context, navbar, selected) {
    ...
    output = vx_core.f_if_2(
      ...
      vx_core.f_then(
        vx_core.f_new_from_type(vx_core.t_boolean_from_func, () => {return vx_core.f_lt(selected, 1)}),
        vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return navbar})
      ),
      vx_core.f_else(
        vx_core.f_new_from_type(vx_core.t_any_from_func, () => {return vx_core.f_let(
          {"any-1": vx_ui_ui.t_ui},
