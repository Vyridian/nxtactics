  ...
  static f_powermap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_powermap_from_powerlist(
      ...
      vx_core.f_new(
        ...
        ":abilitymap",
        nx_tactics_base.f_abilitymap_from_tactics_keys(tactics, "Ice Flow", "Ice Riding", "Icy Stare")
      ),
      vx_core.f_new(
        {"any-1": nx_tactics_base.t_power},
        ":name",
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          ":Postcognition",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Postcognition", ":summary", "* [Power]: [Divination]"),
          ":Precognition",
