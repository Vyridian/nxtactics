...
export default class nx_tactics_decks_power {
  ...
  static f_powermap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_powermap_from_powerlist(
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_power}, ":name", "Combiner", ":reference", "* Voltron\n* Mobile Suit Gundam ZZ", ":summary", "* The Unit combines from multiple smaller Units.\n* This [Power] is similar to [Hanger], but the Units are prechosen at creation and their [Cost] is included in the Combiner Unit Cost.\n* The Combiner can hold Unit [Cost] up to [Intensity]."),
