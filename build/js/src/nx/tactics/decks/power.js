  ...
  static f_powermap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_powermap_from_powerlist(
      ...
      vx_core.f_new(
        ...
        "Longevity",
        ":abilitymap",
        nx_tactics_base.f_abilitymap_from_tactics_keys(tactics, "Eternal Youth", "Long Life", "Reincarnation", "Reincarnation - Transference", "True Immortality")
      ),
      vx_core.f_new(
        {"any-1": nx_tactics_base.t_power},
        ":name",
      ...
      vx_core.f_new(
        ...
        "Special Ability",
        ":abilitymap",
        nx_tactics_base.f_abilitymap_from_tactics_keys(tactics, "Cannibal", "Chaotic", "Corrupted", "Ethereal", "Feeding Frenzy", "Giant", "Huge", "Lernaean Poison", "Mindless", "Monstrous", "Nemean Invulnerability", "Prey", "Rapid Metabolism", "Savage", "Skeletal", "Soulless", "Tainted", "Undead", "Zombie")
      ),
      vx_core.f_new(
        {"any-1": nx_tactics_base.t_power},
        ":name",
