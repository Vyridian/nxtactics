  ...
  static f_powermap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_powermap_from_powerlist(
      ...
      vx_core.f_new(
        ...
        ":abilitymap",
        nx_tactics_base.f_abilitymap_from_tactics_keys(tactics, "Ablative Armor", "Armor: Abdomen", "Armor: Arms", "Armor: Chest", "Armor: Feet", "Armor: Hands", "Armor: Head", "Armor: Legs", "Armor: Vitals", "Armor: Shoulders", "Auto Med System", "Body Flares", "Cryo Sleep System", "Environmental Containment", "Environmental Independence", "Floation Device", "Grappling Hoist", "Infrared Dampener", "Missile Mount", "Radar Dampener", "Radar Jammer", "Reactive Armor", "Resist: Cold", "Resist: Corrosion", "Resist: Electricity", "Resist: Energy", "Resist: Fire", "Resist: Magnetism", "Resist: Piercing", "Resist: Plasma", "Resist: Pressure", "Resist: Radiation", "Turret Mount", "Ultraviolet Jammer", "Underwater Operation")
      ),
      vx_core.f_new(
        {"any-1": nx_tactics_base.t_power},
        ":name",
