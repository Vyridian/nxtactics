    ...
    output = nx_tactics_base.f_powermap_from_powerlist(
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_abilitymap},
          "Animal Magnetism",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Animal Magnetism", ":summary", "* [Power]: [Wild]"),
          "Animal Ward",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Animal Ward", ":summary", "* [Ward] - Defends against animals.\n* [Power]: [Wild]"),
          "Banish Vermin",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Banish Vermin", ":summary", "* [Power]: [Wild]"),
          "Beast Lore",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Beast Lore", ":summary", "* [Power]: [Wild]"),
          "Beast Tongue",
          ...
          "Calm the Beast",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Calm the Beast", ":summary", "* [Power]: [Wild]"),
          ...
          "Control Beast",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Control Beast", ":summary", "* [Power]: [Wild]"),
          "Purge Venom",
          ...
          "Creeping Doom",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Creeping Doom", ":summary", "* [Power]: [Wild]"),
          "Giant Animal",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Giant Animal", ":summary", "* [Power]: [Wild]"),
          ":Infestation",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Infestation", ":summary", "* [Power]: [Wild]"),
          "Insect Swarm",
          ...
          "Locate Animal",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Locate Animal", ":summary", "* [Power]: [Wild]"),
          "Nature of the Beast",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Nature of the Beast", ":summary", "* [Power]: [Wild]"),
          "Natural Order",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Natural Order", ":summary", "* [Power]: [Wild]"),
          "Scent of the Wild",
          ...
          "Shrink Animal",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Shrink Animal", ":summary", "* [Power]: [Wild]"),
          "Speak with Animals",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Speak with Animals", ":summary", "* [Power]: [Wild]"),
          "Survival of the Fittest",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Survival of the Fittest", ":titles", "Natural Selection", ":summary", "* [Power]: [Wild]")
        )
      ),
      vx_core.f_new(
        {"any-1": nx_tactics_base.t_power},
        ...
        "Animism",
        ":titles",
        "Correspondence, Curses, Fetishism, Hexcraft, Hexer, Shintoist, Soulcraft, Sympathy, Sympathetic Magic, Synchonicity, Voodoo, Witch man, Witchdoctor",
        ":reference",
