  ...
  static f_powermap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_powermap_from_powerlist(
      ...
      vx_core.f_new(
        ...
        "Move:Ground",
        ":abilitymap",
        nx_tactics_base.f_abilitymap_from_tactics_keys(tactics, "2-Legged", "3-Legged", "4-Legged", "6-Legged", "8-Legged", "Hover", "Jump Jets", "Off Roading", "Snowcraft", "Tracked", "Turbo Booster", "Wall Crawling", "Wall Running", "Water Walking", "Water Running", "Wheeled")
      ),
      vx_core.f_new(
        {"any-1": nx_tactics_base.t_power},
        ":name",
      ...
      vx_core.f_new(
        ...
        ":abilitymap",
        nx_tactics_base.f_abilitymap_from_tactics_keys(tactics, "Faster than Light", "Hyperdrive", "Strategic Warp Jump", "Tactical Warp Jump")
      ),
      vx_core.f_new(
        {"any-1": nx_tactics_base.t_power},
        ":name",
      ...
      vx_core.f_new(
        ...
        ":titles",
        "Fleshcrafting, Fleshmolder, Transfiguration, Vissisitude",
        ":abilitymap",
      ...
      vx_core.f_new(
        ...
        ":abilitymap",
        nx_tactics_base.f_abilitymap_from_tactics_keys(tactics, "1-Handed", "2-Handed", "Anti-Personnel", "Ammo:6", "Armor Piercing", "Arc:1-Side", "Arc:Front", "Autofire", "Bash", "Blast", "Bombardment", "Burstfire", "Capacitors", "Chemical Rounds", "Close Weapon", "Electroshock", "Explosive Rounds", "Extra Ammo", "Firearm Weapon", "Flash Surpressor", "Gun Mount", "Gunnery Weapon", "Gyrojet Rounds", "Hack", "High-Explosive", "Melee Weapon", "Non-Lethal Rounds", "Overcharge", "Overload Weapon", "Paint Rounds", "Pierce", "Ranged Weapon", "Rechargable", "Recoil Compensator", "Scatter", "Silencer", "Slash", "Smoke Rounds", "Targeting Laser", "Telescopic Sight", "Tracer Rounds", "Tracking Rounds", "Turret")
      ),
