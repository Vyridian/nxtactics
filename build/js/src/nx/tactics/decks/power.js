    ...
    output = nx_tactics_base.f_powermap_from_powerlist(
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          "Death Touch",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Death Touch", ":titles", "Dim Mak", ":reference", "Five Point Palm Exploding Heart Technique - Kill Bill", ":summary", "* The fighter strikes vulnerable pressure points, disrupting the opponent's chi flow causing intense pain or death. The effect has no outward effect, but the victim will know something is wrong. Eventually, the victim recovers or dies suddenly from the stress.\n* [Skill]: [Cultivation]-2\n* [Requires]: [Strong]\n* [Damage]: [Stun] only\n* [Crits]: [Poison]\n0 Move\n-1 Defense"),
          "Empty Force",
      ...
      vx_core.f_new(
        ...
        "Quarters",
        ":summary",
        "* The power to have living quarters inside. The maximum Mass is determined by [Intensity]. The amount allocated per person determines the endurance before resupply.",
        ":abilitymap",
      ...
      vx_core.f_new(
        ...
        "Cargo Hold",
        ":summary",
        "* The ability to carry cargo. The maximum Mass is determined by [Intensity].",
        ":abilitymap",
