    ...
    output = nx_tactics_base.f_skillmap_from_skilllist(
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          ":Bargain",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Bargain", ":summary", "* Ability that Limits any attempt to buy or sell goods at their actual worth.", ":titles", "Haggler, Merchant"),
          ":Barter",
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_abilitymap},
          "Armed Robbery",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Armed Robbery"),
          "Blackmail",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Blackmail"),
          "Burglary",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Burglary"),
          "Bribery",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Bribery"),
          "Crime Syndicate",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Crime Syndicate"),
          "Crime Wave",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Crime Wave"),
          "Criminal Mastermind",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Criminal Mastermind"),
          ":Extortion",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Extortion"),
          "Fence Goods",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Fence Goods"),
          ":Kidnapping",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Kidnapping"),
          "Mafia Connections",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Mafia Connections"),
          ":Pimping",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Pimping"),
          ":Piracy",
          ...
          ":Prostitution",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Prostitution"),
          ":Rustling",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Rustling", ":summary", "* Stealing and selling livestock"),
          ":Waylay",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Waylay")
        )
      ),
      vx_core.f_new(
        {"any-1": nx_tactics_base.t_skill},
        ...
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_abilitymap},
          "Con Artist",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Con Artist"),
          "Confidence Game",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Confidence Game", ":titles", "Con Artist, Swindler"),
          ":Decoy",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Decoy", ":summary", "* Create a decoy to mislead.\n* [Move]: Remove this unit from play and place 1 Decoy Token and 1 Decoy Unit Token on this unit's space. Both decoys may act normally during the Action phase, but any action but movement will dispel the decoys.  Both decoys defend as the original unit. If either unit is Hit, both decoys are dispelled. The decoys last until the next turn or until dispelled."),
          "Detect Trap",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Detect Trap"),
          ":Distraction",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Distraction", ":titles", "Throw Dirt"),
          ":Escape",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Escape", ":reference", "* The chain in those handcuffs is high-tensile steel. It'd take you ten minutes to hack through it with this. Now, if you're lucky, you could hack through your ankle in five minutes. Go.", ":summary", "* The ability comes from extensive practice escaping from various bonds and confinements. At higher abilities, the user can dislocate joints to slither out of bonds.", ":titles", "Escape Artist"),
          "Evade Pursuit",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Evade Pursuit", ":summary", "* Ability to correctly evaluate the opponent's pursuit style and outwit the pursuer."),
          ":Forgery",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Forgery", ":summary", "* The ability to forge money or documents. This ability is also used while creating money to prevent forgery.\n* [Extended Action]: Roll vs. object quality or anti-forgery level. Any [Hits] allow a forgery that can pass at a distance. The more [Hits] and [Criticals] rolled, the more indistinquishable from the original. High level forgeries are works of art unto themselves."),
          ":Gambling",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Gambling", ":titles", "Gambler, High Roller"),
          "Honor Among Thieves",
          ...
          ":Smuggling",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Smuggling"),
          "Stage Magic",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Stage Magic"),
          "Thieves Guild Codes",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Thieves Guild Codes", ":summary", "Thieves must conceal their illegal conversations and the guilds have developed a shifting series of hand signals, marks, and code words to communicate simple concepts without arising suspiscion."),
          "Use Blinding Powder",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Use Blinding Powder"),
          "Use Flash Powder",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Use Flash Powder"),
          "Use Irritating Powder",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Use Irritating Powder"),
          "Use Sleeping Powder",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Use Sleeping Powder"),
          ":Vanish",
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          "3 Point Turn",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "3 Point Turn"),
          "Parallel Parking",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Parallel Parking")
        ),
        ":specialtymap",
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_specialtymap},
          ":Motorcycles",
          vx_core.f_new({"any-1": nx_tactics_base.t_specialty}, ":name", "Motorcycles"),
          ":Trucks",
          vx_core.f_new({"any-1": nx_tactics_base.t_specialty}, ":name", "Trucks"),
          "Construction Vehicles",
          vx_core.f_new({"any-1": nx_tactics_base.t_specialty}, ":name", "Construction Vehicles")
        )
      ),
      vx_core.f_new(
        {"any-1": nx_tactics_base.t_skill},
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          ":Duress",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Duress"),
          ":Enslave",
          ...
          "Grip of Fear",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Grip of Fear", ":reference", "* It was Keyser Soze, Agent Kujan. I mean the Devil himself. How do you shoot the devil in the back? What if you miss? - Verbal, Usual Suspects"),
          ":Interrogate",
          ...
          ":Terrorize",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Terrorize", ":summary", "* [Attack]: Any [Critical Hits] may be [Retreats]"),
          ":Torment",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Torment"),
          ":Torture",
      ...
      vx_core.f_new(
        ...
        nx_tactics_base.f_abilitymap_from_abilitylist(
          ...
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Detail Oriented", ":summary", "ONCE IF you found and item during a [Search] AND had [Hits]:10+ THEN you may resuffle that item into the [Search Deck] and draw again taking the new result insteaad."),
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_abilitymap},
          "Ancient History",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Ancient History"),
          ":Antiquities",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Antiquities", ":summary", "* The study and valuation of unique objects throughout history."),
          ":Archeology",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Archeology", ":summary", "* The study and reclamation of ancient relics and remains.", ":titles", "Archeologist, Paleontology, Paleontologist"),
          "Current Events",
          ...
          "Military History",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Military History"),
          "Movie Trivia",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Movie Trivia", ":summary", "* Each topic must be taken separately.\n* Any knowledge rolls in the given field are at +2.\n* Character has a high chance to remember any detail in the given topic.  This is similar to eidetic memory."),
          "Music Trivia",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Music Trivia", ":summary", "* Each topic must be taken separately.\n* Any knowledge rolls in the given field are at +2.\n* Character has a high chance to remember any detail in the given topic.  This is similar to eidetic memory."),
          "Mythology and Legend",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Mythology and Legend"),
          "National History",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "National History"),
          "Religious Studies",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Religious Studies"),
          "Sports Trivia",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Sports Trivia"),
          "World History",
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_abilitymap},
          ":Authority",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Authority"),
          "Blind Justice",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Blind Justice"),
          "Call In Backup",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Call In Backup", ":summary", "Bring me everyone.  What do you mean 'everyone'?  E-V-E-R-Y-O-N-E! - Stansfield and Benny - Leon the Professional"),
          ":Condemn",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Condemn"),
          ":Confiscate",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Confiscate"),
          "Crime and Punishment",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Crime and Punishment"),
          "Crowd Control",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Crowd Control"),
          "Detective Work",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Detective Work", ":reference", "* To a cop the explanation is never that complicated. It's always simple. There's no mystery to the street, no arch criminal behind it all. If you got a dead body and you think his brother did it, you're gonna find out you're right. - Verbal, Usual Suspects"),
          ":Dragnet",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Dragnet", ":reference", "* Our fugitive has been on the run for ninety minutes. Average foot speed over uneven ground barring injuries is 4 miles-per-hour. That gives us a radius of six miles. What I want from each and every one of you is a hard-target search of every gas station, residence, warehouse, farmhouse, henhouse, outhouse and doghouse in that area. - The Fugitive", ":summary", "* Search a large area for a fugitive."),
          ":Exile",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Exile"),
          ":Exonerate",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Exonerate"),
          ":Judgment",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Judgment", ":reference", "* I am the law! - Judge Dredd"),
          ":Precedent",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Precedent"),
          ":Prosecute",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Prosecute"),
          "Scales of Justice",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Scales of Justice"),
          ":Shakedown",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Shakedown", ":reference", "* How many times you been in a lineup? It's always you and four dummies. PD are paying homeless guys $10 a head half the time. And there's no way they'd line five felons in the same row. No way - Keaton, Usual Suspects"),
          ":Trial",
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          ":Seduction",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Seduction", ":reference", "* But what of all those sweet words you spoke in private?  Oh that's just what we call pillow talk, baby, that's all. - Ash, Army of Darkness\n* But you don't understand. That men are weak? \n* Guess I must be dumb. She had a pocket full of horses, trojan and some of them used... I guess I should have closed my eyes when you drove me to the pace where your horses run free. Cause I felt a little ill when I saw all the pictures of the jockeys that were there before me. Believe it or not, I started to worry. I wondered if I had enough class. But it was Saturday night, I guess that makes it alright. And you say, Baby have you got enough gas? Oh, Yeah! - Prince, Little Red Corvette", ":titles", "Femme Fatale, Vamp"),
          "Silver Tongue",
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_abilitymap},
          ":Berserker",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Berserker"),
          ":Frenzy",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Frenzy"),
          ":Fury",
          ...
          ":Taunt",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Taunt", ":reference", "* Kirk: We tried it once your way, Khan, are you game for a rematch? Khan, I'm laughing at the 'superior intellect.' Khan: Full impulse power! Joachim: No, sir! You have Genesis! You can have whatever... Khan: FULL POWER! DAMN YOU! - Star Trek II: The Wrath of Khan", ":summary", "* Dishonor opponent's mother.\n* Roll vs. Mind. If successful, opponent must attack you.", ":titles", "Goad"),
          ":Vengeance",
          ...
          ":Warcry",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Warcry")
        )
      ),
      vx_core.f_new(
        {"any-1": nx_tactics_base.t_skill},
        ...
        vx_core.f_new(
          ...
          ":Charge",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Charge", ":reference", "* We'll use the old ways...speed of horse! - Arthur, Excalibur", ":summary", "* [Requires]: Unit must have moved at least 4 spaces in a straight line.\n* [Action]: Melee Attack costs no [Speed].\n* [Attack], [Damage]: Any [Critical Hits] may be [Morale Tokens]"),
          "Drive Carriage",
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          ":Philosophy",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Philosophy"),
          ":Profile",
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_abilitymap},
          ":Astronavigation",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Astronavigation"),
          "Astronavigation - FTL",
          ...
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Combat Orbital Piloting"),
          "Combat Space Piloting",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Combat Space Piloting"),
          "Orbital Piloting",
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          ...
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Cold Weather Survival", ":summary", "* Hazards - Blizzard, Avalanche, Frostbite"),
          "Dead Reckoning",
