  ...
  static f_skillmap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_skillmap_from_skilllist(
      ...
      vx_core.f_new(
        ...
        "Driver, Trucker",
        ":abilitymap",
        nx_tactics_base.f_abilitymap_from_tactics_keys(tactics, "3 Point Turn", "Bootlegger Reverse", "Parallel Parking", "Swerve"),
        ":specialtymap",
      ...
      vx_core.f_new(
        ...
        "Shadow",
        ":abilitymap",
        nx_tactics_base.f_abilitymap_from_tactics_keys(tactics, "Coercion", "Death March", "Duress", "Enslave", "Grip of Fear", "Interrogate", "Intimidate", "Reign of Terror", "Roar", "Terrorize", "Torment", "Torture")
      ),
      vx_core.f_new(
        {"any-1": nx_tactics_base.t_skill},
        ":name",
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_abilitymap},
          "Antiquities",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Antiquities", ":reference", "* Ah Dr. Jones. We've heard a great deal about you... Professor of archeology, expert on the occult. and how does one say it: obtainer of rare antiquities. - Raiders of the Lost Ark", ":summary", "* [Skill]: [Knowledge]\n* The study and valuation of unique objects throughout history."),
          "Archeology",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Archeology", ":summary", "* [Skill]: [Knowledge]\n* The study and reclamation of ancient relics and remains.", ":titles", "Archeologist, Paleontology, Paleontologist"),
          "Current Events",
      ...
      vx_core.f_new(
        ...
        vx_core.f_new(
          {"any-1": nx_tactics_base.t_abilitymap},
          ":Allure",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Allure"),
          ":Amplify",
          ...
          ":Ballad",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Ballad"),
          "Ballroom Dance",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Ballroom Dance"),
          "Break Dance",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Break Dance"),
          ":Calm",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Calm", ":titles", "Pacify, Soothe the Savage"),
          "Captivating Song",
          ...
          ":Comedy",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Comedy", ":titles", "Clown, Comedian, Mime, Jester"),
          ":Crescendo",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Crescendo"),
          ":Dirge",
          ...
          "Gabriel's Horn",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Gabriel's Horn", ":summary", "* [Requires]: Horn\n* Damages Walls of any kind"),
          ":Harmonize",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Harmonize"),
          ":Heartstrings",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Heartstrings", ":reference", "* I felt he found all my letters and read each one out loud. I prayed he would finish. But he just kept right on... He sang as if he knew me. In all my dark despair. And then he looked right through me. As if I wasn't there... Strumming my pain with his fingers. Singing my life with his words. Killing me softly with his song. Killing me softly with his song. Telling my whole life with his words. Killing me softly with his song. - Roberta Flack, Killing Me Softly"),
          "Hip Hop Dance",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Hip Hop Dance"),
          ":Imitation",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Imitation"),
          ":Impersonation",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Impersonation"),
          ":Incite",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Incite"),
          "Inspiration",
          nx_tactics_base.f_ability_from_tactics_key(tactics, "Inspiration"),
          ":Juggling",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Juggling", ":summary", "* Besides juggling objects, this ability allows the user to catch objects.\n* [Reaction]: When an object is thrown at a space within one space of the user, roll vs. the [Attack], the object is caught if any [Hits] are scored. Further, the user may immediately throw the object using [Juggling] level as attack value."),
          ":Lullaby",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Lullaby"),
          "Performance Art",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Performance Art", ":reference", "Cirque de Soleil"),
          "Pole Dance",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Pole Dance"),
          ":Requiem",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Requiem"),
          "Salsa Dance",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Salsa Dance"),
          ":Satirize",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Satirize"),
          ":Serenade",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Serenade"),
          ":Sexpertise",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Sexpertise", ":reference", "* If you don't like the company, let's just do it you and me...you and me...or three...or four, on the floor. - Britney Spears, Three"),
          ":Silence",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Silence"),
          "Siren Song",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Siren Song", ":summary", "* [Action]: For each success, during its turn, the target must use half of its [Move] to approach the singer."),
          ":Speeches",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Speeches"),
          ":Song",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Song"),
          ":Storytelling",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Storytelling", ":titles", "Storyteller"),
          ":Style",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Style"),
          ":Tango",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Tango"),
          ":Waltz",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Waltz"),
          "War Song",
          vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "War Song", ":reference", "Battle Hymn, Glorious Anthem"),
          "Work Song",
