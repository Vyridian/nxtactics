  ...
  static f_skillmap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_skillmap_from_skilllist(
      ...
      vx_core.f_new(
        ...
        "Beast",
        ":abilitymap",
        nx_tactics_base.f_abilitymap_from_tactics_keys(tactics, "Berserker", "Call Out", "Coercion", "Death March", "Duress", "Enslave", "Frenzy", "Fury", "Grip of Fear", "Interrogate", "Intimidate", "Hatred", "Howl", "Oppress", "Reign of Terror", "Repress", "Roar", "Taunt", "Terrorize", "Torment", "Torture", "Vengeance", "Warcry")
      ),
      vx_core.f_new(
        {"any-1": nx_tactics_base.t_skill},
        ":name",
