...
export default class nx_tactics_decks_ability {
  ...
  static f_abilitymap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_abilitymap_from_abilitylist(
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Acid Spit", ":summary", "* [Power]: [Acidic]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Acid Sting", ":summary", "* [Power]: [Acidic]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Adhesive Grip", ":summary", "* [Power]: [Beastial]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Airborne Assault", ":summary", "* [Skill]: [Military]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Ammo", ":summary", "Shots before reloading\n* [Power]: [Weapon]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Amphibious Assault", ":summary", "* [Skill]: [Military]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Analyze Weakness"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Anti-Personnel", ":titles", "Hollow Point", ":summary", "* [Action]: [+1 Damage] or [-1 Damage] vs. 2 or more Armor\n* [Power]: [Weapon]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Arc:1-Side", ":summary", "* Equip on Left or Right. Covers the equiped [Arc]\n* [Power]: [Weapon]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Arc:Back", ":summary", "* Covers the Back [Arc]\n* [Power]: [Weapon] or [Armor]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Armed Robbery", ":reference", "* My friend an I are.. toll collectors. - Navori Highwayman, Runeterra\n* Stand and Deliver! You're money or your life. - Adam and the Ants, Stand and Deliver", ":summary", "* [Skill]: [Crime]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Armor Piercing", ":titles", "Depleted Uraniumn", ":summary", "* [Action]: Enemy at [-2 Armor]\n* [Power]: [Weapon]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Armor:Abdomen", ":summary", "* Protects Abdomen [J]\n* [Power]: [Armor]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Armor:Arms", ":summary", "* Protects Arms [8] and [9]\n* [Power]: [Armor]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Armor:Chest", ":summary", "* Protects Chest [Q]\n* [Power]: [Armor]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Armor:Feet", ":summary", "* Protects Feet [2] and [3]\n* [Power]: [Armor]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Armor:Hands", ":summary", "* Protects Arms [6] and [7]\n* [Power]: [Armor]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Armor:Head", ":summary", "* Protects Head [A]\n* [Power]: [Armor]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Armor:Legs", ":summary", "* Protects Legs [4] and [5]\n* [Power]: [Armor]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Armor:Shoulders", ":summary", "* Protects Shoulders [K]\n* [Power]: [Armor]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Armor:Vitals", ":summary", "* Protects Vitals [10]\n* [Power]: [Armor]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Art Imitates Life", ":reference", "Dorian Gray", ":summary", "* [Power]: [Artistry]\n* Artwork become real"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Aspect of Wolf", ":reference", "Everquest", ":summary", "* [Power]: [Beastial]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Awestrike", ":summary", "* [Power]: [Presence]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Backstab", ":summary", "* [Fight]: IF [Flanking] double the Flanking Bonus", ":titles", "Back Biter, Back Stabber, Opportunist, Traitor"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Balanced for Throwing", ":summary", "* [Power]: [Quality]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Banishment", ":summary", "* [Action]: Return any [Outsider] to its original realm.\n* [Power]: [Abjuration]\n* This ability may only be attempted on a particular being once per month."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Bareback", ":summary", "* [Skill]: [Animals]\n* Can ride without a saddle without penalty."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Bartending", ":summary", "The ability to make drinks and get tips\n* [Skill]: [Tradeskill]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Bash", ":summary", "* Impact or Explosive Damage. Causes [Fatigue] and [Push].\n* [Power]: [Weapon]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Bat Sight", ":summary", "* [Power]: [Beastial]"),
      vx_core.f_new(
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Bear Form", ":summary", "* [Power]: [Beastial]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Bear Strength", ":summary", "* [Power]: [Beastial]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Berserker", ":summary", "* [Skill]: [Intimidation]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Besiege", ":summary", "* [Skill]: [Military]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Bite the Bullet", ":reference", "* Harriet Tubman related having once assisted in a Civil War amputation in which the patient was given a bullet to bite down on.", ":summary", "* [Skill]: [Defense]\n* [Block] 10: Reduce [Block:Overkill] Damage by 1"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Blade Locking", ":summary", "After a [Block], both weapons are locked together and unusable\n* [Skill]: [Evasion]\n* [Requires]: Cannot be used against Rivals with [Body] 3 greater than your [Body]\n* [Continuous]: Both weapons cannot be used until you take damage"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Blind Fighting", ":summary", "* [Power]: [Mysticism]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Blur", ":summary", "You become strangely difficult to focus on.\n* [Power]: [Dimensional] or [Illusion]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Bombardment", ":summary", "* [Power]: [Weapon]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Bone Chill", ":summary", "* [Power]: [Necromancy]\n* An Undead Minion can use this during [Close Combat] to do [Freezing] Damage"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Bowel Raker", ":titles", "Serrated Arrow", ":summary", "Damage becomes [Slash] only\n* [Skill]: [Ranged]\n* [Bleeding]:+1"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Bravado", ":summary", "Say something to act cool.\n* [Skill]: [Intimidation]\n* [Free]: Ignore the effect of Stress:1 this Round"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Brood Parasitism", ":summary", "Manipulate a host to raise its young as if it were its own, usually using egg mimicry\n* [Power]: [Spawning]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Cat Feet", ":summary", "* Reduce damage from falls", ":summary", "* [Power]: [Beastial]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Catabatan Circle", ":summary", "* [Skill]: [Animals]\n* [Formation]\n* High Dodge and Concentrated firepower"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Chastity Lock", ":summary", "* A magical barrier prevents unwanted sex.\n* [Power]: [Purity]\n* This powerful magic is sustained by the user's Will and lasted until voluntarily released (cannot be coerced)."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Combat Driver", ":summary", "* Experienced in fighting in a car.", ":summary", "* [Skill]: [Military]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Combat Sense", ":summary", "* [Skill]: [Close Combat] or [Melee]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Combination", ":summary", "* Any combat abilities may be strung together as a Combination.\n* [Skill]: [Close Combat] or [Melee]\n* Every ability after the first gets +1 to initiative. If any ability misses or fails, then the combo ends and the next ability is at -1 initiative. Each combo must be chosen when this ability is gained and must be taken again for each separate combo."),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Command the Dead", ":reference", "* All who live will serve. Viego, Runeterra", ":summary", "* Compel undead creatures to serve you for the duration of the ability.\n* [Power]: [Necromancy]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Copy Host", ":titles", "DNA Reflex, Horizontal Gene Transfer", ":reference", "* Alien", ":summary", "Take on characteristics of the host\n* [Power]: [Spawning]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Counterattack", ":summary", "* [Skill]: [Evasion]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Craft Chimera", ":summary", "A Chimera is an imaginary creation. It exists only to the user, though those with magical abilities, young children and the mentally impaired may see them. They only can affect those who can see them."),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Craft Elder Sign", ":summary", "* [Power]: [Abjuration]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Delve into the Past", ":summary", "* Ritual to have a group relive a moment in the past\n* [Power]: [Divination]\n* The group 'exists' in this version of the past and any damage taken is carried into the present. Their existence may seem to alter events, but they cannot otherwise alter the present."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Detach Body Parts", ":summary", "* [Power]: [Spawning]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Dimension Door", ":summary", "Cross through a doorway or arch of some sort and appear through another similar arch some distance away.\n* [Power]: [Dimensional] or [Sorcery]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Dimension Drop", ":summary", "Send a small object through a dimensional portal and immediately close it again.\n* [Power]: [Dimensional]\n* This is most practical for sending messages or explosives."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Diversionary Tactics", ":summary", "* [Skill]: [Military]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Divide and Conquer", ":summary", "* [Skill]: [Military]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Dream Mirroring", ":summary", "* The ability to swap dreams with another. They are in your dream. You are in their's.\n* [Skill]: [Dreaming]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Drilling", ":summary", "* [Power]: [Terrestrial]\n* Create a hole"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Dragon Strike", ":titles", "Dragon Fist, Dragon Punch", ":summary", "* When striking with the fist, more power can be exerted when the movement originates from the feet, is guided by the waist, flows through the body, and exits through the fist.\n* [Skill]: [Close Combat]\n* [Attack] [J]: Push:+1, Stun:+1\n* [Aerial]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Drive Carriage", ":summary", "* [Skill]: [Animals]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Drive Cart", ":summary", "* [Skill]: [Animals]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Drunken Monkey Roll", ":summary", "* [Crouching]\n-1 Action\n+2 Initiative\n+2 Move\n+1 Defense"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Dual Pistols", ":summary", "* Use a pistol in each hand.\n* [Skill]: [Firearm]\n* [Requires]: Additional Shots to be used.\n* Increases Scatter"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Dual SMGs", ":summary", "* Use a submachinegun in each hand.\n* [Skill]: [Firearm]\n* [Requires]: [Dual SMSs]\n* [Requires]: Additional Shots to be used.\n* Increases Scatter"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Durable", ":summary", "This item is exceptionally well constructed and can withstand a suprising amount of punishment compared to a normal item of its type.\n* [Power]: [Quality]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Egg Laying", ":summary", "Can lay eggs\n* [Power]: [Spawning]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Ego Whip", ":summary", "* [Skill]: [Mental Combat] vs. [Will].", ":titles", "Mind Whip"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Electroshock", ":titles", "Taser", ":summary", "* [Power]: [Weapon]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Entanglement", ":titles", "Tanglers", ":summary", "Reduces Movement\n* [Power]: [Weapon]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Enthrall", ":summary", "* [Power]: [Presence]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Entrance", ":summary", "* [Power]: [Presence]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Excavating", ":summary", "* [Power]: [Terrestrial]\n* Expose a large buried area."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Explosive Rounds", ":titles", "High Explosive Rounds", ":summary", "* [Action]: Use [Blast] rules for targetting and damage.\n* [Power]: [Weapon]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Extra Limbs", ":summary", "* [Power]: [Beastial]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Eye of Shadow", ":titles", "Dark Sight, Night Vision", ":summary", "* See perfectly in any form of darkness.\n* [Power]: [Darkness]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Falconry", ":summary", "* [Skill]: [Animals]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Fallout", ":summary", "* [Power]: [Radiation]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Field Fortifications", ":summary", "* [Skill]: [Military]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Financial Genius"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Fine", ":summary", "This item possesses fine details that are particularly attractive to collectors.\n* [Power]: [Quality]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Fire Charm", ":summary", "Cause a Rival to stare at a Fire.\n* [Power]: [Pyromancy]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Fish Eye", ":summary", "* [Power]: [Beastial]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Fish Form", ":summary", "* [Power]: [Beastial]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Frenzy", ":summary", "* [Skill]: [Intimidation]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Fury", ":summary", "* [Skill]: [Intimidation]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Gambling", ":titles", "Gambler, High Roller", ":reference", "* Never lost a fair game. Never played one. - Twisted Fate, Runeterra", ":summary", "* [Skill]: [Deception]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Gills", ":summary", "* [Power]: [Beastial]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Guard Training", ":summary", "* [Skill]: [Animals]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Guards and Wards", ":summary", "* A protective barrier inscribed on the ground to protect the caster from summoned beings (usually his own).\n* [Power]: [Abjuration]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Gun Mount", ":titles", "Bipod, Tripod", ":summary", "* [Power]: [Weapon]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Guns Blazing", ":summary", "Shoot fast to increase combo\n* [Skill]: [Firearm]\n* [Attack]: 7s in hand can be treated as 6 or 8 for Combos"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Gyrojet Rounds", ":titles", "Rocket Rounds", ":summary", "* [Action]: [+1 Damage] at Long Range, [-1 Damage] at Short Range\n* [Power]: [Weapon]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Hack", ":summary", "* Chopping and Spliting Damage. Causes ugly wounds and [Stress].\n* [Power]: [Weapon]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Hall of Mirrors", ":summary", "Target is forced to confront twisted versions of themselves representing their self doubt and hatred.\n* [Power]: [Psychic Combat] vs [Will]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Halo Drop", ":summary", "* [Skill]: [Military]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Hamstring", ":summary", "* Attack the legs to slow the opponent.\n* [Action]\n-1 Accuracy\nCriticals - [Cripple]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Handed:1", ":summary", "* Requires: 1 Hand\n* [Power]: [Weapon] or [Armor]\n* Usable only to [Arc:Front] and [Arc:Left] or [Arc:Right]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Handed:2", ":summary", "* Requires: 2 Hands\n* [Power]: [Weapon]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Hard Headed", ":summary", "* [Skill]: [Close Combat]\n* [Reaction]: Take one less Damage when giving or receiving a [Head Butt]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Harvest:Parts", ":titles", "Skinning", ":summary", "* Retrieve skin or other valuable parts from a carcass.\n* [Skill]: [Hunting]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Harvest:Poison", ":summary", "* [Skill]: [Animals] or [Assassination]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Hatred", ":reference", "* I killed Wesley. I shot him seven times. Because the clip ran out. He. Deserved. MORE! - Karen Page and Kingpin, Daredevil", ":summary", "* [Skill]: [Intimidation]\n* Attack: +1 Speed vs. Tribal or long-standing personal enemies."),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Hawk Eye", ":titles", "Eagle Eye", ":summary", "* [Power]: [Beastial]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Hawk Form", ":summary", "* [Power]: [Beastial]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Heart of Darkness", ":summary", "* [Power]: [Darkness]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Herding", ":titles", "Cowboy, Pig Farmer, Rancher, Shepherd", ":summary", "* [Skill]: [Animals]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Hibernate", ":summary", "Fall unconscious and lower metabolism to survive harsh conditions for extended periods\n* [Power]: [Beastial]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Hide in Plain Sight", ":summary", "A tricky ability to remain hidden despite being in direct sight\n* [Skill]: [Stealth]\n* Requires: [Camouflage]\n* IF you have appropriate camouflage AND you don't move THEN you cannot be detected using normal vision"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "High-Explosive", ":titles", "HE", ":summary", "* [Power]: [Weapon:Firearm] or [Weapon:Cannon] or [Weapon:Missile]\n* [Targetting]: Target a space. All units in that space and surrounding spaces are attacked.\n* [Damage]: All target's are [+2 Armor] against this attack.\n* [Damage]: Units surrounding the space are attacked at -1 Damage for each space distant.\n\nAdvanced:\n* Instead of standard [High Explosive (HE)] rules the following may be used to more accurately simulate the damage exponential decrease in energy of explosives.\n* [Targetting]: Target a space. All units in that space and surrounding spaces are attacked.\n* [Damage]: All target's are [+2 Armor] against this attack.\n* [Damage]: Units surrounding the space are attacked by dividing the energy (in Joules, or tons of TNT) using the following reduction pattern for each space distant: 1/1, 1/3, 1/10, 1/30, 1/100, 1/300, 1/1000, etc. Then look up the new damage based on the new energy level."),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Hip Shoot", ":summary", "* Can shoot from the Hip ignoring normal Disadvantage\n* [Skill]: [Ranged] or [Firearm]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Hospitality", ":summary", "The ability to make serve customers in restaurants or hotels\n* [Skill]: [Tradeskill]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Horse Archery", ":summary", "* [Skill]: [Animals]\nCan use a bow while riding without penalty."),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "House Painting", ":summary", "* [Skill]: [Tradeskill]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Howl", ":summary", "* [Skill]: [Intimidation]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Hurricane Kick", ":titles", "Butterfly Kick, Whirlwind Kick", ":image", "MartialArts/HurricaneKick.jpg", ":reference", "* Ryu, Ken, Akuma, Street Fighter", ":summary", "* May attack up to 2 units in any surrounding spaces.\n* [Skill]: [Close Combat]\n-1 Speed\n-2 Attack"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Ice Flow", ":summary", "* A floating block of ice suitable for a raft rises to the water's surface.\n* [Skill]: [Cold] or [Cryomancy]\n* [Requires]: May only be cast near water."),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Ice Riding", ":titles", "Ice Walk", ":summary", "* Provides [Skating] ability without the requirement of Skates.\n* [Power]: [Cold] or [Cryomancy]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Icy Grip", ":summary", "* [Power]: [Cryomancy] or [Cold]\n* Your [Close Combat] can do [Freezing] Damage"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Icy Stare", ":summary", "* [Power]: [Cryomancy]\n* Your eyes frost over and you can only see in Arc:Forward, but you see different levels of cold like [Heat Sense]. You can also see through ice as if it was clear glass."),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Imitation:Creature", ":reference", "* So, how do we know who's human? If I was an imitation, a perfect imitation, how would you know it was really me? - Childs, The Thing", ":summary", "* Imititate another creature\n* [Power]: [Shapeshift]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Imitation:Inanimate", ":summary", "* Imititate an inanimate object\n* [Power]: [Shapeshift]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Indominable", ":summary", "* [Skill]: [Defense]\n* [Reaction]: Reduce Push or Knockdown by 1"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Impersonate", ":reference", "* Places to go, people to be. - Leblanc, Runeterra", ":summary", "* [Skill]: [Performance]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Inspire", ":summary", "* Allies in Radius are Continuously inspired to greater feats by this ability.\n* [Skill]: [Performance]\n* [Passive]\n* [Continuous]: [Retreats] are reduced by 1 for all allies within the radius."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Jump Suit Combat", ":summary", "* [Skill]: [Military]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Kippup", ":summary", "Stand up from Prone\n* [Skill]: [Athletics]\n* Move:-2 to change from [Prone] to [Standing]."),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Kiss of Death"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Knife Throwing", ":summary", "Can throw any small blade using [Close Combat] or [Ranged]\n* [Skill]: [Close Combat] or [Ranged]\n* Such accuracy has many non-combat applications as well"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Large Litter", ":summary", "Many offspring from each pregnancy\n* [Power]: [Spawning]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Line Swinging", ":titles", "Web Swinging", ":summary", "* [Power]: [Terrestrial]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Linguistic Genius"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Liquid Courage", ":summary", "Increase benefits of intoxicants.\n* [Skill]: [Intimidation]\n* [Reaction]: When you use an intoxicant increase any one effect by 1."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Mage Sight", ":titles", "Detect Magic, Detect Dweomer", ":summary", "* See Magic around you.\n* [Power]: [Wizardry]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Makeup", ":reference", "* I hate having to put my face on. - Leblanc, Runeterra", ":summary", "* [Skill]: [Performance]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Marriage", ":summary", "* The formal act of binding a couples' fate together.\n* [Skill]: [Religion]\n* As long as the bond lasts, each person gains Level:+1 whenever directly defending or supporting the other."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Melting Beam", ":summary", "* Place [Melted] counters on the target body location.\n* [Power]: [Transmutation] vs [Will]\n* Any body location with a [Melted] becomes soft and liquidy. Any area that suffers 3 [Melted] turns completely to stone.\n* Additional Effects: A melted arm cannot move. A melted leg reduces Move by half. A melted head is unable to see or hear. Other melted areas have no additional effect. Melted Arms or legs can drop off like a clean amputation without blood loss.\n* This ability can also be used to restore a melted target back to its original form if the skill is at least equal to the original. Lost limbs may also be restored by reattaching the limb before restoration.\n* This ability can also be used on any sort of earth to soften the earth to equivalent mud."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Mind's Eye", ":summary", "* Eye - Unit may close their eyes and see into the astral world instead of the real world.\n* [Power]: [Mentalism]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Mine Clearing", ":summary", "* [Skill]: [Demolitions]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Mine Laying", ":summary", "* [Skill]: [Demolitionss]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Molecular Alteration", ":summary", "* [Power]: [Transmutation]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Moon Bridge", ":titles", "Moon Gate", ":summary", "* Opens a bridge to the Ethereal version of the Moon.\n* [Power]: [Astrology]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Monstrous", ":summary", "* [Power]: [Special Ability]\n* [Body]:+0x3"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Mounted Combat", ":summary", "* [Skill]: [Animals]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Nightfall", ":summary", "* Gain [Darkness]:+1 for the first hour after dusk.\n* [Power]: [Darkness]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Oppress", ":summary", "* [Skill]: [Intimidation]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Orbital Halo Drop", ":summary", "* [Skill]: [Military]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Oubliette", ":reference", "* Without her, there is only darkness. - Viego, Runeterra", ":summary", "* Trap a target in a prison of absolute darkness.\n* [Power]: [Darkness]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Parachute Assault", ":summary", "* [Skill]: [Military]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Parasitic Offspring", ":reference", "* Parasitic Wasps\n* Alien", ":summary", "Offspring are injected into a host\n* [Power]: [Spawning]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Point Defense", ":summary", "* Shielding moves to block attacks\n* [Power]: [Shielding]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Poison Backlash", ":summary", "* [Power]: [Life]\n* [Action]: Touch a unit with a [Poison] ability. The target is affected as if the ability was used against itself at full strength."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Poison Tolerance", ":reference", "* B: To think, all that time it was your cup that was poisoned. M: They were both poisoned. I spent the last few years building up an immunity to Iocane powder. - Buttercup, Man In Black Princess Bride", ":summary", "* [Skill]: [Assassination]\n* Become resistant to a particular poison by taking small amounts of it over a long period."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Polymorph", ":reference", "* She turned me into a newt. A newt? Well I got better. - Monty Python and the Holy Grail", ":summary", "* [Skill]: [Transmutation] vs. [Will].\n* A unit with 0 Spirit due to polymorph changes into any creature desired of equal Body. When the damage inflicted by Polymorph is removed, the unit returns to normal."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Pounce", ":summary", "* [Power]: [Beastial] vs. [Body]\n* Drop into a crouch and then explode into a mighty leap at his prey attempting to knock down the opponent.\n* [Aerial]\n* +1 Accuracy\n* +1 Move\n* Criticals - [Knockdown]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Power Copy", ":summary", "* Temporarily copy a Power\n* [Power]: [Power Control]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Power Disruption", ":summary", "* Temporarily prevent the use of a Power\n* [Power]: [Power Control]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Power Drain", ":summary", "* Weaken a Power\n* [Power]: [Power Control]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Power Feedback", ":summary", "* Cause a Unit to take Damge when they use a particular Power\n* [Power]: [Power Control]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Power Fluctuation", ":summary", "* Temporarily cause a Power to randomly increase or decrease\n* [Power]: [Power Control]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Power Reflection", ":summary", "* Cause a Power to change Targets\n* [Power]: [Power Control]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Power Theft", ":summary", "* A combination of [Power Copy] and [Power Disruption]\n* [Power]: [Power Control]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Power Vampire", ":summary", "* Weaken a Power and gain energy\n* [Power]: [Power Control]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Puzzles", ":reference", "* Admiral Brindsen: I suppose you're one of those fellows who does the Times crossword puzzle in ten minutes. ffolkes: I have *never* taken *ten* minutes. - ffolkes", ":summary", "* Expert at puzzles.\n* [Skill]: [Brilliance]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Quick Draw", ":summary", "Instantly draw a small item from a holster to hip\n* [Skill]: [Ranged] or [Firearm]\n* [Requires]: [Handed:1] Item in a holster\n* [Free]: Draw an Item from holster to hip. Note: Attacks from the hip are at [Disadvantage]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Quick Study", ":reference", "I know Kung Fu. - Neo, The Matrix", ":summary", "Cram to learn a low level skill very quickly\n* [Skill]: [Intellect]\n* The skill doesn't last long, but often it doesn't have to."),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Quill Attack"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Quills", ":summary", "* [Power]: [Beastial]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Radiation Beam", ":summary", "* [Power]: [Radiation]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Radiation Blast", ":summary", "* [Power]: [Radiation]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Rapid Fire", ":summary", "* [Skill]: [Firearm]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Rapid Gestation", ":summary", "Short period between fertilization and birth\n* [Power]: [Spawning]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Rapid Maturity", ":summary", "Offspring mature fully very quickly\n* [Power]: [Spawning]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Rat Form", ":summary", "* [Power]: [Beastial]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Repress", ":reference", "* Help! Help! I'm being repressed. - Peasant, Monty Python and the Holy Grail", ":summary", "* [Skill]: [Intimidation]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Resist:Bash", ":summary", "* [Damage]: [Armor]:+1 if attack is a [Bash]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Resist:Fire", ":summary", "Reduce Fire Damage\n* [Power]: [Armor], [Quality] or [Toughness]\n* [Damage]: [Armor]:+1 if attack produces [Fire]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Resist:Hack", ":summary", "* [Damage]: [Armor]:+1 if attack is a [Hack]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Resist:Pierce", ":summary", "* [Damage]: [Armor]:+1 if attack is a [Pierce]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Resist:Slash", ":summary", "* [Damage]: [Armor]:+1 if attack is a [Slash]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Restful Sleep", ":summary", "Ensure restful sleep for levelx2 hours."),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Retrieve", ":summary", "* [Skill]: [Animals]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Ride", ":summary", "* Ride a horse or other similar creature.\n* [Skill]: [Animals]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Ride:Bull", ":summary", "* [Skill]: [Animals]\n* While riding a hostile creature, the Scale of the creature considered to be one less for you."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Seeing Eye Training", ":summary", "* [Skill]: [Animals]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Sharpshooting", ":summary", "* Effective Range is doubled\n* [Skill]: [Firearm]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Shield Sacrifice", ":summary", "* [Skill]: [Defense]\n* [Resolution] [Block] [Wand]: The shield becomes the target of any [Overrun] damage."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Shielding:Magical", ":summary", "* IF the Shielding falls due to Damage THEN all further Damage is cancelled.\n* [Power]: [Shielding]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Side Saddle", ":summary", "* [Skill]: [Animals]\n* Can ride side saddle without penalty."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Silencer", ":summary", "* [Power]: [Weapon]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Slash", ":summary", "* Slicing and Cutting Damage. Causes [Bleeding] and [Slow].\n* [Power]: [Weapon]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Sleight of Hand", ":titles", "Legerdemain", ":summary", "* [Skill]: [Deception]\n* Hide a small object in hand without being noticed."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Smoke Rounds", ":summary", "* [Power]: [Weapon]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Smuggling", ":summary", "* [Skill]: [Deception]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Snake Bite", ":summary", "* [Power]: [Beastial]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Snake Charming", ":summary", "* [Skill]: [Animals]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Snake Form", ":summary", "* [Power]: [Beastial]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Soulless", ":summary", "* [Power]: [Special Ability]\n* A soulless unit is not truly alive. It may not use or gain Spirit skills."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Space Combat", ":summary", "* [Skill]: [Military]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Spider Climb", ":summary", "* [Power]: [Beastial]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Spines", ":summary", "* [Power]: [Beastial]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Stare Down", ":summary", "Lock eyes with a willing target and engage in a battle of Wills\n* [Skill]: [Animals] or [Intimidation] vs. [Will]\n* [Damage]: [Stress] only"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Steed Trample", ":summary", "* [Skill]: [Animals]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Supressive Fire", ":titles", "Covering Fire, Pin Down", ":summary", "* Firing weapons at enemy forces with the primary goal of forcing them to remain under cover.\n* [Requires]: [Weapon] with [Autofire]\n* [Skill]: [Fireamr]\n* [Action]: Target a unit that has not been activated this turn, all [Hits] and [Critical Hits] are [Stun] tokens.\n+1 Attack"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Suspended Animation", ":summary", "* Sleep for extended periods without dying.\n* [Power]: [Longevity]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Targeting Laser", ":summary", "* [Power]: [Weapon]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Telescopic Sight", ":summary", "* Improved Long Range accuracy\n* [Power]: [Weapon]\n* IF you haven't moved for 1 Round THEN treat Long Range as Medium Range"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Tendrils", ":summary", "* [Power]: [Beastial]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Tracer Rounds", ":summary", "* [Power]: [Weapon]\n* [Requires]: [Auto], Must attack same target on subsequent round.\n* [Action]: [+1 Attack], [-1 Damage]."),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Track"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Tracked"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Tracking Rounds", ":summary", "* [Power]: [Weapon]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Train Dog", ":summary", "* [Skill]: [Animals]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Train Elephant", ":summary", "* [Skill]: [Animals]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Train Horse", ":summary", "* [Skill]: [Animals]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Tunneling", ":summary", "* [Power]: [Terrestrial]\n* Create caves underground."),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Turbo Booster", ":titles", "Boost, Nitro, Turbo, Turbo Charger"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Turret", ":summary", "* Turret mounted weapons may turn their turret toward any Arc and fire toward its facing.\n* [Power]: [Weapon]\n* Turning - Spend Turn:1 to change turret facing by 45 degrees\n* Facing - IF not facing forward THEN place a Token to show facing\n* Armor - Turrets are considered an additional location and must be Armored separately."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Unnerve", ":reference", "* Your timing is impeccable. Pity you were all they sent... The Fatui would do well to update their intelligence concerning me. Ah, but of course, that would require one of you to return in one piece. - Ayato, Genshin Impact\n* ...to the death. No. To the pain. I don't think I'm quite familiar with that phrase. ... To the pain means the first thing you will lose will be your feet below the ankles. Then your hands at the wrists. Next your nose. ...And then my ears, I understand let's get on with it. WRONG. Your ears you keep and I'll tell you why. So that every shriek of every child at seeing your hideousness will be yours to cherish. Every babe that weeps at your approach, every woman who cries out, 'Dear God! What is that THING?,' will echo in your perfect ears. That is what to the pain means. It means I leave you in anguish, wallowing in freakish misery ... forever. ...I think you're bluffing. It's possible, Pig, I might be bluffing. It's conceivable, you miserable, vomitous mass, that I'm only lying here because I lack the strength to stand. But, then again... perhaps I have the strength after all. - Princess Bride", ":summary", "Tell your opponent something to instill fear.\n* [Skill]: [Intimidation]\n* [Action]: Test [Intimidation] vs [Will]\n* [Damage]: [Fear]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Unsettling Presence", ":summary", "Your intimidating presence is palapable to everyone near you.\n* [Skill]: [Intimidation]\n* [Action]: Place a Token on this card (max:1). The next Unit that attacks you must spend Will:-1 (discard the Token)"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Urban Assault", ":summary", "* [Skill]: [Military]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Vengeance", ":reference", "* More names off the list, more names on it. - Pyke, Runeterra\n* You and I have unfinished business. - The Bride, Kill Bill\n* Revenge is a dish best served cold. - Khan, Star Trek II: Wrath of Khan\n* She opened a book and a box of tools. Sunny came home with a mission... Sunny came home with a list of names. She didn't believe in transcendence. 'It's time for a few small repairs.' she said. Sunny came home with a Vengence. - Shawn Colvin, Sunny Came Home", ":summary", "* [Skill]: [Intimidation]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Wall Crawling", ":summary", "* [Power]: [Terrestrial]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Wall Running", ":summary", "* [Power]: [Terrestrial]\n* Requires: [Wall Crawling]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "War Training", ":summary", "* [Skill]: [Animals]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Warcry", ":summary", "* [Skill]: [Intimidation]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Warding Sign", ":summary", "* [Power]: [Enchantment]\n* The opposite of [Malediction]. Warding Sign reduces the severity of negative effects.\n* [Requires]: Target cannot have any [Charm] Tokens.\n* [Action]: Roll vs. Spirit and add a Black [Charm] Token for each [Hit]."),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Water Walking", ":summary", "* [Continuous]: May move over water at Move:-1 penalty.\n* [Power]: [Hydromancy] or [Water]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Water Running", ":summary", "* [Continuous]: May move over water.\n* [Power]: [Hydromancy] or [Water]\n* Requires: [Water Walking]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Water Weapon", ":summary", "Create a water weapon\n* [Power]: [Hydromancy] or [Water]\n* [Action]: Form a weapon out of nearby water (like a water bottle)\n* [Continuous]: Maintain the weapon\n* [Action]: Dissolve the weapon into a nearby container"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Weapon:Close", ":summary", "* A Close Combat Weapon.\n* [Power]: [Weapon]\n* [Skill]: [Close Combat]\n* [Arc]: [Arc:Front]\n* [Range]: 0-1\n* [Damage]: [Body] + [Energy]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Weapon:Demolitions", ":summary", "* An Explosive Weapon.\n* [Power]: [Weapon]\n* [Skill]: [Demolitions]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Weapon:Firearm", ":summary", "* A Firearm.\n* [Power]: [Weapon]\n* [Skill]: [Firearm]\n* [Arc]: [Arc:Front]\n* [Range]: [Skill]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Weapon:Gunnery", ":summary", "A Gunnery Weapon including Cannons and Rockets.\n* [Power]: [Weapon]\n* [Skill]: [Gunnery]\n* [Range]: [Skill]\n* [Arc]: [Arc:Front]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Weapon:Melee", ":summary", "* A Melee Weapon.\n* [Power]: [Weapon]\n* [Skill]: [Melee]\n* [Arc]: [Arc:Front] and [Arc:Left] or [Arc:Right]\n* [Range]: 0 or 1\n* [Damage]: [Body] + [Energy]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Weapon:Ranged", ":summary", "* A Manually powered Ranged Weapon including Bows, Crossbows, Darts.\n* [Power]: [Weapon]\n* [Skill]: [Ranged]\n* [Arc]: [Arc:Front]\n* [Range]: [Body] + [Skill]\n* [Damage]: [Body] + Item [Body]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Wings", ":summary", "* [Power]: [Beastial]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Wingsuit Combat", ":summary", "* [Skill]: [Military]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Without a Trace", ":summary", "* Extremely difficult tor track you."),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Wolf Form", ":summary", "* [Power]: [Beastial]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Wolf Scent", ":summary", "* [Power]: [Beastial]"),
