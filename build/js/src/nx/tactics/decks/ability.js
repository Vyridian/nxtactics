...
export default class nx_tactics_decks_ability {
  ...
  static f_abilitymap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_abilitymap_from_abilitylist(
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Damage:Body", ":summary", "* Does [Damage] equal to [Body]\n* [Power]: [Weapon]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Damage:Body+1", ":summary", "* Does [Damage] equal to [Body]+1\n* [Power]: [Weapon]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Damage:Body+2", ":summary", "* Does [Damage] equal to [Body]+2\n* [Power]: [Weapon]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Damage:Body+3", ":summary", "* Does [Damage] equal to [Body]+3\n* [Power]: [Weapon]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Hide", ":summary", "* Find a hiding place in an area where you will not normally be detected.\n* [Skill]: [Stealth]\n* IF You have [Full Cover] AND you don't move AND Rivals are at least your [Body] spaces away.\n* THEN [Action] [Continuous]: You are hidden from view AND Rivals must succeed at [Investigate]/[Seek] to detect you."),
