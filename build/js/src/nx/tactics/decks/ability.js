...
export default class nx_tactics_decks_ability {
  ...
  static f_abilitymap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_abilitymap_from_abilitylist(
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "1-Handed", ":summary", "* Requires: 1 Hand\n* [Power]: [Weapon] or [Armor]\n* Usable only to [Arc:Front] and [Arc:Left] or [Arc:Right]"),
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "2-Handed", ":summary", "* Requires: 2 Hands\n* [Power]: [Weapon]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Ammo:6", ":summary", "6 Shots before reloading\n* [Power]: [Weapon]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Close Weapon", ":summary", "* A Close Combat Weapon.\n* [Power]: [Weapon]\n* [Skill]: [Close Combat]\n* [Arc]: [Arc:Front]\n* [Range]: 0-1\n* [Damage]: [Body] + [Energy]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Explosives", ":reference", "Catch! - Jinx, Runeterra", ":summary", "* Experienced using various small explosives in combat.\n* [Skill]: [Demolitions]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Firearm Weapon", ":summary", "* A Firearm.\n* [Power]: [Weapon]\n* [Skill]: [Firearm]\n* [Arc]: [Arc:Front]\n* [Range]: [Skill]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Faster than Light", ":titles", "FTL", ":summary", "* [Power]: [Move:Stellar]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Gunnery Weapon", ":summary", "A Gunnery Weapon including Cannons and Rockets.\n* [Power]: [Weapon]\n* [Skill]: [Gunnery]\n* [Range]: [Skill]\n* [Arc]: [Arc:Front]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Melee Weapon", ":summary", "* A Melee Weapon.\n* [Power]: [Weapon]\n* [Skill]: [Melee]\n* [Arc]: [Arc:Front] and [Arc:Left] or [Arc:Right]\n* [Range]: 0 or 1\n* [Damage]: [Body] + [Energy]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Mine Laying", ":summary", "* [Skill]: [Demolitions]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Ranged Weapon", ":summary", "* A Manually powered Ranged Weapon including Bows, Crossbows, Darts.\n* [Power]: [Weapon]\n* [Skill]: [Ranged]\n* [Arc]: [Arc:Front]\n* [Range]: [Body] + [Skill]\n* [Damage]: [Body] + Item [Body]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Resist:Fire", ":summary", "* [Damage]: [Armor]:+1 if attack produces [Fire]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Stare Down", ":summary", "* [Skill]: [Animals] vs. [Will]\n* Causes an animal to hesitate or back down."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Turret", ":summary", "* Turret mounted weapons may turn their turret toward any Arc and fire from the side the turret is facing.\n* Track the Turret facing. Unit may spend Turn:1 to change the turret facing by 1 side.\n* Armor - Turrets are considered an additional location and must be Armored separately."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Wall Crawling", ":summary", "* [Power]: [Move:Ground]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Wall Running", ":summary", "* [Power]: [Move:Ground]\n* Requires: [Wall Crawling]"),
