...
export default class nx_tactics_decks_ability {
  ...
  static f_abilitymap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_abilitymap_from_abilitylist(
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Shield Modulation", ":summary", "* [Skill]: [Shielding]\n* Alter the Shields to Resist a single [Damage Type] while becoming vulnerable to 2 others."),
