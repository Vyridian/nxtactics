...
export default class nx_tactics_decks_ability {
  ...
  static f_abilitymap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_abilitymap_from_abilitylist(
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Blacksmithing", ":titles", "Blacksmith", ":summary", "* [Skill]: [Tradeskills]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Carpentry", ":titles", "Carpenter", ":summary", "* [Skill]: [Tradeskills]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Charm of Virgo", ":summary", "* [Power]: [Astrology]\n* [Action]: Gain [Synergy] on unit's next communication skill. Duration 1 turn."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Honor Among Thieves", ":summary", "* [Skill]: [Deception]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Husbandry", ":summary", "* [Skill]: [Animal Handling]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Lightning Warp", ":summary", "* [Power]: [Electricity] or [Electro]\n* Near instantaneous travel in a flash of lightning.\n* Level determines distance travelled."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_ability}, ":name", "Livestock", ":summary", "* [Skill]: [Animal Handling]"),
