  ...
  static f_deck_reference(tactics) {
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new_from_type(vx_core.t_any_from_func, () => {
        const rulelist = nx_tactics_base.f_rulelist_from_tactics_keys(tactics, "Ability", "Ability Point", "Advantage", "Area Effect", "Beast", "Blast", "Bleeding", "Blood Loss", "Body", "Burning", "Character Point", "Choking", "Collision", "Collision: Angle", "Collision: Headon", "Damaged", "Disadvantage", "Diseased", "Drag", "Drop", "Dying", "Elevation", "Exposure", "Falling", "Flanking", "Held", "Hunger", "Immobilized", "Impaired", "Isolation", "Map: Car Chase", "Map: Dogfight", "Map: Exploration", "Map: Galactic", "Map: Global", "Map: Narrative", "Map: Naval", "Map: Orbital", "Map: Personal", "Map: Planetary", "Map: Regional", "Map: Road Trip", "Map: Starship", "Map: Stellar", "Mind", "Poisoned", "Power", "Pull/Push", "Shadow", "Skill", "Skill Point", "Specialty", "Speed", "Stat: 0", "Stat: Add", "Stat: Multiply", "Surprise", "Surrounded", "Task", "Thirst", "Unskilled", "Weapon: Barehanded", "Weapon: Improvised", "Weather", "Weather: Clouds", "Weather: Humidity", "Weather: Temperature", "Weather: Wind", "Will", "Withdraw")
