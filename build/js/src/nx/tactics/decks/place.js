...
export default class nx_tactics_decks_place {
  ...
  static f_placemap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_placemap_from_placelist(
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Snow", ":image", "images/cards/place-snow.svg", ":summary", "* Depth: Each token on Snow is 10cm/4in of snow. Move:-1/depth"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Street", ":image", "images/cards/place-street.svg"),
