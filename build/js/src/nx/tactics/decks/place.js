...
export default class nx_tactics_decks_place {
  ...
  static f_placemap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_placemap_from_placelist(
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Terrain:Dirt", ":image", "images/cards/place-terrain-dirt.svg", ":summary", "* A map for plain dirt. No terrain penalties."),
