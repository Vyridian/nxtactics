...
export default class nx_tactics_decks_place {
  ...
  static f_placemap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_placemap_from_placelist(
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Terrain:Dirt", ":image", "images/terrain/terrain-dirt.svg", ":summary", "A map for plain dirt. No terrain penalty"),
      vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Terrain:Forest", ":image", "images/terrain/terrain-forest.svg", ":summary", "A map for plain dirt. No terrain penalty\n* [Move]:-1\n* [Line of Sight]: Blocked\n* [Block]: [Skill]:+1, [Armor]:+1\n* [Evade]: [Skill]:+1"),
      vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Terrain:Grassland", ":image", "images/terrain/terrain-grassland.svg", ":summary", "A map for plain grass. No terrain penalty"),
      vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Terrain:Sea", ":image", "images/terrain/terrain-sea.svg", ":summary", "A map for open sea. No terrain penalty"),
      vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Terrain:Sky", ":image", "images/terrain/terrain-sky.svg", ":summary", "A map for open sky. No terrain penalty"),
      vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Terrain:Snowfield", ":image", "images/terrain/terrain-snowfield.svg", ":summary", "A map for snowfield. Move:-2"),
      vx_core.f_new({"any-1": nx_tactics_base.t_place}, ":name", "Terrain:Space", ":image", "images/terrain/terrain-space.svg", ":summary", "A map for open space. No terrain penalty."),
