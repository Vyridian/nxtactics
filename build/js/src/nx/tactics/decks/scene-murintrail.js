      ...
      nx_tactics_base.f_cardmap_from_cardlist(
        vx_core.f_new(
          ...
          vx_core.f_list_from_list(
            ...
            nx_tactics_base.f_unitlist_from_tactics_keys(tactics, "Flint (Early)", "Jes Aveer", "Jon Aveer", "Xeib Hanower", "Wilm Ducon", "Lili Ducon", "Goblin: Scout", "Bandit", "Bruiser", "Guardsman", "Dog: Wild", "Horse", "Cart: Wooden")
          ),
          vx_core.f_list_from_list(
            ...
            nx_tactics_base.f_cardimagelist_from_tactics_unitkeys(tactics, "Flint (Early)", "Jes Aveer", "Jon Aveer", "Xeib Hanower", "Wilm Ducon", "Lili Ducon", "Goblin: Scout", "Bandit", "Bruiser", "Guardsman", "Dog: Wild", "Horse", "Cart: Wooden")
          ),
          vx_core.f_list_from_list(
