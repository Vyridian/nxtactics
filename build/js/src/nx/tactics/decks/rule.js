...
export default class nx_tactics_decks_rule {
  ...
  static f_rulemap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_rulemap_from_rulelist(
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Overview", ":summary", "* Drawn to Destiny (D2D) is a free, print-and-play game intended for tactical mini board/war/role-playing gaming\n* I want to combine my favorite game mechanics into a crunchy AND rules-light tabletop game for any genre\n* Classless, Skill-based RPG with GM optional rules\n* Magic the Gathering and Arkham Horror TCG showed me how cards are the perfect platform for compact and modular rules\n* Car Wars, Tales from the Red Dragon Inn, and X-Wing minis showed me the importance of tactical movement and powers"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Scene: Units", ":summary", "Gather and layout your Unit cards\n* Unit - Unit stat and mini cards\n* Skills - Skill cards on the Unit\n* Abilities - Ability cards on the Unit\n* Specialties - Specialty cards on the Unit\n* Items - Item cards on the Unit. Arrange these like a paper doll to show what you are wearing or holding."),
      vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Setup: Decks", ":summary", "* Fate Deck - Shuffle an extra Conflict Deck to be the Fate Deck. You may use this instead of cards from your hand.\n* Damage Decks - Shuffle the Wound, Disorder, Trauma, and Restraint decks.\n* Resource Deck - Keep this deck sorted for easy access.\n* Clock Deck - Set out the Clock Deck (sorted numerically). It is the game clock."),
      vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Setup: Overview", ":summary", "Setup is common to every game:\n* Players - Everyone gets a colored Player Deck\n* Decks - Damage decks are placed for easy access\n* Tokens - Some abilities require tokens"),
      vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Setup: Players", ":summary", "All Players have the same setup:\n* Player Deck - Take a Colored Player Deck.\n* Conflict Deck - Take a Conflict Deck for Skill Checks, shuffle it, and draw 5 cards.\n* Character Deck - Players may have a deck of their character cards.\n* Narrator - Some Players may be Game Masters."),
