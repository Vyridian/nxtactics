...
export default class nx_tactics_decks_rule {
  ...
  static f_rulemap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_rulemap_from_rulelist(
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Hits: Rank", ":summary", "Hits:+1 for each card (including Combo):\n* IF A-J\nOR\n* Rank + Level Bonus > Difficulty"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Scene: Status Bar", ":summary", "The Status Bar is an area near the board where all Units are displayed\n* Place each Unit card on the Status Bar with a Unit# card above it."),
