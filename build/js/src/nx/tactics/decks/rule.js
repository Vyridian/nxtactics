...
export default class nx_tactics_decks_rule {
  ...
  static f_rulemap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_rulemap_from_rulelist(
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Disadvantage", ":summary", "* Your [Normal] [Block] cards Fail against [Fast]."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Hit Location", ":image", "images/rule-hitlocation.svg"),
      vx_core.f_new({"any-1": nx_tactics_base.t_rule}, ":name", "Hit Location: Vehicle", ":image", "images/rule-hitlocation-vehicle.svg"),
