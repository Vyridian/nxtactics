...
export default class nx_tactics_decks_item {
  ...
  static f_itemmap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_itemmap_from_itemlist(
      vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Accesory: Monocle", ":image", "images/cards/item-accessory-monocle.svg", ":summary", "* [Passive]: IF examining small objects THEN [Investigation]:+1", ":body", "2x-2", ":mass", "20g/.05lb"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Axe: Wood", ":titles", "Splitting Maul", ":image", "images/cards/item-axe-wood.svg", ":summary", "* [Fight]: [Melee]:-1\n* [Damage]: [Body]:+3 [Hack] [Slash]\n* [Location]: [2-hand]\n* [Armor]: 1x1", ":body", "3x0", ":mass", "3.1kg/7lb"),
      vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Bare Handed", ":image", "images/cards/item-barehanded.svg", ":summary", "* [Fight]: [Close Combat] or [Melee]\n* [Arc]: [Arc:Front]\n* [Damage]: [Body] [Bash]"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Flint Stone"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Pond Water", ":summary", "* IF drank [Reveal Fate] THEN IF [Cups] THEN [Diseased]:+1"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Raspberries", ":classification", "Plant", ":image", "images/cards/item-raspberries.svg", ":summary", "* Nutrition for a day. [Reveal Fate]. IF [Coins] THEN they are sour. IF [Cups] THEN they are sweet."),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Shield: Round", ":image", "images/cards/item-shield-round.svg", ":titles", "Hoplon Round Shield, Target Shield", ":classification", "Shield", ":summary", "* [Armor]: 2x1 [Hardened vs Pierce]\n* [Arc]: [Arc:Front], [Arc:Left] OR [Arc:Right]\n* [Location]: [1-hand]", ":armor", "2", ":body", "5x0", ":mass", "5kg/11lb"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Torch"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Wild Onions", ":classification", "Plant", ":image", "images/cards/item-wildonions.svg", ":summary", "* Nutrition for a day."),
      vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Wild Yams", ":classification", "Plant", ":image", "images/cards/item-wildyams.svg", ":summary", "* Nutrition for a day.")
    )
    return output
  }
