...
export default class nx_tactics_decks_item {
  ...
  static f_itemmap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_itemmap_from_itemlist(
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Armor:Laminated", ":armor", "1mm"),
      vx_core.f_new(
        ...
        "Leather Body Armor",
        ":image",
        "images/cards/item-armor-leather-cuirass.svg",
        ":body",
        "7x0",
        ":mass",
        "7kg/15lb",
        ...
        nx_tactics_base.f_unitpowermap_from_unitpowerlist(
          nx_tactics_base.f_unitpower_from_tactics_key_rating_abilities(
            ...
            "Armor",
            "2x1",
            vx_core.f_new({"any-1": vx_core.t_stringlist}, "Armor:Shoulders", "Armor:Chest", "Armor:Abdomen", "Armor:Vitals", "Resist:Slash")
          )
        )
      ),
      vx_core.f_new(
        ...
        ":image",
        "images/cards/item-armor-leather-helmet.svg",
        ":body",
        "2x0",
        ":mass",
        "2kg/5lb",
        ...
        nx_tactics_base.f_unitpowermap_from_unitpowerlist(
          nx_tactics_base.f_unitpower_from_tactics_key_rating_abilities(
            ...
            "Armor",
            "2x1",
            vx_core.f_new({"any-1": vx_core.t_stringlist}, "Armor:Head", "Resist:Slash")
          )
        )
      ),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Bow:Moon", ":titles", "Cresent Bow", ":summary", "An Alfar made bow designed like a cresent moon. Arrows fired from it are treated as [Silver]."),
      vx_core.f_new(
        {"any-1": nx_tactics_base.t_item},
        ":name",
        "Bow:Short",
      ...
      vx_core.f_new(
        ...
        "Knife:Dagger",
        ":image",
        "images/cards/item-knife-dagger.svg",
        ":body",
        "5x-1",
        ":mass",
        "500g/1lb",
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Knife:Moonblade", ":titles", "Cresent Blade, Faeknife", ":summary", "An Alfar made curved knife designed like a cresent moon. It are treated as [Silver]."),
      ...
      vx_core.f_new(
        ...
        "Pistol:.45 Colt 1873",
        ":image",
        "images/cards/item-pistol-45-colt-1873.svg",
        ":titles",
        "Peacemaker",
        ":reference",
      ...
      vx_core.f_new(
        ...
        "Pistol:.45 S&W 1869",
        ":image",
        "images/cards/item-pistol-45-sw-1869.svg",
        ":titles",
        "Schofield",
        ":reference",
      ...
      vx_core.f_new(
        ...
        "Shield:Round",
        ":image",
        "images/cards/item-shield-round.svg",
        ":titles",
        "Hoplon Shield, Target Shield",
        ":classification",
        "Shield",
        ":body",
        "5x0",
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Sword:Moon", ":titles", "Cresent Sword, Faeblade", ":summary", "An Alfar made sword/scimitar designed like a cresent moon. It is treated as [Silver]."),
