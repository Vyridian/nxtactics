...
export default class nx_tactics_decks_item {
  ...
  static f_itemmap_tactics(tactics) {
    ...
    output = nx_tactics_base.f_itemmap_from_itemlist(
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Axe: Wood", ":titles", "Splitting Maul", ":image", "images/cards/item-axe-wood.svg", ":summary", "* [Combat]: [Melee]-1\n* [Damage]: [Body]+3 [Hack] [Slash]\n* [Location]: [2-hand]\n* [Armor]: 1x1", ":body", "3x0", ":mass", "3.1kg/7lb"),
      ...
      vx_core.f_new({"any-1": nx_tactics_base.t_item}, ":name", "Shield: Buckler", ":classification", "Shield", ":image", "images/cards/item-shieldbuckler.svg", ":summary", "* [Armor]: 1x1\n* [Arc]: [Arc:Front]\n* [Location]: [1-hand]", ":armor", "1", ":body", "10x-1", ":mass", "1kg/2lb"),
