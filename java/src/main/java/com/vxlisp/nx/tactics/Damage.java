      ...
      for (Object valsub : vals) {
        if (valsub instanceof Core.Type_msgblock) {
          ...
          if (valsub instanceof Core.Type_string) {
            ...
            msg = Core.vx_msg_from_error("nx/tactics/damage/wound", ":invalidkeytype", msgval);
          ...
          if (istestkey) {
            ...
            if (isvalidkey) {
              ...
              msg = Core.vx_msg_from_error("nx/tactics/damage/wound", ":invalidkey", msgval);
              msgblock = msgblock.vx_copy(msg);
            }
          }
        } else {
          ...
          case ":name":
            if (valsub == vx_p_name) {
              ...
              msg = Core.vx_msg_from_error("nx/tactics/damage/wound", ":invalidvalue", msgmap);
              msgblock = msgblock.vx_copy(msg);
            }
            break;
          case ":image":
