...
public final class Superheroes {
   ...
   */
  public static interface Func_chapter_dc_universe extends Core.Type_func, Core.Type_replfunc {
    public Base.Type_chapter vx_chapter_dc_universe();
  }

  public static class Class_chapter_dc_universe extends Core.Class_base implements Func_chapter_dc_universe {

    @Override
    public Func_chapter_dc_universe vx_new(Object... vals) {
      Class_chapter_dc_universe output = new Class_chapter_dc_universe();
      return output;
    }

    @Override
    public Func_chapter_dc_universe vx_copy(Object... vals) {
      Class_chapter_dc_universe output = new Class_chapter_dc_universe();
      return output;
    }
    ...
    @Override
    public Func_chapter_dc_universe vx_empty() {return e_chapter_dc_universe;}
    @Override
    public Func_chapter_dc_universe vx_type() {return t_chapter_dc_universe;}

    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      output = Superheroes.f_chapter_dc_universe();
      return output;
    }

    @Override
    public Base.Type_chapter vx_chapter_dc_universe() {
      return Superheroes.f_chapter_dc_universe();
    }

  }

  public static final Func_chapter_dc_universe e_chapter_dc_universe = new Superheroes.Class_chapter_dc_universe();
  public static final Func_chapter_dc_universe t_chapter_dc_universe = new Superheroes.Class_chapter_dc_universe();

  public static Base.Type_chapter f_chapter_dc_universe() {
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Superheroes/Batman.png"),
                    ...
                    Core.vx_new_string("Green Lantern"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Green Lantern"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/GreenLantern.png")
                      )
                    ),
                    Core.vx_new_string("Martian Manhunter"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Martian Manhunter"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/MartianManhunter.png")
                      )
                    ),
                    Core.vx_new_string(":Supergirl"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Supergirl"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Supergirl.png")
                      )
                    ),
                    Core.vx_new_string(":Superman"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                          ...
                          Core.t_anylist.vx_new(
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Strength"),
                                Core.vx_new_string(":strength"),
                                Core.vx_new_string("66x10^18tons")
                              )
                            )
                          )
                        )
                    ...
                    Core.vx_new_string("Wonder Woman"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Wonder Woman"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/WonderWoman.png")
                      )
                    )
                  )
                )
   ...
   */
  public static interface Func_chapter_dragonball_z extends Core.Type_func, Core.Type_replfunc {
    public Base.Type_chapter vx_chapter_dragonball_z();
  }

  public static class Class_chapter_dragonball_z extends Core.Class_base implements Func_chapter_dragonball_z {

    @Override
    public Func_chapter_dragonball_z vx_new(Object... vals) {
      Class_chapter_dragonball_z output = new Class_chapter_dragonball_z();
      return output;
    }

    @Override
    public Func_chapter_dragonball_z vx_copy(Object... vals) {
      Class_chapter_dragonball_z output = new Class_chapter_dragonball_z();
      return output;
    }
    ...
    @Override
    public Func_chapter_dragonball_z vx_empty() {return e_chapter_dragonball_z;}
    @Override
    public Func_chapter_dragonball_z vx_type() {return t_chapter_dragonball_z;}

    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      output = Superheroes.f_chapter_dragonball_z();
      return output;
    }

    @Override
    public Base.Type_chapter vx_chapter_dragonball_z() {
      return Superheroes.f_chapter_dragonball_z();
    }

  }

  public static final Func_chapter_dragonball_z e_chapter_dragonball_z = new Superheroes.Class_chapter_dragonball_z();
  public static final Func_chapter_dragonball_z t_chapter_dragonball_z = new Superheroes.Class_chapter_dragonball_z();

  public static Base.Type_chapter f_chapter_dragonball_z() {
    Base.Type_chapter output = Base.e_chapter;
    output = Core.f_new(
      Base.t_chapter,
      Core.t_anylist.vx_new(
        ...
        Core.f_new(
          Base.t_sectionmap,
          Core.t_anylist.vx_new(
            Core.vx_new_string("Dragonball Equipment"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                ...
                Core.f_new(
                  Base.t_itemmap,
                  Core.t_anylist.vx_new(
                    Core.vx_new_string("Battle Armor"),
                    Core.f_new(
                      Base.t_item,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Dragon Radar"),
                    Core.f_new(
                      Base.t_item,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Flying Nimbus"),
                    Core.f_new(
                      Base.t_item,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Regeneration Chamber"),
                    Core.f_new(
                      Base.t_item,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Scouter"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* +2 [Sense Power Levels] (Max 4) even if one does not have this ability.")
                      )
                    ),
                    Core.vx_new_string("Senzu Bean"),
                    Core.f_new(
                      Base.t_item,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
            ...
            Core.vx_new_string("Dragonball Rules"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                ...
                Core.f_new(
                  Base.t_powermap,
                  Core.t_anylist.vx_new(
                    Core.vx_new_string("Zenkai Attacks"),
                    Core.f_new(
                      Base.t_power,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        ...
                        Core.vx_new_string("Final Power"),
                        Core.vx_new_string(":abilitymap"),
                        Core.f_new(
                          Base.t_abilitymap,
                          Core.t_anylist.vx_new(
                            Core.vx_new_string("Destructive Wave"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                Core.vx_new_string("Destructive Wave"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Requires: [Explosive Wave]\n* Take [Damage] tokens and raise damage dice by the number of [Damage] taken.")
                              )
                            ),
                            Core.vx_new_string("Destructo Disk"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                Core.vx_new_string("Destructo Disk"),
                                Core.vx_new_string(":image"),
                                Core.vx_new_string("Units/Superheroes/DestructoDisk.jpg")
                              )
                            ),
                            Core.vx_new_string("Energy Barrage"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Explosive Wave"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Final Flash"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                Core.vx_new_string("Final Flash"),
                                Core.vx_new_string(":image"),
                                Core.vx_new_string("Units/Superheroes/FinalFlash.jpg")
                              )
                            ),
                            Core.vx_new_string("Homing Disk"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Homing Spirit Ball"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Neo Tri-Beam"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                Core.vx_new_string("Neo Tri-Beam"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* [Attack]: [+2 Damage], but each use does [+1 Damage Token] to the user.")
                              )
                            ),
                            Core.vx_new_string("Kamehameha Wave"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                Core.vx_new_string("Kamehameha Wave"),
                                Core.vx_new_string(":image"),
                                Core.vx_new_string("Units/Superheroes/Kamehameha.jpg")
                              )
                            ),
                            Core.vx_new_string("Spirit Bomb"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Zenkai Defense"),
                    Core.f_new(
                      Base.t_power,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        ...
                        Core.f_new(
                          Base.t_abilitymap,
                          Core.t_anylist.vx_new(
                            Core.vx_new_string("Energy Block"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Energy Duel"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Energy Defense"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Energy Redirect"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Energy Shield"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Kiai"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("By screaming very loud you disperse several weaker Ki attacks.")
                              )
                            )
                          )
                        )
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.f_new(
                          Base.t_abilitymap,
                          Core.t_anylist.vx_new(
                            Core.vx_new_string("Blinding Speed"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Compare Power Levels"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                Core.vx_new_string("Compare Power Levels"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* By studying a target, one may identify which of 2 subjects has a greater Spirit")
                              )
                            ),
                            Core.vx_new_string("Energy Transfer"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                Core.vx_new_string("Energy Transfer"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Unit may offer any amount of Spirit to another unit who adds it to their own total up to their maximum.")
                              )
                            ),
                            Core.vx_new_string("Fusion Dance"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                Core.vx_new_string("Fusion Dance"),
                                Core.vx_new_string(":image"),
                                Core.vx_new_string("Units/Superheroes/Fusion.jpg"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* 2 units with Fusion may merge into 1 being with both sets of skills with each skill at 3 greater than the\nlower of the 3 levels or the higher skill whichever is higher.\n* [Prepare] +1")
                              )
                            ),
                            Core.vx_new_string("Gravity Training 10x"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                Core.vx_new_string("Gravity Training 10x"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Gravity Training 10x increases combat skills to level 17.\n* All those who train with King Kai must learn this ability.")
                              )
                            ),
                            Core.vx_new_string("Gravity Training 100x"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                Core.vx_new_string("Gravity Training 100x"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Gravity Training 100x increases combat skills to level 22.")
                              )
                            ),
                            Core.vx_new_string("Hide Power Level"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                Core.vx_new_string("Hide Power Level"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Reduce effectiveness of [Sense Power Levels] and [Compare Power Levels]")
                              )
                            ),
                            Core.vx_new_string("Inspirational Moment"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                Core.vx_new_string("Inspirational Moment"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* When confronted with tragedy or extreme motivation, Saiyans may regain nearly all of their Spirit.")
                              )
                            ),
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Kaio-Ken"),
                                Core.vx_new_string(":image"),
                                Core.vx_new_string("Units/Superheroes/Kaioken.jpg"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Kaio-Ken x2 increases combat skills to level 18.\n* Kaio-Ken gives a boost to Power and Speed for a short period of time.  However, it puts great strain on\nthe stamina and body.\n* This is stronger than Nappa (Goku vs. Nappa)"),
                                Core.vx_new_string(":titles"),
                                Core.vx_new_string("Fist of the Worlds")
                              )
                            ),
                            Core.vx_new_string("Kaio-Ken x2"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                ...
                                Core.vx_new_string("Units/Superheroes/Kaioken.jpg"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Kaio-Ken x2 increases combat skills to level 19.")
                              )
                            ),
                            Core.vx_new_string("Kaio-Ken x3"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                ...
                                Core.vx_new_string("Units/Superheroes/Kaioken.jpg"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Kaio-Ken x3 increases combat skills to level 20.")
                              )
                            ),
                            Core.vx_new_string("Kaio-Ken x4"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Units/Superheroes/Kaioken.jpg"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Kaio-Ken x10 increases combat skills to level 23.\n* This is equal to Frieza at 50% of maximum.")
                              )
                            ),
                            Core.vx_new_string("Kaio-Ken x20"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                ...
                                Core.vx_new_string("Units/Superheroes/Kaioken.jpg"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Kaio-Ken x20 increases combat skills to level 24.\n* This is still not as strong as Frieza Fourth Form (Goku vs. Frieza).")
                              )
                            ),
                            Core.vx_new_string("Ki Flight"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Multi-Form"),
                                Core.vx_new_string(":image"),
                                Core.vx_new_string("Units/Superheroes/MultiForm.jpg")
                              )
                            ),
                            Core.vx_new_string("Sense Power Levels"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                Core.vx_new_string("Sense Power Levels"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Detect strong Spirits.  The stronger the Spirit the greater the distance of detection.\n* May be used to target others even when they cannot be seen.")
                              )
                            ),
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Solar Flare"),
                                Core.vx_new_string(":image"),
                                Core.vx_new_string("Units/Superheroes/SolarFlare.jpg"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* [Roll vs. Mind] - A blinding area attack that does not damage but prevents all units in range from taking\nany action for 1 turn for each Hit.")
                              )
                            ),
                            Core.vx_new_string("Unlock Potential"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                Core.vx_new_string("Unlock Potential"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Unlock Potential increases combat skills to level 20.\n* This is equal to some of the Ginyu Force (Krillin vs. Guildo)")
                              )
                            )
                          )
                        )
                          ...
                          Core.t_anylist.vx_new(
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Imperfect Cell"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Combat related skills raise to level 28\n* Equal to Android Models 16-18 (Imperfect Cell vs. 17)")
                              )
                            ),
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Second Form Cell"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Combat related skills raise to level 29\n* Can destroy Android Models 16-18 (Second Form Cell vs. 17)")
                              )
                            ),
                          ...
                          Core.t_anylist.vx_new(
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Death Ball"),
                                Core.vx_new_string(":image"),
                                Core.vx_new_string("Superheroes/Deathball.jpg")
                              )
                            ),
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Frieza First Form"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Combat related skills raise to level 22")
                              )
                            ),
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Frieza Third Form"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Combat related skills raise to level 24.")
                              )
                            ),
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Frieza Fourth Form"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Combat related skills raise to level 25.\n* Mind Over Matter can lift 10Mtons (small mountain)")
                              )
                            ),
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Cooler Fifth Form"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Combat related skills raise to level 26.")
                              )
                            )
                          )
                        )
                    ...
                    Core.vx_new_string("Gero Android"),
                    Core.f_new(
                      Base.t_power,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                          ...
                          Core.t_anylist.vx_new(
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Fat Buu Form"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Combat related skills raise to level 33.\n* Can destroy Super Saiyan 2 (Majin Vegeta Super Saiyan 2 vs. Fat Buu)")
                              )
                            ),
                            Core.vx_new_string("Super Buu Form"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Kid Buu Form"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Combat related skills raise to level 35.")
                              )
                            )
                          )
                        )
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.f_new(
                          ...
                          Core.t_anylist.vx_new(
                            ...
                            Core.vx_new_string("Instant Regeneration"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Merge with Nail"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Merge with Namekian"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Special Beam Cannon"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Super Namek"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                ...
                                Core.vx_new_string(":titles"),
                                Core.vx_new_string("Merge with Kami")
                              )
                            )
                          )
                        )
                    ...
                    Core.vx_new_string("Red Ribbon Android"),
                    Core.f_new(
                      Base.t_power,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        ...
                        Core.f_new(
                          Base.t_abilitymap,
                          Core.t_anylist.vx_new(
                            Core.vx_new_string("Models 16-18"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Android Absorption"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Android Energy Absorption"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string(":Inexhaustible"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                Core.vx_new_string("Inexhaustible"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* [Activate]: Remove all [Stun Tokens].")
                              )
                            )
                          )
                        )
                          ...
                          Core.t_anylist.vx_new(
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string(":titles"),
                                Core.vx_new_string("Oozaru")
                              )
                            ),
                            Core.vx_new_string("Super Saiyan"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                Core.vx_new_string("Super Saiyan"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Combat related skills raise to level 27.\n* Can destroy Cooler Fifth Form and can easily destroy Frieza Fourth Form (Trunks vs. Freiza)")
                              )
                            ),
                            Core.vx_new_string("Ascended Super Saiyan"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                Core.vx_new_string("Ascended Super Saiyan"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Combat related skills raise to level 30.\n* Can destroy Second Form Cell (Super Vegeta vs Second Form Cell)")
                              )
                            ),
                            Core.vx_new_string("Ultra Super Saiyan"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                                Core.vx_new_string("Ultra Super Saiyan"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Combat related skills raise to level 31, but all attack and speed at -1.\n* Equal to Perfect Cell in power but slower (Super Saiyan 2 Trunks vs. Perfect Cell)")
                              )
                            ),
                            Core.vx_new_string("Super Saiyan 2"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Ultimate Saiyan"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Super Saiyan 3"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Golden Great Ape"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Super Saiyan 4"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.vx_new_string("Super Saiyan God"),
                            Core.f_new(
                              Base.t_ability,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Zenkai"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Zenkai is an ability that is genetically exclusive to Saiyans.  The ability allows a Saiyan's power to\nincrease substantially after recovering from near fatal injuries.")
                              )
                            )
                          )
                        )
            ...
            Core.vx_new_string("Dragon Ball Heroes"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Android 18"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Android18.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Gohan (Kid)"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Gohan.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.vx_new_string("Gohan (Great Saiyaman)"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Gohan (Great Saiyaman)"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/GreatSaiyaman.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Goku"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Goku.png"),
                        Core.vx_new_string(":titles"),
                        Core.vx_new_string("Kakarot"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Gogeta"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Gogeta.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Goten"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Goten.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Gotenks"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Gotenks.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Kid Trunks"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/KidTrunks.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Krillin"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Krillin.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Piccolo"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Piccolo.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Shenron"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Shenron.png")
                      )
                    ),
                    Core.vx_new_string("Tien Shinhan"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Trunks"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Trunks.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
   ...
   */
  public static interface Func_chapter_marvel_universe extends Core.Type_func, Core.Type_replfunc {
    public Base.Type_chapter vx_chapter_marvel_universe();
  }

  public static class Class_chapter_marvel_universe extends Core.Class_base implements Func_chapter_marvel_universe {

    @Override
    public Func_chapter_marvel_universe vx_new(Object... vals) {
      Class_chapter_marvel_universe output = new Class_chapter_marvel_universe();
      return output;
    }

    @Override
    public Func_chapter_marvel_universe vx_copy(Object... vals) {
      Class_chapter_marvel_universe output = new Class_chapter_marvel_universe();
      return output;
    }
    ...
    @Override
    public Func_chapter_marvel_universe vx_empty() {return e_chapter_marvel_universe;}
    @Override
    public Func_chapter_marvel_universe vx_type() {return t_chapter_marvel_universe;}

    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      output = Superheroes.f_chapter_marvel_universe();
      return output;
    }

    @Override
    public Base.Type_chapter vx_chapter_marvel_universe() {
      return Superheroes.f_chapter_marvel_universe();
    }

  }

  public static final Func_chapter_marvel_universe e_chapter_marvel_universe = new Superheroes.Class_chapter_marvel_universe();
  public static final Func_chapter_marvel_universe t_chapter_marvel_universe = new Superheroes.Class_chapter_marvel_universe();

  public static Base.Type_chapter f_chapter_marvel_universe() {
    Base.Type_chapter output = Base.e_chapter;
    output = Core.f_new(
      Base.t_chapter,
      Core.t_anylist.vx_new(
        ...
        Core.f_new(
          Base.t_sectionmap,
          Core.t_anylist.vx_new(
            Core.vx_new_string("Marvel Aliens"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                ...
                Core.f_new(
                  Base.t_unitmap,
                  Core.t_anylist.vx_new(
                    Core.vx_new_string("Adam Warlock"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Adam Warlock"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/AdamWarlock.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Annihilus"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Annihilus.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.vx_new_string("Captain Marvel I"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Captain Marvel I"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/CaptainMarvel.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Celestial"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Celestial.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Firefall"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Firefall.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.vx_new_string("Gabriel the Airwalker"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Gabriel the Airwalker"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Gabriel.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Galactus"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Galactus.png"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Appearance - Although Galactus is usually represented in humanoid form, each sentient being perceives him having a form resembling his own. Hence, humanoids see Galactus in humanoid form, while a Skrull, for example, would perceive Galactus as resembling a Skrull. Although as Galan, Galactus was indeed a humanoid; his true current form is unknown. It is unclear why beings from different sentient races perceive him differently."),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Hybrid"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Hybrid.png")
                      )
                    ),
                    Core.vx_new_string(":Nova"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Nova"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Nova.png")
                      )
                    ),
                    Core.vx_new_string(":Rom"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Silver Surfer"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Silver Surfer"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/SilverSurfer.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Terrax"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Terrax.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Thanos"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Thanos.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Amora"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Enchantress.png"),
                        Core.vx_new_string(":titles"),
                        Core.vx_new_string("Enchantress, Freyja"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.vx_new_string("Beta Ray Bill"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Beta Ray Bill"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/BetaRayBill.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.vx_new_string("Destroyer, The"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Destroyer, The"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Destroyer.png")
                      )
                    ),
                    Core.vx_new_string(":Loki"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Odin"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Odin.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Surtur"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Surtur.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Thor"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Thor.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Valkyrie"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Valkyrie.png"),
                        Core.vx_new_string(":titles"),
                        Core.vx_new_string("Brunnhilde"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
            ...
            Core.vx_new_string("Marvel Avengers"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                ...
                Core.f_new(
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.vx_new_string("Black Widow"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Captain America"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/CaptainAmerica.png"),
                        Core.vx_new_string(":reference"),
                        Core.vx_new_string("* When I see a situation pointed south, I can't ignore it. Sometimes I wish I could.\n* No you don't.\n* No, I don't - Steve Rogers and Tony Stark, Captain America: Civil War")
                      )
                    ),
                    Core.vx_new_string("Captain Marvel (III)"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Captain Marvel (III)"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/MsMarvel.png"),
                        Core.vx_new_string(":reference"),
                        Core.vx_new_string("* My name is Ms. Marvel. I'm here to welcome you to Earth...Now go home!"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("She has the ability to attack her enemies with high-energy photon blasts equal to those of Iron Man"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Armor"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("She is able to withstand bullets from pistols and machine gun fire, and can also absorb mortar shells and energy blasts, though extremely high-energy attacks may overload her absorbing ability")
                              )
                            )
                          )
                        )
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Iron Man"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/IronMan.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.vx_new_string("Kang the Conqueror"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Kang the Conqueror"),
                        Core.vx_new_string(":reference"),
                        Core.vx_new_string("* Story is not written, scholar and neither is destiny! History is made! Made\nby the deeds of the strong! The brave! And destiny is forged! The historians,\nthe students, the gray-beards they come in the wake of the strong and write\ndown what the brave have done! But it is the conquerors who change the world!\n- Kang"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Damocles - Immense, time-travelling starship that serves as Kang's mobile\nheadquarters."),
                        Core.vx_new_string(":titles"),
                        Core.vx_new_string("Nathaniel Richards")
                      )
                    ),
                    Core.vx_new_string("Mandarin, The"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Mandarin, The"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Mandarin.png"),
                        Core.vx_new_string(":unitskillmap"),
                        Core.f_new(
                          Base.t_unitskillmap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.vx_new_string("Red Skull, The"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Wasp, The"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Wasp.png")
                      )
                    )
                  )
                )
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Dormammu"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Dormammu.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.vx_new_string("Doctor Strange"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Doctor Strange"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/DrStrange.png")
                      )
                    ),
                    Core.vx_new_string("Hulk, The"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Hulk, The"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Hulk.png"),
                        Core.vx_new_string(":reference"),
                        Core.vx_new_string("* Dr. Banner, your work is unparalleled. And I'm a huge fan of the way you lose control and turn into an enormous green rage monster. Thanks.\n- Tony Stark and Bruce Banner, The Avengers\n* Doctor Banner, I think now might be a good time for you to get angry. That's my secret, Cap: I'm always angry. - Captain America and Bruce\nBanner, The Avengers"),
                        Core.vx_new_string(":titles"),
                        Core.vx_new_string("Bruce Banner"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.vx_new_string("Morgan Le Fey"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Prince Namor"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Prince Namor"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Namor.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
            ...
            Core.vx_new_string("Fantastic Four"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Dr. Doom"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/DrDoom.png"),
                        Core.vx_new_string(":reference"),
                        Core.vx_new_string("* I love my people. I do, but they are MY people. I keep them safe from harm. I give them a better life, and at night, before they sleep, to whatever god they pray, they give thanks for me. - Doom"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.vx_new_string("Human Torch"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Human Torch"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/HumanTorch.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.vx_new_string("Invisible Woman"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Invisible Woman"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/InvisibleWoman.png")
                      )
                    ),
                    Core.vx_new_string("Mr. Fantastic"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("She-Hulk"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/SheHulk.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.vx_new_string("Super Skrull, The"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Super Skrull, The"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/SuperSkrull.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Thing, The"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Thing.png"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* The Thing's body is able to withstand extremes of temperature from -75 to 800 Fahrenheit for up to an hour before exposure or heat prostration occurs. He can withstand the explosive effects of armor-piercing bazooka shells (15 pounds of high explosives) against his skin with no injury. He is still susceptible to colds, disease, and emotional stress."),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
            ...
            Core.vx_new_string("Marvel Independents"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Bullseye"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Bullseye.png"),
                        Core.vx_new_string(":reference"),
                        Core.vx_new_string("You're good, baby, I'll give you that. But me? I'm magic. - Bullseye")
                      )
                    ),
                    Core.vx_new_string(":Daredevil"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Daredevil"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Daredevil.png")
                      )
                    ),
                    Core.vx_new_string(":Elektra"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Elektra"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Elektra.png")
                      )
                    ),
                    Core.vx_new_string("Moon Knight"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Moon Knight"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/MoonKnight.png")
                      )
                    ),
                    Core.vx_new_string(":Punisher"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Punisher"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Punisher.png"),
                        Core.vx_new_string(":reference"),
                        Core.vx_new_string("P..P...P...Punisher!")
                      )
                    )
                  )
                )
            ...
            Core.vx_new_string("Marvel Micronauts"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Acroyear"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Acroyear.png")
                      )
                    ),
                    Core.vx_new_string("Baron Karza"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Baron Karza"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/BaronKarza.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.vx_new_string("Bug, Micronaut"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Bug, Micronaut"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Bug.png")
                      )
                    ),
                    Core.vx_new_string("Commander Rann"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Commander Rann"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/CommanderRann.png")
                      )
                    ),
                    Core.vx_new_string("Dog Soldier"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Dog Soldier"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/DogSoldier.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Marionette"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Marionette.png")
                      )
                    ),
                    Core.vx_new_string(":Shaitan"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Shaitan"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Shaitan.png")
                      )
                    ),
                    Core.vx_new_string("Time Traveller"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Time Traveller"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/TimeTraveller.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
            ...
            Core.vx_new_string("Marvel Sword and Shield"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                ...
                Core.f_new(
                  Base.t_unitmap,
                  Core.t_anylist.vx_new(
                    Core.vx_new_string("Abigail Brand"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
            ...
            Core.vx_new_string("Marvel Spiderman"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                ...
                Core.f_new(
                  Base.t_unitmap,
                  Core.t_anylist.vx_new(
                    Core.vx_new_string("Black Cat, The"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Black Cat, The"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/BlackCat.png")
                      )
                    ),
                    Core.vx_new_string("Dr. Octopus"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Dr. Octopus"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/DrOctopus.png")
                      )
                    ),
                    Core.vx_new_string("Green Goblin"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Green Goblin"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/GreenGoblin.png")
                      )
                    ),
                    Core.vx_new_string(":Kingpin"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Kingpin"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Kingpin.png"),
                        Core.vx_new_string(":unitskillmap"),
                        Core.f_new(
                          Base.t_unitskillmap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Lizard, The"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Lizard.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Spiderman"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Spiderman.png"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Venom"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Venom.png")
                      )
                    )
                  )
                )
   ...
   */
  public static interface Func_chapter_original_groups extends Core.Type_func, Core.Type_replfunc {
    public Base.Type_chapter vx_chapter_original_groups();
  }

  public static class Class_chapter_original_groups extends Core.Class_base implements Func_chapter_original_groups {

    @Override
    public Func_chapter_original_groups vx_new(Object... vals) {
      Class_chapter_original_groups output = new Class_chapter_original_groups();
      return output;
    }

    @Override
    public Func_chapter_original_groups vx_copy(Object... vals) {
      Class_chapter_original_groups output = new Class_chapter_original_groups();
      return output;
    }
    ...
    @Override
    public Func_chapter_original_groups vx_empty() {return e_chapter_original_groups;}
    @Override
    public Func_chapter_original_groups vx_type() {return t_chapter_original_groups;}

    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      output = Superheroes.f_chapter_original_groups();
      return output;
    }

    @Override
    public Base.Type_chapter vx_chapter_original_groups() {
      return Superheroes.f_chapter_original_groups();
    }

  }

  public static final Func_chapter_original_groups e_chapter_original_groups = new Superheroes.Class_chapter_original_groups();
  public static final Func_chapter_original_groups t_chapter_original_groups = new Superheroes.Class_chapter_original_groups();

  public static Base.Type_chapter f_chapter_original_groups() {
    Base.Type_chapter output = Base.e_chapter;
    output = Core.f_new(
      Base.t_chapter,
      Core.t_anylist.vx_new(
        ...
        Core.f_new(
          Base.t_sectionmap,
          Core.t_anylist.vx_new(
            Core.vx_new_string("Miscellaneous Groups"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
            ...
            Core.vx_new_string("Deadly Sins"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Envy"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Envy.png")
                      )
                    ),
                    Core.vx_new_string(":Gluttony"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Gluttony"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Gluttony.png")
                      )
                    ),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Greed"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Greed.png"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Greed is more subtle than most of the Sins. He is a clever asian businessman who uses his power to amass wealth.")
                      )
                    ),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Lust"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Lust.png"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* A gorgeous, curvy, hispanic woman. She drips of sweat, seductiveness, and passion. Lust craves passion constantly and inspires the same in others. Passionate encounters with her are a religious experience that leave the person drained and helpless.")
                      )
                    ),
                    Core.vx_new_string(":Pride"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Pride"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Pride.png"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Pride is a strikingly handsome man with long golden hair. He and those around him have are utterly convinced of their own superiority and have nothing but distain for others. Pride's victims pose and talk about how great they are, and argue with each other instead of actually doing anything useful. His power is the opposite of teamwork, and close teams will immediately turn on each other, fighting over imagined mutual lack of respect.")
                      )
                    ),
                    Core.vx_new_string(":Sloth"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Sloth"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Sloth.png"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* A tired, bored, young man who lags behind and looks for someplace to lie down.\nVictims of Sloth lose all will to move or resist.")
                      )
                    ),
                    Core.vx_new_string(":Wrath"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
            ...
            Core.vx_new_string("Fabricators, Inc."),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
            ...
            Core.f_new(
              ...
              Core.t_anylist.vx_new(
                ...
                Core.vx_new_string("Renegades"),
                Core.vx_new_string(":summary"),
                Core.vx_new_string("* The Renegades are the personal strikeforce of the Will. They are ironically called Renegades despite being completely under the control of the Will."),
                Core.vx_new_string(":locationmap"),
                Core.f_new(
                  Base.t_locationmap,
                  Core.t_anylist.vx_new(
                    Core.vx_new_string("Parapsychological Studies Institute"),
                    Core.f_new(
                      Base.t_location,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string(":titles"),
                        Core.vx_new_string("Headmaster, Hieronymous Faust"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
                    ...
                    Core.vx_new_string("Windshear, Renegade"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Cobalt, Renegade"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Glare, Renegade"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Lash, Renegade"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Smoke, Renegade"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Swan Song, Renegade"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
            ...
            Core.vx_new_string("Independent Super Heroes"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                  ...
                  Core.t_anylist.vx_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.f_new(
                          ...
                          Core.t_anylist.vx_new(
                            ...
                            Core.vx_new_string(":Correspondence"),
                            Core.f_new(
                              Base.t_unitpower,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Exia"),
                        Core.vx_new_string(":titles"),
                        Core.vx_new_string("Experimental Prototype: X1A")
                      )
                    ),
                    Core.vx_new_string(":Neon"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Hazard"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Hazard was a biochemist working on new fungicides when one of his experiments had unforseen side effects. Unknown to him, he had become infected with an aggressive fungal growth. His body was rapidly consumed, but for undetermined reasons his mind remained mostly intact and began to direct the fungus."),
                        Core.vx_new_string(":titles"),
                        Core.vx_new_string("Bio, Colony, Plasm")
                      )
                    ),
                    Core.vx_new_string(":Razor"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Razor"),
                        Core.vx_new_string(":titles"),
                        Core.vx_new_string("Whisper")
                      )
                    ),
                    Core.vx_new_string(":Revenant"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Revenant"),
                        Core.vx_new_string(":titles"),
                        Core.vx_new_string("Blood")
                      )
                    ),
                    Core.vx_new_string("Saber, The"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string(":Toothgnasher"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Wyrd"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Superheroes/Koli.png"),
                        Core.vx_new_string(":reference"),
                        Core.vx_new_string("* I have existed through two Ice Ages. I have lived and died a hundred thousand ways. Through all my lives, and loves, ... and loses, I know one thing: in four or five hundred years, for good or for bad, I will have forgotten all about you. - Wyrd"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Wyrd's first memories are as a prehistoric woman. Since then each time she dies, her essense transfers to another woman at the verge of death. If the woman allows it, Wyrd's essense merges with the dying woman, and she soon recovers. Initially, the woman is as she was, but gradually Wyrd's combined memories and personality resurface and blend into a new persona dominated by the amalgam personality that is Wyrd.\n* Wyrd is an amalgamation of the thousands of personalities that it has merged with over the ages.\n* She has innumerable skills at expert level, but she often cannot remember them among all the other memories.\n* She is at once alien and empathetic having experienced every aspect of human existence over her long 'life'."),
                        Core.vx_new_string(":titles"),
                        Core.vx_new_string("Faith, Fate, Myriad, Seraphim"),
                        Core.vx_new_string(":unitpowermap"),
                        Core.f_new(
                          Base.t_unitpowermap,
                          Core.t_anylist.vx_new(
            ...
            Core.vx_new_string("Revengers, The"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                ...
                Core.f_new(
                  Base.t_unitmap,
                  Core.t_anylist.vx_new(
                    Core.vx_new_string("Captain America II"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Phalanx"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* In the Sentinel alternate future, Senturion recovered the Awesome Android from its watery grave. He reporgrammed the Android and now it now serves only the Senturion."),
                        Core.vx_new_string(":titles"),
                        Core.vx_new_string("Awesome Android")
                      )
                    ),
                    Core.vx_new_string(":Senturion"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
   ...
   */
  public static interface Func_chapter_superhero_characters extends Core.Type_func, Core.Type_replfunc {
    public Base.Type_chapter vx_chapter_superhero_characters();
  }

  public static class Class_chapter_superhero_characters extends Core.Class_base implements Func_chapter_superhero_characters {

    @Override
    public Func_chapter_superhero_characters vx_new(Object... vals) {
      Class_chapter_superhero_characters output = new Class_chapter_superhero_characters();
      return output;
    }

    @Override
    public Func_chapter_superhero_characters vx_copy(Object... vals) {
      Class_chapter_superhero_characters output = new Class_chapter_superhero_characters();
      return output;
    }
    ...
    public Core.Type_funcdef vx_funcdef() {
      return Core.funcdef_new(
        "nx/tactics/books/superheroes", // pkgname
        "chapter_superhero_characters", // name
        0, // idx
        false, // async
        Core.typedef_new(
          "nx/tactics/base", // pkgname
    ...
    @Override
    public Func_chapter_superhero_characters vx_empty() {return e_chapter_superhero_characters;}
    @Override
    public Func_chapter_superhero_characters vx_type() {return t_chapter_superhero_characters;}

    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      output = Superheroes.f_chapter_superhero_characters();
      return output;
    }

    @Override
    public Base.Type_chapter vx_chapter_superhero_characters() {
      return Superheroes.f_chapter_superhero_characters();
    }

  }

  public static final Func_chapter_superhero_characters e_chapter_superhero_characters = new Superheroes.Class_chapter_superhero_characters();
  public static final Func_chapter_superhero_characters t_chapter_superhero_characters = new Superheroes.Class_chapter_superhero_characters();

  public static Base.Type_chapter f_chapter_superhero_characters() {
    Base.Type_chapter output = Base.e_chapter;
    output = Core.f_new(
      Base.t_chapter,
      Core.t_anylist.vx_new(
   ...
   */
  public static interface Func_chapter_superheroes_overview extends Core.Type_func, Core.Type_replfunc {
    public Base.Type_chapter vx_chapter_superheroes_overview();
  }

  public static class Class_chapter_superheroes_overview extends Core.Class_base implements Func_chapter_superheroes_overview {

    @Override
    public Func_chapter_superheroes_overview vx_new(Object... vals) {
      Class_chapter_superheroes_overview output = new Class_chapter_superheroes_overview();
      return output;
    }

    @Override
    public Func_chapter_superheroes_overview vx_copy(Object... vals) {
      Class_chapter_superheroes_overview output = new Class_chapter_superheroes_overview();
      return output;
    }
    ...
    public Core.Type_funcdef vx_funcdef() {
      return Core.funcdef_new(
        "nx/tactics/books/superheroes", // pkgname
        "chapter_superheroes_overview", // name
        0, // idx
        false, // async
        Core.typedef_new(
          "nx/tactics/base", // pkgname
    ...
    @Override
    public Func_chapter_superheroes_overview vx_empty() {return e_chapter_superheroes_overview;}
    @Override
    public Func_chapter_superheroes_overview vx_type() {return t_chapter_superheroes_overview;}

    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      output = Superheroes.f_chapter_superheroes_overview();
      return output;
    }

    @Override
    public Base.Type_chapter vx_chapter_superheroes_overview() {
      return Superheroes.f_chapter_superheroes_overview();
    }

  }

  public static final Func_chapter_superheroes_overview e_chapter_superheroes_overview = new Superheroes.Class_chapter_superheroes_overview();
  public static final Func_chapter_superheroes_overview t_chapter_superheroes_overview = new Superheroes.Class_chapter_superheroes_overview();

  public static Base.Type_chapter f_chapter_superheroes_overview() {
    Base.Type_chapter output = Base.e_chapter;
    output = Core.f_new(
      Base.t_chapter,
      Core.t_anylist.vx_new(
    ...
    output = Core.f_new(
      ...
      Core.t_anylist.vx_new(
        ...
        Core.f_new(
          ...
          Core.t_anylist.vx_new(
            Core.vx_new_string("Superheroes Overview"),
            Superheroes.f_chapter_superheroes_overview(),
            Core.vx_new_string("Superhero Characters"),
            Superheroes.f_chapter_superhero_characters(),
            Core.vx_new_string("DC Universe"),
            Superheroes.f_chapter_dc_universe(),
            Core.vx_new_string("Dragonball Z"),
            Superheroes.f_chapter_dragonball_z(),
            Core.vx_new_string("Marvel Universe"),
            Superheroes.f_chapter_marvel_universe(),
            Core.vx_new_string("Original Groups"),
            Superheroes.f_chapter_original_groups()
          )
        )
      )
    );
  ...
  static {
    ...
    mapfunc.put("chapter_dc_universe", Superheroes.t_chapter_dc_universe);
    mapfunc.put("chapter_dragonball_z", Superheroes.t_chapter_dragonball_z);
    mapfunc.put("chapter_marvel_universe", Superheroes.t_chapter_marvel_universe);
    mapfunc.put("chapter_original_groups", Superheroes.t_chapter_original_groups);
    mapfunc.put("chapter_superhero_characters", Superheroes.t_chapter_superhero_characters);
    mapfunc.put("chapter_superheroes_overview", Superheroes.t_chapter_superheroes_overview);
