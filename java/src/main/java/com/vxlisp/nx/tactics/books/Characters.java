...
public final class Characters {
   ...
   * (func chapter_cast)
   */
  public static interface Func_chapter_cast extends Core.Type_func, Core.Type_replfunc {
    public Base.Type_chapter vx_chapter_cast();
  }

  public static class Class_chapter_cast extends Core.Class_base implements Func_chapter_cast {

    @Override
    public Func_chapter_cast vx_new(Object... vals) {
      Class_chapter_cast output = new Class_chapter_cast();
      return output;
    }

    @Override
    public Func_chapter_cast vx_copy(Object... vals) {
      Class_chapter_cast output = new Class_chapter_cast();
      return output;
    }
    ...
    @Override
    public Func_chapter_cast vx_empty() {return e_chapter_cast;}
    @Override
    public Func_chapter_cast vx_type() {return t_chapter_cast;}

    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      output = Characters.f_chapter_cast();
      return output;
    }

    @Override
    public Base.Type_chapter vx_chapter_cast() {
      return Characters.f_chapter_cast();
    }

  }

  public static final Func_chapter_cast e_chapter_cast = new Characters.Class_chapter_cast();
  public static final Func_chapter_cast t_chapter_cast = new Characters.Class_chapter_cast();

  public static Base.Type_chapter f_chapter_cast() {
    ...
    output = Core.f_new(
      ...
      Core.t_anylist.vx_new(
        ...
        Core.f_new(
          Base.t_sectionmap,
          Core.t_anylist.vx_new(
            Core.vx_new_string("Memorable Characters"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
   ...
   */
  public static interface Func_chapter_character_archetypes extends Core.Type_func, Core.Type_replfunc {
    public Base.Type_chapter vx_chapter_character_archetypes();
  }

  public static class Class_chapter_character_archetypes extends Core.Class_base implements Func_chapter_character_archetypes {

    @Override
    public Func_chapter_character_archetypes vx_new(Object... vals) {
      Class_chapter_character_archetypes output = new Class_chapter_character_archetypes();
      return output;
    }

    @Override
    public Func_chapter_character_archetypes vx_copy(Object... vals) {
      Class_chapter_character_archetypes output = new Class_chapter_character_archetypes();
      return output;
    }
    ...
    public Core.Type_funcdef vx_funcdef() {
      return Core.funcdef_new(
        "nx/tactics/books/characters", // pkgname
        "chapter_character_archetypes", // name
        0, // idx
        false, // async
        Core.typedef_new(
          "nx/tactics/base", // pkgname
    ...
    @Override
    public Func_chapter_character_archetypes vx_empty() {return e_chapter_character_archetypes;}
    @Override
    public Func_chapter_character_archetypes vx_type() {return t_chapter_character_archetypes;}

    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      output = Characters.f_chapter_character_archetypes();
      return output;
    }

    @Override
    public Base.Type_chapter vx_chapter_character_archetypes() {
      return Characters.f_chapter_character_archetypes();
    }

  }

  public static final Func_chapter_character_archetypes e_chapter_character_archetypes = new Characters.Class_chapter_character_archetypes();
  public static final Func_chapter_character_archetypes t_chapter_character_archetypes = new Characters.Class_chapter_character_archetypes();

  public static Base.Type_chapter f_chapter_character_archetypes() {
    Base.Type_chapter output = Base.e_chapter;
    output = Core.f_new(
      Base.t_chapter,
      Core.t_anylist.vx_new(
        ...
        Core.f_new(
          Base.t_sectionmap,
          Core.t_anylist.vx_new(
            Core.vx_new_string("Warrior Classes"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Gladiator"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Preferred Skills: [Melee Combat]:Spears, Flexible Weaponry, [Close Combat]:Grappling, [Athletics],\n[Evasion]")
                      )
                    ),
                    Core.vx_new_string(":Knight"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Martial Artist"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Martial Artist"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Preferred Skills: [Close Combat]:Martial Arts, [Evasion], [Acrobatics]")
                      )
                    ),
                    Core.vx_new_string(":Paladin"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Ranger"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Preferred Skills: [Ranged Combat]:Archery, [Hunting], [Forestry], [Riding]")
                      )
                    ),
                    Core.vx_new_string(":Samurai"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Samurai"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Preferred Skills: [Melee Combat]:Swords, [Ranged Combat]:Archery, [Riding], [Evasion]")
                      )
                    ),
                    Core.vx_new_string(":Soldier"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Soldier"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Preferred Skills: [Melee Combat], [Military], [Armor]")
                      )
                    ),
                    Core.vx_new_string(":Warrior"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Warrior"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Preferred Skills: [Melee Combat], [Armor], [Riding]")
                      )
                    )
                  )
                )
            ...
            Core.vx_new_string("Rogue Classes"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Assassin"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Preferred Skills: [Assassination], [Ranged Combat]:Thrown Weapons")
                      )
                    ),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Charlatan"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Preferred Skills: [Performance], [Deception]")
                      )
                    ),
                    Core.vx_new_string(":Ninja"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Ninja"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Preferred Skills: [Assassination], [Melee Combat], [Deception], [Stealth]")
                      )
                    ),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Rogue"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Preferred Skills: [Crime], [Close Combat]:Knives, [Deception], [Stealth]")
                      )
                    ),
                    Core.vx_new_string(":Scout"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Scout"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Preferred Skills: [Scouting]")
                      )
                    ),
                    Core.vx_new_string(":Spy"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Spy"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Preferred Skills: [Espionage], [Scouting], [Stealth]")
                      )
                    ),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Thief"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Preferred Skills: [Thrown Weapons], [Deception]:Thievery, [Mechanics], [Climbing], [Acrobatics], [Scouting], [Stealth]")
                      )
                    )
                  )
                )
            ...
            Core.vx_new_string("Mentalist Classes"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
            ...
            Core.vx_new_string("Spiritualist Classes"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Druid"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Preferred Skills: [Nature Magic], [Herbalism], [Aeromancy]")
                      )
                    ),
                    Core.vx_new_string(":Monk"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Monk"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Preferred Skills: [Martial Arts]:Striking, [Mind Over Body]")
                      )
                    ),
                    ...
                    Core.vx_new_string(":Witch/Warlock"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Witch Doctor"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
   ...
   */
  public static interface Func_chapter_characters_overview extends Core.Type_func, Core.Type_replfunc {
    public Base.Type_chapter vx_chapter_characters_overview();
  }

  public static class Class_chapter_characters_overview extends Core.Class_base implements Func_chapter_characters_overview {

    @Override
    public Func_chapter_characters_overview vx_new(Object... vals) {
      Class_chapter_characters_overview output = new Class_chapter_characters_overview();
      return output;
    }

    @Override
    public Func_chapter_characters_overview vx_copy(Object... vals) {
      Class_chapter_characters_overview output = new Class_chapter_characters_overview();
      return output;
    }
    ...
    public Core.Type_funcdef vx_funcdef() {
      return Core.funcdef_new(
        "nx/tactics/books/characters", // pkgname
        "chapter_characters_overview", // name
        0, // idx
        false, // async
        Core.typedef_new(
          "nx/tactics/base", // pkgname
    ...
    @Override
    public Func_chapter_characters_overview vx_empty() {return e_chapter_characters_overview;}
    @Override
    public Func_chapter_characters_overview vx_type() {return t_chapter_characters_overview;}

    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      output = Characters.f_chapter_characters_overview();
      return output;
    }

    @Override
    public Base.Type_chapter vx_chapter_characters_overview() {
      return Characters.f_chapter_characters_overview();
    }

  }

  public static final Func_chapter_characters_overview e_chapter_characters_overview = new Characters.Class_chapter_characters_overview();
  public static final Func_chapter_characters_overview t_chapter_characters_overview = new Characters.Class_chapter_characters_overview();

  public static Base.Type_chapter f_chapter_characters_overview() {
    Base.Type_chapter output = Base.e_chapter;
    output = Core.f_new(
      Base.t_chapter,
      Core.t_anylist.vx_new(
   ...
   */
  public static interface Func_chapter_creating_characters extends Core.Type_func, Core.Type_replfunc {
    public Base.Type_chapter vx_chapter_creating_characters();
  }

  public static class Class_chapter_creating_characters extends Core.Class_base implements Func_chapter_creating_characters {

    @Override
    public Func_chapter_creating_characters vx_new(Object... vals) {
      Class_chapter_creating_characters output = new Class_chapter_creating_characters();
      return output;
    }

    @Override
    public Func_chapter_creating_characters vx_copy(Object... vals) {
      Class_chapter_creating_characters output = new Class_chapter_creating_characters();
      return output;
    }
    ...
    public Core.Type_funcdef vx_funcdef() {
      return Core.funcdef_new(
        "nx/tactics/books/characters", // pkgname
        "chapter_creating_characters", // name
        0, // idx
        false, // async
        Core.typedef_new(
          "nx/tactics/base", // pkgname
    ...
    @Override
    public Func_chapter_creating_characters vx_empty() {return e_chapter_creating_characters;}
    @Override
    public Func_chapter_creating_characters vx_type() {return t_chapter_creating_characters;}

    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      output = Characters.f_chapter_creating_characters();
      return output;
    }

    @Override
    public Base.Type_chapter vx_chapter_creating_characters() {
      return Characters.f_chapter_creating_characters();
    }

  }

  public static final Func_chapter_creating_characters e_chapter_creating_characters = new Characters.Class_chapter_creating_characters();
  public static final Func_chapter_creating_characters t_chapter_creating_characters = new Characters.Class_chapter_creating_characters();

  public static Base.Type_chapter f_chapter_creating_characters() {
    Base.Type_chapter output = Base.e_chapter;
    output = Core.f_new(
      Base.t_chapter,
      Core.t_anylist.vx_new(
        ...
        Core.f_new(
          Base.t_sectionmap,
          Core.t_anylist.vx_new(
            Core.vx_new_string("Friends and Family"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                ...
                Core.f_new(
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.vx_new_string("Emergency Worker"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Love Interest"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Senior Citizen"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Store Employee"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
            ...
            Core.vx_new_string("Character Rules"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
   ...
   * (func chapter_props)
   */
  public static interface Func_chapter_props extends Core.Type_func, Core.Type_replfunc {
    public Base.Type_chapter vx_chapter_props();
  }

  public static class Class_chapter_props extends Core.Class_base implements Func_chapter_props {

    @Override
    public Func_chapter_props vx_new(Object... vals) {
      Class_chapter_props output = new Class_chapter_props();
      return output;
    }

    @Override
    public Func_chapter_props vx_copy(Object... vals) {
      Class_chapter_props output = new Class_chapter_props();
      return output;
    }
    ...
    @Override
    public Func_chapter_props vx_empty() {return e_chapter_props;}
    @Override
    public Func_chapter_props vx_type() {return t_chapter_props;}

    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      output = Characters.f_chapter_props();
      return output;
    }

    @Override
    public Base.Type_chapter vx_chapter_props() {
      return Characters.f_chapter_props();
    }

  }

  public static final Func_chapter_props e_chapter_props = new Characters.Class_chapter_props();
  public static final Func_chapter_props t_chapter_props = new Characters.Class_chapter_props();

  public static Base.Type_chapter f_chapter_props() {
    Base.Type_chapter output = Base.e_chapter;
    output = Core.f_new(
      Base.t_chapter,
      Core.t_anylist.vx_new(
   ...
   * (func chapter_sets)
   */
  public static interface Func_chapter_sets extends Core.Type_func, Core.Type_replfunc {
    public Base.Type_chapter vx_chapter_sets();
  }

  public static class Class_chapter_sets extends Core.Class_base implements Func_chapter_sets {

    @Override
    public Func_chapter_sets vx_new(Object... vals) {
      Class_chapter_sets output = new Class_chapter_sets();
      return output;
    }

    @Override
    public Func_chapter_sets vx_copy(Object... vals) {
      Class_chapter_sets output = new Class_chapter_sets();
      return output;
    }
    ...
    @Override
    public Func_chapter_sets vx_empty() {return e_chapter_sets;}
    @Override
    public Func_chapter_sets vx_type() {return t_chapter_sets;}

    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      output = Characters.f_chapter_sets();
      return output;
    }

    @Override
    public Base.Type_chapter vx_chapter_sets() {
      return Characters.f_chapter_sets();
    }

  }

  public static final Func_chapter_sets e_chapter_sets = new Characters.Class_chapter_sets();
  public static final Func_chapter_sets t_chapter_sets = new Characters.Class_chapter_sets();

  public static Base.Type_chapter f_chapter_sets() {
    Base.Type_chapter output = Base.e_chapter;
    output = Core.f_new(
      Base.t_chapter,
      Core.t_anylist.vx_new(
        ...
        Core.f_new(
          Base.t_sectionmap,
          Core.t_anylist.vx_new(
            Core.vx_new_string("Foreign Lands"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
   ...
   */
  public static interface Func_chapter_storytelling extends Core.Type_func, Core.Type_replfunc {
    public Base.Type_chapter vx_chapter_storytelling();
  }

  public static class Class_chapter_storytelling extends Core.Class_base implements Func_chapter_storytelling {

    @Override
    public Func_chapter_storytelling vx_new(Object... vals) {
      Class_chapter_storytelling output = new Class_chapter_storytelling();
      return output;
    }

    @Override
    public Func_chapter_storytelling vx_copy(Object... vals) {
      Class_chapter_storytelling output = new Class_chapter_storytelling();
      return output;
    }
    ...
    @Override
    public Func_chapter_storytelling vx_empty() {return e_chapter_storytelling;}
    @Override
    public Func_chapter_storytelling vx_type() {return t_chapter_storytelling;}

    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      output = Characters.f_chapter_storytelling();
      return output;
    }

    @Override
    public Base.Type_chapter vx_chapter_storytelling() {
      return Characters.f_chapter_storytelling();
    }

  }

  public static final Func_chapter_storytelling e_chapter_storytelling = new Characters.Class_chapter_storytelling();
  public static final Func_chapter_storytelling t_chapter_storytelling = new Characters.Class_chapter_storytelling();

  public static Base.Type_chapter f_chapter_storytelling() {
    Base.Type_chapter output = Base.e_chapter;
    output = Core.f_new(
      Base.t_chapter,
      Core.t_anylist.vx_new(
        ...
        Core.f_new(
          Base.t_sectionmap,
          Core.t_anylist.vx_new(
            Core.vx_new_string(":Roleplaying"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
            ...
            Core.vx_new_string("Story Elements"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Intrigue"),
                        Core.vx_new_string(":reference"),
                        Core.vx_new_string("* The greatest trick the devil ever pulled was convincing the world he didn't exist - Verbal Kint, The Usual Suspects"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Everyone has an agenda. Sometimes that agenda is obvious. Sometimes a person is unaware of what drives him/her. Even without secret agendas, the interaction between peoples goals are complex and subtle.\n* Some ambitious people will use secret agendas and plots to further their goals. When others run afoul of these plots, they may find unexpected conflict or unwittingly become a pawn in someone else's game.\n* The most successful plots are never detected. They are shielded by false goals and red herrings.")
                      )
                    ),
                    Core.vx_new_string(":Suspense"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Prologue"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Some Stories may benefit from a brief side Story that sets the tone, describes history, brings the players together.\n* Prologues can take place long before the events of the main story.")
                      )
                    ),
                    Core.vx_new_string(":Plot"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Scenes"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* The story will move from scene to scene.\n\nEach scene includes:\n* Sets\n* Props\n* Cast\n\nAfter the scene has completed its purpose, we move to the next scene:\n* Scene Goals")
                      )
                    ),
                    Core.vx_new_string("Story Ending"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Story Ending"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Climax\n* Anti-Climax\n* Surprise Ending")
                      )
                    ),
                    Core.vx_new_string(":Epilogue"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Epilogue"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Are there any loose ends that hint at the next story."),
                        Core.vx_new_string(":titles"),
                        Core.vx_new_string("Aftermath")
                      )
                    )
                  )
                )
            ...
            Core.vx_new_string("Plot Archetypes"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Assault"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* An all out attack on an enemy stronghold.")
                      )
                    ),
                    Core.vx_new_string("Assault Defense"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Assault Defense"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Defend your stronghold against an enemy assault.")
                      )
                    ),
                    Core.vx_new_string("Bank Robbery"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Betrayal"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* The plot appears to be another kind, but the characters realize they\nhave been betrayed. They must now escape or gain revenge.")
                      )
                    ),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Bug Hunt"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* A killer is on the loose and must be tracked down.")
                      )
                    ),
                    Core.vx_new_string(":Bullying"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Conspiracy"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* A group plans a course of action which the characters directly or\nindirectly.")
                      )
                    ),
                    Core.vx_new_string(":Crash"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Cyber Crime"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Dangerous Animal"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Disease Outbreak"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Drug Trafficking"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Escape"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* The characters are threatened with overwhelming danger and must find a\nsafe place and travel there while dodging aggressors.")
                      )
                    ),
                    Core.vx_new_string(":Falling"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Framing"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Characters are maneuvered into a situation where it appears they have\ncommitted an offense. This may lead to an escape and a mystery.")
                      )
                    ),
                    ...
                    Core.vx_new_string("Gang Activty"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Guard"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Guard a person or item from theft.")
                      )
                    ),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Injustice"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* A wrong has been perpetrated and the characters feel obliged to right it.")
                      )
                    ),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Jealosy"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* The characters have inspired envy or jealousy in another and steps are\nbeing taken against them. Their enemy may be someone they recently\ncrossed.")
                      )
                    ),
                    ...
                    Core.vx_new_string("Love Affair"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Mystery"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Events have taken place and the characters must find out what it all\nmeans, who is behind it, and what actions to take.")
                      )
                    ),
                    Core.vx_new_string("Organized Crime"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Petty Theft"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Police Activity"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Political Situation"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Rescue"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* The characters must penetrate and enemy stronghold and find an ally, and\nescape.")
                      )
                    ),
                    Core.vx_new_string(":Revenge"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.vx_new_string("Siege Defense"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Siege Defense"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Your stronghold is surrounded. You must escape or break the siege.")
                      )
                    ),
                    Core.vx_new_string(":Trapped"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Treasure Hunt"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Something of value is discovered and the characters must find it before\nanyone else does.")
                      )
                    ),
                    Core.vx_new_string("White Collar Crime"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Dream Sequences"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* Dreams and Dream-like situations can be an interesting plot device and can also allow the character to\nrediscover their nature when put into unusual circumstances.")
                      )
                    ),
                    Core.vx_new_string("Hero's Journey"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Real Time Action"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* An extreme way to make the story gripping is to move the game into real time.  Players only have as much time as\ntheir characters do to make decisions.")
                      )
                    ),
                    Core.vx_new_string(":Subplots"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
            ...
            Core.f_new(
              ...
              Core.t_anylist.vx_new(
                ...
                Core.vx_new_string("Encounters"),
                Core.vx_new_string(":summary"),
                Core.vx_new_string("* When characters travel, they may encounter others seemingly randomly.  These encounters keep players on their toes as\nthey are often vulnerable while travelling."),
                Core.vx_new_string(":rulemap"),
                Core.f_new(
                  Base.t_rulemap,
                  Core.t_anylist.vx_new(
                    Core.vx_new_string(":Traces"),
                    Core.f_new(
                      Base.t_rule,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
    ...
    output = Core.f_new(
      ...
      Core.t_anylist.vx_new(
        ...
        Core.f_new(
          ...
          Core.t_anylist.vx_new(
            Core.vx_new_string("Characters Overview"),
            Characters.f_chapter_characters_overview(),
            Core.vx_new_string("Creating Characters"),
            Characters.f_chapter_creating_characters(),
            Core.vx_new_string("Character Archetypes"),
            Characters.f_chapter_character_archetypes(),
            Core.vx_new_string("Storytelling"),
            Characters.f_chapter_storytelling(),
            Core.vx_new_string("Sets"),
            Characters.f_chapter_sets(),
            Core.vx_new_string("Props"),
            Characters.f_chapter_props(),
            Core.vx_new_string("Cast"),
            Characters.f_chapter_cast()
          )
        )
      )
    );
  ...
  static {
    ...
    mapfunc.put("chapter_cast", Characters.t_chapter_cast);
    mapfunc.put("chapter_character_archetypes", Characters.t_chapter_character_archetypes);
    mapfunc.put("chapter_characters_overview", Characters.t_chapter_characters_overview);
    mapfunc.put("chapter_creating_characters", Characters.t_chapter_creating_characters);
    mapfunc.put("chapter_props", Characters.t_chapter_props);
    mapfunc.put("chapter_sets", Characters.t_chapter_sets);
    mapfunc.put("chapter_storytelling", Characters.t_chapter_storytelling);
