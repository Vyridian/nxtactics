...
public final class Horror {
   ...
   */
  public static interface Func_chapter_call_of_cthulhu extends Core.Type_func, Core.Type_replfunc {
    public Base.Type_chapter vx_chapter_call_of_cthulhu();
  }

  public static class Class_chapter_call_of_cthulhu extends Core.Class_base implements Func_chapter_call_of_cthulhu {

    @Override
    public Func_chapter_call_of_cthulhu vx_new(Object... vals) {
      Class_chapter_call_of_cthulhu output = new Class_chapter_call_of_cthulhu();
      return output;
    }

    @Override
    public Func_chapter_call_of_cthulhu vx_copy(Object... vals) {
      Class_chapter_call_of_cthulhu output = new Class_chapter_call_of_cthulhu();
      return output;
    }
    ...
    @Override
    public Func_chapter_call_of_cthulhu vx_empty() {return e_chapter_call_of_cthulhu;}
    @Override
    public Func_chapter_call_of_cthulhu vx_type() {return t_chapter_call_of_cthulhu;}

    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      output = Horror.f_chapter_call_of_cthulhu();
      return output;
    }

    @Override
    public Base.Type_chapter vx_chapter_call_of_cthulhu() {
      return Horror.f_chapter_call_of_cthulhu();
    }

  }

  public static final Func_chapter_call_of_cthulhu e_chapter_call_of_cthulhu = new Horror.Class_chapter_call_of_cthulhu();
  public static final Func_chapter_call_of_cthulhu t_chapter_call_of_cthulhu = new Horror.Class_chapter_call_of_cthulhu();

  public static Base.Type_chapter f_chapter_call_of_cthulhu() {
    ...
    output = Core.f_new(
      ...
      Core.t_anylist.vx_new(
        ...
        Core.f_new(
          Base.t_sectionmap,
          Core.t_anylist.vx_new(
            Core.vx_new_string("Mythos Places"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Cthulhu/Ryleh.jpg"),
                        Core.vx_new_string(":reference"),
                        Core.vx_new_string("That is not dead which can eternal lie, And with strange aeons even death may die.")
                      )
                    ),
                    Core.vx_new_string(":Yaddith"),
                    Core.f_new(
                      Base.t_location,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                          ...
                          Core.t_anylist.vx_new(
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Crag of the Ghouls"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* The Crag of the Ghouls is a rugged cliff in the Peaks of Thok from which the ghouls of deeper dreamland pitch the leftover bones of their sepulchral feasts. Uncounted miles below the crag is the bone-filled [Vale of Pnath].")
                              )
                            ),
                            Core.vx_new_string("Great Abyss"),
                            Core.f_new(
                              Base.t_location,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Peaks of Thok"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* The Peaks of Thok (or Throk) is a frightening range of towering granite\nmountains in the underworld.")
                              )
                            ),
                            Core.vx_new_string("Stony Desert"),
                            Core.f_new(
                              Base.t_location,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
                            ...
                            Core.f_new(
                              ...
                              Core.t_anylist.vx_new(
                                ...
                                Core.vx_new_string("Ultar"),
                                Core.vx_new_string(":summary"),
                                Core.vx_new_string("* Ulthar - Ulthar is a pleasant city, well-known to dreamers for its ban on\nharming cats and the enormous number of cats that make Ulthar their home.")
                              )
                            ),
                            Core.vx_new_string("Vale of Pnath"),
                            Core.f_new(
                              Base.t_location,
                              Core.t_anylist.vx_new(
                                Core.vx_new_string(":name"),
            ...
            Core.vx_new_string("Mythos Items"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                ...
                Core.f_new(
                  Base.t_itemmap,
                  Core.t_anylist.vx_new(
                    Core.vx_new_string("Book of Eibon"),
                    Core.f_new(
                      Base.t_item,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Celaeno Fragments"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Cthulhu/CelaenoFragments.jpg"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("225 million years ago, the stone tablets that become the Celaeno Fragments are scribed\naround the middle Triassic (presumably by Serpent People). One set of the tablets is\neventually taken to the Great Library of Celaeno, on the fourth planet around the star\nCelaeno."),
                        Core.vx_new_string(":classification"),
                        Core.vx_new_string("Book")
                      )
                    ),
                    Core.vx_new_string("Cthaat Aquadingen"),
                    Core.f_new(
                      Base.t_item,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Elder Sign"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Cthulhu/ElderSign.jpg"),
                        Core.vx_new_string(":reference"),
                        Core.vx_new_string("H.P. Lovecraft (who had created the Elder Sign without ever describing what it looked\nlike) had drawn a picture of the Elder Sign in a letter. This branch-like image is\nconsidered by many to be the true Elder Sign.")
                      )
                    ),
                    Core.vx_new_string("Mi-Go Armor"),
                    Core.f_new(
                      Base.t_item,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Mi-Go Armor"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Cthulhu/MigoArmor.jpg"),
                        Core.vx_new_string(":classification"),
                        Core.vx_new_string("Med. Armor")
                      )
                    ),
                    Core.vx_new_string("Mi-Go Brain Bottle"),
                    Core.f_new(
                      Base.t_item,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Mi-Go Brain Bottle"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Cthulhu/BrainCase.jpg")
                      )
                    ),
                    Core.vx_new_string(":Necronomicon"),
                    Core.f_new(
                      Base.t_item,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Pnakotic Manuscripts"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Cthulhu/PnakoticManuscripts.jpg"),
                        Core.vx_new_string(":classification"),
                        Core.vx_new_string("Book")
                      )
                    ),
                    Core.vx_new_string("R'lyeh Text"),
                    Core.f_new(
                      Base.t_item,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("R'lyeh Text"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Cthulhu/RlyehText.jpg"),
                        Core.vx_new_string(":classification"),
                        Core.vx_new_string("Book")
                      )
                    ),
                    Core.vx_new_string("True Magick"),
                    Core.f_new(
                      Base.t_item,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("True Magick"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Cthulhu/TrueMagick.jpg"),
                        Core.vx_new_string(":classification"),
                        Core.vx_new_string("Book")
                      )
                    )
            ...
            Core.vx_new_string("Mythos Independent Races"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                ...
                Core.f_new(
                  Base.t_unitmap,
                  Core.t_anylist.vx_new(
                    Core.vx_new_string("Colour Out of Space"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Cthonian"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Cthulhu/Cthonian.png")
                      )
                    ),
                    Core.vx_new_string("Elder Thing"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Great Race of Yith"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Cthulhu/GreatRaceOfYith.png")
                      )
                    ),
                    Core.vx_new_string("Hound of Tindalos"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Hunting Horror"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Cthulhu/HuntingHorror.png")
                      )
                    ),
                    Core.vx_new_string(":Mi-Go"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Shoggoth"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Cthulhu/Shoggoth.png"),
                        Core.vx_new_string(":reference"),
                        Core.vx_new_string("This was the dream in which I saw a shoggoth for the first time, and the sight set me awake in a frenzy\nof screaming. - The Shadow Over Innsmouth")
                      )
                    )
                  )
                )
            ...
            Core.vx_new_string("Mythos Servitor Races"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                ...
                Core.f_new(
                  Base.t_unitmap,
                  Core.t_anylist.vx_new(
                    Core.vx_new_string("Dark Young of Shub-Niggurath"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Spawn of Cthulhu"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Cthulhu/SpawnOfCthulhu.png")
                      )
                    )
                  )
                )
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Nodens"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Cthulhu/Nodens.png")
                      )
                    ),
                    Core.vx_new_string(":Yibb-Tstll"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
            ...
            Core.vx_new_string("Great Old Ones"),
            Core.f_new(
              Base.t_section,
              Core.t_anylist.vx_new(
                Core.vx_new_string(":name"),
                Core.vx_new_string("Great Old Ones"),
                Core.vx_new_string(":reference"),
                Core.vx_new_string("Behind the Veil what gulfs of Time and Space?  What blinking mowing Shapes to blast the sight?  I shrink\nbefore a vague colossal Face...Born in the mad immensities of Night. - Robert E. Howard, An Open Window"),
                Core.vx_new_string(":unitmap"),
                Core.f_new(
                  Base.t_unitmap,
                  Core.t_anylist.vx_new(
                    Core.vx_new_string(":Cthulhu"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Dagon"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Cthulhu/Dagon.png"),
                        Core.vx_new_string(":reference"),
                        Core.vx_new_string("* I cannot think of the deep sea without shuddering at the nameless things that may at this very moment be crawling and floundering on its slimy bed, worshipping their ancient stone idols and carving their own detestable likenesses on submarine obelisks of water-soaked granite. I dream of a day when they may rise above the billows to drag down in their reeking talons the remnants of puny, war-exhausted mankind—of a day when the land shall sink, and the dark ocean floor shall ascend amidst universal pandemonium. - Dagon")
                      )
                    ),
                    Core.vx_new_string("Hastur the Unspeakable"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Hastur the Unspeakable"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Cthulhu/Hastur.png"),
                        Core.vx_new_string(":titles"),
                        Core.vx_new_string("The King in Yellow")
                      )
                    ),
                    Core.vx_new_string("Ithaqua the Windwalker"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Ithaqua the Windwalker"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Cthulhu/Ithaqua.png")
                      )
                    )
                  )
                )
                  ...
                  Core.t_anylist.vx_new(
                    ...
                    Core.f_new(
                      ...
                      Core.t_anylist.vx_new(
                        ...
                        Core.vx_new_string("Azathoth"),
                        Core.vx_new_string(":image"),
                        Core.vx_new_string("Cthulhu/Azathoth.png"),
                        Core.vx_new_string(":reference"),
                        Core.vx_new_string("This is about at close as Lovecraft's mythos ever come to establishing a\ncreator deity. It was Azathoth who birthed the Darkness and the Nameless\nmists from which nearly all the other gods and deities sprang. It was he who\ncreated the universe and he who will one day be its destruction. ...\nknow that Azathoth is neither malevolent nor benevolent - that he is entropy\nincarnate; a mindless, indiffernt force of pure chaos. The Blind, Idiot God.\nThere is nothing to be gained from calling on him and literally everything\nto lose. ... He is the epitome of cosmic horror in the mythos, embodying the\ncold, indifference of the cosmos and the sheer insignificance of intelligent\nlife. - Tale Foundry"),
                        Core.vx_new_string(":summary"),
                        Core.vx_new_string("* At the center of the universe, deep within a self-created abyss past time and space, dwells the blind idiot god Azathoth. Possessing True Immortality, Azathoth cannot be destroyed. The concept of death only exists within his dreams. Long ago, all was Azathoth. His dreams are all of existence and we are in his dreams. The mad piping attempts to keep Azathoth slumbering for when he wakes, all things will end and all will become Azathoth again.\n* Azathoth is perhaps the most powerful being in fiction."),
                        Core.vx_new_string(":titles"),
                        Core.vx_new_string("Daemon Sultan, The Blind, Idiot God")
                      )
                    ),
                    Core.vx_new_string(":Nyarlathotep"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
   ...
   */
  public static interface Func_chapter_deadly_beasts extends Core.Type_func, Core.Type_replfunc {
    public Base.Type_chapter vx_chapter_deadly_beasts();
  }

  public static class Class_chapter_deadly_beasts extends Core.Class_base implements Func_chapter_deadly_beasts {

    @Override
    public Func_chapter_deadly_beasts vx_new(Object... vals) {
      Class_chapter_deadly_beasts output = new Class_chapter_deadly_beasts();
      return output;
    }

    @Override
    public Func_chapter_deadly_beasts vx_copy(Object... vals) {
      Class_chapter_deadly_beasts output = new Class_chapter_deadly_beasts();
      return output;
    }
    ...
    @Override
    public Func_chapter_deadly_beasts vx_empty() {return e_chapter_deadly_beasts;}
    @Override
    public Func_chapter_deadly_beasts vx_type() {return t_chapter_deadly_beasts;}

    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      output = Horror.f_chapter_deadly_beasts();
      return output;
    }

    @Override
    public Base.Type_chapter vx_chapter_deadly_beasts() {
      return Horror.f_chapter_deadly_beasts();
    }

  }

  public static final Func_chapter_deadly_beasts e_chapter_deadly_beasts = new Horror.Class_chapter_deadly_beasts();
  public static final Func_chapter_deadly_beasts t_chapter_deadly_beasts = new Horror.Class_chapter_deadly_beasts();

  public static Base.Type_chapter f_chapter_deadly_beasts() {
    Base.Type_chapter output = Base.e_chapter;
    output = Core.f_new(
      Base.t_chapter,
      Core.t_anylist.vx_new(
   ...
   */
  public static interface Func_chapter_horror_overview extends Core.Type_func, Core.Type_replfunc {
    public Base.Type_chapter vx_chapter_horror_overview();
  }

  public static class Class_chapter_horror_overview extends Core.Class_base implements Func_chapter_horror_overview {

    @Override
    public Func_chapter_horror_overview vx_new(Object... vals) {
      Class_chapter_horror_overview output = new Class_chapter_horror_overview();
      return output;
    }

    @Override
    public Func_chapter_horror_overview vx_copy(Object... vals) {
      Class_chapter_horror_overview output = new Class_chapter_horror_overview();
      return output;
    }
    ...
    @Override
    public Func_chapter_horror_overview vx_empty() {return e_chapter_horror_overview;}
    @Override
    public Func_chapter_horror_overview vx_type() {return t_chapter_horror_overview;}

    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      output = Horror.f_chapter_horror_overview();
      return output;
    }

    @Override
    public Base.Type_chapter vx_chapter_horror_overview() {
      return Horror.f_chapter_horror_overview();
    }

  }

  public static final Func_chapter_horror_overview e_chapter_horror_overview = new Horror.Class_chapter_horror_overview();
  public static final Func_chapter_horror_overview t_chapter_horror_overview = new Horror.Class_chapter_horror_overview();

  public static Base.Type_chapter f_chapter_horror_overview() {
    Base.Type_chapter output = Base.e_chapter;
    output = Core.f_new(
      Base.t_chapter,
      Core.t_anylist.vx_new(
   ...
   */
  public static interface Func_chapter_kingdom_of_the_gods extends Core.Type_func, Core.Type_replfunc {
    public Base.Type_chapter vx_chapter_kingdom_of_the_gods();
  }

  public static class Class_chapter_kingdom_of_the_gods extends Core.Class_base implements Func_chapter_kingdom_of_the_gods {

    @Override
    public Func_chapter_kingdom_of_the_gods vx_new(Object... vals) {
      Class_chapter_kingdom_of_the_gods output = new Class_chapter_kingdom_of_the_gods();
      return output;
    }

    @Override
    public Func_chapter_kingdom_of_the_gods vx_copy(Object... vals) {
      Class_chapter_kingdom_of_the_gods output = new Class_chapter_kingdom_of_the_gods();
      return output;
    }
    ...
    public Core.Type_funcdef vx_funcdef() {
      return Core.funcdef_new(
        "nx/tactics/books/horror", // pkgname
        "chapter_kingdom_of_the_gods", // name
        0, // idx
        false, // async
        Core.typedef_new(
          "nx/tactics/base", // pkgname
    ...
    @Override
    public Func_chapter_kingdom_of_the_gods vx_empty() {return e_chapter_kingdom_of_the_gods;}
    @Override
    public Func_chapter_kingdom_of_the_gods vx_type() {return t_chapter_kingdom_of_the_gods;}

    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      output = Horror.f_chapter_kingdom_of_the_gods();
      return output;
    }

    @Override
    public Base.Type_chapter vx_chapter_kingdom_of_the_gods() {
      return Horror.f_chapter_kingdom_of_the_gods();
    }

  }

  public static final Func_chapter_kingdom_of_the_gods e_chapter_kingdom_of_the_gods = new Horror.Class_chapter_kingdom_of_the_gods();
  public static final Func_chapter_kingdom_of_the_gods t_chapter_kingdom_of_the_gods = new Horror.Class_chapter_kingdom_of_the_gods();

  public static Base.Type_chapter f_chapter_kingdom_of_the_gods() {
    Base.Type_chapter output = Base.e_chapter;
    output = Core.f_new(
      Base.t_chapter,
      Core.t_anylist.vx_new(
   ...
   */
  public static interface Func_chapter_night_of_the_living_dead extends Core.Type_func, Core.Type_replfunc {
    public Base.Type_chapter vx_chapter_night_of_the_living_dead();
  }

  public static class Class_chapter_night_of_the_living_dead extends Core.Class_base implements Func_chapter_night_of_the_living_dead {

    @Override
    public Func_chapter_night_of_the_living_dead vx_new(Object... vals) {
      Class_chapter_night_of_the_living_dead output = new Class_chapter_night_of_the_living_dead();
      return output;
    }

    @Override
    public Func_chapter_night_of_the_living_dead vx_copy(Object... vals) {
      Class_chapter_night_of_the_living_dead output = new Class_chapter_night_of_the_living_dead();
      return output;
    }
    ...
    public Core.Type_funcdef vx_funcdef() {
      return Core.funcdef_new(
        "nx/tactics/books/horror", // pkgname
        "chapter_night_of_the_living_dead", // name
        0, // idx
        false, // async
        Core.typedef_new(
          "nx/tactics/base", // pkgname
    ...
    @Override
    public Func_chapter_night_of_the_living_dead vx_empty() {return e_chapter_night_of_the_living_dead;}
    @Override
    public Func_chapter_night_of_the_living_dead vx_type() {return t_chapter_night_of_the_living_dead;}

    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      output = Horror.f_chapter_night_of_the_living_dead();
      return output;
    }

    @Override
    public Base.Type_chapter vx_chapter_night_of_the_living_dead() {
      return Horror.f_chapter_night_of_the_living_dead();
    }

  }

  public static final Func_chapter_night_of_the_living_dead e_chapter_night_of_the_living_dead = new Horror.Class_chapter_night_of_the_living_dead();
  public static final Func_chapter_night_of_the_living_dead t_chapter_night_of_the_living_dead = new Horror.Class_chapter_night_of_the_living_dead();

  public static Base.Type_chapter f_chapter_night_of_the_living_dead() {
    Base.Type_chapter output = Base.e_chapter;
    output = Core.f_new(
      Base.t_chapter,
      Core.t_anylist.vx_new(
   ...
   */
  public static interface Func_chapter_serial_killers extends Core.Type_func, Core.Type_replfunc {
    public Base.Type_chapter vx_chapter_serial_killers();
  }

  public static class Class_chapter_serial_killers extends Core.Class_base implements Func_chapter_serial_killers {

    @Override
    public Func_chapter_serial_killers vx_new(Object... vals) {
      Class_chapter_serial_killers output = new Class_chapter_serial_killers();
      return output;
    }

    @Override
    public Func_chapter_serial_killers vx_copy(Object... vals) {
      Class_chapter_serial_killers output = new Class_chapter_serial_killers();
      return output;
    }
    ...
    @Override
    public Func_chapter_serial_killers vx_empty() {return e_chapter_serial_killers;}
    @Override
    public Func_chapter_serial_killers vx_type() {return t_chapter_serial_killers;}

    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      output = Horror.f_chapter_serial_killers();
      return output;
    }

    @Override
    public Base.Type_chapter vx_chapter_serial_killers() {
      return Horror.f_chapter_serial_killers();
    }

  }

  public static final Func_chapter_serial_killers e_chapter_serial_killers = new Horror.Class_chapter_serial_killers();
  public static final Func_chapter_serial_killers t_chapter_serial_killers = new Horror.Class_chapter_serial_killers();

  public static Base.Type_chapter f_chapter_serial_killers() {
    Base.Type_chapter output = Base.e_chapter;
    output = Core.f_new(
      Base.t_chapter,
      Core.t_anylist.vx_new(
            ...
            Core.f_new(
              ...
              Core.t_anylist.vx_new(
                ...
                Core.f_new(
                  Base.t_unitmap,
                  Core.t_anylist.vx_new(
                    Core.vx_new_string("Backwoods Crazies"),
                    Core.f_new(
                      Base.t_unit,
                      Core.t_anylist.vx_new(
                        Core.vx_new_string(":name"),
                        Core.vx_new_string("Backwoods Crazies"),
                        Core.vx_new_string(":reference"),
                        Core.vx_new_string("* Deliverance, Hills Have Eyes, Texas Chainsaw Massacre")
                      )
                    )
                  )
                )
    ...
    output = Core.f_new(
      ...
      Core.t_anylist.vx_new(
        ...
        Core.f_new(
          ...
          Core.t_anylist.vx_new(
            Core.vx_new_string("Horror Overview"),
            Horror.f_chapter_horror_overview(),
            Core.vx_new_string("Call of Cthulhu"),
            Horror.f_chapter_call_of_cthulhu(),
            Core.vx_new_string("Kingdom of the Gods"),
            Horror.f_chapter_kingdom_of_the_gods(),
            Core.vx_new_string("Night of the Living Dead"),
            Horror.f_chapter_night_of_the_living_dead(),
            Core.vx_new_string("Serial Killers"),
            Horror.f_chapter_serial_killers(),
            Core.vx_new_string("Deadly Beasts"),
            Horror.f_chapter_deadly_beasts()
          )
        )
      )
    );
  ...
  static {
    ...
    mapfunc.put("chapter_call_of_cthulhu", Horror.t_chapter_call_of_cthulhu);
    mapfunc.put("chapter_deadly_beasts", Horror.t_chapter_deadly_beasts);
    mapfunc.put("chapter_horror_overview", Horror.t_chapter_horror_overview);
    mapfunc.put("chapter_kingdom_of_the_gods", Horror.t_chapter_kingdom_of_the_gods);
    mapfunc.put("chapter_night_of_the_living_dead", Horror.t_chapter_night_of_the_living_dead);
    mapfunc.put("chapter_serial_killers", Horror.t_chapter_serial_killers);
