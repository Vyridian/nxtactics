...
export default class nx_tactics_books_gettingstarted {
   ...
   * {scenario}
   */
  static c_scenario_murin_a0 = {vx_type: nx_tactics_base.t_scenario, vx_constdef: {pkgname: 'nx/tactics/books/gettingstarted', name: 'scenario-murin-a0'}}

  /**
   * Constant: scenario-murin-a1
   * {scenario}
   */
  static c_scenario_murin_a1 = {vx_type: nx_tactics_base.t_scenario, vx_constdef: {pkgname: 'nx/tactics/books/gettingstarted', name: 'scenario-murin-a1'}}
  ...
  static {
    ...
    Object.assign(nx_tactics_books_gettingstarted.c_scenario_murin_a0, vx_core.f_new(
    ...
    Object.assign(nx_tactics_books_gettingstarted.c_scenario_murin_a1, vx_core.f_new(
      nx_tactics_base.t_scenario,
      ":summary",
    ...
    Object.assign(nx_tactics_books_gettingstarted.c_scenario_murin_a2, vx_core.f_new(
      nx_tactics_base.t_scenario,
      ":summary",
