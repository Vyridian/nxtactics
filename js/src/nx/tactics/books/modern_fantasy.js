            ...
            vx_core.f_new(
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  "Biomechanic",
                  ":summary",
                  "* BioMechanics focus on using cybernetic implants to achieve a\nman-machine interface."
                ),
                "Central Computer",
                vx_core.f_new(
                  nx_tactics_base.t_unit,
            ...
            vx_core.f_new(
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  "Progenitor Security",
                  ":summary",
                  "* Created by Damage Control, they are the front line security detail\nfor any Progenitor operation. They are fearless and know little\nbesides combat.",
                  ":titles",
                  "Blank, Pawn"
                ),
                "Damage Control",
                vx_core.f_new(
                  ...
                  "Damage Control",
                  ":summary",
                  "* Damage Control is the security wing of the Progenitors. They focus\non weaponizing cloning, implants, and tailored viruses."
                ),
                "Glamor Trap",
                vx_core.f_new(
                  nx_tactics_base.t_unit,
            ...
            vx_core.f_new(
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  "Syndicate Financier",
                  ":summary",
                  "* The Financiers work in positions of finanical influence and perform\nsilent adjustments to the flow of global commerce."
                ),
                "Syndicate Messenger",
                vx_core.f_new(
                  nx_tactics_base.t_unit,
            ...
            vx_core.f_new(
              ...
              vx_core.f_new(
                ...
                vx_core.f_new(
                  ...
                  "Research Corp",
                  ":summary",
                  "* The Research Corp is responsible for the development of dimensional\nscience, the Technocratic study of the Umbra."
                ),
                "Void Border Corp",
                vx_core.f_new(
                  nx_tactics_base.t_unit,
