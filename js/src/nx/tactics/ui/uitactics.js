  ...
  static f_string_display_from_unit(unit) {
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new(vx_core.t_any_from_func, () => {
        ...
        const skilllist = nx_tactics_ui_uitactics.f_stringlist_display_from_unitskillmap(unitskillmap)
  ...
  static f_string_from_conscience_beast_shadow(conscience, beast, shadow) {
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new(vx_core.t_any_from_func, () => {
        ...
        return vx_type.f_string_from_stringlist_join(slist, " ")
      })
    )
    return output
  }
  ...
  static f_uilist_from_item_parent(unit, parent) {
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new(vx_core.t_any_from_func, () => {
        ...
        const uiitemsummary = vx_core.f_new(
          vx_ui_ui.t_ui,
          ":uid",
          vx_core.f_new(
            vx_core.t_string,
        ...
        const uibodydetail = vx_core.f_new(
          vx_ui_ui.t_ui,
          ":uid",
          vx_core.f_new(
            vx_core.t_string,
  ...
  static f_uilist_from_unit_parent(unit, parent) {
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new(vx_core.t_any_from_func, () => {
        ...
        const uiminddetail = vx_core.f_new(
          vx_ui_ui.t_ui,
          ":uid",
          vx_core.f_new(
            vx_core.t_string,
        ...
        const uiwilldetail = vx_core.f_new(
          vx_ui_ui.t_ui,
          ":uid",
          vx_core.f_new(
            vx_core.t_string,
        ...
        const uimovedetail = vx_core.f_new(
          vx_ui_ui.t_ui,
          ":uid",
          vx_core.f_new(
            vx_core.t_string,
