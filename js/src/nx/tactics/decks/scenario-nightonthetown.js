...
export default class nx_tactics_decks_scenario_nightonthetown {
   ...
   * {ability}
   */
  static c_ability_bite = {vx_type: nx_tactics_base.t_ability, vx_constdef: {pkgname: 'nx/tactics/decks/scenario-nightonthetown', name: 'ability-bite'}}

  /**
   * Constant: ability-sneak
   * {ability}
   */
  static c_ability_sneak = {vx_type: nx_tactics_base.t_ability, vx_constdef: {pkgname: 'nx/tactics/decks/scenario-nightonthetown', name: 'ability-sneak'}}

  /**
   * Constant: skill-closecombat
   * {skill}
   */
  static c_skill_closecombat = {vx_type: nx_tactics_base.t_skill, vx_constdef: {pkgname: 'nx/tactics/decks/scenario-nightonthetown', name: 'skill-closecombat'}}

  /**
   * Constant: skill-melee
   * {skill}
   */
  static c_skill_melee = {vx_type: nx_tactics_base.t_skill, vx_constdef: {pkgname: 'nx/tactics/decks/scenario-nightonthetown', name: 'skill-melee'}}

  /**
   * Constant: skill-stealth
   * {skill}
   */
  static c_skill_stealth = {vx_type: nx_tactics_base.t_skill, vx_constdef: {pkgname: 'nx/tactics/decks/scenario-nightonthetown', name: 'skill-stealth'}}

  /**
   * Constant: skill-survival
   * {skill}
   */
  static c_skill_survival = {vx_type: nx_tactics_base.t_skill, vx_constdef: {pkgname: 'nx/tactics/decks/scenario-nightonthetown', name: 'skill-survival'}}

  /**
   * Constant: skill-tradeskill
   * {skill}
   */
  static c_skill_tradeskill = {vx_type: nx_tactics_base.t_skill, vx_constdef: {pkgname: 'nx/tactics/decks/scenario-nightonthetown', name: 'skill-tradeskill'}}
