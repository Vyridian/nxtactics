...
export default class nx_tactics_decks_wound {
   ...
   * {cardback}
   */
  static c_bleeding = {vx_type: nx_tactics_base.t_cardback, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'bleeding'}}

  /**
   * Constant: bloodloss
   * {card}
   */
  static c_bloodloss = {vx_type: nx_tactics_base.t_card, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'bloodloss'}}

  /**
   * Constant: fatigue
   * {cardback}
   */
  static c_fatigue = {vx_type: nx_tactics_base.t_cardback, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'fatigue'}}

  /**
   * Constant: wound-2c
   * {damage}
   */
  static c_wound_2c = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-2c'}}

  /**
   * Constant: wound-2d
   * {damage}
   */
  static c_wound_2d = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-2d'}}

  /**
   * Constant: wound-2h
   * {damage}
   */
  static c_wound_2h = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-2h'}}

  /**
   * Constant: wound-2s
   * {damage}
   */
  static c_wound_2s = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-2s'}}

  /**
   * Constant: wound-3c
   * {damage}
   */
  static c_wound_3c = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-3c'}}

  /**
   * Constant: wound-3d
   * {damage}
   */
  static c_wound_3d = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-3d'}}

  /**
   * Constant: wound-3h
   * {damage}
   */
  static c_wound_3h = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-3h'}}

  /**
   * Constant: wound-3s
   * {damage}
   */
  static c_wound_3s = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-3s'}}

  /**
   * Constant: wound-4c
   * {damage}
   */
  static c_wound_4c = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-4c'}}

  /**
   * Constant: wound-4d
   * {damage}
   */
  static c_wound_4d = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-4d'}}

  /**
   * Constant: wound-4h
   * {damage}
   */
  static c_wound_4h = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-4h'}}

  /**
   * Constant: wound-4s
   * {damage}
   */
  static c_wound_4s = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-4s'}}

  /**
   * Constant: wound-5c
   * {damage}
   */
  static c_wound_5c = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-5c'}}

  /**
   * Constant: wound-5d
   * {damage}
   */
  static c_wound_5d = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-5d'}}

  /**
   * Constant: wound-5h
   * {damage}
   */
  static c_wound_5h = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-5h'}}

  /**
   * Constant: wound-5s
   * {damage}
   */
  static c_wound_5s = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-5s'}}

  /**
   * Constant: wound-6c
   * {damage}
   */
  static c_wound_6c = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-6c'}}

  /**
   * Constant: wound-6d
   * {damage}
   */
  static c_wound_6d = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-6d'}}

  /**
   * Constant: wound-6h
   * {damage}
   */
  static c_wound_6h = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-6h'}}

  /**
   * Constant: wound-6s
   * {damage}
   */
  static c_wound_6s = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-6s'}}

  /**
   * Constant: wound-7c
   * {damage}
   */
  static c_wound_7c = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-7c'}}

  /**
   * Constant: wound-7d
   * {damage}
   */
  static c_wound_7d = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-7d'}}

  /**
   * Constant: wound-7h
   * {damage}
   */
  static c_wound_7h = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-7h'}}

  /**
   * Constant: wound-7s
   * {damage}
   */
  static c_wound_7s = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-7s'}}

  /**
   * Constant: wound-8c
   * {damage}
   */
  static c_wound_8c = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-8c'}}

  /**
   * Constant: wound-8d
   * {damage}
   */
  static c_wound_8d = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-8d'}}

  /**
   * Constant: wound-8h
   * {damage}
   */
  static c_wound_8h = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-8h'}}

  /**
   * Constant: wound-8s
   * {damage}
   */
  static c_wound_8s = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-8s'}}

  /**
   * Constant: wound-9c
   * {damage}
   */
  static c_wound_9c = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-9c'}}

  /**
   * Constant: wound-9d
   * {damage}
   */
  static c_wound_9d = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-9d'}}

  /**
   * Constant: wound-9h
   * {damage}
   */
  static c_wound_9h = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-9h'}}

  /**
   * Constant: wound-9s
   * {damage}
   */
  static c_wound_9s = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-9s'}}

  /**
   * Constant: wound-ac
   * {damage}
   */
  static c_wound_ac = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-ac'}}

  /**
   * Constant: wound-ad
   * {damage}
   */
  static c_wound_ad = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-ad'}}

  /**
   * Constant: wound-ah
   * {damage}
   */
  static c_wound_ah = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-ah'}}

  /**
   * Constant: wound-as
   * {damage}
   */
  static c_wound_as = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-as'}}

  /**
   * Constant: wound-jc
   * {damage}
   */
  static c_wound_jc = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-jc'}}

  /**
   * Constant: wound-jd
   * {damage}
   */
  static c_wound_jd = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-jd'}}

  /**
   * Constant: wound-jh
   * {damage}
   */
  static c_wound_jh = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-jh'}}

  /**
   * Constant: wound-js
   * {damage}
   */
  static c_wound_js = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-js'}}
   ...
   * {damage}
   */
  static c_wound_kc = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-kc'}}
   ...
   * {damage}
   */
  static c_wound_kd = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-kd'}}
   ...
   * {damage}
   */
  static c_wound_kh = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-kh'}}
   ...
   * {damage}
   */
  static c_wound_ks = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-ks'}}
   ...
   * {damage}
   */
  static c_wound_qc = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-qc'}}
   ...
   * {damage}
   */
  static c_wound_qd = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-qd'}}
   ...
   * {damage}
   */
  static c_wound_qh = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-qh'}}
   ...
   * {damage}
   */
  static c_wound_qs = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-qs'}}

  /**
   * Constant: wound-tc
   * {damage}
   */
  static c_wound_tc = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-tc'}}

  /**
   * Constant: wound-td
   * {damage}
   */
  static c_wound_td = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-td'}}

  /**
   * Constant: wound-th
   * {damage}
   */
  static c_wound_th = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-th'}}

  /**
   * Constant: wound-ts
   * {damage}
   */
  static c_wound_ts = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-ts'}}

  /**
   * Constant: wound-wild-black
   * {damage}
   */
  static c_wound_wild_black = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-wild-black'}}

  /**
   * Constant: wound-wild-red
   * {damage}
   */
  static c_wound_wild_red = {vx_type: nx_tactics_base.t_damage, vx_constdef: {pkgname: 'nx/tactics/decks/wound', name: 'wound-wild-red'}}
  ...
  static {
    ...
    // (const bleeding)
    Object.assign(nx_tactics_decks_wound.c_bleeding, vx_core.f_new(
    ...
    // (const bloodloss)
    Object.assign(nx_tactics_decks_wound.c_bloodloss, vx_core.f_new(
