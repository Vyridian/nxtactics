...
export default class nx_tactics_decks_rule {
  ...
  /**
   * @function card_move_action
   * @return {card}
   */
  static t_card_move_action = {
    vx_type: vx_core.t_type
  }
  static e_card_move_action = {
    vx_type: nx_tactics_decks_rule.t_card_move_action
  }

  // (func card-move-action)
  static f_card_move_action() {
    let output = nx_tactics_base.e_card
    output = vx_core.f_new(
      nx_tactics_base.t_card,
      ":id",
  ...
  static f_card_search_action() {
    ...
    output = vx_core.f_new(
      ...
      "Search",
      ":summary",
      "* [Double Action]: Test [Investigate] vs. [Fate] to search the [Place] you occupy. If you succeed, you may find something."
    )
    return output
  }
    ...
    output = vx_core.f_let(
      ...
      vx_core.f_new(vx_core.t_any_from_func, () => {
        const cardlist = vx_core.f_new(
          ...
          nx_tactics_decks_rule.f_card_move_action(),
  ...
  static {
    ...
    // (func card-move-action)
    nx_tactics_decks_rule.t_card_move_action['vx_value'] = {
      name          : "card-move-action",
      pkgname       : "nx/tactics/decks/rule",
      extends       : ":func",
      idx           : 0,
      allowfuncs    : [],
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_decks_rule.f_card_move_action
    }
