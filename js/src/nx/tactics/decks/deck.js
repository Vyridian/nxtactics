...
export default class nx_tactics_decks_deck {
   ...
   * {tactics}
   */
  static c_tactics_all = {vx_type: nx_tactics_base.t_tactics, vx_constdef: {pkgname: 'nx/tactics/decks/deck', name: 'tactics-all'}}
  ...
  static e_booklist_all = {
    vx_type: nx_tactics_decks_deck.t_booklist_all
  }
    ...
    output = vx_core.f_new(
      ...
      nx_tactics_base.f_cardmap_from_cardlist(
        vx_core.f_new(
          ...
          nx_tactics_decks_damage.f_deck_wound(),
  ...
  static {
    const constmap = vx_core.vx_new_map(vx_core.t_constmap, {
      "tactics-all": nx_tactics_decks_deck.c_tactics_all
    })
    const emptymap = vx_core.vx_new_map(vx_core.t_map, {
      "booklist-all": nx_tactics_decks_deck.e_booklist_all,
    ...
    const funcmap = vx_core.vx_new_map(vx_core.t_funcmap, {
      "booklist-all": nx_tactics_decks_deck.t_booklist_all,
    ...
    // (func booklist-all)
    nx_tactics_decks_deck.t_booklist_all['vx_value'] = {
      name          : "booklist-all",
      ...
      properties    : [],
      proplast      : {},
      fn            : nx_tactics_decks_deck.f_booklist_all
    }
    ...
    // (const tactics-all)
    Object.assign(nx_tactics_decks_deck.c_tactics_all, vx_core.f_let(
      {"any-1": nx_tactics_base.t_tactics},
      [],
      vx_core.f_new(vx_core.t_any_from_func, () => {
        const booklist = nx_tactics_decks_deck.f_booklist_all()
