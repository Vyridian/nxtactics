...
export default class nx_tactics_deck_test {


  static test_package(context) {
    const testcaselist = nx_tactics_deck_test.test_cases(context)
    const output = vx_core.f_new(
      vx_test.t_testpackage,
      ":testpkg", "nx/tactics/deck",
      ":caselist", testcaselist,
      ":coveragesummary", nx_tactics_deck_test.test_coveragesummary(),
      ":coveragedetail", nx_tactics_deck_test.test_coveragedetail()
    );
    return output;
  }
  ...
  static test_coveragesummary() {
    return vx_core.f_new(
      ...
      "docnums", vx_core.f_new(vx_test.t_testcoveragenums, ":pct", 41, ":tests", 5, ":total", 12), 
