...
export default class nx_tactics_decks_damage_test {
  ...
  static test_coveragesummary() {
    return vx_core.f_new(
      ...
      "testpkg",   "nx/tactics/decks/damage", 
      "constnums", vx_core.f_new(vx_test.t_testcoveragenums, ":pct", 0, ":tests", 0, ":total", 111), 
      "docnums", vx_core.f_new(vx_test.t_testcoveragenums, ":pct", 14, ":tests", 18, ":total", 121), 
      "funcnums", vx_core.f_new(vx_test.t_testcoveragenums, ":pct", 0, ":tests", 0, ":total", 10), 
      "bigospacenums", vx_core.f_new(vx_test.t_testcoveragenums, ":pct", 100, ":tests", 0, ":total", 0), 
      "bigotimenums", vx_core.f_new(vx_test.t_testcoveragenums, ":pct", 100, ":tests", 0, ":total", 0), 
      "totalnums", vx_core.f_new(vx_test.t_testcoveragenums, ":pct", 0, ":tests", 0, ":total", 121), 
