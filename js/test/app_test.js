...
import _test from "./_test.js"
import _test from "./_test.js"
import vx_ui_panel_test from "./vx/ui/panel_test.js"
import _test from "./_test.js"
import _test from "./_test.js"
import _test from "./_test.js"
...
export default class app_test {
  ...
  static async f_displaytestsuite() {
			 const arglist = []
    const context = vx_test.f_context_test(...arglist)
  ...
  static f_testpackagelist_from_all_test(context) {
    const testpackagelist = vx_core.f_new(
      ...
      _test.test_package(context),
      _test.test_package(context),
      vx_ui_element_test.test_package(context),
      _test.test_package(context),
      _test.test_package(context),
      _test.test_package(context),
      vx_ui_panel_test.test_package(context),
      _test.test_package(context),
      _test.test_package(context),
      _test.test_package(context)
    )
